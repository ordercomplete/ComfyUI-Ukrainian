...
import { B as createTextVNode, I as createElementBlock, M as computed, N as createBaseVNode, Nt as ref, St as withCtx, U as defineComponent, V as createVNode, at as openBlock, nt as onMounted, qt as toDisplayString, rt as onUnmounted } from "./vendor-vue-core-oGuyqViA.js";
...
import { fr as useBillingRouting, ir as useWorkspaceUI, tr as useBillingContext } from "./settingStore-pm7IqVHI.js";
import { t as useDialogStore } from "./dialogStore-BAELBvsb.js";
import { c as parseIsoDateSafe } from "./DialogHeader-BkpfMvwx.js";
import { t as getErrorMessage } from "./errorUtil-Bu6ObRx2.js";
	...
	setup(__props) {
		...
		async function onConfirmCancel() {
			...
			try {
				...
				if (!shouldUseWorkspaceBilling.value) telemetry?.trackSubscriptionCancellation("failed", cancellationMetadata());
				toast.add({
					severity: "error",
...
//# sourceMappingURL=CancelSubscriptionDialogContent-OADgCNbh.js.map