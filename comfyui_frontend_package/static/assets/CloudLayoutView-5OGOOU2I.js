...
import { B as createTextVNode, D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, Kt as normalizeStyle, N as createBaseVNode, St as withCtx, U as defineComponent, V as createVNode, at as openBlock, ct as renderSlot, nt as onMounted, qt as toDisplayString, s as useRoute, t as RouterView } from "./vendor-vue-core-oGuyqViA.js";
...
var CloudTemplate_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			]), !unref(route).meta.hideHero ? (openBlock(), createElementBlock("div", _hoisted_4, [createVNode(CloudHeroCarousel_default)])) : createCommentVNode("", true)]);
		};
	}
});
//#endregion
...
//# sourceMappingURL=CloudLayoutView-5OGOOU2I.js.map