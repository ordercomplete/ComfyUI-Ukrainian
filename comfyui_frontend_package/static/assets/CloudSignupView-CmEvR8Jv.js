...
import { ot as script } from "./vendor-primevue-T0qpAVQN.js";
import { B as createTextVNode, D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, M as computed, N as createBaseVNode, Nt as ref, P as createBlock, St as withCtx, U as defineComponent, V as createVNode, at as openBlock, c as useRouter, nt as onMounted, qt as toDisplayString, s as useRoute } from "./vendor-vue-core-oGuyqViA.js";
...
import { Ia as getTierCredits, Qn as isInChina, dr as useAuthActions } from "./settingStore-pm7IqVHI.js";
...
import { t as usePostAuthRedirect } from "./usePostAuthRedirect-BHqUz5uu.js";
...
var _hoisted_9 = { class: "mx-auto my-0 flex w-full max-w-10/12 flex-wrap items-center justify-center gap-x-1 py-4 text-center text-sm/5 tracking-[-0.011em] text-primary-comfy-canvas" };
var _hoisted_10 = {
...
var _hoisted_12 = { class: "mx-auto mt-2 mb-0 flex w-full max-w-10/12 flex-wrap items-center justify-center gap-x-1 text-center text-sm/5 tracking-[-0.011em] text-primary-comfy-canvas" };
var _hoisted_13 = {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [createBaseVNode("div", _hoisted_2, [
				...
				createBaseVNode("p", _hoisted_12, [
					...
					createBaseVNode("a", _hoisted_13, toDisplayString(unref(t)("cloudWaitlist_contactLink")), 1),
					_cache[3] || (_cache[3] = createTextVNode(". ", -1))
				])
			])]);
		};
	}
}), [["__scopeId", "data-v-97c8d869"]]);
//#endregion
export { CloudSignupView_default as default };

//# sourceMappingURL=CloudSignupView-CmEvR8Jv.js.map