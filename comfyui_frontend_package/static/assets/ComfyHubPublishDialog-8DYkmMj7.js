...
import { B as createTextVNode, Ct as withDirectives, D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, Kt as normalizeStyle, M as computed, N as createBaseVNode, Nt as ref, P as createBlock, Q as nextTick, St as withCtx, T as withModifiers, U as defineComponent, V as createVNode, Wt as normalizeClass, X as mergeModels, at as openBlock, et as onBeforeUnmount, ht as useModel, jt as reactive, nt as onMounted, ot as provide, qt as toDisplayString, st as renderList, vt as watch, w as withKeys, y as vModelCheckbox } from "./vendor-vue-core-oGuyqViA.js";
import { an as CollapsibleRoot_default, in as CollapsibleContent_default, rn as CollapsibleTrigger_default } from "./vendor-reka-ui-CLUGudFd.js";
import { r as useI18n } from "./vendor-i18n-CPpp7rsM.js";
import { Et as orderBy, _ as monitorForElements, a as v4, m as setCustomNativeDragPreview, t as vAutoAnimate } from "./vendor-other-hebp3VVz.js";
import { t as cn } from "./src-C1FpYMFF.js";
import { t as Button_default } from "./Button-By8A3toz.js";
import { B as useStepper, M as useMouseInElement, P as useObjectUrl, d as useAsyncState, g as useDropZone } from "./vendor-vueuse-De7x5bAw.js";
import { i as api } from "./api-btlSMXR9.js";
import { t as useToastStore } from "./toastStore-D7DQZkvm.js";
import { A as useWorkflowStore, Ba as BaseModalLayout_default, Dn as Skeleton_default, Jr as TagsInputItemText_default, Jt as usePragmaticDroppable, K as useWorkflowService, Qr as TagsInput_default, Vs as WORKSPACE_STORAGE_KEYS, Xr as TagsInputItem_default, Yr as TagsInputItemDelete_default, Zr as TagsInputInput_default, ki as useCurrentUser, qt as usePragmaticDraggable, za as StatusBadge_default } from "./settingStore-pm7IqVHI.js";
import { c as t } from "./i18n-B4bSsdRi.js";
import { t as appendJsonExt } from "./formatUtil-gEy6QwfT.js";
...
import { a as zHubProfileResponse, i as zHubLabelListResponse, n as AssetSectionList_default, o as zHubWorkflowPublishResponse, r as zHubAssetUploadUrlResponse, t as useWorkflowShareService } from "./workflowShareService-DTbJzYgL.js";
...
function useComfyHubPublishWizard() {
	...
	function applyPrefill(prefill) {
		...
		formData.value = {
			...current,
			name: current.name === defaults.name ? prefill.name ?? current.name : current.name,
...
//# sourceMappingURL=ComfyHubPublishDialog-8DYkmMj7.js.map