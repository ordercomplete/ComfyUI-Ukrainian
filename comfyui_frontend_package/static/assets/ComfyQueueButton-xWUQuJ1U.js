...
import { B as createTextVNode, Ct as withDirectives, D as Fragment, Ht as unref, I as createElementBlock, M as computed, N as createBaseVNode, Nt as ref, P as createBlock, S as vModelText, St as withCtx, T as withModifiers, U as defineComponent, V as createVNode, Wt as normalizeClass, at as openBlock, f as storeToRefs, qt as toDisplayString, st as renderList, ut as resolveDirective, vt as watch, w as withKeys } from "./vendor-vue-core-oGuyqViA.js";
import { Z as DropdownMenuTrigger_default, ct as DropdownMenuRoot_default, it as DropdownMenuPortal_default, ot as DropdownMenuItem_default, st as DropdownMenuContent_default } from "./vendor-reka-ui-CLUGudFd.js";
...
import { Ai as useCommandStore, Br as isInstantMode, Q as useWorkspaceStore, Ur as useQueueSettingsStore, Vr as isInstantRunningMode, jt as useExecutionErrorStore, n as useSettingStore } from "./settingStore-pm7IqVHI.js";
import { t as ButtonGroup_default } from "./ButtonGroup-COPmojS_.js";
//#endregion
				...
				default: withCtx(() => [
					...
					withDirectives((openBlock(), createBlock(Button_default, {
						...
						default: withCtx(() => [createBaseVNode("i", {
							class: normalizeClass(unref(cn)(iconClass.value, "size-4")),
							"data-testid": "queue-button-icon"
						}, null, 2), createTextVNode(" " + toDisplayString(queueButtonLabel.value), 1)]),
						_: 1
...
//# sourceMappingURL=ComfyQueueButton-xWUQuJ1U.js.map