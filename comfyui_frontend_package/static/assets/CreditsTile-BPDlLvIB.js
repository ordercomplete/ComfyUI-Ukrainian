...
import { st as script } from "./vendor-primevue-T0qpAVQN.js";
import { B as createTextVNode, Bt as toValue, Ct as withDirectives, D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, Kt as normalizeStyle, M as computed, N as createBaseVNode, P as createBlock, St as withCtx, U as defineComponent, V as createVNode, Wt as normalizeClass, at as openBlock, nt as onMounted, qt as toDisplayString, ut as resolveDirective } from "./vendor-vue-core-oGuyqViA.js";
...
import { Fa as TIER_TO_KEY, Ia as getTierCredits, Na as DEFAULT_TIER_KEY, br as formatCreditsFromCents, ir as useWorkspaceUI, qn as useDialogService, rr as useSubscriptionDialog, tr as useBillingContext, vr as centsToCredits, yr as formatCredits } from "./settingStore-pm7IqVHI.js";
import { t as useErrorHandling } from "./useErrorHandling-qSb1ezo_.js";
import { o as consumePendingTopup } from "./types-DQDrDd50.js";
...
var CreditsTile_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const creditPoolTotalCredits = computed(() => {
			const monthlyCredits = currentTeamCreditStop.value?.credits_monthly ?? getTierCredits(tierKey.value);
			if (monthlyCredits === null) return null;
			return subscription.value?.duration === "ANNUAL" ? monthlyCredits * 12 : monthlyCredits;
		});
		...
		const showBar = computed(() => showBreakdown.value && creditPoolTotalCredits.value !== null && creditPoolTotalCredits.value > 0);
...
//#endregion
export { CreditsTile_default as t };

//# sourceMappingURL=CreditsTile-BPDlLvIB.js.map