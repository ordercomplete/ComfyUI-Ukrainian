...
import { D as script$1, st as script } from "./vendor-primevue-T0qpAVQN.js";
import { B as createTextVNode, Ct as withDirectives, D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, M as computed, N as createBaseVNode, Nt as ref, P as createBlock, St as withCtx, U as defineComponent, V as createVNode, Wt as normalizeClass, _t as useTemplateRef, at as openBlock, f as storeToRefs, qt as toDisplayString, st as renderList, ut as resolveDirective } from "./vendor-vue-core-oGuyqViA.js";
...
import { l as onClickOutside } from "./vendor-vueuse-De7x5bAw.js";
import { n as useTelemetry } from "./telemetry-C8VBI5GP.js";
import { Li as useTeamWorkspaceStore, Yn as useSettingsDialog, br as formatCreditsFromCents, ir as useWorkspaceUI, ki as useCurrentUser, qn as useDialogService, rr as useSubscriptionDialog, tr as useBillingContext } from "./settingStore-pm7IqVHI.js";
...
import { n as useWorkspaceSwitch, t as useWorkspaceTierLabel } from "./useWorkspaceTierLabel-XdsH01PC.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$1, [createBaseVNode("div", _hoisted_2$1, [unref(isFetchingWorkspaces) ? (openBlock(), createElementBlock("div", _hoisted_3$1, [(openBlock(), createElementBlock(Fragment, null, renderList(2, (i) => {
				...
				return openBlock(), createElementBlock("div", {
					...
					}, toDisplayString(workspace.name), 9, _hoisted_7$1), resolveTierLabel(workspace) ? (openBlock(), createElementBlock("span", _hoisted_8$1, toDisplayString(resolveTierLabel(workspace)), 1)) : createCommentVNode("", true)]), createBaseVNode("span", _hoisted_9$1, toDisplayString(getRoleLabel(workspace.role)), 1)]),
...
var _hoisted_6 = { class: "flex w-0 flex-1 items-center gap-2" };
...
var CurrentUserPopoverWorkspace_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const showSubscribeAction = computed(() => isCancelled.value && permissions.value.canManageSubscriptionLifecycle || !isActiveSubscription.value && permissions.value.canManageSubscription);
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [
				...
				createBaseVNode("div", _hoisted_5, [withDirectives((openBlock(), createElementBlock("div", {
				...
				}, null, 8, ["workspace-name"]), createBaseVNode("span", _hoisted_7, toDisplayString(unref(workspaceName)), 1)]), _cache[1] || (_cache[1] = createBaseVNode("i", { class: "pi pi-chevron-down shrink-0 text-sm text-muted-foreground" }, null, -1))])), [[_directive_tooltip, {
				...
				createBaseVNode("div", _hoisted_8, [
					_cache[3] || (_cache[3] = createBaseVNode("i", { class: "icon-[lucide--component] text-sm text-credit" }, null, -1)),
...
//# sourceMappingURL=CurrentUserPopoverWorkspace-ContCb7S.js.map