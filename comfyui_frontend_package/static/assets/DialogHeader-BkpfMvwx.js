...
import { B as createTextVNode, Bt as toValue, F as createCommentVNode, G as guardReactiveProps, Gt as normalizeProps, Ht as unref, I as createElementBlock, L as createPropsRestProxy, M as computed, N as createBaseVNode, P as createBlock, St as withCtx, U as defineComponent, V as createVNode, Wt as normalizeClass, Z as mergeProps, at as openBlock, ct as renderSlot, qt as toDisplayString } from "./vendor-vue-core-oGuyqViA.js";
import { Jt as DialogTitle_default$1, Qt as DialogContent_default$1, Xt as DialogOverlay_default$1, Yt as DialogPortal_default$1, cn as useForwardPropsEmits, en as DialogClose_default$1, nn as injectDialogRootContext, sn as Presence_default, tn as DialogRoot_default } from "./vendor-reka-ui-CLUGudFd.js";
...
*/
var formatClockTime = (ts, locale, clockPreferenceLocale) => {
	const d = new Date(ts);
	const { hourCycle } = new Intl.DateTimeFormat(clockPreferenceLocale, { hour: "numeric" }).resolvedOptions();
	return new Intl.DateTimeFormat(locale, {
		hour: "numeric",
		minute: "2-digit",
		second: "2-digit",
...
//# sourceMappingURL=DialogHeader-BkpfMvwx.js.map