...
import { B as createTextVNode, C as vShow, Ct as withDirectives, D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, M as computed, N as createBaseVNode, Nt as ref, Ot as isRef, P as createBlock, St as withCtx, U as defineComponent, V as createVNode, Wt as normalizeClass, X as mergeModels, at as openBlock, f as storeToRefs, ht as useModel, k as Teleport, m as Transition, qt as toDisplayString, rt as onUnmounted, st as renderList, vt as watch } from "./vendor-vue-core-oGuyqViA.js";
import { r as useI18n } from "./vendor-i18n-CPpp7rsM.js";
import { t as Button_default } from "./Button-By8A3toz.js";
import { jt as useExecutionErrorStore, on as useSurveyFeatureTracking } from "./settingStore-pm7IqVHI.js";
import { n as getFloatingSurveys, r as getSurveyConfig } from "./useFeatureUsageTracker-B5Lg6nSg.js";
import { t as isTypeformIdValid } from "./useTypeformEmbed-DUkqWdpw.js";
import { t as TypeformEmbed_default } from "./TypeformEmbed-Dx5cc2ST.js";
import { n as useErrorSurveyPopoverState, t as useSurveyEligibility } from "./useSurveyEligibility-RDitj751.js";
	...
	setup(__props, { emit: __emit }) {
		...
		watch(isEligible, (eligible) => {
			...
			showTimeout = setTimeout(() => {
				showTimeout = null;
				if (!isTypeformIdValid(__props.config.typeformId)) return;
		...
		return (_ctx, _cache) => {
			return hasOpenedOnce.value ? (openBlock(), createBlock(Teleport, {
				...
				default: withCtx(() => [withDirectives(createBaseVNode("div", _hoisted_1, [
					...
					createBaseVNode("div", _hoisted_3, [createVNode(TypeformEmbed_default, {
						"typeform-id": __props.config.typeformId,
						"auto-resize": ""
					}, null, 8, ["typeform-id"])]),
...
//# sourceMappingURL=NightlySurveyController-C_XFMqPV.js.map