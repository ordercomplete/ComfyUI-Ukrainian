...
import { G as guardReactiveProps, Gt as normalizeProps, Ht as unref, L as createPropsRestProxy, M as computed, N as createBaseVNode, P as createBlock, St as withCtx, U as defineComponent, V as createVNode, Wt as normalizeClass, Z as mergeProps, at as openBlock, ct as renderSlot } from "./vendor-vue-core-oGuyqViA.js";
import { A as SelectScrollUpButton_default$1, D as SelectViewport_default, F as SelectItem_default$1, I as SelectIcon_default, L as SelectContent_default$1, M as SelectPortal_default, N as SelectItemText_default, O as SelectValue_default$1, P as SelectItemIndicator_default, R as SelectRoot_default, cn as useForwardPropsEmits, j as SelectScrollDownButton_default$1, k as SelectTrigger_default$1 } from "./vendor-reka-ui-CLUGudFd.js";
			...
			return openBlock(), createBlock(unref(SelectPortal_default), { disabled: __props.disablePortal }, {
				default: withCtx(() => [createVNode(unref(SelectContent_default$1), mergeProps({
					...
					default: withCtx(() => [
						...
						createVNode(unref(SelectViewport_default), { class: normalizeClass(unref(cn)("flex scrollbar-custom flex-col gap-0", __props.position === "popper" && "h-(--reka-select-trigger-height) w-full min-w-(--reka-select-trigger-width)")) }, {
							default: withCtx(() => [renderSlot(_ctx.$slots, "default")]),
							_: 3
						}, 8, ["class"]),
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(SelectTrigger_default$1), mergeProps(restProps, {
				...
				class: unref(cn)("flex w-full cursor-pointer items-center justify-between select-none", __props.size === "md" ? "h-8 px-3 py-1 text-xs" : "h-10 px-4 py-2 text-sm", "rounded-lg", "bg-secondary-background text-base-foreground", "transition-all duration-200 ease-in-out", "hover:bg-secondary-background-hover", "border-[2.5px] border-solid", __props.invalid ? "border-destructive-background" : "border-transparent focus:border-node-component-border", "focus:outline-none", "data-placeholder:text-muted-foreground", "disabled:cursor-not-allowed disabled:opacity-30 disabled:hover:bg-secondary-background", "[&>span]:truncate", __props.class)
			}), {
...
//# sourceMappingURL=SelectValue-Bfpp46Bi.js.map