...
import { $ as script$2, D as script$5, H as script$4, X as useToast, a as script, ot as script$1, r as zodResolver, y as script$3 } from "./vendor-primevue-T0qpAVQN.js";
import { B as createTextVNode, D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, M as computed, N as createBaseVNode, Nt as ref, P as createBlock, St as withCtx, U as defineComponent, V as createVNode, Wt as normalizeClass, at as openBlock, nt as onMounted, qt as toDisplayString, rt as onUnmounted } from "./vendor-vue-core-oGuyqViA.js";
...
import { it as useThrottleFn } from "./vendor-vueuse-De7x5bAw.js";
import { Ii as useAuthStore, Ji as getComfyPlatformBaseUrl, Pi as useApiKeyAuthStore, Qn as isInChina, dr as useAuthActions } from "./settingStore-pm7IqVHI.js";
import { i as configValueOrDefault, o as remoteConfig } from "./remoteConfig-F6WCXiNB.js";
import { t as isEmbeddedWebView } from "./webviewDetection-DsB6Z2yt.js";
import { n as signInSchema, t as apiKeySchema } from "./signInSchema-Dmokl1xj.js";
import { t as SignUpForm_default } from "./SignUpForm-DN9KdCN-.js";
...
var _hoisted_9 = ["alt"];
var _hoisted_10 = { class: "text-center text-muted" };
var _hoisted_11 = ["href"];
var _hoisted_12 = { class: "mt-8 text-xs text-muted" };
var _hoisted_13 = {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [showApiKeyForm.value ? (openBlock(), createBlock(ApiKeyForm_default, {
				...
				createBaseVNode("div", _hoisted_7, [
					unref(ssoAllowed) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
						createVNode(Button_default, {
							type: "button",
							class: "h-10",
							variant: "secondary",
						...
						unref(showGoogleSsoInAppBrowserNotice) ? (openBlock(), createElementBlock("p", _hoisted_8, toDisplayString(unref(t)("auth.login.googleSsoInAppBrowserNotice")), 1)) : createCommentVNode("", true)
					], 64)) : createCommentVNode("", true),
					!unref(false) ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [createVNode(Button_default, {
						type: "button",
						class: "h-10",
						variant: "secondary",
						...
						default: withCtx(() => [createBaseVNode("img", {
							...
							class: "mr-2 size-5",
							alt: _ctx.$t("g.comfy")
						}, null, 8, _hoisted_9), createTextVNode(" " + toDisplayString(unref(t)("auth.login.useApiKey")), 1)]),
						_: 1
					}), createBaseVNode("small", _hoisted_10, [createTextVNode(toDisplayString(unref(t)("auth.apiKey.helpText")) + " ", 1), createBaseVNode("a", {
						href: `${comfyPlatformBaseUrl.value}/login`,
						target: "_blank",
						class: "cursor-pointer text-blue-500"
					}, toDisplayString(unref(t)("auth.apiKey.generateKey")), 9, _hoisted_11)])], 64)) : createCommentVNode("", true),
				...
				createBaseVNode("p", _hoisted_12, [
					...
					createBaseVNode("a", _hoisted_13, toDisplayString(unref(t)("auth.login.termsLink")), 1),
					createTextVNode(" " + toDisplayString(unref(t)("auth.login.andText")) + " ", 1),
					createBaseVNode("a", _hoisted_14, toDisplayString(unref(t)("auth.login.privacyLink")), 1),
...
//# sourceMappingURL=SignInContent-CXRu9vNS.js.map