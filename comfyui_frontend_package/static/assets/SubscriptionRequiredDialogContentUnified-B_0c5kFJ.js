...
import { v as script } from "./vendor-primevue-T0qpAVQN.js";
import { B as createTextVNode, C as vShow, Ct as withDirectives, D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, M as computed, N as createBaseVNode, Nt as ref, P as createBlock, St as withCtx, U as defineComponent, V as createVNode, Wt as normalizeClass, X as mergeModels, at as openBlock, ht as useModel, nt as onMounted, qt as toDisplayString, st as renderList, vt as watch } from "./vendor-vue-core-oGuyqViA.js";
import { r as useI18n, t as I18nT } from "./vendor-i18n-CPpp7rsM.js";
import { t as cn } from "./src-C1FpYMFF.js";
import { t as Button_default } from "./Button-By8A3toz.js";
import { I as usePreferredReducedMotion, U as useTransition, b as useEventListener, i as TransitionPresets } from "./vendor-vueuse-De7x5bAw.js";
import { Fa as TIER_TO_KEY, Pa as TIER_PRICING, ar as useBillingPlans, ir as useWorkspaceUI, tr as useBillingContext } from "./settingStore-pm7IqVHI.js";
import { n as useFeatureFlags } from "./useFeatureFlags-CvjPiCWD.js";
import { t as Slider_default } from "./Slider-CDv5K1AE.js";
import { a as mapApiTeamCreditStops, n as TEAM_PLAN_CREDIT_STOPS, r as getStopDiscountedMonthlyUsd } from "./workspaceCheckoutTelemetry-Bit6wMVg.js";
import { i as useSubscriptionCheckout, n as SubscriptionSuccessWorkspace_default, r as SubscriptionAddPaymentPreviewWorkspace_default, t as SubscriptionTransitionPreviewWorkspace_default } from "./SubscriptionTransitionPreviewWorkspace-DiV6gpqI.js";
...
var UnifiedPricingTable_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const { plans: apiPlans, currentPlanSlug, fetchPlans, isTeamPlan, subscription, currentTeamCreditStop } = useBillingContext();
		const canSelectPersonalPlan = computed(() => !isTeamPlan.value || permissions.value.canDowngradeToPersonal);
		...
		const isTeamButtonDisabled = computed(() => !permissions.value.canManageSubscription || __props.isLoading || isTeamSubscribed.value && isTeamCurrentPlanSelected.value && !isCancelled.value);
		...
		const isButtonDisabled = (tier) => {
			if (__props.isLoading || !permissions.value.canManageSubscription || !canSelectPersonalPlan.value) return true;
		...
		function handleSubscribe(tierKey) {
			if (__props.isLoading || !permissions.value.canManageSubscription || !canSelectPersonalPlan.value) return;
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$1, [
				showTeam.value ? (openBlock(), createElementBlock("div", _hoisted_2$1, [createVNode(unref(script), {
					...
					options: planScopeOptions.value,
					"option-label": "label",
					"option-value": "value",
					"allow-empty": false,
					unstyled: "",
...
//# sourceMappingURL=SubscriptionRequiredDialogContentUnified-B_0c5kFJ.js.map