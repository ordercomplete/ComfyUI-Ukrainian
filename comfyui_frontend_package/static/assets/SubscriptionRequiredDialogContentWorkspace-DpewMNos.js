...
import { B as createTextVNode, C as vShow, Ct as withDirectives, D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, M as computed, N as createBaseVNode, Nt as ref, P as createBlock, St as withCtx, U as defineComponent, V as createVNode, Wt as normalizeClass, at as openBlock, lt as resolveComponent, nt as onMounted, qt as toDisplayString, st as renderList } from "./vendor-vue-core-oGuyqViA.js";
...
import { Ai as useCommandStore, Fa as TIER_TO_KEY, Pa as TIER_PRICING, tr as useBillingContext } from "./settingStore-pm7IqVHI.js";
				...
				createBaseVNode("div", _hoisted_5$1, [(openBlock(), createElementBlock(Fragment, null, renderList(tiers, (tier) => {
					return createBaseVNode("div", {
						...
						createBaseVNode("div", _hoisted_20, [
							createBaseVNode("div", _hoisted_21, [createBaseVNode("span", _hoisted_22, toDisplayString(unref(t)("subscription.monthlyCreditsPerMemberLabel")), 1), createBaseVNode("div", _hoisted_23, [_cache[2] || (_cache[2] = createBaseVNode("i", { class: "icon-[lucide--component] text-sm text-credit" }, null, -1)), createBaseVNode("span", _hoisted_24, toDisplayString(unref(n)(getMonthlyCreditsPerMember(tier))), 1)])]),
...
var SubscriptionRequiredDialogContentWorkspace_default = /*#__PURE__*/ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	emits: ["close"],
	setup(__props, { emit: __emit }) {
		const { checkoutStep, isLoadingPreview, loadingTier, isSubscribing, isResubscribing, previewData, selectedTierKey, selectedBillingCycle, isPolling, handleSubscribeClick, handleBackToPricing, handleAddCreditCard, handleConfirmTransition, handleResubscribe, handleSuccessClose } = useSubscriptionCheckout(__emit, __props.reason, { tierPlanType: __props.isPersonal ? "personal" : "team" });
		onMounted(() => {
			if (__props.initialCheckout?.planMode === "personal") handleSubscribeClick(__props.initialCheckout);
		});
		return (_ctx, _cache) => {
...
}), [["__scopeId", "data-v-ffb2d978"]]);
//#endregion
export { SubscriptionRequiredDialogContentWorkspace_default as default };

//# sourceMappingURL=SubscriptionRequiredDialogContentWorkspace-DpewMNos.js.map