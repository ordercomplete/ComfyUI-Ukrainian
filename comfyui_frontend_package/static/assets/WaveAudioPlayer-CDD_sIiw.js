...
import { D as Fragment, Ht as unref, I as createElementBlock, Kt as normalizeStyle, M as computed, N as createBaseVNode, Nt as ref, Rt as toRef, St as withCtx, T as withModifiers, U as defineComponent, V as createVNode, Wt as normalizeClass, at as openBlock, qt as toDisplayString, st as renderList } from "./vendor-vue-core-oGuyqViA.js";
import { t as cn } from "./src-C1FpYMFF.js";
import { t as Button_default } from "./Button-By8A3toz.js";
import { ct as whenever, k as useMediaControls } from "./vendor-vueuse-De7x5bAw.js";
import { i as api } from "./api-btlSMXR9.js";
import { u as formatTime } from "./formatUtil-gEy6QwfT.js";
...
var WaveAudioPlayer_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const { audioRef, waveformRef, bars, loading, isPlaying, playedBarIndex, progressRatio, formattedCurrentTime, formattedDuration, togglePlayPause, seekToStart, seekToEnd, volume, volumeIcon, toggleMute, seekToRatio, handleWaveformClick } = useWaveAudioPlayer({
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [__props.variant === "compact" ? (openBlock(), createElementBlock("div", {
				key: 0,
				class: normalizeClass(unref(cn)("flex w-full gap-2", __props.align === "center" ? "items-center" : "items-end")),
				...
				createBaseVNode("div", {
					...
					class: normalizeClass(unref(cn)("flex min-w-0 flex-1 cursor-pointer gap-px", __props.align === "center" ? "items-center" : "items-end")),
					...
					return openBlock(), createElementBlock("div", {
						...
						style: normalizeStyle({ height: bar.height / 100 * __props.height + "px" })
					}, null, 6);
				}), 128))], 6),
...
//# sourceMappingURL=WaveAudioPlayer-CDD_sIiw.js.map