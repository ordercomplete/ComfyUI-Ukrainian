...
import { D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, Kt as normalizeStyle, M as computed, N as createBaseVNode, Nt as ref, P as createBlock, Rt as toRef, T as withModifiers, U as defineComponent, V as createVNode, Wt as normalizeClass, X as mergeModels, _t as useTemplateRef, at as openBlock, et as onBeforeUnmount, ht as useModel, mt as useId, st as renderList, vt as watch } from "./vendor-vue-core-oGuyqViA.js";
import { mt as clamp } from "./vendor-other-hebp3VVz.js";
import { t as cn } from "./src-C1FpYMFF.js";
import { I as useNodeOutputStore, xn as normalize, yn as denormalize } from "./settingStore-pm7IqVHI.js";
import { t as ScrubableNumberInput_default } from "./ScrubableNumberInput-Da92nH0x.js";
import { n as singleValueExtractor, r as useUpstreamValue } from "./useUpstreamValue-BWGdh8Xp.js";
...
function useRangeEditor({ trackRef, modelValue, valueMin, valueMax, showMidpoint, contentInsetX, handleCenterOffsetX }) {
	...
	function pointerToValue(e, handle = null) {
		...
		return denormalize(clamp((e.clientX + grabShiftFor(handle) - rect.left - inset) / contentWidth, 0, 1), valueMin.value, valueMax.value);
	}
...
//# sourceMappingURL=WidgetRange-LJsHwn6R.js.map