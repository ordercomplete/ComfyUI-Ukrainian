...
import { Z as script } from "./vendor-primevue-T0qpAVQN.js";
import { B as createTextVNode, Bt as toValue, Ct as withDirectives, D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, It as shallowRef, J as inject, Kt as normalizeStyle, M as computed, N as createBaseVNode, Nt as ref, Ot as isRef, P as createBlock, Rt as toRef, St as withCtx, T as withModifiers, U as defineComponent, V as createVNode, Wt as normalizeClass, X as mergeModels, Z as mergeProps, _t as useTemplateRef, at as openBlock, ct as renderSlot, ht as useModel, ot as provide, qt as toDisplayString, st as renderList, ut as resolveDirective, vt as watch, w as withKeys } from "./vendor-vue-core-oGuyqViA.js";
import { Dt as ComboboxItemIndicator_default, Et as ComboboxPortal_default, Mt as ComboboxRoot_default, Ot as ComboboxItem_default, Rt as ComboboxAnchor_default, Tt as ComboboxTrigger_default, jt as ComboboxContent_default, kt as ComboboxInput_default } from "./vendor-reka-ui-CLUGudFd.js";
import { r as useI18n } from "./vendor-i18n-CPpp7rsM.js";
import { lt as capitalize } from "./vendor-other-hebp3VVz.js";
import { t as cn } from "./src-C1FpYMFF.js";
import { t as Button_default } from "./Button-By8A3toz.js";
import { L as useRafFn, Q as refDebounced, T as useIntersectionObserver, b as useEventListener, et as tryOnScopeDispose, nt as useDebounceFn, o as computedAsync, u as unrefElement } from "./vendor-vueuse-De7x5bAw.js";
import { i as api } from "./api-btlSMXR9.js";
import { t as useToastStore } from "./toastStore-D7DQZkvm.js";
import { A as useWorkflowStore, An as resolveOutputAssetItems, E as useCanvasStore, Fr as sortAssets, Hn as AsyncSearchInput_default, Ir as filterItemByBaseModels, Ln as getOutputAssetMetadata, Lr as filterItemByOwnership, Pr as useModelUpload, Sn as useAssetsApi, ai as useAssetFilterOptions, f as SUPPORTED_EXTENSIONS_ACCEPT, ii as VirtualGrid_default, jn as useMissingMediaStore, pi as isComboInputSpec, ui as assetService, ya as appendCloudResParam, zr as useAssetsStore } from "./settingStore-pm7IqVHI.js";
import { c as t } from "./i18n-B4bSsdRi.js";
import { h as getMediaTypeFromFilename } from "./formatUtil-gEy6QwfT.js";
import { a as useWidgetHeight } from "./widgetTypes-DCo-gXsA.js";
import { t as useErrorHandling } from "./useErrorHandling-qSb1ezo_.js";
import { c as getAssetDisplayFilename, g as getAssetUrlFilename, i as getAssetBaseModels, l as getAssetDisplayName, u as getAssetFilename } from "./useImageQuiet-DBL4QWSj.js";
import { t as Loader_default } from "./Loader-CoxcNRNx.js";
import { n as isAssetPreviewSupported, t as findServerPreviewUrl } from "./assetPreviewUtil-CAtUdiU0.js";
import { t as WidgetInputBaseClass } from "./layout-CaAofiYn.js";
import { i as PANEL_EXCLUDED_PROPS, o as filterWidgetProps } from "./widgetPropFilter-BmKfZcVR.js";
import { t as WidgetLayoutField_default } from "./WidgetLayoutField-Bcyh-FD_.js";
import { t as WidgetWithControl_default } from "./WidgetWithControl-CpTdgvP6.js";
import { t as useTransformState } from "./useTransformState-LpGflNmu.js";
...
var FormDropdownMenuActions_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		function toggleBaseModelSelection(item) {
			...
			baseModelSelected.value = current.has(item.value) ? new Set([...current].filter((v) => v !== item.value)) : /* @__PURE__ */ new Set([...current, item.value]);
		}
	...
	setup(__props, { emit: __emit }) {
		...
		*/
		...
		function handleSelection(item, index) {
			...
			if (itemIsSelected) sel.delete(item.id);
			...
			if (isSingleSelect.value) closeDropdown({ restoreFocus: true });
		}
...
function useWidgetSelectActions(options) {
	...
	function updateSelectedItems(selectedItems) {
		...
		const name = id == null ? void 0 : dropdownItems.value.find((item) => item.id === id)?.name;
...
function useWidgetSelectItems(options) {
	...
	return {
		...
		selectedSet: computed(() => {
			...
			return item ? /* @__PURE__ */ new Set([item.id]) : /* @__PURE__ */ new Set();
		})
	};
}
//#endregion
...
//# sourceMappingURL=WidgetSelect-Cv7SDzu6.js.map