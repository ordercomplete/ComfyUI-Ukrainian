...
import { Ti as useExtensionService, Zo as getNodeByLocatorId, i as app } from "./settingStore-pm7IqVHI.js";
import { c as t } from "./i18n-B4bSsdRi.js";
import { t as useLoad3dService } from "./load3dService-DMEySLTa.js";
import { i as nodeToLoad3dMap, o as useLoad3d } from "./useLoad3d-DQeWn-fO.js";
...
function applyResultToLoad3d(node, load3d, filePath, cameraState, modelTransform, loadFolder) {
...
function createPreview3DExtension(comfyClass, extensionName, loadFolder) {
	const applyPreviewOutput = (node, result) => {
		...
		useLoad3d(node).waitForLoad3d((load3d) => {
			applyResultToLoad3d(node, load3d, filePath, cameraState, modelTransform, loadFolder);
		});
	};
	return {
		name: extensionName,
		...
		async nodeCreated(node) {
			...
			waitForLoad3d((load3d) => {
				...
				node.onExecuted = function(output) {
					...
					applyResultToLoad3d(node, resolveLoad3d(), filePath, result?.[1], result?.[2]?.[0], loadFolder);
				};
			});
		}
	};
...
//# sourceMappingURL=load3dPreviewExtensions-D2xeI1xG.js.map