//#region src/locales/fr/main.json
var actionbar = {
	"dockToTop": "Ancrer en haut",
	"feedback": "Retour",
	"feedbackTooltip": "Retour",
	"freeTierPartner": "Les nodes partenaires nécessitent un forfait payant",
	"freeTierRuns": "{available} / {MAX_AVAILABLE} exécutions restantes",
	"freeTierRunsExhausted": "Aucune exécution restante",
	"share": "Partager",
...
var assetBrowser = /*#__PURE__*/ JSON.parse("{\"allCategory\":\"Tous les {category}\",\"allModels\":\"Tous les modèles\",\"apiKeyHint\":\"Vous importez des modèles privés ou restreints ? {link}.\",\"apiKeyHintLink\":\"Ajoutez vos clés API dans les Paramètres\",\"ariaLabel\":{\"assetCard\":\"Ressource {name} - {type}\",\"loadingAsset\":\"Chargement de la ressource\"},\"assetCollection\":\"Collection d'actifs\",\"assets\":\"Ressources\",\"baseModel\":\"Modèle de base\",\"baseModels\":\"Modèles de base\",\"browseAssets\":\"Parcourir les ressources\",\"byType\":\"Par type\",\"checkpoints\":\"Checkpoints\",\"civitaiLinkExample\":\"{example} {link}\",\"civitaiLinkExampleStrong\":\"Exemple :\",\"civitaiLinkExampleUrl\":\"https://civitai.com/models/10706/luisap-z-image-and-qwen-pixel-art-refiner?modelVersionId=2225295\",\"civitaiLinkLabel\":\"Lien {download} du modèle Civitai\",\"civitaiLinkLabelDownload\":\"télécharger\",\"civitaiLinkPlaceholder\":\"Collez le lien ici\",\"confirmModelDetails\":\"Confirmer les détails du modèle\",\"connectionError\":\"Veuillez vérifier votre connexion et réessayer\",\"deletion\":{\"body\":\"Ce modèle sera définitivement supprimé de votre bibliothèque.\",\"complete\":\"{assetName} a été supprimé.\",\"failed\":\"{assetName} n'a pas pu être supprimé.\",\"header\":\"Supprimer ce modèle ?\",\"inProgress\":\"Suppression de {assetName}...\"},\"download\":{\"complete\":\"Téléchargement terminé\",\"failed\":\"Échec du téléchargement\",\"inProgress\":\"Téléchargement de {assetName}...\"},\"emptyImported\":{\"canImport\":\"Aucun modèle importé pour le moment. Cliquez sur «\xA0Importer un modèle\xA0» pour ajouter le vôtre.\",\"restricted\":\"Les modèles personnels sont disponibles uniquement à partir du niveau Creator.\"},\"errorAccessForbidden\":\"L'accès à cette ressource est interdit.\",\"errorConnectionRefused\":\"Impossible de se connecter à la source. Veuillez réessayer plus tard.\",\"errorDownloadCancelled\":\"Le téléchargement a été annulé.\",\"errorFileTooLarge\":\"Le fichier dépasse la taille maximale autorisée\",\"errorFormatNotAllowed\":\"Seul le format SafeTensor est autorisé\",\"errorHttpError\":\"Une erreur est survenue lors de la récupération des métadonnées.\",\"errorInternalError\":\"Une erreur inattendue est survenue. Veuillez réessayer.\",\"errorInvalidHost\":\"Le nom d’hôte de l’URL source n’a pas pu être résolu.\",\"errorInvalidUrl\":\"Veuillez fournir une URL.\",\"errorInvalidUrlFormat\":\"Le format de l’URL est invalide. Veuillez vérifier et réessayer.\",\"errorMetadataFetchFailed\":\"Impossible de récupérer les informations du fichier depuis la source.\",\"errorModelTypeNotSupported\":\"Ce type de modèle n'est pas pris en charge\",\"errorNetworkError\":\"Une erreur réseau est survenue. Veuillez vérifier votre connexion et réessayer.\",\"errorNetworkTimeout\":\"La requête a expiré. Veuillez réessayer.\",\"errorRateLimited\":\"Trop de requêtes. Veuillez réessayer dans quelques minutes.\",\"errorRequestCancelled\":\"La requête a été annulée.\",\"errorResourceNotFound\":\"Le fichier est introuvable. Veuillez vérifier l’URL et réessayer.\",\"errorServiceUnavailable\":\"Service temporairement indisponible. Veuillez réessayer plus tard.\",\"errorSourceServerError\":\"Le serveur source rencontre des problèmes. Veuillez réessayer plus tard.\",\"errorUnauthorized\":\"Veuillez vous connecter pour continuer.\",\"errorUnauthorizedSource\":\"Cette ressource nécessite une authentification. Veuillez ajouter votre jeton API dans les paramètres.\",\"errorUnknown\":\"Une erreur inattendue s'est produite\",\"errorUnsafePickleScan\":\"CivitAI a détecté un code potentiellement dangereux dans ce fichier\",\"errorUnsafeVirusScan\":\"CivitAI a détecté un logiciel malveillant ou un contenu suspect dans ce fichier\",\"errorUnsupportedSource\":\"Cette URL n’est pas prise en charge. Seules les URLs Hugging Face et Civitai sont autorisées.\",\"errorUploadFailed\":\"Échec de l'importation de l'actif. Veuillez réessayer.\",\"errorUserTokenAccessDenied\":\"Votre jeton API n’a pas accès à cette ressource. Veuillez vérifier les autorisations de votre jeton.\",\"errorUserTokenInvalid\":\"Votre jeton API enregistré est invalide ou expiré. Veuillez le mettre à jour dans les paramètres.\",\"failedToCreateNode\":\"Échec de la création du nœud. Veuillez réessayer ou consulter la console pour plus de détails.\",\"failedToSetModelValue\":\"Nœud ajouté, mais son modèle n’a pas pu être défini automatiquement. Consultez la console pour plus de détails.\",\"fileFormats\":\"Formats de fichier\",\"fileName\":\"Nom du fichier\",\"fileSize\":\"Taille du fichier\",\"filterBy\":\"Filtrer par\",\"findInLibrary\":\"Trouvez-le dans la section {type} de la bibliothèque de modèles.\",\"finish\":\"Terminer\",\"genericLinkPlaceholder\":\"Collez le lien ici\",\"gridView\":\"Vue en grille\",\"importAnother\":\"Importer un autre\",\"imported\":\"Importé\",\"invalidAsset\":\"Ressource invalide\",\"invalidAssetDetail\":\"La ressource sélectionnée n’a pas pu être validée. Veuillez réessayer.\",\"invalidFilename\":\"Nom de fichier invalide\",\"invalidFilenameDetail\":\"Le nom de fichier de la ressource n’a pas pu être déterminé. Veuillez réessayer.\",\"jobId\":\"ID de tâche\",\"listView\":\"Vue en liste\",\"loadingModels\":\"Chargement de {type}...\",\"maxFileSize\":\"Taille maximale du fichier : {size}\",\"maxFileSizeValue\":\"1 Go\",\"media\":{\"audioPlaceholder\":\"Audio\",\"threeDModelPlaceholder\":\"Modèle 3D\"},\"missingModelImportTypeLocked\":\"Verrouillé sur {type} pour ce modèle manquant\",\"missingModelImportTypeMismatchAlreadyImported\":\"Ce fichier est déjà importé en tant que {actual}.\",\"missingModelImportTypeMismatchNextAction\":\"Essayez d'importer un autre modèle {required} que ce nœud peut utiliser.\",\"missingModelImportTypeMismatchRequired\":\"Ce nœud requiert {required}, donc cette importation ne peut pas résoudre le modèle manquant.\",\"missingModelImportTypeMismatchTitle\":\"Ce modèle ne peut pas résoudre le modèle manquant.\",\"missingModelImportUnknownType\":\"un autre type de modèle\",\"missingModelImportWillReplace\":\"Cette importation remplacera {model} dans :\",\"modelAssociatedWithLink\":\"Le modèle associé au lien que vous avez fourni :\",\"modelInfo\":{\"addBaseModel\":\"Ajouter un modèle de base...\",\"addTag\":\"Ajouter un tag...\",\"additionalTags\":\"Tags supplémentaires\",\"baseModelUnknown\":\"Modèle de base inconnu\",\"basicInfo\":\"Informations de base\",\"compatibleBaseModels\":\"Modèles de base compatibles\",\"description\":\"Description\",\"descriptionNotSet\":\"Aucune description définie\",\"descriptionPlaceholder\":\"Ajoutez une description pour ce modèle...\",\"displayName\":\"Nom d'affichage\",\"editDisplayName\":\"Modifier le nom affiché\",\"fileName\":\"Nom du fichier\",\"modelDescription\":\"Description du modèle\",\"modelTagging\":\"Étiquetage du modèle\",\"modelType\":\"Type de modèle\",\"noAdditionalTags\":\"Aucun tag supplémentaire\",\"selectModelPrompt\":\"Sélectionnez un modèle pour voir ses informations\",\"selectModelType\":\"Sélectionner le type de modèle...\",\"source\":\"Source\",\"title\":\"Infos du modèle\",\"triggerPhrases\":\"Phrases déclencheuses\",\"viewOnSource\":\"Voir sur {source}\"},\"modelName\":\"Nom du modèle\",\"modelNamePlaceholder\":\"Entrez un nom pour ce modèle\",\"modelTypeSelectorLabel\":\"Quel type de modèle est-ce ?\",\"modelTypeSelectorPlaceholder\":\"Sélectionnez le type de modèle\",\"modelUploaded\":\"Modèle importé avec succès.\",\"noAssetsFound\":\"Aucune ressource trouvée\",\"noModelsInFolder\":\"Aucun {type} disponible dans ce dossier\",\"noResultsCanImport\":\"Essayez d’ajuster votre recherche ou vos filtres.\\nVous pouvez également ajouter des modèles en utilisant le bouton «\xA0Importer\xA0» ci-dessus.\",\"noValidSourceDetected\":\"Aucune source d'importation valide détectée\",\"notSureLeaveAsIs\":\"Vous n'êtes pas sûr ? Laissez tel quel\",\"onlyCivitaiUrlsSupported\":\"Seules les URL Civitai sont prises en charge\",\"ownership\":\"Propriété\",\"ownershipAll\":\"Tous\",\"ownershipMyModels\":\"Mes modèles\",\"ownershipPublicModels\":\"Modèles publics\",\"processingModel\":\"Téléchargement démarré\",\"processingModelDescription\":\"Vous pouvez fermer cette fenêtre. Le téléchargement continuera en arrière-plan.\",\"providerCivitai\":\"Civitai\",\"providerHuggingFace\":\"Hugging Face\",\"rename\":{\"failed\":\"Impossible de renommer l'actif.\"},\"selectFrameworks\":\"Sélectionner les frameworks\",\"selectModelType\":\"Sélectionner le type de modèle\",\"selectProjects\":\"Sélectionner les projets\",\"sortAZ\":\"A-Z\",\"sortBy\":\"Trier par\",\"sortDefault\":\"Par défaut\",\"sortPopular\":\"Populaire\",\"sortRecent\":\"Récent\",\"sortUnsorted\":\"Non trié\",\"sortZA\":\"Z-A\",\"sortingType\":\"Type de tri\",\"tags\":\"Tags\",\"tagsHelp\":\"Séparez les tags par des virgules\",\"tagsPlaceholder\":\"ex. : modèles, checkpoint\",\"tryAdjustingFilters\":\"Essayez d'ajuster votre recherche ou vos filtres\",\"unknown\":\"Inconnu\",\"unsupportedUrlSource\":\"Seules les URL provenant de {sources} sont prises en charge\",\"upgradeFeatureDescription\":\"Cette fonctionnalité est disponible uniquement avec les abonnements Creator ou Pro.\",\"upgradeToUnlockFeature\":\"Passez à la version supérieure pour débloquer cette fonctionnalité\",\"upload\":\"Importer\",\"uploadFailed\":\"Échec de l'importation\",\"uploadModel\":\"Importer\",\"uploadModelDescription1\":\"Collez un lien de téléchargement de modèle Civitai pour l'ajouter à votre bibliothèque.\",\"uploadModelDescription1Generic\":\"Collez un lien de téléchargement de modèle pour l'ajouter à votre bibliothèque.\",\"uploadModelDescription2\":\"Seuls les liens provenant de {link} sont actuellement pris en charge\",\"uploadModelDescription2Generic\":\"Seules les URL des fournisseurs suivants sont prises en charge :\",\"uploadModelDescription2Link\":\"https://civitai.com/models\",\"uploadModelDescription3\":\"Taille maximale du fichier : {size}\",\"uploadModelFailedToRetrieveMetadata\":\"Impossible de récupérer les métadonnées. Veuillez vérifier le lien et réessayer.\",\"uploadModelFromCivitai\":\"Importer un modèle depuis Civitai\",\"uploadModelGeneric\":\"Importer un modèle\",\"uploadModelHelpFooterText\":\"Besoin d'aide pour trouver les URL ? Cliquez sur un fournisseur ci-dessous pour voir une vidéo explicative.\",\"uploadModelHelpVideo\":\"Vidéo d'aide à l'importation de modèle\",\"uploadModelHowDoIFindThis\":\"Comment trouver ceci ?\",\"uploadSuccess\":\"Modèle importé avec succès !\",\"uploadingModel\":\"Importation du modèle...\"}");
var auth = {
	"apiKey": {
	...
	"deleteAccount": { "contactSupport": "Pour supprimer votre compte, veuillez contacter {email}" },
	"errors": {
		"auth/cancelled-popup-request": "La connexion a été annulée. Veuillez réessayer.",
		"auth/email-already-in-use": "Un compte avec cette adresse e-mail existe déjà. Essayez plutôt de vous connecter.",
		"auth/invalid-credential": "Identifiants de connexion invalides. Veuillez vérifier votre e-mail et votre mot de passe.",
		"auth/invalid-email": "Veuillez entrer une adresse e-mail valide.",
		"auth/network-request-failed": "Erreur réseau. Veuillez vérifier votre connexion et réessayer.",
		"auth/operation-not-allowed": "Cette méthode de connexion n'est actuellement pas prise en charge.",
		"auth/popup-closed-by-user": "La connexion a été annulée. Veuillez réessayer.",
		"auth/too-many-requests": "Trop de tentatives de connexion. Veuillez patienter un moment et réessayer.",
		"auth/user-disabled": "Ce compte a été désactivé. Veuillez contacter le support.",
	...
	"login": {
		...
		"googleSsoInAppBrowserNotice": "Si vous avez ouvert ceci depuis un navigateur intégré à une application (par exemple Instagram, LinkedIn), la connexion Google peut ne pas fonctionner. Utilisez GitHub ou l'e-mail, ou ouvrez cette page dans le navigateur par défaut de votre appareil.",
		...
		"passwordResetError": "Échec de l'envoi de l'e-mail de réinitialisation du mot de passe. Veuillez réessayer.",
	...
	"loginButton": {
		"tooltipHelp": "Connectez-vous pour pouvoir utiliser les \"Nœuds API\"",
	...
	"reauthRequired": {
		"cancel": "Annuler",
		"confirm": "Se reconnecter",
		"message": "Pour des raisons de sécurité, cette action nécessite que vous vous reconnectiez. Souhaitez-vous continuer ?",
		"title": "Réauthentification requise"
	},
	"signOut": {
		"saveFailed": "Déconnexion annulée car l’enregistrement de «\xA0{workflow}\xA0» a échoué.",
...
var billingOperation = {
	...
	"cancelTimeout": "Délai d'annulation de l'abonnement dépassé",
	...
	"subscriptionSuccess": "Abonnement mis à jour avec succès",
	"subscriptionTimeout": "Le délai de vérification de l'abonnement a expiré",
	"topupFailed": "Échec de la recharge",
	"topupProcessing": "Traitement du paiement — ajout de crédits...",
	"topupSuccess": "Crédits ajoutés avec succès",
	"topupTimeout": "Le délai de vérification de la recharge a expiré"
};
var boundingBox = {
	"height": "Hauteur",
	"width": "Largeur",
...
var builderSave = {
	...
	"successBodyApp": "Ce workflow s’ouvrira désormais par défaut en mode Application.\n\nVoulez-vous le consulter maintenant ?",
	"successBodyGraph": "Ce workflow s’ouvrira sous forme de graphe de nœuds.",
...
var cloudFooter_needHelp = "Besoin d'aide ?";
var cloudForgotPassword_backToLogin = "Retour à la connexion";
var cloudForgotPassword_didntReceiveEmail = "Vous n'avez pas reçu d'e-mail ?";
var cloudForgotPassword_emailLabel = "E-mail";
var cloudForgotPassword_emailPlaceholder = "Entrez votre e-mail";
var cloudForgotPassword_emailRequired = "L'e-mail est requis";
var cloudForgotPassword_instructions = "Entrez votre adresse e-mail et nous vous enverrons un lien pour réinitialiser votre mot de passe.";
var cloudForgotPassword_passwordResetError = "Échec de l'envoi de l'e-mail de réinitialisation du mot de passe";
var cloudForgotPassword_passwordResetSent = "Réinitialisation du mot de passe envoyée";
var cloudForgotPassword_sendResetLink = "Envoyer le lien de réinitialisation";
var cloudForgotPassword_title = "Mot de passe oublié";
var cloudHero = {
	"nextSlide": "Diapositive suivante",
	"previousSlide": "Diapositive précédente",
	"slidePagerLabel": "Aller à la diapositive {index}",
	"slides": {
		"cloud": {
			"description": "Idéal pour la plupart des utilisateurs souhaitant travailler de n'importe où avec des modèles vérifiés pour une licence commerciale.",
			"title": "Cloud"
		},
		"models": {
			"description": "Modèles sélectionnés et licenciés commercialement, prêts à l’emploi sans configuration.",
			"title": "Modèles"
		},
		"team": {
			"description": "Intégrez votre équipe dès aujourd'hui. Partagez des workflows et des ressources dans toute votre organisation.",
			"title": "Équipe"
		},
		"workflows": {
			"description": "De l’idée au résultat en quelques minutes. Générez plusieurs variantes côte à côte.",
			"title": "Workflows"
		}
	}
};
...
var cloudOnboarding = {
	"authTimeout": {
		...
		"helpText": "Besoin d'aide ? Contactez le",
		"message": "Nous avons des difficultés à nous connecter à ComfyUI Cloud. Cela peut être dû à une connexion lente ou à un problème temporaire du service.",
		"restart": "Se déconnecter et réessayer",
		"supportLink": "support",
		"technicalDetails": "Détails techniques",
		"title": "Connexion trop longue",
		"troubleshooting": "Causes fréquentes :"
	},
	"checkingStatus": "Vérification du statut de votre compte...",
	"forgotPassword": {
		"backToLogin": "Retour à la connexion",
		"didntReceiveEmail": "Vous n'avez pas reçu d'e-mail ? Contactez-nous à",
		"emailLabel": "E-mail",
		...
		"instructions": "Entrez votre adresse e-mail et nous vous enverrons un lien pour réinitialiser votre mot de passe.",
		"passwordResetError": "Échec de l'envoi de l'e-mail de réinitialisation du mot de passe. Veuillez réessayer.",
		"passwordResetSent": "E-mail de réinitialisation du mot de passe envoyé",
		"sendResetLink": "Envoyer le lien de réinitialisation",
	...
	"privateBeta": {
		"desc": "Connectez-vous pour rejoindre la liste d'attente. Nous vous préviendrons quand ce sera votre tour. Déjà notifié ? Connectez-vous pour commencer à utiliser Cloud.",
		"title": "Le cloud est actuellement en bêta privée"
	},
	"retry": "Réessayer",
	...
	"start": {
		...
		"explain": "Générez plusieurs résultats à la fois. Partagez facilement vos flux de travail.",
		"learnAboutButton": "En savoir plus sur Cloud",
...
var cloudPrivateBeta_desc = "Connectez-vous pour rejoindre la liste d'attente. Nous vous préviendrons quand ce sera votre tour. Déjà notifié ? Connectez-vous pour commencer à utiliser Cloud.";
var cloudPrivateBeta_title = "Cloud est actuellement en bêta privée";
var cloudSorryContactSupport_title = "Désolé, contactez le support";
var cloudStart_desc = "Aucune configuration requise. Fonctionne sur tous les appareils.";
var cloudStart_download = "Télécharger ComfyUI";
var cloudStart_explain = "Générez plusieurs résultats à la fois. Partagez facilement vos flux de travail.";
var cloudStart_learnAboutButton = "En savoir plus sur Cloud";
var cloudStart_title = "créez en quelques secondes";
var cloudStart_wantToRun = "Vous préférez exécuter ComfyUI localement ?";
var cloudSurvey_steps_experience = "Quel est votre niveau de connaissance de ComfyUI ?";
var cloudSurvey_steps_focus = "Qu'êtes-vous en train de créer ?";
var cloudSurvey_steps_intent = "Que souhaitez-vous créer avec ComfyUI ?";
var cloudSurvey_steps_source = "Où avez-vous entendu parler de ComfyUI ?";
var cloudSurvey_steps_source_social = "Quelle plateforme ?";
var cloudWaitlist_contactLink = "ici";
var cloudWaitlist_questionsText = "Des questions ? Contactez-nous";
var color = {
	"alpha": "Alpha",
	"black": "Noir",
	"blue": "Bleu",
	...
	"red": "Rouge",
	"rgba": "RGBA",
	"saturationBrightness": "Saturation et luminosité de la couleur",
	"yellow": "Jaune"
};
var comfyHubProfile = {
	...
	"createProfileTitle": "Créez votre profil Comfy Workflows",
	...
	"introSubtitle": "Pour partager votre workflow sur Comfy Workflows, créons d'abord votre profil.",
	"introTitle": "Publier sur le Comfy Workflows",
	"modalTitle": "Créez votre profil sur Comfy Workflows",
	"nameLabel": "Votre nom",
	"namePlaceholder": "Entrez votre nom ici",
	"profileCreationNav": "Création du profil",
	"startPublishingButton": "Commencer la publication",
	"startUpdatingButton": "Mettre à jour le workflow",
	...
	"updateIntroDescription": "Poussez vos dernières modifications sur Comfy Workflows. Votre lien de partage et vos statistiques restent inchangés.",
	"updateIntroTitle": "Mettez à jour votre workflow Comfy Workflows",
...
var comfyHubPublish = {
	...
	"createProfileToPublish": "Créez un profil pour publier sur Comfy Workflows",
	...
	"next": "Suivant",
	"publishButton": "Publier sur Comfy Workflows",
	...
	"publishSuccessDescription": "Votre workflow est maintenant en ligne sur Comfy Workflows.",
	"publishSuccessTitle": "Publication réussie",
	"removeExampleImage": "Supprimer l’image d’exemple",
	"renameFailedDescription": "Votre workflow a été publié avec succès, mais le renommage du fichier local a échoué. Renommez-le à nouveau pour correspondre.",
	"renameFailedTitle": "Échec du renommage",
	...
	"title": "Publier sur Comfy Workflows",
	"unsavedDescription": "Vous devez enregistrer votre workflow avant de le publier sur Comfy Workflows. Enregistrez-le maintenant pour continuer.",
	"updateButton": "Mettre à jour le workflow",
...
var commands = {
	...
	"refresh": "Actualiser les définitions de nœud",
...
var contextMenu = {
	...
	"Add Subgraph to Library": "Ajouter le sous-graphe à la bibliothèque",
	"Adjust Size": "Ajuster la taille",
	"Align Selected To": "Aligner la sélection sur",
	"Bottom": "Bas",
	"Bypass": "Contourner",
	"Clone": "Cloner",
	"Collapse": "Réduire",
	"Color": "Couleur",
	"Colors": "Couleurs",
	"Convert to Subgraph": "Convertir en sous-graphe",
	"Copy": "Copier",
	"Copy (Clipspace)": "Copier (Clipspace)",
	"Copy Image": "Copier l'image",
	"Delete": "Supprimer",
	"Distribute Nodes": "Répartir les nœuds",
	"Duplicate": "Dupliquer",
	"Edit Subgraph Widgets": "Modifier les widgets du sous-graphe",
	"Expand": "Développer",
	...
	"Remove": "Supprimer",
	"Remove Bypass": "Supprimer le contournement",
	"Rename": "Renommer",
	"RenameWidget": "Renommer le widget",
	"Resize": "Redimensionner",
	"Right": "Droite",
	"Run Branch": "Exécuter la branche",
...
var credits = {
	...
	"faqs": "FAQ",
	"insufficient": {
		"memberCta": "Ok, compris",
		"memberDescription": "Votre équipe a utilisé tous ses crédits. Les administrateurs de votre espace de travail doivent ajouter des crédits pour exécuter des workflows.",
		"memberTitle": "Cet espace de travail n'a plus de crédits"
	},
	"invoiceHistory": "Historique des factures",
	"lastUpdated": "Dernière mise à jour",
	"loadEventsError": "Échec du chargement de l'activité. Veuillez réessayer.",
	"loadEventsUnknownError": "Une erreur s'est produite lors du chargement de l'activité. Veuillez actualiser et réessayer.",
	"messageSupport": "Contacter le support",
	"model": "Modèle",
	"purchaseCredits": "Acheter des crédits",
	"refreshes": "Rafraîchit le {date}",
	"time": "Heure",
	"topUp": {
		"addMoreCredits": "Ajouter des crédits",
		"addMoreCreditsToRun": "Ajouter des crédits pour exécuter",
		"amountToPayLabel": "Montant à payer en dollars",
		"buy": "Acheter",
		"buyCredits": "Continuer vers le paiement",
		"buyNow": "Acheter maintenant",
		"contactUs": "Contactez-nous",
		"creditsDescription": "Les crédits sont utilisés pour exécuter des workflows ou des nœuds partenaires.",
		"creditsPerDollar": "crédits par dollar",
		"creditsToReceiveLabel": "Crédits à recevoir",
		"howManyCredits": "Combien de crédits souhaitez-vous ajouter ?",
		"insufficientMessage": "Vous n'avez pas assez de crédits pour exécuter ce workflow.",
		"insufficientTitle": "Crédits insuffisants",
		"insufficientWorkflowMessage": "Vous n'avez pas assez de crédits pour exécuter ce workflow.",
		"maxAllowed": "Maximum {credits} crédits.",
		"maxAmount": "(Max. 1 000 $ US)",
		"maximumAmount": "Maximum ${amount}.",
		"minRequired": "Minimum {credits} crédits",
		"minimumPurchase": "Achat minimum de ${amount} ({credits} crédits)",
		"needMore": "Besoin de plus ?",
		"purchaseError": "Échec de l'achat",
		"purchaseErrorDetail": "Échec de l'achat de crédits : {error}",
		"purchaseSuccess": "Crédits ajoutés avec succès !",
		"quickPurchase": "Achat rapide",
		"seeDetails": "Voir les détails",
		"selectAmount": "Sélectionner le montant",
		"templateNote": "*Généré avec le modèle Wan Fun Control",
		"topUp": "Recharger",
		"unknownError": "Une erreur inconnue est survenue",
		"usdAmount": "${amount}",
		"videosEstimate": "~{count} vidéos",
		"viewPricing": "Voir les détails des tarifs",
		"youGet": "Crédits",
		"youPay": "Montant (USD)"
	},
	"unified": {
		"message": "Les crédits ont été unifiés",
		"tooltip": "Nous avons unifié les paiements sur Comfy. Tout fonctionne désormais avec les Comfy Credits :\n- Nœuds partenaires (anciennement nœuds API)\n- Workflows cloud\n\nVotre solde de nœuds partenaires a été converti en crédits."
	},
...
var dataTypes = {
	...
	"IMAGE": "IMAGE",
	"IMAGECOMPARE": "COMPARAISON_IMAGE",
	"INT": "ENTIER",
	"INTERP_MODEL": "MODÈLE_INTERP",
	...
	"LOAD3D_MODEL_INFO": "CHARGER_INFO_MODÈLE_3D",
	"LOAD_3D": "CHARGER_3D",
	...
	"MOGE_GEOMETRY": "MOGE_GÉOMÉTRIE",
	"MOGE_MODEL": "MOGE_MODÈLE",
	"NOISE": "BRUIT",
	...
	"VIDEO": "Vidéo",
	"VOXEL": "VOXEL",
	"WAN_CAMERA_EMBEDDING": "INTÉGRATION_CAMÉRA_WAN",
	"WEBCAM": "WEBCAM"
};
var desktopDialogs = { "": {
	"buttons": { "Close": "Fermer" },
	"message": "Un ID de dialogue invalide a été fourni.",
	"title": "Dialogue invalide"
} };
var desktopLogin = {
	"confirmMessage": "L’application de bureau ComfyUI attend de se connecter avec votre compte. Continuez uniquement si vous venez de lancer la connexion depuis l’application de bureau ComfyUI.",
	"confirmSummary": "Approuver la connexion sur le bureau\xA0?",
	"expiredDetail": "La demande de connexion a expiré ou a déjà été utilisée. Relancez la connexion depuis l’application de bureau ComfyUI.",
	"expiredSummary": "Échec de la connexion sur le bureau",
	"failedDetail": "Une erreur est survenue lors de la connexion sur le bureau. Relancez la connexion depuis l’application de bureau ComfyUI.",
	"failedSummary": "Échec de la connexion sur le bureau",
	"successDetail": "Vous pouvez retourner sur l’application de bureau ComfyUI.",
	"successSummary": "Connecté"
};
var desktopMenu = {
...
var desktopStart = { "initialising": "Initialisation..." };
var desktopUpdate = {
...
var downloadGit = {
	...
	"warning": "Si vous êtes sûr de ne pas avoir besoin de git installé, ou s'il y a eu une erreur, vous pouvez cliquer sur Passer pour contourner cette vérification. Essayer de faire fonctionner ComfyUI sans une copie fonctionnelle de git n'est actuellement pas pris en charge."
};
...
var errorCatalog = /*#__PURE__*/ JSON.parse("{\"fallbacks\":{\"inputName\":\"entrée inconnue\",\"nodeName\":\"Ce nœud\"},\"missingErrors\":{\"missing_media\":{\"displayMessage\":\"Une entrée média requise n’a pas de fichier sélectionné.\",\"itemLabel\":\"{nodeName} - {inputName}\",\"toastMessageMany\":\"Veuillez sélectionner les entrées média manquantes avant d’exécuter ce workflow.\",\"toastMessageWithNode\":\"{nodeName} nécessite un fichier média requis.\",\"toastTitleMany\":\"Entrées média manquantes\",\"toastTitleOne\":\"Entrée média manquante\"},\"missing_model\":{\"displayMessageCloud\":\"Importez un modèle ou ouvrez le nœud pour le remplacer.\",\"displayMessageOss\":\"Téléchargez un modèle ou ouvrez le nœud pour le remplacer.\",\"toastMessageManyCloud\":\"Certains modèles ne sont pas pris en charge. Veuillez en choisir d’autres.\",\"toastMessageManyOss\":\"{count} fichiers de modèles sont manquants.\",\"toastMessageOneCloud\":\"Ce modèle n’est pas pris en charge. Choisissez-en un autre.\",\"toastMessageOneOss\":\"{nodeName} nécessite un fichier modèle manquant.\",\"toastTitleMany\":\"Modèles manquants\",\"toastTitleManyCloud\":\"Des modèles ne sont pas disponibles sur le Cloud\",\"toastTitleOneCloud\":\"{modelName} n’est pas disponible sur le Cloud\",\"toastTitleOneOss\":\"{modelName} est manquant\"},\"missing_node\":{\"displayMessageCloud\":\"Les nœuds personnalisés requis ne sont pas pris en charge sur le Cloud. Remplacez-les par des nœuds compatibles.\",\"displayMessageOss\":\"Installez les packs manquants pour utiliser ce workflow.\",\"toastMessageManyCloud\":\"Ce workflow utilise des nœuds qui ne sont pas pris en charge sur le Cloud.\",\"toastMessageManyOss\":\"{count} nœuds nécessitent des packs de nœuds manquants.\",\"toastMessageOneCloud\":\"Ce nœud n’est pas pris en charge sur le Cloud.\",\"toastMessageOneOss\":\"Ce workflow utilise un nœud personnalisé qui n’est pas installé. Installez-le depuis le registre ou remplacez le nœud.\",\"toastTitleManyCloud\":\"Des nœuds ne sont pas disponibles sur le Cloud\",\"toastTitleManyOss\":\"Nœuds manquants\",\"toastTitleOneCloud\":\"{nodeType} n’est pas disponible sur le Cloud\",\"toastTitleOneOss\":\"Nœud manquant : {nodeType}\"},\"swap_nodes\":{\"displayMessage\":\"Certains nœuds peuvent être remplacés par des alternatives\",\"toastMessageMany\":\"{count} types de nœuds peuvent être remplacés par des alternatives compatibles.\",\"toastMessageOne\":\"Remplacez-le par {replacementNodeType} depuis le panneau d’erreur.\",\"toastTitleMany\":\"Des nœuds peuvent être remplacés\",\"toastTitleOne\":\"{nodeType} peut être remplacé\"}},\"promptErrors\":{\"missing_node_type\":{\"desc\":\"Un type de nœud est manquant ou indisponible. Le workflow peut être corrompu ou nécessiter un nœud personnalisé.\",\"title\":\"Type de nœud manquant\"},\"no_prompt\":{\"desc\":\"Les données du workflow envoyées au serveur sont vides. Il peut s’agir d’une erreur système inattendue.\",\"title\":\"Les données du workflow sont vides\"},\"prompt_no_outputs\":{\"desc\":\"Le workflow ne contient aucun nœud de sortie (par exemple, Enregistrer l’image, Prévisualiser l’image) pour produire un résultat.\",\"title\":\"L'invite n'a pas de sorties\"},\"prompt_outputs_failed_validation\":{\"desc\":\"Le workflow comporte des entrées de nœud invalides. Corrigez les nœuds surlignés avant de le relancer.\",\"title\":\"Échec de la validation de l'invite\"},\"server_error_cloud\":{\"desc\":\"Le serveur a rencontré une erreur inattendue. Veuillez réessayer plus tard.\",\"title\":\"Erreur du serveur\"},\"server_error_local\":{\"desc\":\"Le serveur a rencontré une erreur inattendue. Veuillez consulter les journaux du serveur.\",\"title\":\"Erreur du serveur\"}},\"runtimeErrors\":{\"access_required\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Cette exécution nécessite un accès qui n'est pas disponible pour le compte actuel.\",\"title\":\"Accès requis\",\"toastMessage\":\"Cette exécution nécessite un accès qui n'est pas disponible pour le compte actuel.\",\"toastTitle\":\"Accès requis\"},\"content_blocked\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Cette requête a été bloquée par le système de modération de contenu. Essayez de modifier l'invite ou les entrées.\",\"title\":\"Contenu bloqué\",\"toastMessage\":\"Cette requête a été bloquée par le système de modération de contenu. Essayez de modifier l'invite ou les entrées.\",\"toastTitle\":\"Contenu bloqué\"},\"execution_failed\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Le nœud a généré une erreur lors de l'exécution.\",\"title\":\"Échec de l'exécution\",\"toastMessage\":\"Ce nœud a généré une erreur lors de l'exécution. Vérifiez ses entrées ou essayez une configuration différente.\",\"toastTitle\":\"{nodeName} a échoué\"},\"generation_stalled\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Ce workflow a cessé de progresser. Essayez de le relancer.\",\"title\":\"Génération bloquée\",\"toastMessage\":\"Ce workflow a cessé de progresser. Essayez de le relancer.\",\"toastTitle\":\"Génération bloquée\"},\"image_not_loaded\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Le système n'a pas pu charger cette image.\",\"title\":\"Image non chargée\",\"toastMessage\":\"L'image pour {nodeName} n'a pas pu être chargée. Essayez de l'ajouter à nouveau.\",\"toastTitle\":\"Impossible de charger l'image d'entrée\"},\"insufficient_credits\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Ajoutez des crédits à votre compte pour utiliser ce nœud.\",\"title\":\"Crédits insuffisants\",\"toastMessage\":\"Ajoutez des crédits à votre compte pour utiliser ce nœud.\",\"toastTitle\":\"Crédits insuffisants\"},\"invalid_clip_input\":{\"itemLabel\":\"{nodeName}\",\"message\":\"L'entrée CLIP est manquante ou invalide. Vérifiez le checkpoint connecté ou le chargeur CLIP.\",\"title\":\"Entrée CLIP invalide\",\"toastMessage\":\"{nodeName} a une entrée CLIP manquante ou invalide.\",\"toastTitle\":\"Entrée CLIP invalide\"},\"invalid_prompt\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Saisissez une invite avant d'exécuter ce workflow.\",\"title\":\"Invite vide\",\"toastMessage\":\"Saisissez une invite avant d'exécuter ce workflow.\",\"toastTitle\":\"Invite vide\"},\"invalid_workflow_request\":{\"itemLabel\":\"{nodeName}\",\"message\":\"La requête de workflow est invalide. Vérifiez le workflow et réessayez.\",\"title\":\"Requête de workflow invalide\",\"toastMessage\":\"La requête de workflow est invalide. Vérifiez le workflow et réessayez.\",\"toastTitle\":\"Requête de workflow invalide\"},\"model_access_error\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Un ou plusieurs modèles requis n'ont pas pu être accédés.\",\"title\":\"Accès au modèle requis\",\"toastMessage\":\"Un ou plusieurs modèles requis n'ont pas pu être accédés.\",\"toastTitle\":\"Accès au modèle requis\"},\"model_download_failed\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Un modèle n'a pas pu être téléchargé. Réessayez.\",\"title\":\"Échec du téléchargement du modèle\",\"toastMessage\":\"Un modèle n'a pas pu être téléchargé. Réessayez.\",\"toastTitle\":\"Échec du téléchargement du modèle\"},\"out_of_memory\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Mémoire GPU insuffisante. Essayez de réduire la résolution de l'image ou la taille du lot, puis relancez.\",\"title\":\"Échec de la génération\",\"toastMessage\":\"Mémoire GPU insuffisante. Essayez de réduire la résolution de l'image ou la taille du lot, puis relancez.\",\"toastTitle\":\"Échec de la génération\"},\"preprocessing_failed\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Le workflow n'a pas pu être préparé. Essayez de le relancer.\",\"title\":\"Échec de la préparation\",\"toastMessage\":\"Le workflow n'a pas pu être préparé. Essayez de le relancer.\",\"toastTitle\":\"Échec de la préparation\"},\"preprocessing_timeout\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Le workflow a mis trop de temps à se préparer. Essayez de le relancer.\",\"title\":\"Délai de préparation dépassé\",\"toastMessage\":\"Le workflow a mis trop de temps à se préparer. Essayez de le relancer.\",\"toastTitle\":\"Délai de préparation dépassé\"},\"rate_limited\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Forte demande en ce moment. Réessayez dans un instant.\",\"title\":\"Serveurs occupés\",\"toastMessage\":\"Forte demande en ce moment. Réessayez dans un instant.\",\"toastTitle\":\"Serveurs occupés\"},\"request_failed\":{\"itemLabel\":\"{nodeName}\",\"message\":\"La requête a échoué avant la fin de l'exécution. Réessayez.\",\"title\":\"Échec de la requête\",\"toastMessage\":\"La requête a échoué avant la fin de l'exécution. Réessayez.\",\"toastTitle\":\"Échec de la requête\"},\"run_ended_unexpectedly\":{\"itemLabel\":\"{nodeName}\",\"message\":\"L'exécution s'est terminée de façon inattendue. Réessayez.\",\"title\":\"Exécution terminée de façon inattendue\",\"toastMessage\":\"L'exécution s'est terminée de façon inattendue. Réessayez.\",\"toastTitle\":\"Exécution terminée de façon inattendue\"},\"run_start_failed\":{\"itemLabel\":\"{nodeName}\",\"message\":\"L'exécution n'a pas pu démarrer. Réessayez.\",\"title\":\"Impossible de démarrer l'exécution\",\"toastMessage\":\"L'exécution n'a pas pu démarrer. Réessayez.\",\"toastTitle\":\"Impossible de démarrer l'exécution\"},\"server_busy\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Les serveurs sont occupés en ce moment. Réessayez dans un instant.\",\"title\":\"Serveurs occupés\",\"toastMessage\":\"Les serveurs sont occupés en ce moment. Réessayez dans un instant.\",\"toastTitle\":\"Serveurs occupés\"},\"server_crashed\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Le serveur s'est arrêté pendant l'exécution de ce workflow. Réessayez.\",\"title\":\"Serveur arrêté\",\"toastMessage\":\"Le serveur s'est arrêté pendant l'exécution de ce workflow. Réessayez.\",\"toastTitle\":\"Serveur arrêté\"},\"sign_in_required\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Les nœuds partenaires nécessitent un compte Comfy. Connectez-vous pour continuer.\",\"title\":\"Connexion requise\",\"toastMessage\":\"Les nœuds partenaires nécessitent un compte Comfy. Connectez-vous pour continuer.\",\"toastTitle\":\"Connectez-vous pour utiliser ce nœud\"},\"subscription_required\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Abonnez-vous à un forfait pour continuer à exécuter ce workflow.\",\"title\":\"Abonnement requis\",\"toastMessage\":\"Abonnez-vous à un forfait pour continuer à exécuter ce workflow.\",\"toastTitle\":\"Abonnement requis\"},\"subscription_upgrade_required\":{\"details\":\"Les modèles privés nécessitent une mise à niveau d'abonnement : {modelNames}\",\"itemLabel\":\"{nodeName}\",\"message\":\"Mettez à niveau votre abonnement pour utiliser les modèles privés dans ce workflow.\",\"title\":\"Mise à niveau d'abonnement requise\",\"toastMessage\":\"Mettez à niveau votre abonnement pour utiliser ces modèles privés : {modelNames}.\",\"toastTitle\":\"Mise à niveau d'abonnement requise\"},\"timeout\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Ce workflow a atteint la durée maximale d'exécution. Essayez de réduire la résolution de l'image, la taille du lot ou la longueur du workflow, puis relancez.\",\"title\":\"Délai de génération dépassé\",\"toastMessage\":\"Ce workflow a atteint la durée maximale d'exécution. Essayez de réduire la résolution de l'image, la taille du lot ou la longueur du workflow, puis relancez.\",\"toastTitle\":\"Délai de génération dépassé\"},\"unexpected_service_error\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Le service a rencontré une erreur inattendue. Réessayez.\",\"title\":\"Erreur du service\",\"toastMessage\":\"Le service a rencontré une erreur inattendue. Réessayez.\",\"toastTitle\":\"Erreur du service\"},\"workspace_insufficient_credits\":{\"itemLabel\":\"{nodeName}\",\"message\":\"Ajoutez des crédits à votre espace de travail pour continuer.\",\"title\":\"Crédits insuffisants\",\"toastMessage\":\"Ajoutez des crédits à votre espace de travail pour continuer.\",\"toastTitle\":\"Crédits insuffisants\"}},\"validationErrors\":{\"bad_linked_input\":{\"details\":\"{nodeName} a une connexion invalide pour {inputName}.\",\"itemLabel\":\"{nodeName} - {inputName}\",\"message\":\"Une connexion de nœud n'a pas pu être lue correctement.\",\"title\":\"Connexion invalide\",\"toastMessage\":\"{nodeName} a une connexion invalide pour {inputName}.\",\"toastTitle\":\"Connexion invalide\"},\"custom_validation_failed\":{\"details\":\"{nodeName} a rejeté la valeur pour {inputName}.\",\"detailsWithRawDetails\":\"{nodeName} a échoué à la validation personnalisée : {rawDetails}\",\"itemLabel\":\"{nodeName} - {inputName}\",\"message\":\"Un nœud a rejeté une ou plusieurs valeurs d'entrée.\",\"title\":\"Entrée invalide\",\"toastMessage\":\"{nodeName} a rejeté la valeur pour {inputName}.\",\"toastTitle\":\"Entrée invalide\"},\"dependency_cycle\":{\"details\":\"{nodeName} fait partie d'une connexion circulaire.\",\"detailsWithRawDetails\":\"{nodeName} fait partie d'une connexion circulaire : {rawDetails}\",\"itemLabel\":\"{nodeName}\",\"message\":\"Le workflow comporte une connexion circulaire de nœuds.\",\"title\":\"Workflow invalide\",\"toastMessage\":\"{nodeName} fait partie d'une connexion circulaire.\",\"toastTitle\":\"Workflow invalide\"},\"exception_during_inner_validation\":{\"details\":\"{nodeName} n'a pas pu valider {inputName}.\",\"detailsWithRawDetails\":\"{nodeName} n'a pas pu valider {inputName} : {rawDetails}\",\"itemLabel\":\"{nodeName} - {inputName}\",\"message\":\"Le workflow n'a pas pu valider un nœud connecté.\",\"title\":\"Échec de la validation\",\"toastMessage\":\"{nodeName} n'a pas pu valider {inputName}.\",\"toastMessageWithRawDetails\":\"{nodeName} n'a pas pu valider {inputName} : {rawDetails}\",\"toastTitle\":\"Échec de la validation\"},\"exception_during_validation\":{\"details\":\"{nodeName} a échoué lors de la validation.\",\"detailsWithRawDetails\":\"{nodeName} a échoué lors de la validation : {rawDetails}\",\"itemLabel\":\"{nodeName}\",\"message\":\"Le workflow n'a pas pu être validé car une vérification de validation de nœud a échoué de façon inattendue.\",\"title\":\"Échec de la validation\",\"toastMessage\":\"{nodeName} a échoué lors de la validation.\",\"toastMessageWithRawDetails\":\"{nodeName} a échoué lors de la validation : {rawDetails}\",\"toastTitle\":\"Échec de la validation\"},\"image_not_loaded\":{\"details\":\"L'image pour {nodeName} n'a pas pu être chargée. Essayez de l'ajouter à nouveau.\",\"itemLabel\":\"{nodeName}\",\"message\":\"Le système n'a pas pu charger cette image.\",\"title\":\"Image non chargée\",\"toastMessage\":\"L'image pour {nodeName} n'a pas pu être chargée. Essayez de l'ajouter à nouveau.\",\"toastTitle\":\"Impossible de charger l'image d'entrée\"},\"invalid_input_type\":{\"details\":\"{nodeName} n'a pas pu convertir {inputName} au type attendu.\",\"detailsWithValue\":\"La valeur {receivedValue} pour l'entrée {inputName} de {nodeName} n'a pas pu être convertie en {expectedType}.\",\"itemLabel\":\"{nodeName} - {inputName}\",\"message\":\"Une valeur d'entrée a un type incorrect.\",\"title\":\"Entrée invalide\",\"toastMessage\":\"{nodeName} n'a pas pu convertir {inputName} au type attendu.\",\"toastMessageWithValue\":\"La valeur {receivedValue} pour l'entrée {inputName} de {nodeName} n'a pas pu être convertie en {expectedType}.\",\"toastTitle\":\"Entrée invalide\"},\"required_input_missing\":{\"details\":\"{nodeName} nécessite une entrée obligatoire : {inputName}\",\"itemLabel\":\"{nodeName} - {inputName}\",\"message\":\"Des entrées requises ne sont pas connectées.\",\"title\":\"Connexion manquante\",\"toastMessage\":\"{nodeName} nécessite une entrée obligatoire : {inputName}\",\"toastTitle\":\"Entrée requise manquante\"},\"return_type_mismatch\":{\"details\":\"{nodeName} a une connexion incompatible pour {inputName}.\",\"detailsWithTypes\":\"L'entrée {inputName} de {nodeName} attend {expectedType}, mais la sortie connectée est {receivedType}.\",\"itemLabel\":\"{nodeName} - {inputName}\",\"message\":\"Les nœuds connectés utilisent des types d'entrée et de sortie incompatibles.\",\"title\":\"Connexion invalide\",\"toastMessage\":\"{nodeName} a une connexion incompatible pour {inputName}.\",\"toastMessageWithTypes\":\"L'entrée {inputName} de {nodeName} attend {expectedType}, mais la sortie connectée est {receivedType}.\",\"toastTitle\":\"Connexion invalide\"},\"unknown_validation_error\":{\"details\":\"{nodeName} a retourné une erreur de validation non reconnue : {errorType}\",\"detailsWithRawDetails\":\"{nodeName} a retourné une erreur de validation non reconnue ({errorType}) : {rawDetails}\",\"itemLabel\":\"{nodeName}\",\"message\":\"Un nœud a retourné une erreur de validation non reconnue par ComfyUI.\",\"title\":\"Échec de la validation\",\"toastMessage\":\"{nodeName} a retourné une erreur de validation non reconnue.\",\"toastTitle\":\"Échec de la validation\"},\"value_bigger_than_max\":{\"details\":\"{nodeName} a une valeur supérieure au maximum pour {inputName}.\",\"detailsWithValue\":\"La valeur {receivedValue} pour l'entrée {inputName} de {nodeName} est supérieure au maximum {maxValue}.\",\"itemLabel\":\"{nodeName} - {inputName}\",\"message\":\"Certaines valeurs d'entrée sont en dehors de la plage autorisée.\",\"title\":\"Entrée hors limites\",\"toastMessage\":\"{nodeName} a une valeur supérieure au maximum pour {inputName}.\",\"toastMessageWithValue\":\"La valeur {receivedValue} pour l'entrée {inputName} de {nodeName} est supérieure au maximum {maxValue}.\",\"toastTitle\":\"Entrée hors limites\"},\"value_not_in_list\":{\"details\":\"{nodeName} a une valeur non prise en charge pour {inputName}.\",\"detailsWithValue\":\"La valeur {receivedValue} pour l'entrée {inputName} de {nodeName} n'est pas disponible.\",\"itemLabel\":\"{nodeName} - {inputName}\",\"message\":\"Certaines valeurs d'entrée ne sont pas disponibles pour ce nœud.\",\"title\":\"Entrée invalide\",\"toastMessage\":\"{nodeName} a une valeur non prise en charge pour {inputName}.\",\"toastMessageWithValue\":\"La valeur {receivedValue} pour l'entrée {inputName} de {nodeName} n'est pas disponible.\",\"toastTitle\":\"Entrée invalide\"},\"value_smaller_than_min\":{\"details\":\"{nodeName} a une valeur inférieure au minimum pour {inputName}.\",\"detailsWithValue\":\"La valeur {receivedValue} pour l'entrée {inputName} de {nodeName} est inférieure au minimum {minValue}.\",\"itemLabel\":\"{nodeName} - {inputName}\",\"message\":\"Certaines valeurs d'entrée sont en dehors de la plage autorisée.\",\"title\":\"Entrée hors limites\",\"toastMessage\":\"{nodeName} a une valeur inférieure au minimum pour {inputName}.\",\"toastMessageWithValue\":\"La valeur {receivedValue} pour l'entrée {inputName} de {nodeName} est inférieure au minimum {minValue}.\",\"toastTitle\":\"Entrée hors limites\"}}}");
var errorDialog = {
...
var errorPanelSurvey = {
	...
	"ctaText": "Que pensez-vous du nouveau panneau d’erreurs\xA0?"
};
var essentials = {
	"3d-transform": "Transformation 3D",
	"control-guidance": "Contrôle & Guidage",
	"control-image": "Contrôle d'image",
	"editing-utilities": "Outils d’édition",
	"generate": "Générer",
	"generate-3d": "3D",
	"generate-audio": "Audio",
	"generate-image": "Image",
	"generate-text": "Texte",
	"generate-video": "Vidéo",
	"image-color": "Couleur d'image",
	"image-filters-effects": "Filtres & Effets d'image",
	"image-selection-masking": "Sélection & Masquage d'image",
	"image-transform": "Transformation d'image",
	"image-utilities": "Outils d'image",
	"inputs-outputs": "Entrées & Sorties",
	"jumpTo": "Aller à",
	"video-compose": "Composition vidéo",
	"video-selection-masking": "Sélection & Masquage vidéo",
	"video-transform": "Transformation vidéo"
};
var execution = {
	"decoding": "Décodage…",
	"encoding": "Encodage…",
...
var exportToast = {
	...
	"noExportsInQueue": "Aucune exportation {filter} en file d’attente",
	"preparingExport": "Préparation de l’export...",
	"retryDownload": "Réessayer le téléchargement"
};
var feedback = { "title": "Partager un retour" };
var g = /*#__PURE__*/ JSON.parse("{\"1x\":\"1x\",\"2x\":\"2x\",\"about\":\"À propos\",\"add\":\"Ajouter\",\"addNewKeybinding\":\"Ajouter un nouveau raccourci clavier\",\"addNode\":\"Ajouter un nœud...\",\"addNodeFilterCondition\":\"Ajouter une condition de filtre de nœud\",\"all\":\"Tout\",\"allKeybindingsReset\":\"Tous les raccourcis clavier ont été réinitialisés par défaut\",\"amount\":\"Quantité\",\"apply\":\"Appliquer\",\"architecture\":\"Architecture\",\"arrange\":\"Organiser\",\"arrangeAsGrid\":\"Organiser en grille\",\"arrangeHorizontally\":\"Organiser horizontalement\",\"arrangeSpacing\":\"Espacement de l’organisation\",\"arrangeVertically\":\"Organiser verticalement\",\"asset\":\"{count} ressource | {count} ressources\",\"audioFailedToLoad\":\"Échec du chargement de l'audio\",\"audioProgress\":\"Progression audio\",\"author\":\"Auteur\",\"back\":\"Retour\",\"batchRename\":\"Renommer en lot\",\"beta\":\"BÊTA\",\"blueprints\":\"Plans\",\"bookmark\":\"Enregistrer dans la bibliothèque\",\"bookmarked\":\"Mis en favori\",\"browserReservedKeybinding\":\"Ce raccourci est réservé par certains navigateurs et peut entraîner des résultats inattendus.\",\"browserReservedKeybindingTooltip\":\"Ce raccourci est en conflit avec des raccourcis réservés du navigateur\",\"calculatingDimensions\":\"Calcul des dimensions\",\"cancel\":\"Annuler\",\"cancelled\":\"Annulé\",\"capture\":\"capture\",\"categories\":\"Catégories\",\"category\":\"Catégorie\",\"changeKeybinding\":\"Modifier le raccourci clavier\",\"chart\":\"Graphique\",\"chartLowercase\":\"graphique\",\"choose_file_to_upload\":\"choisissez le fichier à télécharger\",\"clear\":\"Effacer\",\"clearAll\":\"Tout effacer\",\"clearFilters\":\"Effacer les filtres\",\"close\":\"Fermer\",\"closeDialog\":\"Fermer la boîte de dialogue\",\"collapseAll\":\"Tout réduire\",\"color\":\"Couleur\",\"comfy\":\"Comfy\",\"comfyCloud\":\"Comfy Cloud\",\"comfyOrgLogoAlt\":\"Logo ComfyOrg\",\"comfyPackageOutdated\":\"La version installée de {name} ({installedVersion}) est inférieure à la version requise ({requiredVersion}).\",\"comingSoon\":\"Bientôt disponible\",\"command\":\"Commande\",\"commandProhibited\":\"La commande {command} est interdite. Contactez un administrateur pour plus d'informations.\",\"community\":\"Communauté\",\"completed\":\"Terminé\",\"completedWithCheckmark\":\"Terminé ✓\",\"confirm\":\"Confirmer\",\"confirmed\":\"Confirmé\",\"content\":\"contenu\",\"continue\":\"Continuer\",\"control_after_generate\":\"contrôle après génération\",\"control_before_generate\":\"contrôle avant génération\",\"copied\":\"Copié\",\"copy\":\"Copier\",\"copyAll\":\"Tout copier\",\"copyJobId\":\"Copier l'ID du travail\",\"copySystemInfo\":\"Copier les informations système\",\"copyToClipboard\":\"Copier dans le presse-papiers\",\"copyURL\":\"Copier l’URL\",\"core\":\"Noyau\",\"currentUser\":\"Utilisateur actuel\",\"custom\":\"Personnalisé\",\"customBackground\":\"Arrière-plan personnalisé\",\"customize\":\"Personnaliser\",\"customizeFolder\":\"Personnaliser le dossier\",\"decrement\":\"Diminuer\",\"defaultBanner\":\"bannière par défaut\",\"delete\":\"Supprimer\",\"deleteAudioFile\":\"Supprimer le fichier audio\",\"deleteImage\":\"Supprimer l'image\",\"deprecated\":\"DEPR\",\"description\":\"Description\",\"details\":\"Détails\",\"devOnly\":\"DEV\",\"devices\":\"Appareils\",\"disableAll\":\"Désactiver tout\",\"disableSelected\":\"Désactiver la sélection\",\"disableThirdParty\":\"Désactiver les tiers\",\"disabling\":\"Désactivation\",\"disconnectedFromBackend\":\"Déconnecté du backend. Vérifiez si le serveur est en cours d’exécution.\",\"dismiss\":\"Fermer\",\"download\":\"Télécharger\",\"downloadAudio\":\"Télécharger l'audio\",\"downloadImage\":\"Télécharger l'image\",\"downloadVideo\":\"Télécharger la vidéo\",\"downloadWithSize\":\"Télécharger ({size})\",\"downloading\":\"Téléchargement\",\"dropYourFileOr\":\"Déposez votre fichier ou\",\"duplicate\":\"Dupliquer\",\"edit\":\"Modifier\",\"editImage\":\"Modifier l'image\",\"editOrMaskImage\":\"Modifier ou masquer l'image\",\"emDash\":\"—\",\"empty\":\"Vide\",\"enableAll\":\"Activer tout\",\"enableOrDisablePack\":\"Activer ou désactiver le pack\",\"enableSelected\":\"Activer la sélection\",\"enabled\":\"Activé\",\"enabling\":\"Activation\",\"enter\":\"Entrer\",\"enterBaseName\":\"Entrez le nom de base\",\"enterNewName\":\"Entrez le nouveau nom\",\"enterNewNamePrompt\":\"Entrez le nouveau nom :\",\"enterSubgraph\":\"Entrer dans le sous-graphe\",\"enterYourKeybind\":\"Saisissez votre raccourci\",\"error\":\"Erreur\",\"errorLoadingImage\":\"Erreur lors du chargement de l'image\",\"errorLoadingVideo\":\"Erreur lors du chargement de la vidéo\",\"essentials\":\"Essentiels\",\"expandAll\":\"Tout développer\",\"experimental\":\"BETA\",\"export\":\"Exportation\",\"extensionName\":\"Nom de l'extension\",\"extensions\":\"Extensions\",\"failed\":\"Échec\",\"failedToCopyJobId\":\"Échec de la copie de l'ID du travail\",\"failedToDownloadFile\":\"Échec du téléchargement du fichier\",\"failedToDownloadImage\":\"Échec du téléchargement de l'image\",\"failedToDownloadVideo\":\"Échec du téléchargement de la vidéo\",\"favorites\":\"Favoris\",\"feedback\":\"Commentaires\",\"file\":\"fichier\",\"filter\":\"Filtrer\",\"filterBy\":\"Filtrer par :\",\"filterByType\":\"Filtrer par {type}...\",\"findIssues\":\"Trouver des problèmes\",\"findOnGithub\":\"Trouver sur GitHub\",\"frameNodes\":\"Encadrer les nœuds\",\"frontendNewer\":\"La version du frontend {frontendVersion} peut ne pas être compatible avec la version du backend {backendVersion}.\",\"frontendOutdated\":\"La version du frontend {frontendVersion} est obsolète. Le backend requiert la version {requiredVersion} ou supérieure.\",\"gallery\":\"Galerie\",\"galleryImage\":\"Image de la galerie\",\"galleryThumbnail\":\"Miniature de la galerie\",\"getHelpAction\":\"Obtenir de l'aide\",\"goToNode\":\"Aller au nœud\",\"graphNavigation\":\"Navigation dans le graphe\",\"halfSpeed\":\"0.5x\",\"hideLeftPanel\":\"Masquer le panneau de gauche\",\"hideRightPanel\":\"Masquer le panneau de droite\",\"icon\":\"Icône\",\"imageDoesNotExist\":\"L’image n’existe pas\",\"imageFailedToLoad\":\"Échec du chargement de l'image\",\"imageGallery\":\"galerie d’images\",\"imageLightbox\":\"Aperçu de l'image\",\"imagePreview\":\"Aperçu de l'image - Utilisez les flèches pour naviguer entre les images\",\"imageUrl\":\"URL de l'image\",\"import\":\"Importer\",\"inProgress\":\"En cours\",\"inSubgraph\":\"dans le sous-graphe «\xA0{name}\xA0»\",\"increment\":\"Augmenter\",\"info\":\"Informations du nœud\",\"input\":\"Entrée\",\"insert\":\"Insérer\",\"install\":\"Installer\",\"installed\":\"Installé\",\"installing\":\"Installation\",\"interrupted\":\"Interrompu\",\"itemsCopiedToClipboard\":\"Éléments copiés dans le presse-papiers\",\"itemsSelected\":\"{selectedCount} éléments sélectionnés\",\"job\":\"Tâche\",\"jobIdCopied\":\"ID du travail copié dans le presse-papiers\",\"keybinding\":\"Raccourci clavier\",\"keybindingAlreadyExists\":\"Le raccourci clavier existe déjà\",\"keybindingListAriaLabel\":\"Raccourcis clavier : {combos}\",\"keybindingPresets\":{\"default\":\"Préréglage par défaut\",\"deletePreset\":\"Supprimer le préréglage\",\"deletePresetFailed\":\"Échec de la suppression du préréglage \\\"{name}\\\"\",\"deletePresetTitle\":\"Supprimer le préréglage actuel ?\",\"deletePresetWarning\":\"Ce préréglage sera supprimé. Cette action est irréversible.\",\"discardAndSwitch\":\"Ignorer et changer\",\"exportPreset\":\"Exporter le préréglage\",\"importKeybindingPreset\":\"Importer un préréglage de raccourcis\",\"importPreset\":\"Importer un préréglage\",\"invalidPresetFile\":\"Le fichier de préréglage doit être un JSON valide exporté depuis ComfyUI\",\"invalidPresetName\":\"Le nom du préréglage ne doit pas être vide, \\\"default\\\", commencer par un point, contenir des séparateurs de chemin ou se terminer par .json\",\"loadPresetFailed\":\"Échec du chargement du préréglage \\\"{name}\\\"\",\"overwritePresetMessage\":\"Un préréglage nommé \\\"{name}\\\" existe déjà. Voulez-vous l'écraser ?\",\"overwritePresetTitle\":\"Écraser le préréglage\",\"presetDeleted\":\"Préréglage \\\"{name}\\\" supprimé\",\"presetImported\":\"Préréglage de raccourcis importé\",\"presetNamePrompt\":\"Entrez un nom pour le préréglage\",\"presetSaved\":\"Préréglage \\\"{name}\\\" enregistré\",\"resetToDefault\":\"Réinitialiser par défaut\",\"saveAndSwitch\":\"Enregistrer et changer\",\"saveAsNewPreset\":\"Enregistrer comme nouveau préréglage\",\"saveChanges\":\"Enregistrer les modifications\",\"unsavedChangesMessage\":\"Vous avez des modifications non enregistrées qui seront perdues si vous changez sans enregistrer.\",\"unsavedChangesTo\":\"Modifications non enregistrées pour {name}\"},\"keybindings\":\"Raccourcis clavier\",\"learnMore\":\"En savoir plus\",\"listening\":\"Écoute en cours...\",\"liveSamplingPreview\":\"Aperçu en temps réel\",\"loadAllFolders\":\"Charger tous les dossiers\",\"loadWorkflow\":\"Charger le flux de travail\",\"loading\":\"Chargement\",\"loadingPanel\":\"Chargement du panneau {panel}...\",\"login\":\"Connexion\",\"logoAlt\":\"Logo ComfyUI\",\"logs\":\"Journaux\",\"manageExtensions\":\"Gérer les extensions\",\"markdown\":\"markdown\",\"maximizeDialog\":\"Agrandir la boîte de dialogue\",\"micPermissionDenied\":\"Permission du microphone refusée\",\"migrate\":\"Migrer\",\"missing\":\"Manquant\",\"modifyKeybinding\":\"Modifier le raccourci clavier\",\"more\":\"Plus\",\"moreOptions\":\"Plus d'options\",\"moreWorkflows\":\"Plus de workflows\",\"mostRelevant\":\"Les plus pertinents\",\"multiSelectDropdown\":\"Menu déroulant à sélection multiple\",\"nMoreKeybindings\":\"+ {count} de plus\",\"nMoreKeybindingsCompact\":\"+ {count}\",\"name\":\"Nom\",\"newFolder\":\"Nouveau dossier\",\"next\":\"Suivant\",\"nextImage\":\"Image suivante\",\"nightly\":\"NIGHTLY\",\"no\":\"Non\",\"noAudioRecorded\":\"Aucun audio enregistré\",\"noItems\":\"Aucun élément\",\"noResults\":\"Aucun résultat\",\"noResultsFound\":\"Aucun résultat trouvé\",\"noTasksFound\":\"Aucune tâche trouvée\",\"noTasksFoundMessage\":\"Il n'y a pas de tâches dans la file d'attente.\",\"noWorkflowsFound\":\"Aucun flux de travail trouvé.\",\"nodeContentError\":\"Erreur de contenu du nœud\",\"nodeHeaderError\":\"Erreur d'en-tête du nœud\",\"nodeRenderError\":\"Erreur de rendu du nœud\",\"nodeSlotsError\":\"Erreur d'emplacements du nœud\",\"nodeWidgetsError\":\"Erreur de widgets du nœud\",\"nodes\":\"Nœuds\",\"nodesCount\":\"{count} nœud | {count} nœuds\",\"nodesRunning\":\"nœuds en cours d’exécution\",\"none\":\"Aucun\",\"nothingToCopy\":\"Rien à copier\",\"nothingToDelete\":\"Rien à supprimer\",\"nothingToDuplicate\":\"Rien à dupliquer\",\"nothingToRename\":\"Rien à renommer\",\"off\":\"Désactivé\",\"ok\":\"OK\",\"on\":\"Activé\",\"openManager\":\"Ouvrir le gestionnaire\",\"openNewIssue\":\"Ouvrir un nouveau problème\",\"or\":\"ou\",\"output\":\"Sortie\",\"overwrite\":\"Écraser\",\"partner\":\"Partenaire\",\"partnerNodes\":\"Nœuds partenaires\",\"pause\":\"Pause\",\"play\":\"Lecture\",\"playPause\":\"Lecture/Pause\",\"playRecording\":\"Lire l'enregistrement\",\"playbackSpeed\":\"Vitesse de lecture\",\"playing\":\"Lecture en cours\",\"preloadError\":\"Une ressource requise n’a pas pu être chargée. Veuillez recharger la page.\",\"preloadErrorTitle\":\"Erreur de chargement\",\"preview\":\"APERÇU\",\"previous\":\"Précédent\",\"previousImage\":\"Image précédente\",\"profile\":\"Profil\",\"progressCountOf\":\"sur\",\"queued\":\"En file d’attente\",\"ready\":\"Prêt\",\"recents\":\"Récents\",\"reconnected\":\"Reconnecté\",\"reconnecting\":\"Reconnexion\",\"refresh\":\"Rafraîchir\",\"refreshNode\":\"Actualiser le nœud\",\"relativeTime\":{\"daysAgo\":\"il y a {count}j\",\"hoursAgo\":\"il y a {count}h\",\"minutesAgo\":\"il y a {count}min\",\"monthsAgo\":\"il y a {count}mo\",\"now\":\"maintenant\",\"weeksAgo\":\"il y a {count}s\",\"yearsAgo\":\"il y a {count}a\"},\"releaseTitle\":\"Publication de {package} {version}\",\"reloadToApplyChanges\":\"Recharger pour appliquer les modifications\",\"remove\":\"Supprimer\",\"removeAll\":\"Tout supprimer\",\"removeAllKeybindingsMessage\":\"Tous les raccourcis clavier pour cette commande seront supprimés\",\"removeAllKeybindingsTitle\":\"Supprimer tous les raccourcis clavier\xA0?\",\"removeImage\":\"Supprimer l'image\",\"removeKeybinding\":\"Supprimer le raccourci clavier\",\"removeTag\":\"Supprimer le tag\",\"removeVideo\":\"Supprimer la vidéo\",\"rename\":\"Renommer\",\"reportIssue\":\"Envoyer le rapport\",\"reportIssueTooltip\":\"Soumettre le rapport d'erreur à Comfy Org\",\"reportSent\":\"Rapport soumis\",\"reset\":\"Réinitialiser\",\"resetAll\":\"Réinitialiser tout\",\"resetAllKeybindingsMessage\":\"Tous les raccourcis clavier seront réinitialisés à leurs valeurs par défaut. Cette action est irréversible.\",\"resetAllKeybindingsTitle\":\"Réinitialiser tous les raccourcis clavier\xA0?\",\"resetAllKeybindingsTooltip\":\"Réinitialiser tous les raccourcis clavier par défaut\",\"resetToDefault\":\"Réinitialiser par défaut\",\"resizeFromBottomLeft\":\"Redimensionner depuis le coin inférieur gauche\",\"resizeFromBottomRight\":\"Redimensionner depuis le coin inférieur droit\",\"resizeFromTopLeft\":\"Redimensionner depuis le coin supérieur gauche\",\"resizeFromTopRight\":\"Redimensionner depuis le coin supérieur droit\",\"restart\":\"Redémarrer\",\"restoreDialog\":\"Restaurer la boîte de dialogue\",\"resultsCount\":\"{count} Résultats Trouvés\",\"running\":\"En cours\",\"save\":\"Enregistrer\",\"saveAnyway\":\"Enregistrer quand même\",\"saving\":\"Enregistrement\",\"scrollLeft\":\"Faire défiler à gauche\",\"scrollRight\":\"Faire défiler à droite\",\"search\":\"Rechercher\",\"searchExtensions\":\"Rechercher des extensions\",\"searchFailedMessage\":\"Nous n'avons trouvé aucun paramètre correspondant à votre recherche. Essayez d'ajuster vos termes de recherche.\",\"searchKeybindings\":\"Rechercher des raccourcis clavier\",\"searchModels\":\"Rechercher des modèles\",\"searchNodes\":\"Rechercher des nœuds\",\"searchPlaceholder\":\"Rechercher...\",\"searchSettings\":\"Rechercher des paramètres\",\"searchWorkflows\":\"Rechercher des flux de travail\",\"seeTutorial\":\"Voir un tutoriel\",\"selectItemsToCopy\":\"Sélectionnez les éléments à copier\",\"selectItemsToDelete\":\"Sélectionnez les éléments à supprimer\",\"selectItemsToDuplicate\":\"Sélectionnez les éléments à dupliquer\",\"selectItemsToRename\":\"Sélectionnez les éléments à renommer\",\"selectedFile\":\"Fichier sélectionné\",\"setAKeybindingForTheFollowing\":\"Définir un raccourci clavier pour :\",\"setAsBackground\":\"Définir comme arrière-plan\",\"settings\":\"Paramètres\",\"shortcutSuffix\":\" ({shortcut})\",\"showLeftPanel\":\"Afficher le panneau de gauche\",\"showReport\":\"Afficher le rapport\",\"showRightPanel\":\"Afficher le panneau de droite\",\"singleSelectDropdown\":\"Menu déroulant à sélection unique\",\"skipToEnd\":\"Aller à la fin\",\"skipToStart\":\"Aller au début\",\"sort\":\"Trier\",\"source\":\"Source\",\"startRecording\":\"Commencer l’enregistrement\",\"status\":\"Statut\",\"stopPlayback\":\"Arrêter la lecture\",\"stopRecording\":\"Arrêter l’enregistrement\",\"submit\":\"Soumettre\",\"success\":\"Succès\",\"switchToGridView\":\"Passer à la vue grille\",\"switchToSingleView\":\"Passer à la vue unique\",\"systemInfo\":\"Informations système\",\"systemStatsArguments\":\"Arguments\",\"systemStatsCloudVersion\":\"Version Cloud\",\"systemStatsComfyUIVersion\":\"Version de ComfyUI\",\"systemStatsEmbeddedPython\":\"Python intégré\",\"systemStatsFrontendVersion\":\"Version du frontal\",\"systemStatsOS\":\"OS\",\"systemStatsPyTorchVersion\":\"Version de PyTorch\",\"systemStatsPythonVersion\":\"Version de Python\",\"systemStatsRAMFree\":\"RAM libre\",\"systemStatsRAMTotal\":\"RAM totale\",\"systemStatsTemplatesVersion\":\"Version des modèles\",\"terminal\":\"Terminal\",\"textFailedToLoad\":\"Échec du chargement du texte\",\"title\":\"Titre\",\"triggerPhrase\":\"Phrase déclencheuse\",\"unknownError\":\"Erreur inconnue\",\"unknownFile\":\"Fichier inconnu\",\"untitled\":\"Sans titre\",\"update\":\"Mettre à jour\",\"updateAvailable\":\"Mise à jour disponible\",\"updateFrontend\":\"Mettre à jour le frontend\",\"updated\":\"Mis à jour\",\"updating\":\"Mise à jour\",\"upload\":\"Téléverser\",\"uploadAlreadyInProgress\":\"Téléversement déjà en cours\",\"uploadTimedOut\":\"Le téléchargement a expiré. Veuillez réessayer.\",\"usageHint\":\"Conseil d'utilisation\",\"use\":\"Utiliser\",\"user\":\"Utilisateur\",\"versionMismatchWarning\":\"Avertissement de compatibilité de version\",\"versionMismatchWarningMessage\":\"{warning} : {detail} Consultez https://docs.comfy.org/installation/update_comfyui#common-update-issues pour les instructions de mise à jour.\",\"videoFailedToLoad\":\"Échec du chargement de la vidéo\",\"videoPreview\":\"Aperçu de la vidéo - Utilisez les flèches pour naviguer entre les vidéos\",\"viewGrid\":\"Vue grille\",\"viewImageOfTotal\":\"Voir l'image {index} sur {total}\",\"viewVideoOfTotal\":\"Voir la vidéo {index} sur {total}\",\"volume\":\"Volume\",\"warning\":\"Avertissement\",\"workflow\":\"Flux de travail\",\"you\":\"Vous\"}");
var graphCanvasMenu = {
...
var helpCenter = {
	...
	"recentReleases": "Versions récentes",
	"reinstall": "Réinstaller",
	"updateAvailable": "Mise à jour",
	"updateComfyUI": "Mettre à jour ComfyUI",
	"updateComfyUIFailed": "Échec de la mise à jour de ComfyUI. Veuillez réessayer.",
	"updateComfyUIStarted": "Mise à jour commencée",
	"updateComfyUIStartedDetail": "La mise à jour de ComfyUI a été ajoutée à la file d’attente. Veuillez patienter...",
	"updateComfyUISuccess": "Mise à jour terminée",
	"updateComfyUISuccessDetail": "ComfyUI a été mis à jour. Redémarrage en cours...",
...
var install = {
	...
	"customNodes": "Nœuds personnalisés",
	"customNodesDescription": "Réinstallez les nœuds personnalisés à partir des installations existantes de ComfyUI.",
	"desktopAppSettings": "Paramètres de l'application de bureau",
	"desktopAppSettingsDescription": "Configurez comment ComfyUI se comporte sur votre bureau. Vous pouvez modifier ces paramètres plus tard.",
	"desktopSettings": "Paramètres de bureau",
	"failedToSelectDirectory": "Échec de la sélection du répertoire",
	"gpu": "GPU",
	"gpuPicker": {
		"amdDescription": "Utilisez votre GPU AMD avec l’accélération ROCm™ pour des performances optimales.",
		"amdSubtitle": "AMD ROCm™",
		"appleMetalDescription": "Exploite le GPU de votre Mac pour une vitesse plus rapide et une meilleure expérience globale",
		...
		"manualDescription": "Configurez ComfyUI manuellement pour des configurations avancées ou du matériel non pris en charge",
		"manualSubtitle": "Configuration manuelle",
		"nvidiaDescription": "Utilisez votre GPU NVIDIA avec l'accélération CUDA pour de meilleures performances.",
	...
	"gpuSelection": {
		...
		"cpuModeDescription2": "Si vous n'êtes pas absolument certain d'en avoir besoin, veuillez ignorer cette case et sélectionnez votre GPU ci-dessus.",
	...
	"insideAppInstallDir": "Ce dossier se trouve dans le bundle de l’application ComfyUI Desktop et sera supprimé lors des mises à jour. Choisissez un répertoire en dehors du dossier d’installation, comme Documents/ComfyUI.",
	"insideUpdaterCache": "Ce dossier se trouve dans le cache de mise à jour de ComfyUI, qui est effacé à chaque mise à jour. Sélectionnez un autre emplacement pour vos données.",
	...
	"locationPicker": {
		...
		"downloadServersDescription": "Sélectionnez des serveurs miroirs spécifiques pour télécharger Python, les packages PyPI et PyTorch en fonction de votre emplacement.",
		"migrateDescription": "Copiez ou liez vos modèles, nœuds personnalisés et configurations existants d'une installation ComfyUI précédente.",
		"migrateFromExisting": "Migrer depuis une installation existante",
		"migrationPathPlaceholder": "Sélectionnez une installation ComfyUI existante (facultatif)",
		"pathPlaceholder": "/Users/nomutilisateur/Documents/ComfyUI",
		"subtitle": "Sélectionnez un dossier pour les fichiers de ComfyUI. Nous configurerons également Python automatiquement.",
...
var issueReport = { "helpFix": "Aidez à résoudre cela" };
var linearMode = {
	"appModeToolbar": {
	...
	"arrange": {
		...
		"descriptionPlaceholder": "Double-cliquez pour ajouter une description",
		...
		"switchToOutputs": "Passez à l'étape « Sortie » et cliquez sur les nœuds de sortie pour les ajouter ici.",
...
var load3d = {
	...
	"centerCameraOnModel": "Centrer la caméra sur le modèle",
	"clearRecording": "Effacer l'enregistrement",
	"dropToLoad": "Déposez un modèle 3D à charger",
	"edgeThreshold": "Seuil de bord",
	"export": "Exportation",
	...
	"tiledMode": "Mosaïque",
	"unsupportedFileType": "Type de fichier non pris en charge (supporte .gltf, .glb, .obj, .fbx, .stl)",
	...
	"uploadingModel": "Téléversement du modèle 3D...",
	"viewer": {
		"apply": "Appliquer",
		"cameraSettings": "Paramètres de caméra",
		...
		"sceneSettings": "Paramètres de scène",
...
var logsTerminal = {
	"loadError": "Impossible de charger les journaux, veuillez vous assurer que votre backend ComfyUI est à jour.",
	"resyncError": "Impossible de resynchroniser les journaux après la reconnexion du backend. Rouvrez la console pour réessayer."
};
var maintenance = {
	"None": "Aucun",
	"OK": "OK",
	...
	"title": "Maintenance",
	"unsafeMigration": {
		"action": "Utilisez la tâche de maintenance « Chemin de base » ci-dessous pour déplacer ComfyUI vers un emplacement sécurisé.",
		"appInstallDir": "Votre chemin de base se trouve dans le bundle de l’application ComfyUI Desktop. Ce dossier peut être supprimé ou écrasé lors des mises à jour. Choisissez un répertoire en dehors du dossier d’installation, comme Documents/ComfyUI.",
		"generic": "Votre chemin de base ComfyUI actuel se trouve dans un emplacement qui peut être supprimé ou modifié lors des mises à jour. Pour éviter toute perte de données, déplacez-le dans un dossier sécurisé.",
		"oneDrive": "Votre chemin de base se trouve sur OneDrive, ce qui peut entraîner des problèmes de synchronisation et une perte accidentelle de données. Choisissez un dossier local qui n’est pas géré par OneDrive.",
		"title": "Emplacement d’installation non sécurisé détecté",
		"updaterCache": "Votre chemin de base se trouve dans le cache de mise à jour de ComfyUI, qui est effacé à chaque mise à jour. Choisissez un autre emplacement pour vos données."
	}
};
var manager = {
	"actions": "Actions",
	...
	"conflicts": {
		"conflictInfoTitle": "Pourquoi cela se produit-il ?",
		"conflictMessages": {
			"accelerator": "GPU/Accélérateur non pris en charge (disponible : {current}, requis : {required})",
			"banned": "Ce package est banni pour des raisons de sécurité",
			"comfyui_version": "Incompatibilité de version ComfyUI (actuelle : {current}, requise : {required})",
			"frontend_version": "Incompatibilité de version du frontend (actuelle : {current}, requise : {required})",
			"generic": "Problème de compatibilité (actuel : {current}, requis : {required})",
			"import_failed": "Échec de l'importation",
			"os": "Système d'exploitation non pris en charge (actuel : {current}, requis : {required})",
			"pending": "Vérification de sécurité en attente - la compatibilité ne peut pas être vérifiée"
		},
		"conflicts": "Conflits",
		"description": "Nous avons détecté des conflits entre certaines de vos extensions et la nouvelle version de ComfyUI. En mettant à jour, vous risquez de casser des workflows qui dépendent de ces extensions.",
		"enableAnyway": "Activer quand même",
		"extensionAtRisk": "Extension à risque",
		"importFailedExtensions": "Extensions dont l'importation a échoué",
		"info": "Si vous continuez avec la mise à jour, les extensions en conflit seront désactivées automatiquement. Vous pouvez les examiner et les gérer à tout moment dans le gestionnaire ComfyUI.",
		"installAnyway": "Installer quand même",
		"title": "Problèmes de pack de nœuds détectés !",
		"understood": "Compris",
		"warningBanner": {
			"button": "En savoir plus...",
			"message": "Ces extensions nécessitent des versions de packages système différentes de votre configuration actuelle. Les installer peut remplacer les dépendances principales et affecter d'autres extensions ou workflows.",
			"title": "Certaines extensions sont désactivées en raison d'incompatibilité avec votre configuration actuelle"
		},
		"warningTooltip": "Ce package peut avoir des problèmes de compatibilité avec votre environnement actuel"
	},
	"createdBy": "Créé par",
	"dependencies": "Dépendances",
	"disabledNodesWontUpdate": "Les nœuds désactivés ne seront pas mis à jour",
	"discoverCommunityContent": "Découvrez les packs de nœuds, extensions et plus encore créés par la communauté...",
	"downloads": "Téléchargements",
	"emptyState": {
		"allInstalled": {
			"message": "Vous n'avez pas encore installé d'extensions.",
			"title": "Aucune extension installée"
		},
		"conflicting": {
			"message": "Toutes vos extensions sont compatibles.",
			"title": "Aucun conflit détecté"
		},
		"missing": {
			"message": "Tous les nœuds requis sont installés.",
			"title": "Aucun nœud manquant"
		},
		"updateAvailable": {
			"message": "Toutes vos extensions sont à jour.",
			"title": "Tout est à jour"
		},
		"workflow": {
			"message": "Ce workflow n'utilise aucun nœud d'extension.",
			"title": "Aucune extension dans le workflow"
		}
	},
	"enablePackToChangeVersion": "Activez ce pack pour changer de version",
	"errorConnecting": "Erreur de connexion au registre de nœuds Comfy.",
	"extensionsSuccessfullyInstalled": "Extension(s) installée(s) avec succès et prête(s) à l'emploi !",
	"failed": "Échoué ({count})",
	...
	"gettingInfo": "Obtention des informations...",
	"importFailedGenericError": "Échec de l'importation du package. Vérifiez la console pour plus de détails.",
	"inWorkflow": "Dans le flux de travail",
	"incompatibleVersion": {
		"message": "Veuillez mettre à niveau ComfyUI-Manager vers la version 4.2.1 ou supérieure.\n• Bureau : Mettez à jour l'application ComfyUI Desktop\n• Autonome : Exécutez pip install -U comfyui-manager et redémarrez\nEn savoir plus : https://github.com/Comfy-Org/ComfyUI-Manager",
		"title": "Mise à niveau de ComfyUI-Manager requise"
	},
	...
	"legacyManagerSearchTip": "Vous cherchez ComfyUI-Manager ? Vous pouvez activer l’interface du gestionnaire hérité en lançant ComfyUI avec le paramètre --enable-manager-legacy-ui.",
	...
	"packInstall": { "nodeIdRequired": "L'identifiant du nœud est requis pour l'installation" },
	...
	"status": {
		...
		"deleted": "Supprimé",
		"flagged": "Signalé",
		"importFailed": "Erreur d'installation",
		"pending": "En attente",
		"unknown": "Inconnu"
	},
	"survey": {
		"error": "Ce sondage n'a pas pu être chargé. Veuillez réessayer plus tard.",
		"intro": "L'installation de nodes personnalisés arrive bientôt sur Comfy Cloud. Répondez à quelques questions rapides pour rejoindre la liste d'attente et contribuer à façonner cette fonctionnalité.",
		"title": "Rejoignez la liste d'attente"
	},
	"title": "Gestionnaire de Nœuds Personnalisés",
	"toFinishSetup": "pour terminer la configuration",
	"totalNodes": "Total de Nœuds",
	"tryAgainLater": "Veuillez réessayer plus tard.",
	"tryDifferentSearch": "Veuillez essayer une autre requête de recherche.",
	"tryUpdate": "Essayer de mettre à jour",
	"tryUpdateTooltip": "Récupérer les dernières modifications du dépôt. Les versions nightly peuvent avoir des mises à jour qui ne sont pas détectées automatiquement.",
...
var maskEditor = {
	"activateLayer": "Activer le calque",
	"applyToWholeImage": "Appliquer à toute l'image",
	"baseImageLayer": "Calque d'image de base",
	"baseLayerPreview": "Aperçu du calque de base",
	"black": "Noir",
	"brushSettings": "Paramètres du pinceau",
	"brushShape": "Forme du pinceau",
	"clear": "Effacer",
	"clickToResetZoom": "Cliquez pour réinitialiser le zoom",
	"colorSelectSettings": "Paramètres de sélection de couleur",
...
var mediaAsset = {
	"actions": {
		"copyJobId": "Copier l’ID de tâche",
		"delete": "Supprimer",
		...
		"openWorkflow": "Ouvrir comme flux de travail dans un nouvel onglet",
		"seeMoreOutputs": "Voir plus de sorties",
		"zoom": "Zoomer"
	},
	"assetDeletedSuccessfully": "Élément supprimé avec succès",
	"deleteAssetDescription": "Cet élément sera définitivement supprimé.",
	...
	"noJobIdFound": "Aucun ID de tâche trouvé pour cet actif",
	"noWorkflowDataFound": "Aucune donnée de flux de travail trouvée dans cet actif",
	"nodeAddedToWorkflow": "Nœud {nodeType} ajouté au flux de travail",
	"nodeTypeNotFound": "Type de nœud {nodeType} introuvable",
	"selection": {
		"assetsDeletedSuccessfully": "{count} élément(s) supprimé(s) avec succès",
		"deleteSelected": "Supprimer",
		"deleteSelectedAll": "Tout supprimer",
		...
		"exportStarted": "Préparation de l’export ZIP pour {count} fichier | Préparation de l’export ZIP pour {count} fichiers",
		"exportWorkflowAll": "Exporter tous les workflows",
		"failedToAddNodes": "Échec de l’ajout des nœuds au workflow",
	...
	"workflowOpenedInNewTab": "Flux de travail ouvert dans un nouvel onglet"
};
var menu = {
	...
	"clipspace": "Ouvrir Clipspace",
	"customNodesManager": "Gestionnaire de nœuds personnalisés",
	"dark": "Sombre",
	"disabled": "Désactivé",
	...
	"runWorkflowDisabled": "Le workflow contient des nœuds non pris en charge (en rouge). Supprimez-les pour exécuter le workflow.",
	"runWorkflowFront": "Exécuter le workflow (Mettre en file d'attente en premier)",
	"settings": "Paramètres",
	"showMenu": "Afficher le menu",
	"stopRunInstant": "Arrêter l'exécution (immédiat)",
	"stopRunInstantTooltip": "Arrêter l'exécution",
	"theme": "Thème",
	"toggleBottomPanel": "Basculer le panneau inférieur"
};
var menuLabels = {
	...
	"Desktop User Guide": "Guide utilisateur du bureau",
	...
	"Experimental: Enable Nodes 2_0": "Expérimental : Activer Nodes 2.0",
	"Export": "Exporter",
	...
	"Toggle Logs Bottom Panel": "Afficher/Masquer le panneau des journaux en bas",
	"Toggle Queue Panel V2": "Basculer le panneau de file d’attente V2",
	"Toggle Search Box": "Basculer la boîte de recherche",
	"Toggle Terminal Bottom Panel": "Afficher/Masquer le panneau terminal en bas",
...
var missingNodes = {
	"cloud": {
		"description": "Ce flux de travail utilise des nœuds personnalisés qui ne sont pas encore pris en charge dans la version Cloud.",
		"gotIt": "Ok, compris",
		"learnMore": "En savoir plus",
		"priorityMessage": "Nous avons automatiquement signalé ces nœuds afin de prioriser leur ajout.",
		"replacementInstruction": "En attendant, remplacez ces nœuds (surlignés en rouge sur le canevas) par des nœuds pris en charge si possible, ou essayez un autre flux de travail.",
		"title": "Ces nœuds ne sont pas encore disponibles sur Comfy Cloud"
	},
	"oss": {
		"description": "Ce flux de travail utilise des nœuds personnalisés que vous n’avez pas encore installés.",
		"replacementInstruction": "Installez ces nœuds pour exécuter ce flux de travail, ou remplacez-les par des alternatives installées. Les nœuds manquants sont surlignés en rouge sur le canevas.",
...
var nodeCategories = {
	...
	"filters": "filtres",
	"flux": "flux",
	"fun control": "contrôle amusant",
	"fun inpaint": "inpaint amusant",
	"geometry estimation": "estimation de la géométrie",
	"gligen": "gligen",
	"guidance": "guidance",
	"guiders": "guides",
	"hidream": "HiDream",
	...
	"image": "image",
	"infinite talk": "conversation infinie",
	...
	"mochi": "mochi",
	"model": "modèle",
	"model specific": "spécifique au modèle",
	...
	"partner": "partenaire",
	"patch": "correctif",
	"phantom subject": "sujet fantôme",
	"photomaker": "photomaker",
	"pixart": "pixart",
	"post-processors": "post-traitements",
	"pre-processors": "pré-traitements",
	...
	"stable diffusion upscaler": "upscaler stable diffusion",
...
var nodeErrors = {
	"content": "Erreur de contenu du nœud",
	"header": "Erreur d'en-tête du nœud",
	"render": "Erreur de rendu du nœud",
	"slots": "Erreur de slots du nœud",
	"widgets": "Erreur de widgets du nœud"
};
var nodeFilters = {
	"hideDeprecated": "Masquer les nœuds obsolètes",
	"hideDeprecatedDescription": "Masque les nœuds marqués comme obsolètes sauf si explicitement activés",
	"hideDevOnly": "Masquer les nœuds développeur uniquement",
	"hideDevOnlyDescription": "Masque les nœuds réservés au développement sauf si le mode développeur est activé",
	"hideExperimental": "Masquer les nœuds expérimentaux",
	"hideExperimentalDescription": "Masque les nœuds marqués comme expérimentaux sauf si explicitement activés",
	"hideSubgraph": "Masquer les nœuds de sous-graphe",
	"hideSubgraphDescription": "Masque temporairement les nœuds de sous-graphe de la bibliothèque de nœuds et de la recherche"
};
var nodeHelpPage = {
...
var notSupported = {
	...
	"illustrationAlt": "Illustration d’une fille triste",
	"learnMore": "En savoir plus",
...
var oauth = {
	"consent": {
		"allow": "Continuer",
		"appTypeNative": "Application native",
		"appTypeWeb": "Application web",
		"deny": "Annuler",
		"detailsHeader": "Détails",
		"errorExpired": "Cette demande de consentement a expiré ou a déjà été utilisée. Veuillez redémarrer depuis l’application cliente.",
		"errorScopeBroadening": "Les autorisations précédemment approuvées ne couvrent pas cette demande. Vous devrez réautoriser avec les nouvelles autorisations.",
		"errorUnavailable": "Cette fonctionnalité n’est pas disponible pour le moment. Veuillez contacter le support si le problème persiste.",
		"genericError": "La demande OAuth a échoué. Veuillez redémarrer depuis l’application cliente.",
		"loading": "Chargement de la demande d’autorisation…",
		"missingRequest": "Cette demande d’autorisation est manquante. Veuillez redémarrer depuis l’application cliente.",
		"noWorkspaces": "Aucun espace de travail éligible n’est disponible pour cette demande.",
		"permissionsHeader": "Autorisations",
		"redirectNotice": "Vous allez être redirigé vers",
		"resourceFallback": "cette application",
		"sessionError": "Échec de l’établissement de la session. Veuillez réessayer.",
		"sessionErrorToastSummary": "Impossible de poursuivre la connexion OAuth",
		"subtitle": "Connectez-vous à {resource} pour continuer",
		"title": "{client} souhaite accéder",
		"workspaceLabel": "Espace de travail"
	},
	"scopes": {
		"mcp:tools:call": { "label": "Exécuter des workflows en votre nom" },
		"mcp:tools:read": { "label": "Voir les outils de workflow disponibles" }
	},
	"workspace": {
		"member": "Membre",
		"owner": "Propriétaire",
...
var painter = {
	...
	"tool": "Outil",
	"uploadError": "Échec du téléversement de l'image du peintre\xA0: {status} - {statusText}",
	"width": "Largeur"
};
var palette = {
...
var progressToast = {
	...
	"finished": "Terminé",
	"importingModels": "Importation des modèles",
	"noImportsInQueue": "Aucun {filter} dans la file d’attente",
	"pending": "En attente",
	"progressCount": "{completed} sur {total}"
};
var queue = {
	"completedIn": "Terminé en {duration}",
	"inQueue": "En file d'attente...",
	"initializingAlmostReady": "Initialisation - Presque prêt",
	"jobAddedToQueue": "Tâche ajoutée à la file d'attente",
	"jobDetails": {
		"computeHoursUsed": "Heures de calcul utilisées",
		"errorMessage": "Message d'erreur",
		"estimatedFinishIn": "Fin estimée dans",
		"estimatedStartIn": "Début estimé dans",
		"eta": {
			"minutes": "~{count} minute | ~{count} minutes",
			"minutesRange": "~{lo}-{hi} minutes",
			"seconds": "~{count} seconde | ~{count} secondes",
			"secondsRange": "~{lo}-{hi} secondes"
		},
		"failedAfter": "Échec après",
		"generatedOn": "Généré le",
		"header": "Détails de la tâche",
		"jobId": "ID de la tâche",
		"queuePosition": "Position dans la file",
		"queuePositionValue": "~{count} tâche devant la vôtre | ~{count} tâches devant la vôtre",
		"queuedAt": "Mis en file à",
		"report": "Signaler",
		"timeElapsed": "Temps écoulé",
		"totalGenerationTime": "Temps total de génération",
		"workflow": "Workflow"
	},
	"jobHistory": "Historique des tâches",
	"jobList": {
		"sortComputeHoursUsed": "Heures de calcul utilisées (le plus en premier)",
		"sortMostRecent": "Le plus récent",
		"sortTotalGenerationTime": "Temps total de génération (le plus long en premier)",
		"undated": "Sans date"
	},
	"jobMenu": {
		"addToCurrentWorkflow": "Ajouter au workflow actuel",
		"cancelJob": "Annuler la tâche",
		"copyErrorMessage": "Copier le message d'erreur",
		"copyJobId": "Copier l'ID de la tâche",
		"delete": "Supprimer",
		"deleteAsset": "Supprimer l'élément",
		"download": "Télécharger",
		"exportWorkflow": "Exporter le workflow",
		"inspectAsset": "Inspecter l'élément",
		"openAsWorkflowNewTab": "Ouvrir comme workflow dans un nouvel onglet",
		"openWorkflowNewTab": "Ouvrir le workflow dans un nouvel onglet",
		"removeJob": "Retirer la tâche",
		"reportError": "Signaler une erreur"
	},
	"jobQueueing": "Mise en file d’attente de la tâche",
	"toggleJobHistory": "Afficher/Masquer l'historique des tâches"
};
var releaseToast = {
	"description": "Découvrez les dernières améliorations et fonctionnalités de cette mise à jour.",
	"newVersionAvailable": "Nouvelle version disponible\xA0!",
	"skip": "Ignorer",
	"update": "Mettre à jour",
	"whatsNew": "Quoi de neuf\xA0?"
};
var rightSidePanel = {
	"addFavorite": "Favori",
	...
	"errorNodeSummary": "{nodes} node — {count} erreur | {nodes} node — {count} erreurs",
	"errorNodesSummary": "{nodes} nodes — {count} erreur | {nodes} nodes — {count} erreurs",
	"errors": "Erreurs",
	"errorsDetected": "Erreur détectée | Erreurs détectées",
	"errorsSummary": "{count} erreur | {count} erreurs",
	...
	"globalSettings": {
		...
		"showAdvancedTooltip": "Ceci est un paramètre important qui, lorsqu’il est activé, affiche tous les paramètres avancés des nœuds",
		"showConnectedLinks": "Afficher les liens connectés",
		"showInfoBadges": "Afficher les badges d’information",
	...
	"missingMedia": { "missingMediaTitle": "Entrées manquantes" },
	"missingModels": {
		...
		"refresh": "Rafraîchir",
		"refreshFailed": "Échec du rafraîchissement des modèles manquants. Veuillez réessayer.",
		"refreshing": "Rafraîchissement des modèles manquants.",
	...
	"resetToDefault": "Réinitialiser par défaut",
	"resolveBeforeRun": "Résolvez avant d'exécuter le workflow",
	"seeError": "Voir l'erreur",
	"selectedNodeErrors": "{node} — {count} erreur | {node} — {count} erreurs",
	"selectedNodesErrors": "{nodes} nodes sélectionnés — {count} erreur | {nodes} nodes sélectionnés — {count} erreurs",
	"settings": "Paramètres",
	"showAdvancedInputsButton": "Afficher les entrées avancées",
	"showAdvancedShort": "Afficher les options avancées",
...
var secrets = {
	...
	"deleteConfirmMessage": "Êtes-vous sûr de vouloir supprimer «\xA0{name}\xA0» ? Cette action est irréversible.",
	...
	"providerHelp": {
		"gemini": "Saisissez votre clé API Google Gemini. Vous pouvez en générer une dans Google AI Studio.",
		"runway": "Saisissez votre clé API Runway. Vous pouvez la trouver dans les paramètres de votre compte Runway sous Clés API."
	},
...
var selectionToolbox = {
	...
	"Set Group Nodes to Never": "Définir les nœuds de groupe sur Jamais",
	"executeButton": {
...
var serverConfig = {
	...
	"restart": "Redémarrer",
	"restartRequiredToastDetail": "Redémarrez l’application pour appliquer les modifications de configuration du serveur.",
	"restartRequiredToastSummary": "Redémarrage requis",
...
var serverConfigItems = {
	"cache-classic": { "name": "Utiliser le système de cache classique" },
	"cache-lru": {
		"name": "Utiliser le cache LRU avec un maximum de N résultats de nœuds mis en cache.",
		"tooltip": "Peut utiliser plus de RAM/VRAM."
	},
	"cpu-vae": { "name": "Exécuter VAE sur CPU" },
	"cross-attention-method": { "name": "Méthode d'attention croisée" },
	"cuda-device": { "name": "Index de l'appareil CUDA à utiliser" },
	"cuda-malloc": { "name": "Utiliser CUDA malloc pour l'allocation de mémoire" },
	"default-hashing-function": { "name": "Fonction de hachage par défaut pour les fichiers de modèle" },
	"deterministic": {
	...
	"directml": { "name": "Index de l'appareil DirectML" },
	"disable-all-custom-nodes": { "name": "Désactiver le chargement de tous les nœuds personnalisés." },
	"disable-ipex-optimize": { "name": "Désactiver l'optimisation IPEX" },
	"disable-metadata": { "name": "Désactiver l'enregistrement des métadonnées d'invite dans les fichiers." },
	"disable-smart-memory": {
		"name": "Désactiver la gestion intelligente de la mémoire",
		"tooltip": "Force ComfyUI à décharger agressivement vers la ram régulière au lieu de garder les modèles dans la vram quand il le peut."
	},
	"disable-xformers": { "name": "Désactiver l'optimisation xFormers" },
	"dont-print-server": { "name": "Ne pas imprimer la sortie du serveur sur la console." },
	"dont-upcast-attention": { "name": "Prévenir l'attention de conversion ascendante" },
	"enable-cors-header": { "name": "Activer l'en-tête CORS: Utilisez \"*\" pour toutes les origines ou spécifiez le domaine" },
	"enable-manager-legacy-ui": {
		"name": "Utiliser l’interface Manager héritée",
		"tooltip": "Utilise l’ancienne interface ComfyUI-Manager au lieu de la nouvelle interface."
	},
	"fast": { "name": "Activer certaines optimisations non testées et potentiellement dégradantes pour la qualité." },
	"force-channels-last": { "name": "Forcer le format de mémoire des derniers canaux" },
	"force-upcast-attention": { "name": "Forcer l'attention de conversion ascendante" },
	"global-precision": {
		"name": "Précision globale des points flottants",
		"tooltip": "Précision globale des points flottants"
	},
	"input-directory": { "name": "Répertoire d'entrée" },
	"listen": { "name": "Hôte: L'adresse IP à écouter" },
	"log-level": { "name": "Niveau de verbosité de la journalisation" },
	"max-upload-size": { "name": "Taille maximale de téléchargement (MB)" },
	"output-directory": { "name": "Répertoire de sortie" },
	"port": { "name": "Port: Le port à écouter" },
	"preview-method": { "name": "Méthode utilisée pour les aperçus latents" },
	"preview-size": { "name": "Taille des images d'aperçu" },
	"reserve-vram": {
	...
	"tls-certfile": { "name": "Fichier de certificat TLS: Chemin vers le fichier de certificat TLS pour HTTPS" },
	"tls-keyfile": { "name": "Fichier de clé TLS: Chemin vers le fichier de clé TLS pour HTTPS" },
	"unet-precision": {
		"name": "Précision UNET",
...
var settingsCategories = {
	...
	"Camera": "Caméra",
	"Canvas": "Toile",
	"Canvas Navigation": "Navigation sur le canevas",
...
var shareWorkflow = {
	...
	"comfyHubButton": "Téléverser sur Comfy Workflows",
	"comfyHubDescription": "Comfy Workflows est le hub communautaire officiel de ComfyUI.\nVotre workflow aura une page publique visible par tous.",
	"comfyHubTitle": "Téléverser sur Comfy Workflows",
	"copyLink": "Copier",
...
var shortcuts = {
	...
	"noKeybinding": "Aucun raccourci clavier",
	"shortcuts": "Raccourcis",
	"subcategories": {
		"node": "Nœud",
		"panelControls": "Contrôles de panneau",
		"queue": "File d'attente",
		"view": "Affichage",
		"workflow": "Flux de travail"
	},
...
var sideToolbar = {
	...
	"downloads": "Téléchargements",
	"folderView": {
		"errorDetail": "Impossible de récupérer les sorties pour ce travail. Veuillez réessayer.",
		"errorSummary": "Échec du chargement des sorties"
	},
	...
	"logout": "Déconnexion",
	"mediaAssets": "Ressources multimédias",
	"modelLibrary": "Bibliothèque de modèles",
	"newBlankWorkflow": "Créer un nouveau flux de travail vierge",
	"noFilesFound": "Aucun fichier trouvé",
	"noFilesFoundMessage": "Téléversez des fichiers ou générez du contenu pour les voir ici",
	...
	"nodeLibraryTab": {
		...
		"noMatchingNodes": "Aucun nœud ne correspond à «\xA0{query}\xA0»",
		"resetView": "Réinitialiser la vue par défaut",
		"sections": {
			"bookmarked": "Favoris",
			"comfyBlueprints": "Plans Comfy",
			"comfyNodes": "Nœuds Comfy",
			"essentialNodes": "Nœuds essentiels",
			"extensions": "Extensions",
	...
	"queueProgressOverlay": {
		...
		"clearAllJobsTooltip": "Annuler tous les travaux en cours",
		"clearHistory": "Effacer l’historique de la file d’attente",
		"clearHistoryDialogAssetsNote": "Les ressources générées par ces travaux ne seront pas supprimées et resteront accessibles depuis le panneau des ressources.",
		"clearHistoryDialogDescription": "Tous les travaux terminés ou échoués ci-dessous seront supprimés de ce panneau de file d’attente.",
		"clearHistoryDialogTitle": "Effacer l’historique de la file d’attente ?",
		"clearHistoryMenuAssetsNote": "Les ressources média ne seront pas supprimées.",
		"clearQueueTooltip": "Vider la file d’attente",
		"clearQueued": "Vider la file d’attente",
		"colonPercent": ": {percent}",
		"currentNode": "Nœud actuel :",
		"dockedJobHistory": "Historique des tâches ancré",
		"expandCollapsedQueue": "Développer la file d’attente",
		"filterAllWorkflows": "Tous les workflows",
		...
		"jobQueue": "File d’attente des travaux",
		"jobsAddedToQueue": "{count} tâche ajoutée à la file d’attente | {count} tâches ajoutées à la file d’attente",
		"jobsCompleted": "{count} travail terminé | {count} travaux terminés",
		"jobsFailed": "{count} travail échoué | {count} travaux échoués",
		"moreOptions": "Plus d’options",
		...
		"showRunProgressBar": "Afficher la barre de progression d'exécution",
		"sortBy": "Trier par",
		"sortJobs": "Trier les travaux",
		"stubClipTextEncode": "CLIP Text Encode :",
		"title": "Progression de la file d’attente",
		"total": "Total : {percent}",
		"viewAllJobs": "Voir tous les travaux",
		"viewGrid": "Vue en grille",
		"viewJobHistory": "Voir l’historique des travaux",
	...
	"workflowTab": {
		...
		"confirmOverwriteTitle": "Écraser le fichier existant ?",
...
var subscription = /*#__PURE__*/ JSON.parse("{\"addApiCredits\":\"Ajouter des crédits API\",\"addCredits\":\"Ajouter des crédits\",\"addCreditsLabel\":\"Ajoutez des crédits à tout moment\",\"additionalCredits\":\"Crédits supplémentaires\",\"additionalCreditsInUse\":\"En cours d'utilisation\",\"additionalCreditsInfo\":\"À propos des crédits supplémentaires\",\"additionalCreditsTooltip\":\"Crédits ajoutés à votre forfait. Utilisés après l'épuisement des crédits mensuels. Chaque crédit expire un an après l'achat.\",\"benefits\":{\"benefit1\":\"Crédits mensuels pour les Nœuds Partenaires — rechargez si nécessaire\",\"benefit1FreeTier\":\"Plus de crédits mensuels, recharge à tout moment\",\"benefit2\":\"Jusqu'à 30 min d'exécution par tâche\",\"benefit3\":\"Utilisez vos propres modèles (Creator & Pro)\"},\"beta\":\"BÊTA\",\"billedMonthly\":\"Facturé mensuellement\",\"billedYearly\":\"{total} facturé annuellement\",\"billingComingSoon\":{\"message\":\"La facturation d'équipe arrive bientôt. Vous pourrez souscrire à un abonnement pour votre espace de travail avec un tarif par utilisateur. Restez à l'écoute pour les mises à jour.\",\"title\":\"Bientôt disponible\"},\"cancelDialog\":{\"confirmCancel\":\"Annuler l'abonnement\",\"description\":\"Votre accès continue jusqu'au {date}. Vous ne serez plus facturé, et votre espace de travail ainsi que vos crédits seront conservés. Vous pouvez vous réabonner à tout moment.\",\"endOfBillingPeriod\":\"fin de la période de facturation\",\"failed\":\"Échec de l'annulation de l'abonnement\",\"keepSubscription\":\"Conserver l'abonnement\",\"title\":\"Annuler l'abonnement\"},\"cancelPlan\":\"Annuler l’abonnement\",\"cancelSuccess\":\"Abonnement annulé avec succès\",\"canceled\":\"Annulé\",\"canceledCard\":{\"description\":\"Vous ne serez plus facturé. Vos fonctionnalités restent actives jusqu'au {date}.\",\"title\":\"Votre abonnement a été annulé\"},\"changePlan\":\"Changer d’abonnement\",\"changeTo\":\"Changer pour {plan}\",\"comfyCloud\":\"Comfy Cloud\",\"comfyCloudLogo\":\"Logo Comfy Cloud\",\"contactOwnerToSubscribe\":\"Contactez le propriétaire de l’espace de travail pour vous abonner\",\"contactUs\":\"Contactez-nous\",\"creditSliderSave\":\"Économisez {percent}% ({amount})\",\"creditsLeftOfTotal\":\"{remaining} restant(s) sur {total}\",\"creditsRemainingThisMonth\":\"Crédits restants ce mois-ci\",\"creditsRemainingThisYear\":\"Crédits restants cette année\",\"creditsUsed\":\"{used} utilisé(s)\",\"creditsYouveAdded\":\"Crédits ajoutés\",\"currentPlan\":\"Forfait actuel\",\"customLoRAsLabel\":\"Importer vos propres LoRAs\",\"description\":\"Choisissez le forfait qui vous convient\",\"descriptionWorkspace\":\"Choisissez la meilleure offre pour votre espace de travail\",\"downgrade\":{\"body\":\"Tous les autres membres de cet espace de travail seront immédiatement supprimés.\",\"confirm\":\"Changer de plan\",\"confirmationPhrase\":\"Je comprends\",\"confirmationPrompt\":\"Tapez «\xA0{phrase}\xA0» pour confirmer.\",\"failed\":\"Échec du changement de plan\",\"failedAfterMemberRemoval\":\"Les membres de l’équipe ont été retirés, mais le changement de plan n’a pas abouti — veuillez réessayer ou contacter le support\",\"memberRemovalFailed\":\"Impossible de retirer {email} de l’équipe — certains membres ont peut-être déjà été retirés et votre plan n’a pas été modifié\",\"notAllowed\":\"Ce changement de plan n'est pas disponible\",\"paymentMethodRequired\":\"Un moyen de paiement est requis pour changer de plan\",\"paymentPageBlocked\":\"Impossible d’ouvrir la page de paiement — veuillez réessayer\",\"title\":\"Passer au plan {plan} ?\"},\"endsOnDate\":\"Se termine le {date}\",\"enterprise\":{\"cta\":\"En savoir plus\",\"flexibility\":\"Vous cherchez plus de flexibilité ou des fonctionnalités personnalisées\xA0?\",\"name\":\"Entreprise\",\"needMoreMembers\":\"Besoin de plus de membres\xA0?\",\"reachOut\":\"Contactez-nous pour planifier un échange.\"},\"everythingInPlus\":\"Tout ce qui est dans {plan}, plus\xA0:\",\"expiresDate\":\"Expire le {date}\",\"freePerks\":{\"maxRuntime\":\"{duration} de temps d’exécution maximum\"},\"freeTier\":{\"description\":\"Votre plan gratuit inclut {credits} crédits chaque mois pour essayer Comfy Cloud.\",\"descriptionGeneric\":\"Votre plan gratuit inclut une allocation mensuelle de crédits pour essayer Comfy Cloud.\",\"descriptionQuota\":\"Votre offre gratuite inclut {runs} exécutions pour commencer avec Comfy Cloud — aucune carte requise.\",\"nextRefresh\":\"Vos crédits seront renouvelés le {date}.\",\"outOfCredits\":{\"subtitle\":\"Abonnez-vous pour débloquer les recharges et plus encore\",\"title\":\"Vous n’avez plus de crédits gratuits\"},\"subscribeCta\":\"Abonnez-vous pour plus\",\"title\":\"Vous êtes sur le plan Gratuit\",\"topUpBlocked\":{\"title\":\"Débloquez les recharges et plus encore\"},\"upgradeCta\":\"Voir les offres\"},\"gpuLabel\":\"RTX 6000 Pro (96GB VRAM)\",\"haveQuestions\":\"Des questions ou besoin d'une offre entreprise ?\",\"inactive\":{\"memberCta\":\"Ok, compris\",\"memberDescription\":\"Demandez au propriétaire de l’espace de travail de réactiver l’abonnement pour exécuter des workflows.\",\"memberRunTooltip\":\"Contactez le propriétaire de votre espace de travail pour réactiver l’abonnement\",\"memberTitle\":\"L’abonnement de cet espace de travail est inactif\",\"runLabel\":\"Exécuter\"},\"inviteUpTo\":\"Invitez jusqu’à\",\"invoiceHistory\":\"Historique des factures\",\"learnMore\":\"En savoir plus\",\"manageBilling\":\"Gérer la facturation\",\"managePlan\":\"Gérer le forfait\",\"manageSubscription\":\"Gérer l'abonnement\",\"maxDuration\":{\"creator\":\"30 min\",\"founder\":\"30 min\",\"free\":\"30 min\",\"pro\":\"1 h\",\"standard\":\"30 min\"},\"maxDurationLabel\":\"Durée maximale de chaque exécution de workflow\",\"maxMembersLabel\":\"Nombre max. de membres\",\"member\":\"membre\",\"memberCount\":\"{count} membre | {count} membres\",\"messageSupport\":\"Contacter le support\",\"monthly\":\"Mensuel\",\"monthlyBonusDescription\":\"Bonus de crédits mensuel\",\"monthlyCredits\":\"crédits mensuels\",\"monthlyCreditsInfo\":\"Ces crédits se renouvellent chaque mois et ne sont pas reportés\",\"monthlyCreditsLabel\":\"Crédits mensuels\",\"monthlyCreditsPerMemberLabel\":\"Crédits mensuels / membre\",\"monthlyCreditsRollover\":\"Ces crédits seront reportés au mois suivant\",\"monthlyCreditsUsedUpDescription\":\"Vous utilisez maintenant des crédits supplémentaires.\",\"monthlyCreditsUsedUpTitle\":\"Crédits mensuels épuisés. Recharge le {date}\",\"monthlyCreditsUsedUpTitleNoDate\":\"Crédits mensuels épuisés\",\"monthlyUsageProgress\":\"{used} sur {total} crédits mensuels utilisés\",\"mostPopular\":\"Le plus populaire\",\"needTeamWorkspace\":\"Besoin d’un espace de travail d’équipe\xA0?\",\"nextBillingCycle\":\"prochain cycle de facturation\",\"outOfCreditsDescription\":\"Ajoutez des crédits pour continuer à générer.\",\"outOfCreditsTitle\":\"Vous n'avez plus de crédits. Recharge le {date}\",\"outOfCreditsTitleNoDate\":\"Vous n'avez plus de crédits\",\"partnerNodesBalance\":\"Solde de crédits \\\"Nœuds Partenaires\\\"\",\"partnerNodesCredits\":\"Crédits Nœuds Partenaires\",\"partnerNodesDescription\":\"Pour exécuter des modèles commerciaux/propriétaires\",\"partnerNodesPricingTable\":\"Tableau des tarifs des Partner Nodes\",\"perMonth\":\"USD / mois\",\"personalHeader\":\"Les plans personnels sont réservés à un usage individuel. {action}\",\"personalHeaderAction\":\"Pour ajouter des coéquipiers, abonnez-vous au plan équipe.\",\"personalWorkspace\":\"Espace de travail personnel\",\"planLoadError\":\"Nous n'avons pas pu charger les détails de votre abonnement.\",\"planLoadErrorRetry\":\"Réessayer\",\"planScope\":{\"personal\":\"Pour usage personnel\",\"team\":\"Pour les équipes\"},\"plansAndPricing\":\"Forfaits & tarifs\",\"plansForWorkspace\":\"Formules pour {workspace}\",\"prepaidCreditsInfo\":\"Crédits achetés séparément qui n'expirent pas\",\"prepaidDescription\":\"Crédits prépayés\",\"preview\":{\"addCreditCard\":\"Ajouter une carte bancaire\",\"afterThat\":\"Après cela\",\"backToAllPlans\":\"Retour à toutes les offres\",\"billedEachMonth\":\"{amount} facturé chaque mois. Annulez à tout moment.\",\"commitment\":\"engagement\",\"confirm\":\"Confirmer\",\"confirmChange\":\"Confirmer la modification\",\"confirmChangeTitle\":\"Vérifiez votre modification programmée\",\"confirmPayment\":\"Confirmer votre paiement\",\"confirmPlanChange\":\"Confirmer le changement d'offre\",\"confirmUpgradeCta\":\"Confirmer la mise à niveau\",\"confirmUpgradeTitle\":\"Confirmer votre mise à niveau\",\"creditFromCurrent\":\"Crédit du forfait actuel {plan}\",\"creditsRefillMonthlyTo\":\"Les crédits sont rechargés mensuellement à\",\"creditsRefillTo\":\"Les crédits sont réinitialisés à\",\"creditsYoullGetToday\":\"Crédits que vous recevrez aujourd'hui\",\"currentMonthly\":\"forfait mensuel\",\"eachMonthCreditsRefill\":\"Chaque mois, les crédits sont réinitialisés à\",\"eachYearCreditsRefill\":\"Chaque année, les crédits sont rechargés à\",\"ends\":\"Se termine le {date}\",\"everyMonthStarting\":\"Chaque mois à partir du {date}\",\"hideFeatures\":\"Masquer les fonctionnalités\",\"newMonthlySubscription\":\"Nouvel abonnement mensuel\",\"nextPaymentDue\":\"Prochain paiement dû le {date}. Annulez à tout moment.\",\"paymentPopupBlocked\":\"Impossible d'ouvrir la page de paiement — veuillez autoriser les pop-ups et réessayer.\",\"perMember\":\"/ membre\",\"privacyPolicy\":\"Politique de confidentialité\",\"proratedCharge\":\"Facturation au prorata pour {plan}\",\"proratedRefund\":\"Remboursement au prorata pour {plan}\",\"refillReplacesNote\":\"Remplace votre recharge mensuelle. Le solde existant est conservé.\",\"showMoreFeatures\":\"Afficher plus de fonctionnalités\",\"starting\":\"À partir du {date}\",\"startingToday\":\"À partir d'aujourd'hui\",\"startsOn\":\"Commence le {date}\",\"stayOnUntil\":\"Vous resterez sur {plan} jusqu'au {date}.\",\"subscribeToPlan\":\"S’abonner au plan {plan}\",\"switchToPlan\":\"Passer au plan {plan}\",\"switchesToday\":\"Changements aujourd'hui\",\"terms\":\"Conditions\",\"termsAgreement\":\"En continuant, vous acceptez les {terms} et la {privacy} de Comfy Org.\",\"totalDueToday\":\"Total dû aujourd'hui\",\"yearlySubscription\":\"Abonnement annuel\",\"youllBeCharged\":\"Vous serez facturé\"},\"pricingBlurb\":\"*Basé sur ce modèle, {seeDetails}. Contactez-nous pour {questions} ou {enterpriseDiscussions}. Pour plus de détails sur les tarifs, {clickHere}.\",\"pricingBlurbClickHere\":\"cliquez ici\",\"pricingBlurbEnterprise\":\"discussions entreprise\",\"pricingBlurbQuestions\":\"questions\",\"pricingBlurbSeeDetails\":\"voir les détails\",\"reactivatePlan\":\"Réactiver l’abonnement\",\"refillsDate\":\"Recharge le {date}\",\"refillsNextCycle\":\"Recharge au prochain cycle\",\"refreshCredits\":\"Actualiser les crédits\",\"remaining\":\"restant\",\"renewsDate\":\"Renouvellement le {date}\",\"renewsOnDate\":\"Renouvellement le {date}\",\"required\":{\"pollingFailed\":\"Échec de l'activation de l'abonnement\",\"pollingSuccess\":\"Abonnement activé avec succès !\",\"pollingTimeout\":\"Délai d'attente de l'abonnement dépassé. Veuillez actualiser et réessayer.\",\"subscribe\":\"S'abonner\",\"title\":\"S'abonner à\",\"waitingForSubscription\":\"Complétez votre abonnement dans le nouvel onglet. Nous détecterons automatiquement quand vous aurez terminé !\"},\"resubscribe\":\"Se réabonner\",\"resubscribeFailed\":\"Échec de la réactivation de l’abonnement\",\"resubscribeSuccess\":\"Abonnement réactivé avec succès\",\"resubscribeTo\":\"Se réabonner à {plan}\",\"saveYearly\":\"Économisez 20 %\",\"saveYearlyUpTo\":\"Économisez jusqu’à 20\xA0%\",\"soloUseOnly\":\"Usage solo uniquement\",\"subscribe\":\"S’abonner\",\"subscribeFailed\":\"Échec de l'abonnement\",\"subscribeForMore\":\"Mettre à niveau\",\"subscribeNow\":\"S'abonner maintenant\",\"subscribeTo\":\"S'abonner à {plan}\",\"subscribeToComfyCloud\":\"S'abonner à Comfy Cloud\",\"subscribeToRun\":\"S'abonner\",\"subscribeToRunFull\":\"S'abonner pour exécuter\",\"subscriptionRequiredMessage\":\"Un abonnement est requis pour que les membres puissent exécuter des workflows sur le Cloud\",\"success\":{\"allSet\":\"Tout est prêt\",\"inviteEmailsPlaceholder\":\"Entrez les emails séparés par des virgules\",\"inviteSubtext\":\"Vous pouvez aussi inviter des personnes plus tard dans les paramètres\",\"inviteTitle\":\"Invitez votre équipe\",\"planUpdated\":\"Votre plan a été mis à jour avec succès.\",\"receiptEmailed\":\"Un reçu vous a été envoyé par e-mail.\",\"sendInvites\":\"Envoyer les invitations\"},\"teamHeader\":\"Pour les équipes souhaitant collaborer. Besoin de plus de membres\xA0? {learnMore} sur l’offre entreprise.\",\"teamHeaderLearnMore\":\"En savoir plus\",\"teamPerks\":{\"concurrentRuns\":\"Les membres peuvent exécuter des workflows simultanément\",\"inviteMembers\":\"Inviter des membres\",\"rolePermissions\":\"Permissions basées sur les rôles\",\"sharedCreditPool\":\"Crédit partagé pour tous les membres\"},\"teamPlan\":{\"changePlan\":\"Changer de plan\",\"comingSoonLabel\":\"Bientôt disponible\xA0:\",\"cta\":\"S’abonner à l’offre Équipe annuelle\",\"ctaMonthly\":\"S’abonner à l’offre Équipe mensuelle\",\"currentPlan\":\"Plan actuel\",\"detailsTitle\":\"Détails\",\"name\":\"Plan Équipe\",\"perkConcurrentRuns\":\"Les membres peuvent exécuter des workflows simultanément\",\"perkInviteMembers\":\"Invitez des membres dans l’équipe\",\"perkProjectAssets\":\"Gestion des projets et des ressources\",\"perkRolePermissions\":\"Permissions basées sur les rôles\",\"perkSharedPool\":\"Crédits partagés pour tous les membres\",\"tagline\":\"Choisissez votre propre abonnement mensuel de crédits. Bénéficiez d’une plus grande remise avec un abonnement de crédits plus important.\",\"unavailable\":\"Ce forfait d'équipe n'est pas disponible pour le moment.\"},\"teamPlanIncludes\":\"Votre abonnement inclut tout dans {plan}, plus :\",\"teamPlanName\":\"Équipe\",\"teamWorkspace\":\"Espace de travail d’équipe\",\"tierNameYearly\":\"{name} Annuel\",\"tiers\":{\"creator\":{\"feature1\":\"Importez vos propres modèles\",\"name\":\"Créateur\"},\"founder\":{\"name\":\"Édition Fondateur\"},\"free\":{\"name\":\"Gratuit\"},\"pro\":{\"feature1\":\"Durée d’exécution du workflow prolongée (jusqu’à 1\xA0h)\",\"name\":\"Pro\"},\"standard\":{\"feature1\":\"Durée maximale d’exécution du workflow\xA0: 30 minutes\",\"feature2\":\"Ajoutez des crédits à tout moment\",\"name\":\"Standard\"}},\"title\":\"Abonnement\",\"titleUnsubscribed\":\"Abonnez-vous à Comfy Cloud\",\"totalCredits\":\"Total des crédits\",\"upgrade\":\"AMÉLIORER\",\"upgradePlan\":\"Améliorer le forfait\",\"upgradeTo\":\"Passer à {plan}\",\"upgradeToAddCredits\":\"Mettre à niveau pour ajouter des crédits\",\"usdPerMonth\":\"USD / mois\",\"usdPerMonthPerMember\":\"USD / mois / membre\",\"usedAfterMonthly\":\"Utilisé après l'épuisement du forfait mensuel\",\"videoEstimate\":\"Génère environ {count} vidéos de 5\xA0s*\",\"videoEstimateExplanation\":\"Ces estimations sont basées sur le modèle Wan 2.2 Image-to-Video avec les paramètres par défaut (5 secondes, 640x640, 16fps, échantillonnage en 4 étapes).\",\"videoEstimateHelp\":\"Plus de détails sur ce modèle\",\"videoEstimateLabel\":\"Nombre approx. de vidéos de 5s générées avec le modèle Wan 2.2 Image-to-Video\",\"videoEstimateTryTemplate\":\"Essayer ce modèle\",\"videoTemplateBasedCredits\":\"Vidéos générées avec Wan 2.2 Image to Video\",\"viewEnterprise\":\"Voir l'offre entreprise\",\"viewMoreDetails\":\"Voir plus de détails\",\"viewMoreDetailsPlans\":\"Voir plus de détails sur les forfaits et tarifs\",\"viewUsageHistory\":\"Voir l'historique d'utilisation\",\"whatsIncluded\":\"Inclus\xA0:\",\"workspaceNotSubscribed\":\"Cet espace de travail n’a pas d’abonnement\",\"yearly\":\"Annuel\",\"yearlyCreditsLabel\":\"Crédits annuels totaux\",\"yourPlanIncludes\":\"Votre forfait comprend :\"}");
var tabMenu = {
...
var teamWorkspacesDialog = {
	...
	"namePlaceholder": "ex.\xA0: Équipe Marketing",
...
var templateWidgets = { "sort": { "searchPlaceholder": "Rechercher..." } };
var templateWorkflows = {
	...
	"category": {
		...
		"LLM API": "API LLM",
		"LLMs": "LLMs",
		"Partner Nodes": "Nœuds partenaires",
		"Upscaling": "Mise à l'échelle",
		"Video": "Vidéo",
		"Video API": "API vidéo"
	},
	"clearAllFilters": "Effacer tous les filtres",
	"error": { "templateNotFound": "Modèle \"{templateName}\" introuvable" },
	"filtersApplied": "{count} filtre appliqué | {count} filtres appliqués",
	"filtersButton": "Filtres",
	"licenseFilter": "Licence",
	"loading": "Chargement des modèles...",
	"loadingMore": "Chargement de plus de modèles...",
	"modelFilter": "Filtre de modèle",
	"modelsSelected": "{count} Modèles",
	"noResults": "Aucun modèle trouvé",
	"noResultsHint": "Essayez d'ajuster votre recherche ou vos filtres",
	"resultsCount": "Affichage de {count} sur {total} modèles",
	"runsOnFilter": "Exécute sur",
	"runsOnSelected": "{count} exécutions sur",
	"searchPlaceholder": "Rechercher des modèles...",
	"sort": {
		"alphabetical": "A → Z",
		"default": "Par défaut",
		"modelSizeLowToHigh": "Taille du modèle (faible à élevée)",
		"newest": "Plus récent",
		"popular": "Populaire",
		"recommended": "Recommandé",
	...
	"useCaseFilter": "Tâches",
	"useCasesSelected": "{count} Cas d'usage"
};
...
var toastMessages = {
	...
	"failedToFetchSubscription": "Échec de la récupération du statut d'abonnement : {error}",
	...
	"failedToUpdateBackgroundRenderMode": "Échec de la mise à jour du mode de rendu d’arrière-plan vers {mode}",
	"failedToUpdateEdgeThreshold": "Échec de la mise à jour du seuil de contour",
	"failedToUpdateFOV": "Échec de la mise à jour du champ de vision",
	"failedToUpdateLightIntensity": "Échec de la mise à jour de l’intensité lumineuse",
	"failedToUpdateMaterialMode": "Échec de la mise à jour du mode matériau",
	"failedToUpdateUpDirection": "Échec de la mise à jour de la direction vers le haut",
	...
	"nodeDefinitionsUpdateFailed": "Échec de la mise à jour des définitions de nœud",
	...
	"useApiKeyTip": "Astuce\xA0: Vous ne pouvez pas accéder à la connexion normale\xA0? Utilisez l’option Clé API Comfy.",
	"userNotAuthenticated": "Utilisateur non authentifié"
};
var typeform = { "loadError": "Échec du chargement du formulaire. Veuillez réessayer plus tard." };
var userSelect = {
...
var vueNodesBanner = {
	...
	"title": "Présentation de Nodes 2.0",
	"tryItOut": "Essayer"
};
var vueNodesMigration = {
	"button": "Ouvrir les paramètres",
	"message": "Préférez-vous le design classique des nœuds ?"
};
var vueNodesMigrationMainMenu = { "message": "Revenez à Nodes 2.0 à tout moment depuis le menu principal." };
var vueNodesSlot = { "iterative": "(Itératif)" };
var welcome = {
...
var widgetFileUpload = {
	...
	"dropPrompt": "Déposez votre fichier ou"
};
var widgets = {
	"boolean": {
		"false": "faux",
	...
	"valueControl": {
		...
		"decrementDesc": "Soustrait 1 de la valeur ou sélectionne l'option précédente",
		"editSettings": "Modifier les paramètres de contrôle",
		"fixed": "Valeur fixe",
		"fixedDesc": "Laisse la valeur inchangée",
		"header": {
			"after": "APRÈS",
			"before": "AVANT",
			"postfix": "l'exécution du workflow :",
			"prefix": "Mettre à jour automatiquement la valeur"
		},
		"increment": "Incrémenter la valeur",
		"incrementDesc": "Ajoute 1 à la valeur ou sélectionne l'option suivante",
		"linkToGlobal": "Lier à",
		"linkToGlobalDesc": "Valeur unique liée au paramètre de contrôle de la Valeur globale",
		"linkToGlobalSeed": "Valeur globale",
		"randomize": "Valeur aléatoire",
		"randomizeDesc": "Mélange la valeur aléatoirement après chaque génération"
	}
};
var workflowService = {
...
var workspacePanel = {
	"activity": {
		...
		"fullActivity": "Activité complète",
		"hoverCard": {
			"lastActivity": "Dernière activité",
			"partnerNodeUsed": "Nœud partenaire utilisé",
			"totalCreditsUsed": "Total de crédits utilisés"
		},
		"perUserHint": "Vous cherchez l'utilisation totale par utilisateur ?",
		"seeMembers": "Voir les membres"
	},
	"billingStatus": {
		"ending": {
			"body": "Les membres conservent un accès complet jusqu'à cette date. Réactivez pour conserver vos crédits et places partagés.",
			"reactivate": "Réactiver le forfait",
			"title": "Votre forfait d'équipe se termine le {date}"
		},
		"outOfCredits": {
			"addCredits": "Ajouter des crédits",
			"body": "Votre équipe a utilisé tous ses crédits. Ajoutez des crédits pour continuer à générer ou attendez le rechargement des crédits le {date}.",
			"bodyNoDate": "Votre équipe a utilisé tous ses crédits. Ajoutez des crédits pour continuer à générer.",
			"dismiss": "Ignorer",
			"memberBody": "Votre équipe a utilisé tous ses crédits. Les administrateurs de votre espace de travail doivent ajouter des crédits pour continuer à générer.",
			"title": "Plus de crédits"
		},
		"paused": {
			"body": "L'abonnement de cet espace de travail est en pause. Mettez à jour le paiement pour reprendre.",
			"memberBody": "L'abonnement de cet espace de travail est en pause. Les administrateurs de votre espace de travail doivent mettre à jour le mode de paiement.",
			"title": "Abonnement en pause"
		},
		"updatePayment": "Mettre à jour le paiement",
		"warning": {
			"body": "Votre dernier paiement n'a pas abouti. Votre abonnement sera mis en pause le {date} sauf si le paiement est mis à jour.",
			"bodyNoDate": "Votre dernier paiement n'a pas abouti. Mettez à jour le paiement pour éviter une pause.",
	...
	"dashboard": { "placeholder": "Paramètres de l'espace de travail du tableau de bord" },
	"deleteDialog": {
	...
	"inviteUpsellDialog": {
		"messageNotSubscribed": "Pour ajouter des membres à cet espace de travail, vous devez disposer d’un forfait Creator ou supérieur. Le forfait Standard ne prend en charge qu’un seul utilisateur (le propriétaire).",
		"messageSingleSeat": "Le forfait Standard inclut une place pour le propriétaire de l’espace de travail. Pour inviter d’autres membres, passez au forfait Creator ou supérieur pour débloquer plusieurs places.",
		"titleNotSubscribed": "Un abonnement est requis pour inviter des membres",
		"titleSingleSeat": "Votre forfait actuel ne prend en charge qu’un seul utilisateur",
	...
	"members": {
		"actions": {
			...
			"setCreditLimit": "Définir une limite de crédits"
		},
		"activity": {
		...
		"contactUs": "Contactez-nous",
		"creditLimitDialog": {
			"description": "Une fois cette limite atteinte, ils ne pourront plus exécuter de workflows.",
			"invalidLimit": "Entrez une limite de crédits supérieure à zéro.",
			"limitOption": "Limiter l'utilisation mensuelle des crédits à :",
			"noLimit": "Aucune limite",
			"title": "Définir une limite mensuelle de crédits pour {name}",
			"update": "Mettre à jour la limite",
			"warning": "Cet utilisateur a déjà dépensé {credits} crédits. Définir la limite à ce montant ou en dessous empêchera toute exécution supplémentaire jusqu'au mois prochain."
		},
		"header": "Membres",
	...
	"removeMemberDialog": {
		"error": "Échec du retrait du membre",
		"message": "Ce membre sera retiré de votre espace de travail. Les crédits qu'il a utilisés ne seront pas remboursés.",
		"remove": "Retirer le membre",
		"success": "Membre retiré",
		"title": "Retirer ce membre ?"
	},
	"revokeInviteDialog": {
		"message": "Cette personne ne pourra plus rejoindre votre espace de travail. Son lien d'invitation sera invalidé.",
		"revoke": "Annuler l'invitation",
		"title": "Annuler l'invitation de cette personne ?"
	},
	"tabs": {
	...
	"toast": {
		...
		"workspaceDeleted": {
			"message": "L'espace de travail a été définitivement supprimé.",
			"title": "Espace de travail supprimé"
		},
		"workspaceLeft": {
			"message": "Vous avez quitté l'espace de travail.",
			"title": "Espace de travail quitté"
		},
		"workspaceUpdated": {
...
//# sourceMappingURL=main-CDmBE_CR.js.map