//#region src/locales/zh-TW/nodeDefs.json
var APG = {
	"display_name": "自適應投影引導",
	"inputs": {
		"eta": {
			"name": "eta",
			"tooltip": "控制平行引導向量的縮放比例。設定為 1 時為預設 CFG 行為。"
		},
		"model": { "name": "模型" },
		"momentum": {
			"name": "momentum",
			"tooltip": "控制擴散過程中引導的移動平均值，設定為 0 時停用。"
		},
		"norm_threshold": {
			"name": "norm_threshold",
			"tooltip": "將引導向量正規化至此值，設定為 0 時停用正規化。"
		}
	},
...
var ARVideoI2V = {
	...
	"inputs": {
		"batch_size": { "name": "批次大小" },
		"height": { "name": "高度" },
		"length": { "name": "長度" },
		"model": { "name": "model" },
		"start_image": { "name": "起始圖像" },
		"vae": { "name": "vae" },
		"width": { "name": "寬度" }
	},
	"outputs": {
...
var AdjustBrightness = {
	...
	"inputs": {
		"factor": {
			"name": "亮度係數",
			"tooltip": "亮度係數。1.0 = 無變化，<1.0 = 變暗，>1.0 = 變亮。"
		},
		"images": {
			"name": "影像",
			"tooltip": "要處理的影像。"
...
var AdjustContrast = {
	"description": "調整圖像的對比度。",
	"display_name": "調整對比度",
	"inputs": {
		"factor": {
			"name": "對比度係數",
			"tooltip": "對比度係數。1.0 = 無變化，<1.0 = 對比度降低，>1.0 = 對比度提高。"
		},
		"images": {
			"name": "影像",
			"tooltip": "要處理的影像。"
...
var AnimaLLLiteApply = {
	"display_name": "套用 Anima LLLite",
	"inputs": {
		"end_percent": { "name": "結束百分比" },
		"image": { "name": "影像" },
		"mask": { "name": "遮罩" },
		"model": { "name": "模型" },
		"model_patch": { "name": "模型補丁" },
		"start_percent": { "name": "起始百分比" },
		"strength": { "name": "強度" }
	}
};
var AudioAdjustVolume = {
	"description": "將音訊音量調整指定的分貝（dB）數值。",
	"display_name": "音訊調整音量",
	"inputs": {
		"audio": { "name": "音訊" },
		"volume": {
			"name": "volume",
			"tooltip": "以分貝 (dB) 為單位的音量調整。0 = 無變化，+6 = 兩倍，-6 = 一半，依此類推"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var AudioConcat = {
	"description": "將 audio1 串接至 audio2 的指定方向。",
	"display_name": "音訊串接",
	"inputs": {
		"audio1": { "name": "audio1" },
		"audio2": { "name": "audio2" },
		"direction": {
			"name": "direction",
			"tooltip": "將 audio2 附加在 audio1 之後或之前。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var AudioEncoderEncode = {
	"display_name": "音訊編碼器編碼",
	"inputs": {
		"audio": { "name": "音訊" },
...
var BatchMasksNode = {
	"display_name": "批次遮罩",
	"inputs": { "masks": { "name": "遮罩" } },
	"outputs": { "0": { "tooltip": null } }
};
var BeebleSwitchXImageEdit = {
	"description": "使用 Beeble SwitchX 編輯單張圖像。可切換場景中的任何元素（背景、光線、服裝），同時保留原始主體像素。請提供參考圖像及／或文字提示以描述新外觀。最大約 2.77MP。",
	"display_name": "Beeble SwitchX 圖像編輯",
	"inputs": {
		"alpha_mode": {
			"name": "alpha 模式",
			"tooltip": "控制 SwitchX 如何決定保留或重建內容。「auto」自動分離主要主體。「fill」重建整個畫面並保留幾何結構。「select」將首幀關鍵影格套用至整個 clip。「custom」使用您提供的每幀 alpha 遮罩。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"image": { "name": "圖像" },
		"max_resolution": {
			"name": "最大解析度",
			"tooltip": "輸出圖像的最大解析度。"
		...
		"prompt": {
			"name": "提示詞",
			"tooltip": "期望輸出內容的文字描述（最多 2000 字元）。「提示詞」或「參考圖像」至少需填寫一項。"
		},
		"reference_image": {
			"name": "參考圖像",
			"tooltip": "結果將採用此參考圖像的外觀（背景、光線、服裝）。「參考圖像」或「提示詞」至少需填寫一項。"
		},
		"seed": {
			"name": "種子",
	...
	"outputs": {
		...
		"1": {
			"name": "alpha",
			"tooltip": "Beeble 使用的 alpha 遮罩。「fill」模式下為空，無獨立遮罩。"
		}
	}
};
var BeebleSwitchXVideoEdit = {
	"description": "使用 Beeble SwitchX 編輯影片。可切換場景中的任何元素（背景、光線、服裝），同時保留原始主體像素與動作。請提供參考圖像及／或文字提示以描述新外觀。最多 240 幀，每幀最大約 2.77MP。",
	"display_name": "Beeble SwitchX 影片編輯",
	"inputs": {
		"alpha_mode": {
			"name": "alpha 模式",
			"tooltip": "控制 SwitchX 如何決定保留或重建內容。「auto」自動分離主要主體。「fill」重建整個畫面並保留幾何結構。「select」將首幀關鍵影格套用至整個 clip。「custom」使用您提供的每幀 alpha 遮罩。"
...
var BerniniConditioning = {
	"description": "Bernini 內文影片/圖像條件設定節點。可用於以下任務：t2v（文字轉影片）、v2v（影片轉影片）、rv2v（參考引導影片編輯）、r2v（參考轉影片）、ads2v（將圖像/影片插入影片）。作為內文 token 注入的參考圖像（r2v、rv2v）會以其原生長寬比獨立編碼（長邊最大值為 ref_max_size）。",
	...
	"inputs": {
		...
		"ref_max_size": {
			"name": "參考最大尺寸",
			"tooltip": "reference_video 與 reference_images 長邊的最大尺寸。會保持長寬比縮放並對齊至 16px。"
		},
		"reference_images": { "name": "參考圖像" },
		"reference_video": {
			"name": "參考影片",
			"tooltip": "要插入來源影片的影片（ads2v）。"
		},
		"source_video": {
			"name": "來源影片",
			"tooltip": "要編輯或重製風格的來源影片（v2v、rv2v）。會調整為指定寬高並裁剪至指定長度。"
		},
		"vae": { "name": "vae" },
		"width": { "name": "寬度" }
	},
...
var BriaImageEditNode = {
	...
	"inputs": {
		...
		"guidance_scale": {
			"name": "指引強度",
			"tooltip": "數值越高，圖像越貼合提示詞。"
		},
		"image": { "name": "圖像" },
		"mask": {
			"name": "遮罩",
			"tooltip": "若未設定，編輯將套用至整張圖像。"
		},
		"model": { "name": "model" },
		"moderation": {
			"name": "審核",
		...
		"structured_prompt": {
			"name": "結構化提示詞",
			"tooltip": "包含結構化編輯提示的 JSON 格式字串。若需精確、程式化控制，請使用此項取代一般提示詞。"
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var BriaRemoveImageBackground = {
	"description": "使用 Bria RMBG 2.0 移除影像的背景。",
	"display_name": "Bria 移除影像背景",
	"inputs": {
		"control_after_generate": { "name": "產生後控制" },
		"image": { "name": "影像" },
		"moderation": {
			"name": "審核",
			"tooltip": "審核設定"
		...
		"seed": {
			"name": "種子",
			"tooltip": "種子控制此節點是否重新執行；無論種子為何，結果皆為非決定性。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var BriaRemoveVideoBackground = {
	"description": "使用 Bria 移除影片的背景。",
	"display_name": "Bria 移除影片背景",
	"inputs": {
		"background_color": {
			"name": "背景顏色",
			"tooltip": "輸出影片的背景顏色。"
...
var BriaTransparentVideoBackground = {
	"description": "使用 Bria 移除影片背景，並返回去背後的影格及 alpha 遮罩。可將兩者連接到合成節點，或傳送到『儲存 WEBM』以輸出透明影片。",
	"display_name": "Bria 移除影片背景（透明）",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"seed": {
			"name": "種子",
...
var BriaVideoGreenScreen = {
	"description": "使用 Bria 將影片背景替換為純色色鍵（chroma-key）幕。",
	"display_name": "Bria Video 綠幕",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"green_shade": {
			"name": "green_shade",
			"tooltip": "套用於前景後方的純色色鍵色調：broadcast_green (#00B140)、chroma_green (#00FF00) 或 blue_screen (#0000FF)。"
		},
		"seed": {
			"name": "seed",
...
var BriaVideoReplaceBackground = {
	"description": "使用 Bria 將影片的背景替換為提供的圖片或影片。輸出會保留前景的解析度與幀率；若背景的長寬比不同，將會被拉伸以符合，因此建議匹配長寬比以避免變形。",
	"display_name": "Bria 影片更換背景",
	"inputs": {
		"background_image": {
			"name": "背景圖片",
			"tooltip": "要合成於前景後方的背景圖片。請僅提供背景圖片或背景影片其中之一。"
		},
		"background_video": {
			"name": "背景影片",
			"tooltip": "要合成於前景後方的背景影片。請僅提供背景圖片或背景影片其中之一。"
		},
		"control_after_generate": { "name": "產生後控制" },
		"seed": {
			"name": "種子",
...
var BuildJsonPromptIdeogram = {
	"description": "為 Ideogram 4 模型建立 JSON 格式的提示詞。",
	"display_name": "建立 JSON 提示（Ideogram）",
	"inputs": {
		"aesthetics": {
			"name": "美學",
			"tooltip": "必填，美學關鍵詞（例如：情緒化、電影感、去飽和）。"
		},
		"background": {
			"name": "背景",
			"tooltip": "必填，圖像背景或環境的描述。"
		},
		"color_palette": {
			"name": "色板",
			"tooltip": "主導圖像色彩的十六進位色碼，最多 16 組。"
		},
		"element": {
			"name": "元素",
			"tooltip": "來自節點 Create Bounding Boxes 的提示元素。"
		},
		"high_level_description": {
			"name": "高階描述",
			"tooltip": "可選的圖像描述，一至兩句話。強烈建議填寫。"
		},
		"lighting": {
			"name": "光線",
			"tooltip": "必填，光線描述（例如：黃金時刻、邊緣光、戲劇性陰影）。"
		},
		"medium": {
			"name": "媒材",
			"tooltip": "必填，媒材類型（例如：攝影、插畫、3d_render、繪畫、平面設計）。當 style = photo 時，請設為攝影。"
		},
		"style": { "name": "風格" }
	},
	"outputs": { "0": {
...
var ByteDance2FirstLastFrameNode = {
	"description": "使用 Seedance 2.0，從首幀圖像與可選的末幀圖像產生影片。",
	"display_name": "ByteDance Seedance 2.0 首末幀轉影片",
	"inputs": {
		"control_after_generate": { "name": "產生後控制" },
		"first_frame": {
			"name": "首幀圖像",
		...
		"first_frame_asset_id": {
			...
			"tooltip": "作為第一幀使用的 Seedance asset_id。與 first_frame 圖像輸入互斥。"
		},
		"last_frame": {
			"name": "末幀圖像",
			"tooltip": "影片的末幀圖像。"
		...
		"last_frame_asset_id": {
			...
			"tooltip": "作為最後一幀使用的 Seedance asset_id。與 last_frame 圖像輸入互斥。"
		},
		"model": {
			"name": "模型",
			"tooltip": "Seedance 2.0 提供最佳品質；Seedance 2.0 Fast 提供速度優化。"
		},
		"model_duration": { "name": "時長" },
		"model_generate_audio": { "name": "產生音訊" },
		"model_prompt": { "name": "提示詞" },
		"model_ratio": { "name": "比例" },
		"model_resolution": { "name": "解析度" },
		"seed": {
			"name": "種子",
			"tooltip": "種子決定此節點是否重新執行；無論種子為何，結果皆為非決定性。"
		},
		"watermark": {
			"name": "浮水印",
			"tooltip": "是否在影片中加入浮水印。"
...
var ByteDance2ReferenceNode = {
	"description": "使用 Seedance 2.0，透過參考圖像、影片與音訊產生、編輯或延伸影片。支援多模態參考、影片編輯與影片延伸。",
	"display_name": "ByteDance Seedance 2.0 參考轉影片",
	"inputs": {
		"control_after_generate": { "name": "產生後控制" },
		"model": {
			"name": "模型",
		...
		"model_auto_downscale": { "name": "自動縮小" },
...
var ByteDance2TextToVideoNode = {
	"description": "根據文字提示，使用 Seedance 2.0 模型產生影片。",
	"display_name": "ByteDance Seedance 2.0 文字轉影片",
	"inputs": {
		"control_after_generate": { "name": "產生後控制" },
		"model": {
			"name": "模型",
...
var ByteDanceCreateImageAsset = {
	"description": "建立一個 Seedance 2.0 個人圖像資產。上傳輸入圖像並將其註冊到指定的資產群組。如果 group_id 為空，將執行真人 H5 認證流程以建立新群組後再新增資產。",
	"display_name": "ByteDance 建立圖像資產",
	"inputs": {
		"group_id": {
			"name": "group_id",
			"tooltip": "重複使用現有的 Seedance 資產群組 ID，可跳過同一人的重複人臉驗證。留空則會在瀏覽器中執行真人認證並建立新群組。"
		},
		"image": {
			"name": "image",
			"tooltip": "要註冊為個人資產的圖像。"
...
var ByteDanceCreateVideoAsset = {
	"description": "建立一個 Seedance 2.0 個人影片資產。上傳輸入影片並將其註冊到指定的資產群組。如果 group_id 為空，將執行真人 H5 認證流程以建立新群組後再新增資產。",
	"display_name": "ByteDance 建立影片資產",
	"inputs": {
		"group_id": {
			"name": "group_id",
			"tooltip": "重複使用現有的 Seedance 資產群組 ID，可跳過同一人的重複人臉驗證。留空則會在瀏覽器中執行真人認證並建立新群組。"
...
var ByteDanceFirstLastFrameNode = {
	...
	"inputs": {
		...
		"camera_fixed": {
			"name": "固定攝影機",
			"tooltip": "指定是否固定攝影機。平台會將固定攝影機的指令附加到您的提示詞中，但不保證實際效果。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"duration": {
			"name": "持續時間",
		...
		"generate_audio": {
			"name": "generate_audio",
			"tooltip": "此參數僅適用於 seedance-1-5-pro，其他模型將會忽略。"
		},
		"last_frame": {
			"name": "尾幀",
			"tooltip": "用於影片的尾幀。"
		...
		"watermark": {
			"name": "浮水印",
			"tooltip": "是否在影片中添加「AI 生成」浮水印。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ByteDanceImageNode = {
	"description": "透過 API 基於提示詞使用字節跳動模型生成圖像",
	"display_name": "字節跳動圖像",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"guidance_scale": {
			"name": "guidance_scale",
			"tooltip": "數值越高，圖像越遵循提示詞"
		},
		"height": {
			"name": "height",
		...
		"size_preset": {
			"name": "size_preset",
			"tooltip": "選擇推薦尺寸。選擇「自訂」以使用下方的寬度和高度"
		},
		"watermark": {
			"name": "watermark",
		...
		"width": {
			"name": "width",
			"tooltip": "圖像的自訂寬度。僅在 `size_preset` 設為 `Custom` 時生效"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ByteDanceImageReferenceNode = {
	"description": "使用提示詞和參考圖像生成影片",
	"display_name": "字節跳動參考圖像轉影片",
	"inputs": {
		"aspect_ratio": {
			"name": "aspect_ratio",
			"tooltip": "輸出影片的長寬比。"
...
var ByteDanceImageToVideoNode = {
	"description": "透過 API 使用字節跳動模型，基於圖片和提示生成影片",
	"display_name": "字節跳動圖片轉影片",
	"inputs": {
		"aspect_ratio": {
			"name": "aspect_ratio",
			"tooltip": "輸出影片的長寬比。"
		...
		"camera_fixed": {
			"name": "camera_fixed",
			"tooltip": "指定是否固定相機。平台會將固定相機的指令附加到您的提示詞中，但不保證實際效果。"
		},
		"control_after_generate": { "name": "control after generate" },
		"duration": {
			"name": "duration",
...
var ByteDanceSeedAudio = {
	"description": "使用 ByteDance Seed Audio 1.0，從單一提示生成語音、音樂、音效及多角色對話。在提示中描述聲音、情感、氛圍、背景音樂與音效，並包含要說的台詞。可選擇內建預設聲音、從最多 3 個參考 clip（在提示中標記為 @Audio1-3）進行聲音克隆，或從角色圖像推導聲音。每次最多可生成 2 分鐘音訊。",
	"display_name": "ByteDance Seed Audio 1.0",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"loudness_rate": {
			"name": "loudness_rate",
			"tooltip": "音量。0 = 正常，100 = 2.0 倍，-50 = 0.5 倍。"
		},
		"model": {
			"name": "model",
			"tooltip": "seed-audio-1.0-multilingual：支援 20 種語言（英語、中文、日語、韓語、墨西哥西班牙語、卡斯提利亞西班牙語、印尼語、德語、巴西葡萄牙語、法語、泰語、越南語、馬來語、菲律賓語、義大利語、俄語、荷蘭語、波蘭語、土耳其語、瑞典語），並可透過「[5.5s:8.0s] ...」時間戳進行逐句時間控制。seed-audio-1.0：僅支援英語與中文，不支援時間控制。"
		},
		"pitch_rate": {
			"name": "pitch_rate",
			"tooltip": "音高變化（半音，-12 至 12）。"
		},
		"reference_mode": {
			"name": "reference_mode",
			"tooltip": "聲音條件設定方式：「僅文字」（所有內容皆於提示中描述）、 「音訊參考」（最多克隆 3 種聲音，標記為 @Audio1-3）、 「圖像參考」（從單一角色圖像推導聲音）、或「預設聲音」（選擇內建命名聲音朗讀提示）。"
		},
		"sample_rate": {
			"name": "sample_rate",
			"tooltip": "輸出取樣率（Hz）。"
		...
		"speech_rate": {
			"name": "speech_rate",
			"tooltip": "語速。0 = 正常，100 = 2.0 倍，-50 = 0.5 倍。"
		},
		"text_prompt": {
			"name": "text_prompt",
			"tooltip": "描述聲音、情感、語速、氛圍、背景音樂與音效，並包含要說的台詞（對話時請直接標註角色名稱）。在「音訊參考」模式下，依順序引用連接的 clip，如 @Audio1、@Audio2、@Audio3。最多 3000 字元。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ByteDanceSeedNode = {
	"description": "使用 ByteDance 的 Seed 2.0 模型生成文字回應。請提供文字提示，並可選擇性地加入一張或多張圖片或影片作為多模態上下文。",
	"display_name": "ByteDance Seed",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model": {
			"name": "模型",
			"tooltip": "用於生成回應的 Seed 模型。"
		},
		"model_temperature": { "name": "溫度" },
		"prompt": {
			"name": "提示詞",
			"tooltip": "輸入給模型的文字內容。"
		},
		"seed": {
			"name": "隨機種子",
			"tooltip": "隨機種子控制此節點是否重新執行；無論種子為何，結果皆為非確定性。"
		},
		"system_prompt": {
			"name": "系統提示",
			"tooltip": "決定模型行為的基礎指令。"
...
var ByteDanceSeedreamNode = {
	...
	"inputs": {
		...
		"fail_on_partial": {
			...
			"tooltip": "若啟用，當任何請求的圖像缺失或回報錯誤時，將中止執行。"
		},
		"height": {
			"name": "height",
			"tooltip": "圖像的自訂高度。僅在 `size_preset` 設為 `Custom` 時生效"
		...
		"image": {
			"name": "image",
			"tooltip": "用於圖像生成圖像的輸入圖片。單一或多參考生成可使用 1-10 張圖片清單。"
		},
		"max_images": {
			"name": "max_images",
			"tooltip": "當 sequential_image_generation='auto' 時，生成圖像的最大數量。總圖像數（輸入 + 生成）不得超過 15 張。"
		},
		"model": { "name": "model" },
		"prompt": {
			"name": "prompt",
			"tooltip": "用於建立或編輯圖片的文字提示。"
		},
		"seed": {
			"name": "seed",
			"tooltip": "用於生成的種子值。"
		...
		"sequential_image_generation": {
			...
			"tooltip": "群組圖像生成模式。「disabled」生成單一圖像。「auto」讓模型決定是否生成多張相關圖像（例如故事場景、角色變體）。"
		},
		"size_preset": {
			"name": "size_preset",
			"tooltip": "選擇推薦尺寸。選擇「自訂」以使用下方的寬度和高度。"
...
var ByteDanceSeedreamNodeV2 = {
	...
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model": { "name": "模型" },
		"model_height": { "name": "高度" },
		"model_size_preset": { "name": "尺寸預設" },
		"model_width": { "name": "寬度" },
		"prompt": {
			"name": "提示詞",
		...
		"thinking": {
			"name": "thinking",
			"tooltip": "啟用模型的提示優化推理（「thinking」），以提升遵循度。可能大幅增加生成時間——特別是在 Seedream 5.0 Pro 上。僅可在文字轉圖像時停用（若有參考圖像則無法停用）。"
		},
		"watermark": {
			"name": "浮水印",
			"tooltip": "是否在圖像上添加「AI 生成」浮水印。"
...
var CFGNorm = {
	"display_name": "CFG 正規化",
	"inputs": {
		"model": { "name": "模型" },
		"pre_cfg": {
			"name": "pre_cfg",
			"tooltip": "若為 true，則在取樣器的 CFG 組合之前對合併後的雜訊進行重新縮放，且不進行夾制（可能會放大）。這與像 Lens 這類模型所使用的 norm-scaled CFG 相符。預設為 false，則保持原本在 CFG 後僅於 x0 空間進行衰減的行為。"
		},
		"strength": { "name": "強度" }
	},
	"outputs": { "0": {
...
var CFGOverride = {
	"description": "將 cfg 覆蓋為固定值，於步驟的 [起始, 結束] 百分比區間內生效。若有多個覆蓋，重疊時以最接近取樣器者為準。",
	"display_name": "CFG 覆蓋",
	"inputs": {
		"cfg": { "name": "cfg" },
		"end_percent": { "name": "結束百分比" },
...
var CLIPSave = {
	"display_name": "CLIP 儲存",
	"inputs": {
		"clip": { "name": "clip" },
		"filename_prefix": { "name": "檔名前綴" }
	}
};
var CLIPSetLastLayer = {
	"display_name": "CLIP 設定最後一層",
	"inputs": {
		"clip": { "name": "clip" },
		"stop_at_clip_layer": { "name": "停止於 CLIP 層" }
	}
};
var CLIPTextEncode = {
	"description": "使用 CLIP 模型將文字提示編碼為嵌入向量，可用於引導擴散模型生成特定圖像。",
	"display_name": "CLIP 文字編碼（提示詞）",
	"inputs": {
		"clip": {
			"name": "CLIP",
	...
	"outputs": { "0": { "tooltip": "包含嵌入文字的條件，用於引導擴散模型。" } }
};
...
var CLIPTextEncodeLumina2 = {
	"description": "使用 CLIP 模型將系統提示與使用者提示編碼為嵌入向量，可用於引導擴散模型生成特定圖像。",
	"display_name": "CLIP 文本編碼（Lumina2）",
	"inputs": {
		"clip": {
			"name": "clip",
			"tooltip": "用於編碼文字的 CLIP 模型。"
		...
		"system_prompt": {
			"name": "system_prompt",
			"tooltip": "Lumina2 提供兩種類型的系統提示：Superior：你是一個旨在根據文字提示或使用者提示，生成圖文對齊度極高的優質圖像的助手。Alignment：你是一個旨在根據文字提示，生成圖文對齊度最高的高品質圖像的助手。"
		},
		"user_prompt": {
			"name": "user_prompt",
			"tooltip": "要編碼的文字內容。"
...
var CLIPTextEncodePixArtAlpha = {
	"description": "編碼文字並設定 PixArt Alpha 的解析度條件。不適用於 PixArt Sigma。",
...
var CLIPTextEncodeSDXL = {
	...
	"inputs": {
		...
		"crop_w": { "name": "裁剪寬度" },
		"height": { "name": "高度" },
		"target_height": { "name": "目標高度" },
		"target_width": { "name": "目標寬度" },
		"text_g": { "name": "文字 G" },
		"text_l": { "name": "文字 L" },
		"width": { "name": "寬度" }
	},
...
var CLIPVisionLoader = {
	"display_name": "載入 CLIP Vision",
	"inputs": { "clip_name": { "name": "clip_name" } }
};
var Canny = {
	"display_name": "Canny",
	"inputs": {
		"high_threshold": { "name": "高閾值" },
		"image": { "name": "影像" },
		"low_threshold": { "name": "低閾值" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var CaseConverter = {
...
var CheckpointLoaderSimple = {
	"description": "載入一個擴散模型檢查點，擴散模型用於對潛在空間進行去噪處理。",
	"display_name": "載入檢查點",
	"inputs": { "ckpt_name": {
		"name": "ckpt_name",
		"tooltip": "要載入的檢查點（模型）名稱。"
	} },
	"outputs": {
		"0": { "tooltip": "用於對潛在空間進行去噪處理的模型。" },
		"1": { "tooltip": "用於編碼文字提示的 CLIP 模型。" },
		"2": { "tooltip": "用於將影像與潛在空間之間進行編碼與解碼的 VAE 模型。" }
	}
};
var CheckpointSave = {
	"display_name": "儲存檢查點",
...
var ChromaRadianceOptions = {
	"description": "允許為 Chroma Radiance 模型設定進階選項。",
	"display_name": "ChromaRadiance 選項",
	"inputs": {
		"end_sigma": {
			"name": "結束 sigma",
			"tooltip": "這些選項將生效的最後一個 sigma 值。"
		},
		"force_sequential_txt_ids": {
			"name": "強制使用連續文本標記ID",
			"tooltip": "強制使用連續文本標記ID，而非全為零。此選項適用於2026-05-22至2026-06-01期間訓練、但狀態字典中未包含 __sequential__ 鍵的checkpoint。"
		},
		"model": { "name": "模型" },
		"nerf_tile_size": {
			"name": "NeRF 圖塊大小",
			"tooltip": "允許覆寫預設的 NeRF 圖塊大小。-1 表示使用預設值 (32)。0 表示使用非平鋪模式（可能需要大量 VRAM）。"
		},
		"preserve_wrapper": {
			"name": "保留包裝器",
			"tooltip": "啟用時，如果存在現有模型函數包裝器，將委派給它。通常應保持啟用狀態。"
		},
		"start_sigma": {
			"name": "起始 sigma",
			"tooltip": "這些選項將生效的第一個 sigma 值。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ClaudeNode = {
	"description": "使用 Anthropic 的 Claude 模型生成文字回應。請提供文字提示，並可選擇性加入一張或多張圖片作為多模態上下文。",
	"display_name": "Anthropic Claude",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"images": {
			"name": "images",
			"tooltip": "可選的圖片作為模型上下文使用。最多可加入 20 張圖片。"
		},
		"model": {
			"name": "model",
			"tooltip": "用於生成回應的 Claude 模型。"
		},
...
var ColorToRGBInt = {
	"description": "將顏色轉換為 RGB 整數值。",
	"display_name": "顏色轉為 RGB 整數值",
	"inputs": { "color": { "name": "顏色" } },
	"outputs": {
		"0": {
			"name": "rgb 整數值",
			"tooltip": null
...
var ColorTransfer = {
	"description": "使用各種演算法將一張圖片的色彩匹配到另一張圖片。",
	"display_name": "ColorTransfer",
	"inputs": {
		"image_ref": {
			"name": "image_ref",
			"tooltip": "要匹配色彩的參考圖片。如果未提供，將跳過處理。"
		},
		"image_target": {
			"name": "image_target",
			"tooltip": "要套用色彩轉換的圖片。"
		...
		"source_stats": {
			"name": "source_stats",
			"tooltip": "per_frame：每一幀分別與 image_ref 匹配。uniform：將所有來源幀的統計數據合併作為基準，並與 image_ref 匹配。target_frame：選擇一幀作為轉換到 image_ref 的基準，並均勻套用到所有幀（保留相對差異）"
		},
...
var ComfyAndNode = {
	"description": "邏輯 AND 運算。若所有值皆為真則回傳 true。依據 Python 的真值規則判斷。",
	"display_name": "And",
...
var ComfyNotNode = {
	"description": "邏輯 NOT 運算。若值為假則回傳 true。依據 Python 的真值規則判斷。",
	"display_name": "Not",
...
var ComfyOrNode = {
	"description": "邏輯 OR 運算。若任一值為真則回傳 true。依據 Python 的真值規則判斷。",
	"display_name": "Or",
	"inputs": { "values": { "name": "values" } },
	"outputs": { "0": { "tooltip": null } }
};
...
var ConditioningSetArea = {
	"display_name": "條件設定（區域設置）",
	"inputs": {
		"conditioning": { "name": "條件" },
		"height": { "name": "高度" },
		"strength": { "name": "強度" },
		"width": { "name": "寬度" },
		"x": { "name": "X 座標" },
...
var ConditioningSetMask = {
	"display_name": "條件設定（設置遮罩）",
	"inputs": {
		"conditioning": { "name": "條件" },
		"mask": { "name": "遮罩" },
		"set_cond_area": { "name": "設定條件區域" },
		"strength": { "name": "強度" }
	}
};
...
var ConditioningStableAudio = {
	"display_name": "條件設定（Stable Audio）",
	"inputs": {
		"negative": { "name": "負向" },
		"positive": { "name": "正向" },
		"seconds_start": { "name": "起始秒數" },
		"seconds_total": { "name": "總秒數" }
	},
	"outputs": {
		"0": {
			"name": "正向",
...
var ConditioningZeroOut = {
	"display_name": "條件設定（歸零）",
	"inputs": { "conditioning": { "name": "條件設定" } }
};
var ContextWindowsManual = {
	"description": "手動設定上下文視窗。",
	"display_name": "上下文視窗（手動）",
	"inputs": {
		"causal_window_fix": {
			"name": "causal_window_fix",
			"tooltip": "是否為非0索引的 context window 添加因果修正框架。"
		},
		"closed_loop": {
			"name": "閉環",
			"tooltip": "是否關閉上下文窗口循環；僅適用於循環排程。"
		},
		"cond_retain_index_list": {
			"name": "cond_retain_index_list",
			"tooltip": "每個視窗中要在 conditioning 張量中保留的 latent 索引列表，例如設為「0」將會在每個視窗中使用初始起始圖像。"
		},
		"context_length": {
			"name": "上下文長度",
			"tooltip": "上下文窗口的長度。"
		...
		"freenoise": {
			"name": "自由雜訊",
			"tooltip": "是否應用 FreeNoise 雜訊洗牌，可改善視窗混合效果。"
		},
		"fuse_method": {
			"name": "融合方法",
			"tooltip": "用於融合上下文窗口的方法。"
		},
		"latent_retain_index_list": {
			"name": "latent_retain_index_list",
			"tooltip": "每個視窗中要在 noise latent 本身中保留的 latent 索引列表。適用於參考內容（例如起始圖像）直接存在於 noise latent 中，而不是在單獨的 conditioning channel 中的工作流程（例如 inplace 風格的 I2V，如 LTXV、AnimateDiff）。與 cond_retain_index_list 無關。"
		},
		"model": {
			"name": "模型",
			"tooltip": "在取樣期間應用上下文窗口的模型。"
		},
		"split_conds_to_windows": {
			"name": "split_conds_to_windows",
			"tooltip": "是否根據區域索引，將多個 conditioning（由 ConditionCombine 建立）分配到各個視窗。"
		}
	},
	"outputs": { "0": { "tooltip": "在取樣期間應用上下文窗口的模型。" } }
};
var ControlNetApply = {
	"display_name": "套用 ControlNet（舊版）",
	"inputs": {
		"conditioning": { "name": "條件設定" },
...
var ControlNetApplySD3 = {
	"display_name": "套用 ControlNet (SD3)",
	"inputs": {
		"control_net": { "name": "control_net" },
		"end_percent": { "name": "結束百分比" },
		"image": { "name": "影像" },
...
var ControlNetInpaintingAliMamaApply = {
	"display_name": "套用 ControlNet 修補（AliMama）",
	"inputs": {
		"control_net": { "name": "control_net" },
		"end_percent": { "name": "結束百分比" },
		"image": { "name": "影像" },
...
var CosmosImageToVideoLatent = {
	"display_name": "Cosmos 圖片轉影片潛在編碼",
	"inputs": {
		"batch_size": { "name": "批次大小" },
		"end_image": { "name": "結束圖片" },
		"height": { "name": "高度" },
		"length": { "name": "長度" },
		"start_image": { "name": "起始影像" },
		"vae": { "name": "vae" },
		"width": { "name": "寬度" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var CreateBoundingBoxes = {
	"description": "在畫布上繪製邊界框。輸出 Ideogram 提示元素、像素空間邊界框，以及預覽圖像。",
	"display_name": "建立邊界框",
	"inputs": {
		"background": {
			"name": "背景",
			"tooltip": "可選，作為畫布及預覽背景的圖像。"
		},
		"bboxes": {
			"name": "bboxes",
			"tooltip": "邊界框、元素，或用於初始化畫布的 JSON 字串。每當上游值變動時會重新初始化畫布；在畫布上的編輯將優先並保留，直到上游值再次變動。"
		},
		"editor_state": {
			"name": "編輯器狀態",
			"tooltip": "繪製邊界框並設定每個框的類型、文字、描述、色板。請先設定背景元素，最後設定前景元素。"
		},
		"height": {
			"name": "高度",
			"tooltip": "畫布及邊界框像素網格的高度。"
		},
		"last_incoming": {
			"name": "last_incoming",
			"tooltip": "由畫布管理的內部狀態：最後一次初始化畫布的上游 bboxes 值。留空則於下次執行時，從 bboxes 輸入重新初始化畫布。"
		},
		"width": {
			"name": "寬度",
			"tooltip": "畫布及邊界框像素網格的寬度。"
		}
	},
	"outputs": {
		"0": {
...
var CreateCameraInfo = {
	"description": "建立 camera_info。模式 'orbit' 以目標為中心進行偏航/俯仰/距離的環繞；'look_at' 則將相機放置於世界座標位置。座標為觀者的世界空間（右手座標系，Y 軸向上）。",
	"display_name": "建立相機資訊",
	"inputs": {
		"camera_type": {
			"name": "相機類型",
			"tooltip": "Render Splat 使用的投影方式：透視（有透視縮短）或正交（平行投影）。"
		},
		"fov": {
			"name": "視野",
			"tooltip": "垂直視野角度（度）。"
		...
		"mode": {
			"name": "模式",
			"tooltip": "定義相機方式：環繞角度、明確位置，或位置加四元數。"
		},
		...
		"roll": {
			"name": "滾轉",
			"tooltip": "相機繞視線軸的滾轉角度（度）。"
		},
		"target_x": {
			"name": "目標_x",
			"tooltip": "注視點（環繞樞紐/瞄準點）。在環繞模式下，移動此點可平移整個相機。四元數模式下忽略。預設為原點。"
		},
		"target_y": { "name": "目標_y" },
		"target_z": { "name": "目標_z" },
		"zoom": {
			"name": "縮放",
			"tooltip": "數位縮放（焦距倍率）。大於 1 時不移動相機而放大。"
		}
	},
	"outputs": { "0": {
		"name": "camera_info",
...
var CreateHookKeyframesFromFloats = {
	"display_name": "從浮點數建立 Hook 關鍵影格",
	"inputs": {
		"end_percent": { "name": "結束百分比" },
		"floats_strength": { "name": "floats_strength" },
		"prev_hook_kf": { "name": "前一個 Hook 關鍵影格" },
		"print_keyframes": { "name": "顯示關鍵影格" },
		"start_percent": { "name": "起始百分比" }
	},
	"outputs": { "0": { "name": "HOOK_KF" } }
};
var CreateHookKeyframesInterpolated = {
	"display_name": "建立 Hook 關鍵影格插值",
	"inputs": {
		"end_percent": { "name": "結束百分比" },
		"interpolation": { "name": "插值方式" },
		"keyframes_count": { "name": "關鍵影格數量" },
		"prev_hook_kf": { "name": "前一個 Hook 關鍵影格" },
		"print_keyframes": { "name": "輸出關鍵影格" },
		"start_percent": { "name": "起始百分比" },
...
var CreateHookModelAsLora = {
	"display_name": "建立 Hook 模型為 LoRA",
	"inputs": {
		"ckpt_name": { "name": "ckpt_name" },
		"prev_hooks": { "name": "前一個 hook" },
		"strength_clip": { "name": "clip 強度" },
		"strength_model": { "name": "模型強度" }
	}
};
var CreateHookModelAsLoraModelOnly = {
	"display_name": "建立 Hook 模型為 LoRA（MO）",
	"inputs": {
		"ckpt_name": { "name": "ckpt_name" },
		"prev_hooks": { "name": "prev_hooks" },
		"strength_model": { "name": "strength_model" }
...
var CropByBBoxes = {
	...
	"inputs": {
		...
		"keep_aspect": {
			"name": "保持比例",
			"tooltip": "選擇是否將裁剪內容拉伸以符合輸出尺寸，或以黑色像素填充以保留長寬比。"
		},
		"output_height": {
			"name": "output_height",
	...
	"outputs": { "0": { "tooltip": "所有裁切區域堆疊為單一影像批次。" } }
};
var CropMask = {
	"display_name": "裁剪遮罩",
	"inputs": {
...
var DA3GeometryToMesh = {
	"description": "將深度圖轉換為三角化的 3D 網格。",
	"display_name": "將 DA3 幾何轉換為網格",
	"inputs": {
		"batch_index": {
			"name": "batch_index",
			"tooltip": "要轉換的批次中的哪一張影像。由於每張影像的頂點數不同，批次無法堆疊。"
		},
		"confidence_threshold": {
			"name": "confidence_threshold",
			"tooltip": "排除每張影像正規化信心值低於此值的像素（0 = 保留全部，1 = 只保留最有信心的像素）。當幾何資料有信心圖時使用（Small/Base 模型）。"
		},
		"da3_geometry": { "name": "da3_geometry" },
		"decimation": {
			"name": "decimation",
			"tooltip": "頂點間隔。1 = 全解析度，2 = 一半，依此類推。"
		},
		"discontinuity_threshold": {
			"name": "discontinuity_threshold",
			"tooltip": "若三角形的 3x3 深度跨度超過此比例則捨棄。0 = 關閉。"
		},
		"texture": {
			"name": "texture",
			"tooltip": "使用來源影像作為基礎色彩貼圖。"
		},
		"use_sky_mask": {
			"name": "use_sky_mask",
			"tooltip": "從網格中排除天空機率像素（sky >= 0.5）。當幾何資料有天空圖時使用（Mono/Metric 模型）。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var DA3Inference = {
	"description": "在影像上執行 Depth Anything 3。多視角模式下，每張影像被視為同一場景的不同視角。",
	"display_name": "執行 Depth Anything 3",
	"inputs": {
		"da3_model": { "name": "da3_model" },
		"image": { "name": "image" },
		"mode": {
			"name": "mode",
			"tooltip": "mono：單視角影像（適用於任何模型變體）。\nmultiview：所有影像一起處理以獲得幾何一致性與相機姿態（僅限 Small/Base 模型）。"
		},
		"resize_method": {
			"name": "resize_method",
			"tooltip": "upper_bound_resize：縮放至最長邊 = 解析度（限制記憶體，預設）。\nlower_bound_resize：縮放至最短邊 = 解析度（在高/寬影像上保留更多細節，但使用更多記憶體）。"
		},
		"resolution": {
			"name": "resolution",
			"tooltip": "模型運行的解析度（最長邊，14 的倍數）。\n較低 = 較快 / 較少 VRAM。\n較高 = 更多細節。\n輸出會上採樣回原始大小。"
		}
	},
	"outputs": { "0": {
		"name": "da3_geometry",
		"tooltip": "非正規化 tensor 字典。\n一定包含的鍵：depth、image、mode。\n可選鍵：sky（Mono/Metric）、confidence（Small/Base）、extrinsics + intrinsics（多視角時）。"
	} }
};
var DA3Render = {
	"description": "從 Depth Anything 3 幾何資料渲染深度圖、信心圖或天空 mask。",
	"display_name": "渲染 Depth Anything 3",
	"inputs": {
		"da3_geometry": { "name": "da3_geometry" },
		"output": {
			"name": "output",
			"tooltip": "- depth：正規化灰階深度影像。\n- depth_colored：經 Turbo 色圖映射的深度。\n- sky_mask：天空機率 [0, 1]（僅 Mono/Metric 模型）。\n- confidence：正規化深度信心（僅 Small/Base 模型）。"
		},
...
var DualCFGGuider = {
	"display_name": "雙 CFG 引導器",
	"inputs": {
		"cfg_cond2_negative": { "name": "cfg cond2 負面" },
		"cfg_conds": { "name": "cfg 條件" },
		"cond1": { "name": "cond1" },
		"cond2": { "name": "cond2" },
		"model": { "name": "model" },
		"negative": { "name": "負面" },
...
var DualCLIPLoader = {
	"description": "[配方]\n\nsdxl：clip-l、clip-g\nsd3：clip-l、clip-g / clip-l、t5 / clip-g、t5\nflux：clip-l、t5\nhidream：至少需有 t5 或 llama，建議同時使用 t5 與 llama",
	"display_name": "雙 CLIP 載入器",
	"inputs": {
...
var DualModelGuider = {
	"display_name": "雙模型 CFG 引導器",
	"inputs": {
		"cfg": { "name": "cfg" },
		"model": {
			"name": "模型",
			"tooltip": "用於正向（條件）階段的模型。"
		},
		"model_negative": {
			"name": "負向模型",
			"tooltip": "用於負向（無條件）階段的模型。一般 CFG 請使用相同模型。"
		},
		"negative": {
			"name": "負向",
			"tooltip": "在負向模型上執行的負向條件。若不連接則為無文字（僅圖像）無條件階段。"
		},
		"positive": { "name": "正向" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var EasyCache = {
	"description": "原生 EasyCache 實現。",
	"display_name": "EasyCache",
	"inputs": {
		"end_percent": {
			"name": "結束百分比",
			"tooltip": "結束使用 EasyCache 的相對取樣步驟。"
		},
		"model": {
			"name": "模型",
			"tooltip": "要添加 EasyCache 的模型。"
		},
		"reuse_threshold": {
			"name": "重用閾值",
			"tooltip": "重用快取步驟的閾值。"
		...
		"start_percent": {
			"name": "起始百分比",
			"tooltip": "開始使用 EasyCache 的相對取樣步驟。"
		},
		"verbose": {
			"name": "詳細模式",
			"tooltip": "是否記錄詳細資訊。"
	...
	"outputs": { "0": { "tooltip": "帶有 EasyCache 的模型。" } }
};
var ElevenLabsAudioIsolation = {
	"description": "從音訊中移除背景噪音，僅保留人聲或語音。",
	"display_name": "ElevenLabs 語音隔離",
	"inputs": { "audio": {
		"name": "音訊",
		"tooltip": "要進行背景噪音移除處理的音訊。"
	} },
	"outputs": { "0": { "tooltip": null } }
};
var ElevenLabsInstantVoiceClone = {
	"description": "從音訊樣本建立克隆語音。請提供 1-8 段要克隆的語音錄音。",
	"display_name": "ElevenLabs 即時語音克隆",
	"inputs": {
		"files": {
			"name": "檔案",
			"tooltip": "用於語音克隆的語音錄音。"
...
var ElevenLabsSpeechToSpeech = {
	"description": "將一種語音轉換為另一種語音，同時保留原始內容與情感。",
	"display_name": "ElevenLabs 語音轉語音",
	"inputs": {
		"audio": {
			"name": "音訊",
			"tooltip": "要轉換的來源音訊。"
		...
		"model": {
			"name": "模型",
			"tooltip": "用於語音轉語音轉換的模型。"
		},
		"model_similarity_boost": { "name": "相似度提升" },
		"model_speed": { "name": "速度" },
		"model_style": { "name": "風格" },
		"model_use_speaker_boost": { "name": "使用說話者增強" },
		"output_format": {
			"name": "輸出格式",
			"tooltip": "音訊輸出格式。"
		},
		...
		"stability": {
			"name": "穩定性",
			"tooltip": "語音穩定性。較低的值提供更廣泛的情感範圍，較高的值則產生更一致但可能較單調的語音。"
		},
		"voice": {
			"name": "目標語音",
			"tooltip": "轉換的目標語音。可從語音選擇器或即時語音克隆連接。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ElevenLabsSpeechToText = {
	"description": "將音訊轉錄為文字。支援自動語言偵測、說話者分離與音訊事件標記。",
	"display_name": "ElevenLabs 語音轉文字",
	"inputs": {
		"audio": {
			"name": "音訊",
			"tooltip": "要轉錄的音訊。"
		...
		"language_code": {
			"name": "語言代碼",
			"tooltip": "ISO-639-1 或 ISO-639-3 語言代碼（例如 'en'、'es'、'fra'）。留空以自動偵測。"
		},
		"model": {
			"name": "模型",
			"tooltip": "用於轉錄的模型。"
		},
		"model_diarization_threshold": { "name": "分離閾值" },
		"model_diarize": { "name": "說話者分離" },
		"model_tag_audio_events": { "name": "音訊事件標記" },
		"model_temperature": { "name": "溫度" },
		"model_timestamps_granularity": { "name": "時間戳精細度" },
		"num_speakers": {
			"name": "說話者數量",
			"tooltip": "預測的最大說話者數量。設為 0 以自動偵測。"
		},
		"seed": {
			"name": "隨機種子",
			"tooltip": "用於重現性的隨機種子（不保證完全確定性）。"
		}
	},
	"outputs": {
		"0": {
...
var ElevenLabsTextToDialogue = {
	"description": "從文字產生多說話者對話。每個對話項目有其專屬文字與語音。",
	"display_name": "ElevenLabs 文字轉對話",
	"inputs": {
		"apply_text_normalization": {
			"name": "套用文字正規化",
			"tooltip": "文字正規化模式。'auto' 由系統決定，'on' 總是套用正規化，'off' 則略過。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"inputs": {
			"name": "對話項目數",
		...
		"stability": {
			"name": "穩定性",
			"tooltip": "語音穩定性。較低值提供更廣的情感範圍，較高值則產生更一致但可能較單調的語音。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ElevenLabsTextToSoundEffects = {
	"description": "根據文字描述產生音效。",
	"display_name": "ElevenLabs 文字轉音效",
	"inputs": {
		"model": {
			"name": "模型",
			"tooltip": "用於音效生成的模型。"
		...
		"model_duration": { "name": "時長" },
		"model_loop": { "name": "循環" },
		"model_prompt_influence": { "name": "提示影響力" },
		"output_format": {
			"name": "輸出格式",
			"tooltip": "音訊輸出格式。"
		},
...
var ElevenLabsTextToSpeech = {
	...
	"display_name": "ElevenLabs 語音合成",
	"inputs": {
		"apply_text_normalization": {
			"name": "套用文字正規化",
			"tooltip": "文字正規化模式。'auto' 由系統自動決定，'on' 總是套用正規化，'off' 則跳過正規化。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"language_code": {
			"name": "語言代碼",
			"tooltip": "ISO-639-1 或 ISO-639-3 語言代碼（例如 'en'、'es'、'fra'）。留空則自動偵測。"
		},
		"model": {
			"name": "模型",
			"tooltip": "用於文字轉語音的模型。"
		...
		"model_speed": { "name": "速度" },
		"model_style": { "name": "風格" },
		"model_use_speaker_boost": { "name": "啟用說話者增強" },
		"output_format": {
			"name": "輸出格式",
			"tooltip": "音訊輸出格式。"
		},
		"seed": {
			"name": "種子值",
			"tooltip": "用於重現性的種子值（不保證完全確定性）。"
		},
		"stability": {
			"name": "穩定性",
			"tooltip": "語音穩定性。較低的值提供更廣泛的情感表現，較高的值則產生更一致但可能較單調的語音。"
		},
		"text": {
			"name": "文字",
			"tooltip": "要轉換為語音的文字內容。"
		...
		"voice": {
			"name": "語音",
			"tooltip": "用於語音合成的聲音。可從語音選擇器或即時語音克隆連接。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ElevenLabsVoiceSelector = {
	"description": "選擇預設的 ElevenLabs 語音用於文字轉語音生成。",
	"display_name": "ElevenLabs 語音選擇器",
	"inputs": { "voice": {
		"name": "語音",
		"tooltip": "從預設的 ElevenLabs 語音中選擇一個語音。"
	} },
	"outputs": { "0": {
		"name": "語音",
		"tooltip": null
...
var EmptyAudio = {
	...
	"inputs": {
		"channels": {
			"name": "聲道數",
			"tooltip": "音訊聲道數量（1為單聲道，2為立體聲）。"
		},
		"duration": {
			"name": "持續時間",
			"tooltip": "空白音訊片段的持續時間（秒）"
		},
		"sample_rate": {
			"name": "取樣率",
			"tooltip": "空白音訊片段的取樣率。"
...
var EmptyHunyuanVideo15Latent = {
	"display_name": "空白 HunyuanVideo 1.5 Latent",
	"inputs": {
		"batch_size": { "name": "批次大小" },
		"height": { "name": "高度" },
		"length": { "name": "長度" },
...
var EmptyLatentAudio = {
	"display_name": "空白潛空間音訊",
	"inputs": {
		"batch_size": {
			"name": "批次大小",
			"tooltip": "此批次中的潛空間影像數量。"
		},
		"seconds": { "name": "秒數" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var EmptyLatentImage = {
	"description": "建立一批新的空白潛在影像，透過取樣去除雜訊。",
	"display_name": "空白潛在影像",
	"inputs": {
		"batch_size": {
			"name": "批次大小",
...
var EmptyQwenImageLayeredLatentImage = {
	"display_name": "空白 Qwen 圖像分層 Latent",
	"inputs": {
		"batch_size": { "name": "批次大小" },
		"height": { "name": "高度" },
		"layers": { "name": "圖層數" },
...
var ExponentialScheduler = {
	"display_name": "指數排程器",
	"inputs": {
		"sigma_max": { "name": "最大 sigma" },
		"sigma_min": { "name": "最小 sigma" },
		"steps": { "name": "步驟數" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var ExtendIntermediateSigmas = {
	...
	"inputs": {
		"end_at_sigma": { "name": "結束 sigma" },
		"sigmas": { "name": "sigmas" },
		"spacing": { "name": "間距" },
		"start_at_sigma": { "name": "起始 sigma" },
		"steps": { "name": "步驟數" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var File3DToSplat = {
	"description": "解析 splat File3D 為高斯 splat。為『建立 3D 檔案（由 Splat）』的反向操作。支援格式：PLY、SPLAT、KSPLAT、SPZ。PLY 含完整球諧資訊，其餘格式僅有基礎色彩。格式會自動從檔案內容判斷。",
	"display_name": "取得 Splat",
	"inputs": { "model_3d": {
		"name": "3D 模型",
		"tooltip": "高斯 splat 3D 檔案"
	} },
	"outputs": { "0": {
		"name": "splat",
		"tooltip": null
...
var Flux2MaxImageNode = {
	...
	"inputs": {
		...
		"prompt_upsampling": {
			"name": "提示詞升頻",
			"tooltip": "是否對提示詞進行升頻。啟用時，會自動調整提示詞以產生更具創意的圖像。"
		},
		"seed": {
			"name": "隨機種子",
			"tooltip": "用於產生雜訊的隨機種子。"
...
var FluxDisableGuidance = {
	"description": "此節點會完全停用 Flux 及類似 Flux 模型上的引導嵌入",
	"display_name": "FluxDisableGuidance",
	"inputs": { "conditioning": { "name": "條件設定" } },
	"outputs": { "0": { "tooltip": null } }
};
var FluxEraseNode = {
	"description": "從影像中移除被遮罩的物件並重建背景。請將 mask 塗在你想要擦除的區域。",
	"display_name": "Flux 擦除影像",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"dilate_pixels": {
			"name": "膨脹像素",
			"tooltip": "擴展 mask 邊界，以確保物件邊緣被完整覆蓋。"
		},
		"image": { "name": "影像" },
		"mask": {
			"name": "mask",
			"tooltip": "白色區域會被移除；黑色區域會被保留。"
		},
		"seed": {
			"name": "seed",
			"tooltip": "用於產生雜訊的隨機種子。"
...
var FluxKVCache = {
	...
	"outputs": { "0": { "tooltip": "已啟用 KV 快取的修補模型。" } }
};
var FluxKontextImageScale = {
	"description": "此節點將圖像調整為更適合flux kontext的尺寸。",
	"display_name": "FluxKontextImageScale",
	"inputs": { "image": { "name": "圖像" } },
	"outputs": { "0": { "tooltip": null } }
};
var FluxKontextMaxImageNode = {
	"description": "基於提示和長寬比，透過API使用Flux.1 Kontext [max]編輯圖像。",
	"display_name": "Flux.1 Kontext [max] 圖像",
	"inputs": {
		"aspect_ratio": {
			"name": "長寬比",
			"tooltip": "圖像長寬比；必須介於1:4至4:1之間。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"guidance": {
			"name": "引導強度",
		...
		"input_image": { "name": "輸入圖像" },
		"prompt": {
			"name": "提示詞",
			"tooltip": "圖像生成的提示詞 - 指定編輯內容和方式。"
		},
		"prompt_upsampling": {
			"name": "提示詞上採樣",
			"tooltip": "是否對提示詞執行上採樣。若啟用，會自動修改提示詞以實現更具創意的生成，但結果具有不確定性（相同種子值不會產生完全相同的結果）。"
		},
		"seed": {
			"name": "種子值",
			"tooltip": "用於創建噪聲的隨機種子值。"
		},
		"steps": {
			"name": "步數",
			"tooltip": "圖像生成過程的步數"
...
var FluxKontextMultiReferenceLatentMethod = {
	"display_name": "FluxKontext 多重參考潛在方法",
	"inputs": {
		"conditioning": { "name": "條件化" },
		"reference_latents_method": { "name": "參考潛在方法" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var FluxKontextProImageNode = {
	"description": "使用 Flux.1 Kontext [專業版] 透過 API 根據提示詞和長寬比編輯影像。",
	"display_name": "Flux.1 Kontext [專業版] 影像",
	"inputs": {
		"aspect_ratio": {
			"name": "長寬比",
			"tooltip": "影像的長寬比；必須在 1:4 到 4:1 之間。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"guidance": {
			"name": "引導強度",
		...
		"input_image": { "name": "輸入影像" },
		"prompt": {
			"name": "提示詞",
			"tooltip": "影像生成的提示詞 - 指定要編輯的內容和方式。"
		},
		"prompt_upsampling": {
			"name": "提示詞上採樣",
			"tooltip": "是否對提示詞執行上採樣。如果啟用，會自動修改提示詞以實現更具創意的生成，但結果具有不確定性（相同種子值不會產生完全相同的結果）。"
		},
		"seed": {
			"name": "種子值",
			"tooltip": "用於創建噪聲的隨機種子值。"
...
var FluxProExpandNode = {
	"description": "根據提示詞對影像進行外擴。",
	"display_name": "Flux.1 擴展影像",
	"inputs": {
		"bottom": {
			"name": "下方",
			"tooltip": "在影像下方擴展的像素數"
		...
		"prompt_upsampling": {
			"name": "提示詞向上採樣",
			"tooltip": "是否對提示詞進行向上採樣。啟用時，會自動修改提示詞以產生更具創意的生成結果，但結果具有不確定性（相同種子不會產生完全相同的結果）。"
		},
		"right": {
			"name": "右側",
			"tooltip": "在影像右側擴展的像素數"
...
var FluxProFillNode = {
	...
	"inputs": {
		...
		"prompt_upsampling": {
			"name": "提示詞向上採樣",
			"tooltip": "是否對提示詞進行向上採樣。啟用時，會自動修改提示詞以產生更具創意的結果，但結果具有不確定性（相同種子不會產生完全相同的結果）。"
		},
		"seed": {
			"name": "種子",
			"tooltip": "用於產生雜訊的隨機種子。"
...
var FluxProUltraImageNode = {
	"description": "透過 API 使用 Flux Pro 1.1 Ultra 根據提示詞與解析度產生影像。",
	"display_name": "Flux 1.1 [pro] Ultra 影像",
	"inputs": {
		"aspect_ratio": {
			"name": "長寬比",
			"tooltip": "影像的長寬比；必須介於 1:4 與 4:1 之間。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"image_prompt": { "name": "影像提示" },
		"image_prompt_strength": {
			"name": "影像提示強度",
			"tooltip": "提示詞與影像提示之間的混合比例。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "用於影像生成的提示詞"
		...
		"raw": {
			"name": "原始",
			"tooltip": "若為 True，則產生較少處理、更自然的影像。"
		},
		"seed": {
			"name": "種子",
			"tooltip": "用於產生雜訊的隨機種子。"
...
var FluxVTONode = {
	"description": "虛擬試穿：將提供的服裝穿在人物身上。",
	"display_name": "Flux 虛擬試穿",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"garment": {
			"name": "服裝",
...
var FrameInterpolate = {
	...
	"inputs": {
		"images": { "name": "影像" },
		"interp_model": { "name": "插值模型" },
		"multiplier": { "name": "倍數" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var FrameInterpolationModelLoader = {
	"display_name": "載入影格插值模型",
	"inputs": { "model_name": {
		"name": "模型名稱",
		"tooltip": "選擇要載入的影格插值模型。模型必須放在「frame_interpolation」資料夾中。"
	} },
	"outputs": { "0": { "tooltip": null } }
};
var FreSca = {
	"description": "對引導應用頻率相關的縮放",
	"display_name": "FreSca",
	"inputs": {
		"freq_cutoff": {
			"name": "freq_cutoff",
			"tooltip": "以中心為基準，視為低頻的頻率索引數量"
		},
		"model": { "name": "model" },
		"scale_high": {
			"name": "scale_high",
...
var GLSLShader = {
	"description": "將 GLSL ES 片段著色器應用於影像。u_resolution（vec2）始終可用。",
	"display_name": "GLSL 葉片著色器",
	"inputs": {
		"bools": {
			"name": "布林值",
			"tooltip": "布林值在著色器程式碼中可作為 u_bool0-9（bool）使用"
		},
		"curves": {
			"name": "曲線",
			"tooltip": "曲線在著色器程式碼中可作為 u_curve0-3（sampler2D，1D LUT）使用。可用 texture(u_curve0, vec2(x, 0.5)).r 取樣"
		},
		"floats": {
			"name": "浮點數",
			"tooltip": "浮點數在著色器程式碼中以 u_float0-4 提供"
		},
		"fragment_shader": {
			"name": "片段著色器",
			"tooltip": "GLSL 片段著色器原始碼（相容 GLSL ES 3.00 / WebGL 2.0）"
		},
		"images": {
			"name": "影像",
			"tooltip": "影像在著色器程式碼中以 u_image0-4（sampler2D）提供"
		},
		"ints": {
			"name": "整數",
			"tooltip": "整數在著色器程式碼中以 u_int0-4 提供"
		},
		"size_mode": {
			"name": "尺寸模式",
			"tooltip": "輸出尺寸：「from_input」使用第一個輸入影像的尺寸，「custom」可手動設定尺寸"
		}
	},
	"outputs": {
		"0": {
			"name": "影像0",
			"tooltip": "可在著色器程式碼中以 layout(location = 0) out vec4 fragColor0 取得"
		},
		"1": {
			"name": "影像1",
			"tooltip": "可在著色器程式碼中以 layout(location = 1) out vec4 fragColor1 取得"
		},
		"2": {
			"name": "影像2",
			"tooltip": "可在著色器程式碼中以 layout(location = 2) out vec4 fragColor2 取得"
		},
		"3": {
			"name": "影像3",
			"tooltip": "可在著色器程式碼中以 layout(location = 3) out vec4 fragColor3 取得"
		}
	}
};
var GeminiImage2Node = {
	...
	"inputs": {
		"aspect_ratio": {
			"name": "aspect_ratio",
			"tooltip": "若設為「auto」，則會配合輸入影像的長寬比；若未提供影像，通常會產生 16:9 的正方形。"
		},
		"control_after_generate": { "name": "control after generate" },
		"files": {
			"name": "files",
			"tooltip": "可選的檔案，作為模型的參考。可接受來自 Gemini Generate Content Input Files 節點的輸入。"
		},
		"images": {
			"name": "images",
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "描述要產生影像或要套用編輯的文字提示。請包含任何限制、風格或模型應遵循的細節。"
		},
		"resolution": {
			"name": "resolution",
		...
		"response_modalities": {
			...
			"tooltip": "選擇「IMAGE」僅輸出影像，或「IMAGE+TEXT」同時回傳產生的影像與文字回應。"
		},
		"seed": {
			"name": "seed",
			"tooltip": "當 seed 設定為特定值時，模型會盡力在重複請求時提供相同的回應，但不保證完全一致。更改模型或參數（如 temperature）即使使用相同 seed 也可能導致回應不同。預設會使用隨機 seed 值。"
		},
		"system_prompt": {
			"name": "system_prompt",
...
var GeminiImageNode = {
	"description": "透過 Google API 同步編輯影像。",
	"display_name": "Google Gemini 影像",
	"inputs": {
		"aspect_ratio": {
			"name": "長寬比",
			"tooltip": "預設將輸出影像大小與輸入影像匹配，否則生成 1:1 正方形。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"files": {
			"name": "檔案",
			"tooltip": "可選的檔案，用作模型的上下文。接受來自 Gemini 生成內容輸入檔案節點的輸入。"
		},
		"images": {
			"name": "影像",
			"tooltip": "可選的影像，用作模型的上下文。要包含多個影像，可以使用批次影像節點。"
		},
		"model": {
			"name": "模型",
			"tooltip": "用於生成回應的 Gemini 模型。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "生成的文字提示詞"
		...
		"seed": {
			"name": "種子值",
			"tooltip": "當種子值固定為特定值時，模型會盡力為重複請求提供相同的回應。不保證輸出具有確定性。此外，更改模型或參數設置（例如溫度）即使使用相同的種子值也可能導致回應發生變化。預設情況下，使用隨機種子值。"
		},
		"system_prompt": {
			"name": "system_prompt",
			"tooltip": "決定 AI 行為的基礎指令。"
...
var GeminiInputFiles = {
	"description": "載入並準備輸入檔案，以作為 Gemini LLM 節點的輸入。生成回應時，Gemini 模型將讀取這些檔案。文字檔案的內容會計入令牌限制。🛈 提示：可以與其他 Gemini 輸入檔案節點鏈接在一起。",
	"display_name": "Gemini 輸入檔案",
	"inputs": {
		"GEMINI_INPUT_FILES": {
			"name": "GEMINI_INPUT_FILES",
			"tooltip": "可選的附加檔案，可與此節點載入的檔案批次處理。允許串接輸入檔案，使單一訊息可包含多個輸入檔案。"
		},
		"file": {
			"name": "檔案",
			"tooltip": "要作為模型上下文包含的輸入檔案。目前僅接受文字 (.txt) 和 PDF (.pdf) 檔案。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var GeminiNanoBanana2 = {
	...
	"inputs": {
		...
		"resolution": {
			"name": "resolution",
			"tooltip": "目標輸出解析度。若選擇 2K/4K，將使用原生 Gemini 放大器。"
		},
	...
	"outputs": {
		...
		"2": {
			"name": "thought_image",
			"tooltip": "模型思考過程中的第一張圖像。僅在 thinking_level 設為 HIGH 且模態為 IMAGE+TEXT 時可用。"
		}
	}
};
var GeminiNanoBanana2V2 = {
	"description": "透過 Google Vertex API 同步生成或編輯影像。",
	"display_name": "Nano Banana 2",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model": { "name": "模型" },
		"model_aspect_ratio": { "name": "長寬比" },
		"model_resolution": { "name": "解析度" },
		"model_thinking_level": { "name": "思考層級" },
		"prompt": {
			"name": "提示詞",
			"tooltip": "描述要生成影像或要套用編輯的文字提示。請包含模型應遵循的任何限制、風格或細節。"
		},
		"response_modalities": { "name": "回應型態" },
		"seed": {
			"name": "種子",
			"tooltip": "當種子值固定時，模型會盡力在重複請求時提供相同的回應，但不保證完全一致。更改模型或參數（如溫度）即使使用相同種子值，也可能導致回應有所不同。預設情況下會使用隨機種子值。"
		},
		"system_prompt": {
			"name": "系統提示",
			"tooltip": "決定 AI 行為的基礎指令。"
		...
		"temperature": {
			"name": "temperature",
			"tooltip": "控制生成內容的隨機性。數值越低越集中／確定。"
		},
		"top_p": {
			"name": "top_p",
			"tooltip": "Nucleus 抽樣閾值。數值越低越集中，越高則越多樣。"
		}
	},
	"outputs": {
		"0": { "tooltip": null },
		...
		"2": {
			"name": "思考影像",
			"tooltip": "模型思考過程中的第一張影像。僅於思考層級為 HIGH 且回應型態為 IMAGE+TEXT 時提供。"
		}
	}
};
var GeminiNode = {
	...
	"inputs": {
		...
		"images": {
			"name": "圖片",
			"tooltip": "可選的圖片，用作模型的上下文。要包含多張圖片，可使用批次圖片節點。"
		},
		"model": {
			"name": "模型",
			"tooltip": "用於生成回應的 Gemini 模型。"
		...
		"prompt": {
			"name": "提示詞",
			"tooltip": "模型的文字輸入，用於生成回應。您可以包含詳細指令、問題或模型上下文。"
		},
		"seed": {
			"name": "種子值",
			"tooltip": "當種子值固定為特定值時，模型會盡力為重複請求提供相同回應。不保證輸出具有確定性。此外，更改模型或參數設定（例如溫度）可能導致回應變化，即使使用相同的種子值。預設使用隨機種子值。"
		},
		"system_prompt": {
			"name": "system_prompt",
			"tooltip": "決定 AI 行為的基礎指令。"
		...
		"video": {
			"name": "影片",
			"tooltip": "可選的影片，用作模型的上下文。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var GeminiNodeV2 = {
	"description": "使用 Google 的 Gemini 模型生成文字回應。請提供文字提示，並可選擇加入一個或多個圖片、音訊片段、影片或檔案作為多模態上下文。",
	"display_name": "Google Gemini",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model": {
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "輸入給模型的文字。請包含詳細指示、問題或上下文。"
		},
		"seed": {
			"name": "seed",
			"tooltip": "取樣用的種子。設為 0 則隨機。無法保證輸出為確定性。"
		},
		"system_prompt": {
			"name": "system_prompt",
			"tooltip": "決定模型行為的基礎指令。"
...
var GeminiVideoOmni = {
	"description": "使用 Google 的 Gemini Omni Flash 模型，從文字提示生成帶音訊的影片。可選擇提供參考圖像及／或影片以引導或編輯結果。請直接在提示中描述所需長度（3-10 秒）及長寬比（16:9 或 9:16）。",
	"display_name": "Google Gemini Omni（影片）",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model": {
			"name": "model",
			"tooltip": "用於生成影片的 Gemini 影片模型。"
		},
...
var GenerateTracks = {
	...
	"inputs": {
		"bezier": {
			"name": "bezier",
			"tooltip": "啟用貝茲曲線路徑，使用中點作為控制點。"
		},
		"end_x": {
			"name": "end_x",
			"tooltip": "結束位置的標準化 X 座標（0-1）。"
		},
		"end_y": {
			"name": "end_y",
			"tooltip": "結束位置的標準化 Y 座標（0-1）。"
		},
		"height": { "name": "height" },
		"interpolation": {
			"name": "interpolation",
			"tooltip": "控制沿路徑移動的時序／速度。"
		},
		"mid_x": {
			"name": "mid_x",
			"tooltip": "貝茲曲線的標準化 X 控制點。僅在啟用 'bezier' 時使用。"
		},
		"mid_y": {
			"name": "mid_y",
			"tooltip": "貝茲曲線的標準化 Y 控制點。僅在啟用 'bezier' 時使用。"
		},
		"num_frames": { "name": "num_frames" },
		"num_tracks": { "name": "num_tracks" },
		"start_x": {
			"name": "start_x",
			"tooltip": "起始位置的標準化 X 座標（0-1）。"
		},
		"start_y": {
			"name": "start_y",
			"tooltip": "起始位置的標準化 Y 座標（0-1）。"
		},
		"track_mask": {
			"name": "track_mask",
			"tooltip": "可選的 mask，用於標示可見的影格。"
		},
		"track_spread": {
			"name": "track_spread",
			"tooltip": "軌跡之間的標準化距離。軌跡會垂直於移動方向分布。"
		},
		"width": { "name": "width" }
	},
	"outputs": {
...
var GetICLoRAParameters = {
	"description": "從已載入 LoRA 模型的 safetensors 中提取 IC-LoRA 參數，並將其輸出給 LTXVAddGuide（例如 reference_downscale_factor）。",
	"display_name": "取得 IC-LoRA 參數",
	"inputs": { "iclora_model": {
		"name": "iclora_model",
		"tooltip": "從 LoRA 載入器直接輸出的特定 IC-LoRA，用於提取中繼資料。"
	} },
	"outputs": { "0": {
		"name": "iclora_parameters",
		"tooltip": "從 LoRA 中繼資料中提取的 IC-LoRA 參數（例如 reference_downscale_factor）。若 LoRA 需要特殊 guide 處理，請連接至 LTXVAddGuide。"
	} }
};
var GetImageSize = {
	"description": "回傳圖片的寬度和高度，並保持原樣傳遞。",
	"display_name": "取得圖片尺寸",
	"inputs": { "image": { "name": "圖片" } },
	"outputs": {
		"0": {
			"name": "寬度",
			"tooltip": null
...
var GetSplatCount = {
	"description": "回傳整個批次中 splat 的總數。",
	"display_name": "取得 Splat 數量",
...
var GrokImageEditNode = {
	...
	"inputs": {
		...
		"seed": {
			"name": "seed",
			"tooltip": "決定節點是否重新執行的種子；實際結果無論種子如何都不具決定性。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var GrokImageEditNodeV2 = {
	...
	"inputs": {
		...
		"model": { "name": "模型" },
		"model_aspect_ratio": { "name": "長寬比" },
		"model_number_of_images": { "name": "圖像數量" },
		"model_resolution": { "name": "解析度" },
		"prompt": {
			"name": "提示詞",
			"tooltip": "用於生成圖像的文字提示"
...
var GrokVideoEditNode = {
	"description": "根據文字提示編輯現有影片。",
	"display_name": "Grok 影片編輯",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model": { "name": "model" },
		"prompt": {
		...
		"video": {
			"name": "video",
			"tooltip": "最大支援長度為 8.7 秒且檔案大小為 50MB。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var GrokVideoExtendNode = {
	"description": "根據文字提示，為現有影片無縫延伸內容。",
	"display_name": "Grok 影片延伸",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model": {
			"name": "模型",
		...
		"prompt": {
			"name": "提示詞",
			"tooltip": "描述影片接下來應該發生什麼的文字說明。"
		},
		"seed": {
			"name": "種子",
			"tooltip": "決定是否重新執行節點的種子值；實際結果無論種子如何都不具決定性。"
		},
		"video": {
			"name": "影片",
			"tooltip": "要延伸的來源影片。MP4 格式，2-15 秒。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var GrokVideoNode = {
	"description": "從提示或圖像生成影片",
	"display_name": "Grok 影片",
	"inputs": {
		"aspect_ratio": {
			"name": "aspect_ratio",
			"tooltip": "輸出影片的長寬比。"
		...
		"image": {
			"name": "image",
			"tooltip": "grok-imagine-video 的可選起始圖像。grok-imagine-video-1.5 則為必填。"
		},
		"model": {
			"name": "model",
			"tooltip": "grok-imagine-video-1.5 目前必須要有輸入圖像。"
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "所需影片的文字描述。"
...
var GrokVideoReferenceNode = {
	"description": "根據參考圖像作為風格與內容指引生成影片。",
	"display_name": "Grok 參考生成影片",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model": {
			"name": "模型",
...
var GrowMask = {
	...
	"inputs": {
		"expand": { "name": "擴展" },
		"mask": { "name": "遮罩" },
		"tapered_corners": { "name": "圓角" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var HappyHorseImageToVideoApi = {
	"description": "使用 HappyHorse 模型，從首幀圖像生成影片。",
	"display_name": "HappyHorse 圖像轉影片",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"first_frame": {
			"name": "first_frame",
			"tooltip": "首幀圖像。輸出長寬比將依據此圖像。"
		},
		"model": { "name": "model" },
		"model_duration": { "name": "時長" },
		"model_prompt": { "name": "提示詞" },
...
var HappyHorseReferenceVideoApi = {
	"description": "使用 HappyHorse 模型，根據參考素材生成包含人物或物件的影片。支援單角色表演與多角色互動。",
	"display_name": "HappyHorse 參考素材轉影片",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model": { "name": "model" },
		"model_duration": { "name": "時長" },
...
var HappyHorseTextToVideoApi = {
	"description": "使用 HappyHorse 模型，根據文字提示生成影片。",
	"display_name": "HappyHorse 文字轉影片",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model": { "name": "model" },
		"model_duration": { "name": "時長" },
...
var HappyHorseVideoEditApi = {
	"description": "使用 HappyHorse 模型，根據文字指令或參考圖像編輯影片。輸出時長為 3-15 秒，並與輸入影片一致；超過 15 秒的輸入將被截斷。",
	"display_name": "HappyHorse 影片編輯",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model": { "name": "model" },
		"model_prompt": { "name": "提示詞" },
...
var HeyGenAvatarVideoNode = {
	"description": "從 HeyGen 虛擬分身產生一段講話主持人影片。包含 HeyGen 最受歡迎的公開分身；可提供任何 look ID 來覆蓋預設分身。",
	"display_name": "HeyGen 虛擬分身影片",
	"inputs": {
		"aspect_ratio": {
			"name": "長寬比",
			"tooltip": "輸出長寬比。'auto' 會依分身來源影片自動設定。"
		},
		"background_color": {
			"name": "背景顏色",
			"tooltip": "選填純色背景，請輸入十六進位色碼（如 '#00ff00'）。留空則使用分身原本背景。"
		},
		"control_after_generate": { "name": "產生後控制" },
		"custom_avatar_id": {
			"name": "自訂分身 ID",
			"tooltip": "選填 HeyGen 分身 look ID。設定後會覆蓋上方選擇的分身。可使用 HeyGen 3000+ 公開 look（或您的私人分身）。"
		},
		"engine": {
			"name": "引擎",
			"tooltip": "渲染引擎；每個選項僅列出支援該引擎的分身。'auto' 提供所有分身並自動選擇最佳引擎（優先 Avatar IV）。Avatar V 最高畫質，Avatar III 最經濟。"
		},
		"engine_avatar": { "name": "分身" },
		"resolution": {
			"name": "解析度",
			"tooltip": "輸出影片解析度。"
		},
		"seed": {
			"name": "種子",
			"tooltip": "不會傳送至 HeyGen；更改此值可強制重新產生。"
		},
		"speech": {
			"name": "語音",
			"tooltip": "用文字腳本（HeyGen 文字轉語音）或自訂音訊驅動分身。"
		},
		"speech_custom_voice_id": { "name": "自訂語音 ID" },
		"speech_text": { "name": "文字" },
		"speech_voice": { "name": "語音" },
		"speech_voice_speed": { "name": "語速" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var HeyGenCreateAvatarNode = {
	"description": "從人物照片或文字提示（生成角色）建立您自己的可重複使用 HeyGen 分身。將產生的 avatar_id 輸入至 HeyGen 虛擬分身影片的 custom_avatar_id，並將 ID 儲存以便未來工作流程重複使用。",
	"display_name": "HeyGen 建立分身",
	"inputs": {
		"source": {
			"name": "來源",
			"tooltip": "可從文字提示生成新角色，或從連接的人物照片建立分身。"
		},
		"source_prompt": { "name": "提示" }
	},
	"outputs": {
		"0": {
			"name": "avatar_id",
			"tooltip": "分身 look ID。請傳遞至 HeyGen 虛擬分身影片的 custom_avatar_id；建議儲存以便日後重複使用。"
		},
		"1": {
			"name": "預覽",
			"tooltip": null
...
var HeyGenTalkingPhotoNode = {
	"description": "將任何人物圖像動畫化為對嘴同步的說話影片（HeyGen Avatar IV）。可用文字腳本或自有音訊驅動。",
	"display_name": "HeyGen 說話照片",
	"inputs": {
		"aspect_ratio": {
			"name": "aspect_ratio",
			"tooltip": "輸出長寬比。'auto' 會依照輸入圖像。"
		},
		"control_after_generate": { "name": "control after generate" },
		"expressiveness": {
			"name": "expressiveness",
			"tooltip": "動畫臉部與動作的表現力程度。"
		},
		"image": {
			"name": "image",
			"tooltip": "要動畫化的人物圖像。若大於 2K 會自動縮小。"
		},
		"resolution": {
			"name": "resolution",
			"tooltip": "輸出影片解析度。"
		...
		"seed": {
			"name": "seed",
			"tooltip": "不會傳送至 HeyGen；更改此值可強制重新執行。"
		},
		"speech": {
			"name": "speech",
			"tooltip": "以文字腳本（HeyGen 文字轉語音）或自有音訊驅動 avatar。"
		},
...
var HeyGenTextToSpeechNode = {
	"description": "使用 HeyGen 的 Starfish TTS 引擎將文字轉為語音音訊。包含 HeyGen 最受歡迎的 17 種語言語音。",
	"display_name": "HeyGen 文字轉語音",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"custom_voice_id": {
			"name": "custom_voice_id",
			"tooltip": "可選的 HeyGen 語音 ID。設定後會覆蓋上方選擇的語音。該語音必須支援 Starfish 引擎。"
		},
		"seed": {
			"name": "seed",
			"tooltip": "不會傳送至 HeyGen；更改此值可強制重新執行。"
		...
		"ssml": {
			"name": "ssml",
			"tooltip": "將文字視為 SSML 標記（用於停頓、強調與發音控制）。"
		},
		"text": {
			"name": "text",
			"tooltip": "要合成的文字（最多 5000 字元）。產生的語音必須至少 1 秒。"
		},
		"voice": {
			"name": "voice",
			"tooltip": "要使用的語音（精選自 HeyGen 最受歡迎且支援 Starfish 的語音）。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var HeyGenVideoTranslateNode = {
	"description": "將語音影片翻譯成其他語言。會複製原說話者的聲音，並重新動畫化嘴型以配合翻譯後的語音。",
	"display_name": "HeyGen 影片翻譯",
	"inputs": {
		"control_after_generate": { "name": "產生後控制" },
		"mode": {
			"name": "模式",
			"tooltip": "「speed」速度較快；「precision」可產生更高品質的唇形同步，但價格為兩倍。"
		},
		"output_language": {
			"name": "目標語言",
			"tooltip": "翻譯後影片的目標語言。"
		...
		"seed": {
			"name": "隨機種子",
			"tooltip": "不會傳送給 HeyGen；更改此值可強制重新執行。"
		},
		"speaker_count": {
			"name": "說話者數量",
			"tooltip": "影片中的說話者數量。0 = 自動偵測。"
		},
		"translate_audio_only": {
			"name": "僅翻譯音訊",
			"tooltip": "只更換音訊軌道，保留原本的嘴型動作（不進行唇形同步）。"
		},
		"video": {
			"name": "影片",
			"tooltip": "要翻譯語音的影片。"
...
var HunyuanRefinerLatent = {
	"display_name": "混元精煉潛空間",
	"inputs": {
		"latent": { "name": "潛空間" },
		"negative": { "name": "負向提示" },
		"noise_augmentation": { "name": "雜訊增強" },
		"positive": { "name": "正向提示" }
	},
	"outputs": {
		"0": {
...
var HyperTile = {
	...
	"inputs": {
		"max_depth": { "name": "最大深度" },
		"model": { "name": "model" },
		"scale_depth": { "name": "縮放深度" },
		"swap_size": { "name": "交換區大小" },
		"tile_size": { "name": "切片尺寸" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var IdeogramV3 = {
	"description": "使用 Ideogram V3 模型同步產生影像。\n\n支援從文字提示產生一般影像，以及結合 mask 進行影像編輯。\n影像連結僅限時有效；如需保留影像，請務必下載。",
	"display_name": "Ideogram V3",
	"inputs": {
		"aspect_ratio": {
			"name": "長寬比",
			"tooltip": "影像生成的長寬比。若解析度未設為自動，則此設定會被忽略。"
		},
		"character_image": {
			"name": "角色圖片",
			"tooltip": "用作角色參考的圖片。"
		...
		"image": {
			"name": "參考影像",
			"tooltip": "（選填）用於影像編輯的參考圖片。"
		},
		"magic_prompt_option": {
			"name": "MagicPrompt 選項",
			"tooltip": "決定是否在生成時使用 MagicPrompt"
		},
		"mask": {
			"name": "遮罩",
			"tooltip": "（選填）用於修補的遮罩（白色區域將被取代）"
		},
		"num_images": { "name": "影像數量" },
		"prompt": {
			"name": "提示詞",
			"tooltip": "用於影像生成或編輯的提示詞"
		},
		"rendering_speed": {
			"name": "生成速度",
			"tooltip": "控制生成速度與品質的取捨"
		},
		"resolution": {
			"name": "解析度",
			"tooltip": "影像生成的解析度。若未設為自動，將覆蓋長寬比設定。"
		},
		"seed": { "name": "種子值" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var IdeogramV4 = {
	"description": "使用 Ideogram 4.0 模型，根據文字提示生成影像。",
...
var ImageBlend = {
	"display_name": "影像混合",
	"inputs": {
		"blend_factor": { "name": "混合係數" },
		"blend_mode": { "name": "混合模式" },
		"image1": { "name": "image1" },
		"image2": { "name": "image2" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var ImageCompare = {
	"description": "將兩張圖像並排顯示，並可用滑桿比較差異。",
	"display_name": "圖像比較",
	"inputs": {
...
var ImageCompositeMasked = {
	"display_name": "影像合成（遮罩）",
	"inputs": {
		"destination": { "name": "目標圖像" },
		"mask": { "name": "遮罩" },
		"resize_source": { "name": "調整來源大小" },
		"source": { "name": "來源圖像" },
		"x": { "name": "X 座標" },
		"y": { "name": "Y 座標" }
	},
...
var ImageCropV2 = {
	"description": "將圖像裁切至指定尺寸。",
	"display_name": "圖像裁切",
	"inputs": {
		"crop_region": { "name": "裁切區域" },
		"height": {},
		"image": { "name": "圖像" },
		"width": {},
		"x": {},
...
var ImageDeduplication = {
	...
	"inputs": {
		...
		"similarity_threshold": {
			"name": "相似度閾值",
			"tooltip": "相似度閾值（0-1）。數值越高表示越相似。超過此閾值的影像會被視為重複。"
		}
	},
	"outputs": { "0": {
		"name": "影像",
...
var ImageFlip = {
	"display_name": "影像翻轉",
	"inputs": {
		"flip_method": { "name": "翻轉方式" },
		"image": { "name": "影像" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var ImageFromBatch = {
	"display_name": "從批次擷取影像",
	"inputs": {
...
var ImageScaleToMaxDimension = {
	"display_name": "影像縮放至最大尺寸",
	"inputs": {
		"image": { "name": "影像" },
		"largest_size": { "name": "最大尺寸" },
		"upscale_method": { "name": "放大方法" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var ImageScaleToTotalPixels = {
	"display_name": "將影像縮放至總像素數",
	"inputs": {
		"image": { "name": "影像" },
		"megapixels": { "name": "百萬像素" },
		"resolution_steps": { "name": "解析度步驟" },
		"upscale_method": { "name": "放大方法" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var ImageStitch = {
	...
	"inputs": {
		...
		"image1": { "name": "影像1" },
		"image2": { "name": "影像2" },
		"match_image_size": { "name": "匹配影像尺寸" },
		"spacing_color": { "name": "間距顏色" },
		"spacing_width": { "name": "間距寬度" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var ImageToMask = {
	"display_name": "將圖片轉換為遮罩",
	"inputs": {
		"channel": { "name": "通道" },
		"image": { "name": "圖片" }
	},
...
var ImageUpscaleWithModel = {
	"display_name": "圖片放大（使用模型）",
	"inputs": {
		"image": { "name": "影像" },
		"upscale_model": { "name": "放大模型" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var ImageYUVToRGB = {
	"display_name": "YUV 轉 RGB",
	"inputs": {
		"U": { "name": "U" },
		"V": { "name": "V" },
		"Y": { "name": "Y" }
...
var InpaintModelConditioning = {
	"display_name": "修補模型條件設定",
	"inputs": {
		"mask": { "name": "遮罩" },
		"negative": { "name": "負向" },
		"noise_mask": {
			"name": "雜訊遮罩",
			"tooltip": "在潛在空間上加入雜訊遮罩，這樣取樣只會發生在遮罩範圍內。根據模型不同，可能會改善結果，也可能完全失效。"
		},
		"pixels": { "name": "像素" },
		"positive": { "name": "正向" },
		"vae": { "name": "vae" }
...
var JoinAudioChannels = {
	"description": "將左聲道與右聲道的單聲道音訊合併為立體聲音訊。",
	"display_name": "合併音訊聲道",
	"inputs": {
...
var KSampler = {
	"description": "使用提供的模型，以及正向與負向條件來去除潛在空間影像中的雜訊。",
	"display_name": "KSampler",
	"inputs": {
		"cfg": {
			"name": "cfg",
			"tooltip": "Classifier-Free Guidance（CFG）比例可平衡創意與提示的貼合度。數值越高，生成的圖片越貼近提示，但過高可能會影響品質。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"denoise": {
			"name": "去雜訊強度",
		...
		"model": {
			"name": "模型",
			"tooltip": "用於去除輸入潛在空間雜訊的模型。"
		},
		"negative": {
			"name": "負向條件",
			"tooltip": "描述你希望在影像中排除的屬性的條件。"
		},
		"positive": {
			"name": "正向條件",
			"tooltip": "描述你希望在影像中包含的屬性的條件。"
		},
		"sampler_name": {
			"name": "取樣器",
			"tooltip": "取樣時所使用的演算法，會影響生成結果的品質、速度與風格。"
		},
		"scheduler": {
			"name": "排程器",
			"tooltip": "排程器控制雜訊如何逐步移除以形成影像。"
		},
		"seed": {
			"name": "種子",
			"tooltip": "用於產生雜訊的隨機種子。"
	...
	"outputs": { "0": { "tooltip": "去噪後的潛在空間。" } }
};
var KSamplerAdvanced = {
	"display_name": "KSampler（進階）",
	"inputs": {
		"add_noise": { "name": "加入雜訊" },
		"cfg": { "name": "cfg" },
		"control_after_generate": { "name": "生成後控制" },
		"end_at_step": { "name": "結束步數" },
		"latent_image": { "name": "潛在空間影像" },
		"model": { "name": "模型" },
		"negative": { "name": "負向" },
		"noise_seed": { "name": "雜訊種子" },
		"positive": { "name": "正向" },
		"return_with_leftover_noise": { "name": "保留剩餘雜訊" },
		"sampler_name": { "name": "取樣器名稱" },
		"scheduler": { "name": "排程器" },
		"start_at_step": { "name": "起始步數" },
		"steps": { "name": "步驟數" }
	}
};
var KSamplerSelect = {
	"display_name": "K採樣器選擇",
	"inputs": { "sampler_name": { "name": "取樣器名稱" } },
	"outputs": { "0": { "tooltip": null } }
};
var Kandinsky5ImageToVideo = {
	...
	"outputs": {
		...
		"3": {
			"name": "cond_latent",
			"tooltip": "已清理編碼的起始圖片，用於取代模型輸出 latent 的雜訊起始"
		}
	}
};
var KarrasScheduler = {
	"display_name": "Karras 排程器",
	"inputs": {
		"rho": { "name": "rho" },
		"sigma_max": { "name": "最大 sigma" },
		"sigma_min": { "name": "最小 sigma" },
...
var KlingAvatarNode = {
	"description": "從單張照片和音訊檔案生成廣播風格的數位人像影片。",
	"display_name": "Kling Avatar 2.0",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"image": {
			"name": "image",
			"tooltip": "頭像參考圖片。寬度與高度需至少 300 像素。長寬比需介於 1:2.5 與 2.5:1 之間。"
		},
		"mode": { "name": "mode" },
		"prompt": {
			"name": "prompt",
			"tooltip": "可選提示，用於定義頭像動作、情緒與鏡頭運動。"
		},
		"seed": {
			"name": "seed",
			"tooltip": "Seed 控制此節點是否重新執行；無論 seed 為何，結果皆為非確定性。"
		...
		"sound_file": {
			"name": "sound_file",
			"tooltip": "音訊輸入。長度必須介於 2 到 300 秒之間。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var KlingCameraControlI2VNode = {
	"description": "將靜態圖片轉換為具有專業攝影機運鏡的電影感影片。可模擬真實世界的攝影效果，並控制虛擬攝影機的動作，包括縮放、旋轉、平移、傾斜及第一人稱視角，同時保持對原始圖片的聚焦。",
	"display_name": "Kling 靜態圖轉影片（攝影機控制）",
	"inputs": {
		"aspect_ratio": { "name": "aspect_ratio" },
		"camera_control": {
			"name": "camera_control",
			"tooltip": "可透過 Kling Camera Controls 節點建立。控制影片生成時的攝影機運動與動作。"
		},
		...
		"start_frame": {
			"name": "start_frame",
			"tooltip": "參考圖片 - 輸入 URL 或 Base64 編碼字串，檔案大小不得超過 10MB，解析度不得低於 300*300 像素，長寬比需介於 1:2.5 ~ 2.5:1。Base64 不需包含 data:image 前綴。"
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var KlingCameraControlT2VNode = {
	"description": "將文字轉換為具備專業攝影機運鏡的電影級影片，模擬真實世界的攝影效果。可控制虛擬攝影機的動作，包括縮放、旋轉、平移、傾斜及第一人稱視角，同時保持對原始文字的聚焦。",
	"display_name": "Kling 文字轉影片（攝影機控制）",
	"inputs": {
		"aspect_ratio": { "name": "aspect_ratio" },
		"camera_control": {
			"name": "camera_control",
...
var KlingCameraControls = {
	"description": "允許指定 Kling 攝影機控制與動作控制效果的設定選項。",
	"display_name": "Kling 攝影機控制",
	"inputs": {
		"camera_control_type": { "name": "camera_control_type" },
		"horizontal_movement": {
			"name": "horizontal_movement",
			"tooltip": "控制攝影機在水平軸（x 軸）上的移動。負值表示向左，正值表示向右。"
		},
		"pan": {
			"name": "pan",
			"tooltip": "控制攝影機在垂直平面（x 軸）上的旋轉。負值表示向下旋轉，正值表示向上旋轉。"
		},
		"roll": {
			"name": "roll",
			"tooltip": "控制攝影機在 z 軸上的滾動量。負值表示逆時針，正值表示順時針。"
		},
		"tilt": {
			"name": "tilt",
			"tooltip": "控制攝影機在水平平面（y 軸）上的旋轉。負值表示向左旋轉，正值表示向右旋轉。"
		},
		"vertical_movement": {
			"name": "vertical_movement",
			"tooltip": "控制攝影機在垂直軸（y 軸）上的移動。負值表示向下，正值表示向上。"
		},
		"zoom": {
			"name": "zoom",
			"tooltip": "控制攝影機焦距的變化。負值表示視野較窄，正值表示視野較寬。"
		}
	},
	"outputs": { "0": {
		"name": "camera_control",
...
var KlingDualCharacterVideoEffectNode = {
	"description": "根據 effect_scene 產生影片時，實現不同的特效。第一張圖片會放在合成畫面的左側，第二張圖片會放在右側。",
	"display_name": "Kling 雙角色影片特效",
	"inputs": {
		"duration": { "name": "時長" },
...
var KlingFirstLastFrameNode = {
	...
	"inputs": {
		...
		"duration": { "name": "時長" },
		"end_frame": { "name": "尾影格" },
		"first_frame": { "name": "首影格" },
		"generate_audio": { "name": "產生音訊" },
		"model": {
			"name": "模型",
			"tooltip": "模型與生成設定。"
		},
...
var KlingImage2VideoNode = {
	...
	"inputs": {
		...
		"start_frame": {
			"name": "start_frame",
			"tooltip": "參考圖片 - URL 或 Base64 編碼字串，檔案大小不可超過 10MB，解析度不得低於 300*300 像素，長寬比需介於 1:2.5 ~ 2.5:1。Base64 不需包含 data:image 前綴。"
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var KlingImageGenerationNode = {
	"description": "Kling 圖像生成節點。根據文字提示生成圖像，可選擇性加入參考圖像。",
	"display_name": "Kling 圖像生成",
	"inputs": {
		"aspect_ratio": { "name": "aspect_ratio" },
		"control_after_generate": { "name": "生成後控制" },
		"human_fidelity": {
...
var KlingImageToVideoWithAudio = {
	"display_name": "Kling 圖片（首幀）轉影片並加音訊",
	"inputs": {
		"duration": { "name": "時長" },
		"generate_audio": { "name": "產生音訊" },
		"mode": { "name": "模式" },
		...
		"start_frame": { "name": "起始幀" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var KlingLipSyncAudioToVideoNode = {
	"description": "Kling 影音口型同步節點。將影片檔案中的嘴型動作與音訊檔案的語音內容同步。",
	"display_name": "Kling 影音口型同步",
	"inputs": {
		"audio": { "name": "音訊" },
		"video": { "name": "影片" },
		"voice_language": { "name": "語音語言" }
	},
	"outputs": {
		"0": { "tooltip": null },
		"1": {
...
var KlingLipSyncTextToVideoNode = {
	"description": "Kling 文字口型同步節點。將影片中的嘴型動作與文字提示同步。",
	"display_name": "Kling 文字口型同步影片",
	"inputs": {
		"text": {
			"name": "文字",
			"tooltip": "用於口型同步影片生成的文字內容。當模式為 text2video 時必填。最長 120 字。"
		},
		"video": { "name": "影片" },
		"voice": { "name": "語音" },
		"voice_speed": {
			"name": "語速",
			"tooltip": "語音速度。有效範圍：0.8~2.0，精確到小數點一位。"
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var KlingMotionControl = {
	"display_name": "Kling 動作控制",
	"inputs": {
		"character_orientation": {
			"name": "角色朝向",
			"tooltip": "控制角色的面向／朝向來源。\nvideo：動作、表情、鏡頭移動與朝向皆依據動作參考影片（其他細節由提示詞決定）。\nimage：動作與表情仍依據動作參考影片，但角色朝向與參考圖片一致（鏡頭／其他細節由提示詞決定）。"
		},
		"keep_original_sound": { "name": "保留原始音訊" },
		"mode": { "name": "模式" },
		"model": { "name": "模型" },
		"prompt": { "name": "提示詞" },
		"reference_image": { "name": "參考圖片" },
		"reference_video": {
			"name": "參考影片",
			"tooltip": "用於驅動動作／表情的動作參考影片。\n時長限制依角色朝向而定：\n - 圖片：3–10秒（最多10秒）\n - 影片：3–30秒（最多30秒）"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var KlingOmniProEditVideoNode = {
	...
	"inputs": {
		...
		"prompt": {
			"name": "提示詞",
			"tooltip": "描述影片內容的文字提示，可包含正向與負向描述。"
		},
		"reference_images": {
			"name": "參考圖片",
			"tooltip": "最多可加入 4 張額外參考圖片。"
		},
		"resolution": { "name": "解析度" },
		"seed": {
			"name": "種子",
...
var KlingOmniProFirstLastFrameNode = {
	...
	"inputs": {
		...
		"end_frame": {
			"name": "結束影格",
			"tooltip": "影片的可選結束影格。不可與「reference_images」同時使用。"
		},
		"first_frame": { "name": "起始影格" },
		"generate_audio": {
			"name": "產生音訊",
		...
		"prompt": {
			"name": "提示詞",
			"tooltip": "描述影片內容的文字提示，可包含正面與負面描述。"
		},
		"reference_images": {
			"name": "參考圖片",
			"tooltip": "最多可加入 6 張額外參考圖片。"
		},
		"resolution": { "name": "解析度" },
		"seed": {
			"name": "種子",
...
var KlingOmniProImageNode = {
	"description": "使用 Kling 最新模型建立或編輯圖像。",
	"display_name": "Kling Omni 圖像 (Pro)",
	"inputs": {
		"aspect_ratio": { "name": "長寬比" },
		"control_after_generate": { "name": "生成後控制" },
		"model_name": { "name": "model_name" },
		"prompt": {
			"name": "提示詞",
			"tooltip": "描述圖像內容的文字提示，可包含正面與負面描述。"
		},
		"reference_images": {
			"name": "參考圖片",
			"tooltip": "最多可加入 10 張額外參考圖片。"
		},
		"resolution": { "name": "解析度" },
		"seed": {
			"name": "種子",
...
var KlingOmniProImageToVideoNode = {
	"description": "使用最多 7 張參考圖片，搭配最新 Kling 模型產生影片。",
	"display_name": "Kling Omni 圖像轉影片 (Pro)",
	"inputs": {
		"aspect_ratio": { "name": "長寬比" },
		"control_after_generate": { "name": "生成後控制" },
		"duration": { "name": "時長" },
...
var KlingOmniProTextToVideoNode = {
	"description": "使用文字提示，搭配最新 Kling 模型產生影片。",
	"display_name": "Kling Omni 文字轉影片 (Pro)",
	"inputs": {
		"aspect_ratio": { "name": "長寬比" },
		"control_after_generate": { "name": "生成後控制" },
		"duration": { "name": "時長" },
...
var KlingOmniProVideoToVideoNode = {
	"description": "使用一段影片和最多 4 張參考圖片，搭配最新 Kling 模型生成影片。",
	"display_name": "Kling Omni 影片轉影片（專業版）",
	"inputs": {
		"aspect_ratio": { "name": "長寬比" },
		"control_after_generate": { "name": "生成後控制" },
		"duration": { "name": "時長" },
		"keep_original_sound": { "name": "保留原始聲音" },
		"model_name": { "name": "model_name" },
		"prompt": {
			"name": "提示詞",
			"tooltip": "描述影片內容的文字提示，可包含正面或負面描述。"
		},
		"reference_images": {
			"name": "參考圖片",
			"tooltip": "最多 4 張額外參考圖片。"
		},
		"reference_video": {
			"name": "參考影片",
			"tooltip": "作為參考的影片。"
...
var KlingSingleImageVideoEffectNode = {
	"description": "根據 effect_scene 產生影片時，實現不同的特殊效果。",
	"display_name": "Kling 影片特效",
	"inputs": {
		"duration": { "name": "時長" },
		"effect_scene": { "name": "effect_scene" },
		"image": {
			"name": "影像",
			"tooltip": "參考圖片。可為 URL 或 Base64 編碼字串（不含 data:image 前綴）。檔案大小不得超過 10MB，解析度不得低於 300*300 像素，長寬比需介於 1:2.5 ~ 2.5:1 之間"
		},
		"model_name": { "name": "model_name" }
	},
	"outputs": {
...
var KlingStartEndFrameNode = {
	"description": "根據您提供的起始與結束影像，產生一段影像序列。此節點會自動生成中間所有影格，讓第一張影像平滑轉換到最後一張影像。",
	"display_name": "Kling 起始-結束影格轉影片",
	"inputs": {
		"aspect_ratio": { "name": "aspect_ratio" },
		"cfg_scale": { "name": "cfg_scale" },
		"end_frame": {
			"name": "end_frame",
			"tooltip": "參考影像 - 結束影格控制。輸入 URL 或 Base64 編碼字串，檔案大小不得超過 10MB，解析度不得低於 300*300 像素。Base64 不需包含 data:image 前綴。"
		},
		"mode": {
			"name": "mode",
			"tooltip": "用於影片生成的設定，格式為：mode / duration / model_name。"
		},
		"negative_prompt": {
			"name": "負向提示詞",
			"tooltip": "負向文字提示"
		...
		"start_frame": {
			"name": "start_frame",
			"tooltip": "參考影像 - 輸入 URL 或 Base64 編碼字串，檔案大小不得超過 10MB，解析度不得低於 300*300 像素，長寬比需介於 1:2.5 ~ 2.5:1。Base64 不需包含 data:image 前綴。"
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var KlingTextToVideoNode = {
	"description": "Kling 文字轉影片節點",
	"display_name": "Kling 文字轉影片",
	"inputs": {
		"aspect_ratio": { "name": "aspect_ratio" },
		"cfg_scale": { "name": "cfg_scale" },
		"mode": {
...
var KlingTextToVideoWithAudio = {
	"display_name": "Kling 文字轉影片（含音訊）",
	"inputs": {
		"aspect_ratio": { "name": "長寬比" },
		"duration": { "name": "時長" },
		"generate_audio": { "name": "生成音訊" },
		"mode": { "name": "模式" },
		"model_name": { "name": "model_name" },
		"prompt": {
			"name": "提示詞",
...
var KlingVideoExtendNode = {
	"description": "Kling Video 延伸節點。可延伸由其他 Kling 節點製作的影片。video_id 是透過其他 Kling 節點產生的。",
	"display_name": "Kling Video 延伸",
	"inputs": {
		"cfg_scale": { "name": "cfg_scale" },
		"negative_prompt": {
			"name": "負向提示詞",
			"tooltip": "用於避免在延伸影片中出現的負向文字提示"
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "用於引導影片延伸的正向文字提示"
		},
		"video_id": {
			"name": "video_id",
			"tooltip": "要延伸的影片 ID。支援由文字轉影片、圖片轉影片及先前影片延伸操作所產生的影片。延伸後總長度不可超過 3 分鐘。"
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var KlingVideoNode = {
	...
	"inputs": {
		...
		"generate_audio": {
			"name": "生成音訊",
			"tooltip": "「kling-3.0-turbo」總是會產生原生音訊，因此音訊切換將被忽略。"
		},
		"model": {
			"name": "模型",
			"tooltip": "模型與生成設定。"
		...
		"multi_shot_duration": { "name": "時長" },
		"multi_shot_negative_prompt": { "name": "負面提示" },
		"multi_shot_prompt": { "name": "提示" },
		"seed": {
			"name": "seed",
			"tooltip": "Seed 控制此節點是否重新執行；無論 seed 為何，結果皆為非確定性。"
		},
...
var Krea2ImageNode = {
	"description": "透過 Krea 2 產生圖像 — 可選擇 Medium（表現性插畫）或 Large（表現性寫實照片）。支援選用 moodboard 及最多 10 個串接的圖像風格參考。",
	"display_name": "Krea 2 圖像",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model": {
			"name": "模型",
			"tooltip": "Krea 2 Medium 最適合表現性插畫；Krea 2 Large 最適合表現性寫實照片。"
		},
		"model_aspect_ratio": { "name": "長寬比" },
		"model_creativity": { "name": "創意度" },
		...
		"seed": {
			"name": "隨機種子",
			"tooltip": "用於結果可重現的隨機種子。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var Krea2StyleReferenceNode = {
	"description": "為 Krea 2 生成加入圖像風格參考。可串接多個 Krea 2 風格參考節點（最多 10 個），並將最終的 `style_reference` 輸出連接到 Krea 2 圖像。每張圖像會上傳至 ComfyAPI 儲存並以 URL 傳遞。",
	"display_name": "Krea 2 風格參考",
	"inputs": {
		"image": {
			"name": "參考圖像",
			"tooltip": "其風格會影響生成的參考圖像。"
		},
		"strength": {
			"name": "強度",
			"tooltip": "參考強度；負值會反轉風格影響。"
		},
		"style_reference": {
			"name": "style_reference",
			"tooltip": "可選的串接風格參考；本節點會再加入一個。"
		}
	},
	"outputs": { "0": {
		"name": "style_reference",
...
var LTXVAddGuide = {
	"display_name": "LTXV 添加引導",
	"inputs": {
		"attention_mask": {
			"name": "注意力遮罩",
			"tooltip": "可選的像素空間遮罩。透過自注意力機制，乘以強度後控制各區域的條件影響。"
		},
		"frame_idx": {
			"name": "起始幀索引",
			"tooltip": "開始條件化的幀索引。對於單幀影像或 1-8 幀的影片，任何 frame_idx 值皆可。對於 9 幀以上的影片，frame_idx 必須能被 8 整除，否則會自動向下取至最接近的 8 的倍數。負值則從影片結尾倒數計算。"
		},
		"iclora_parameters": {
			"name": "iclora_parameters",
			"tooltip": "來自 Get IC-LoRA Parameters 節點的可選 IC-LoRA 參數。用於根據特定 IC-LoRA（例如 reference_downscale_factor > 1）調整 guide 處理。串接時，每個 LTXVAddGuide 僅使用連接到它的參數。"
		},
		"image": {
			"name": "影像",
			"tooltip": "用於條件化 latent 視訊的影像或影片。必須為 8*n + 1 幀。如果影片不是 8*n + 1 幀，將會裁切至最接近的 8*n + 1 幀。"
		},
		"latent": { "name": "潛在空間" },
		"negative": { "name": "負向" },
		"positive": { "name": "正向" },
...
var LTXVAudioVAEDecode = {
	"display_name": "LTXV 音訊 VAE 解碼",
	"inputs": {
		"audio_vae": {
			"name": "audio_vae",
			"tooltip": "用於解碼 latent 的 Audio VAE 模型。"
		},
		"samples": {
			"name": "samples",
			"tooltip": "要解碼的 latent。"
...
var LTXVAudioVAELoader = {
	"display_name": "LTXV 音訊 VAE 載入器",
	"inputs": { "ckpt_name": {
		"name": "ckpt_name",
		"tooltip": "要載入的 Audio VAE 檢查點。"
	} },
	"outputs": { "0": {
		"name": "Audio VAE",
		"tooltip": null
...
var LTXVContextWindows = {
	"description": "為 LTXV 類型模型設定上下文視窗。",
	"display_name": "LTXV 上下文視窗",
	"inputs": {
		"closed_loop": {
			"name": "closed_loop",
			"tooltip": "是否閉合上下文視窗循環；僅適用於循環排程。"
		},
		"context_length": {
			"name": "context_length",
			"tooltip": "上下文視窗的實際幀數長度。必須為 8*n + 1。"
		},
		"context_overlap": {
			"name": "context_overlap",
			"tooltip": "上下文視窗的實際幀數重疊。"
		},
		"context_schedule": {
			"name": "context_schedule",
			"tooltip": "上下文視窗的步驟依賴排程演算法。"
		},
		"context_stride": {
			"name": "context_stride",
			"tooltip": "上下文視窗的步幅；僅適用於均勻排程。"
		},
		"freenoise": {
			"name": "freenoise",
			"tooltip": "是否套用 FreeNoise 噪聲洗牌，可提升視窗融合效果。"
		},
		"fuse_method": {
			"name": "fuse_method",
			"tooltip": "用於融合上下文視窗的方法。"
		},
		"model": {
			"name": "model",
			"tooltip": "在取樣時要套用上下文視窗的模型。"
		},
		"retain_first_frame": {
			"name": "retain_first_frame",
			"tooltip": "在每個上下文視窗中保留第一個 latent 幀（有助於保留初始參考）。"
		},
		"split_conds_to_windows": {
			"name": "split_conds_to_windows",
			"tooltip": "是否根據區域索引將多個 conditioning（由 ConditionCombine 建立）分配到各個視窗。"
		}
	},
	"outputs": { "0": { "tooltip": "在取樣時已套用上下文視窗的模型。" } }
};
var LTXVCropGuides = {
	"display_name": "LTXV 裁剪引導",
	"inputs": {
		"latent": { "name": "潛在空間" },
		"negative": { "name": "負向" },
		"positive": { "name": "正向" }
...
var LTXVEmptyLatentAudio = {
	"display_name": "LTXV 空 latent 音訊",
	"inputs": {
		"audio_vae": {
			"name": "audio_vae",
			"tooltip": "用於取得組態的 Audio VAE 模型。"
		},
		"batch_size": {
			"name": "batch_size",
			"tooltip": "批次中的 latent 音訊樣本數。"
		},
		"frame_rate": {
			"name": "frame_rate",
			"tooltip": "每秒影格數。"
...
var LTXVReferenceAudio = {
	"description": "設定參考音訊以進行 ID-LoRA 說話人身份轉換。將參考音訊 clip 編碼為條件，並可選擇性地以身份指引修補模型（額外進行一次無參考的前向傳遞，以強化說話人身份效果）。",
	"display_name": "LTXV Reference Audio (ID-LoRA)",
	"inputs": {
		"audio_vae": {
			"name": "audio_vae",
			"tooltip": "用於編碼的 LTXV Audio VAE。"
		},
		"end_percent": {
			"name": "end_percent",
			"tooltip": "身份指引啟用的 sigma 範圍結束百分比。"
		},
		"identity_guidance_scale": {
			"name": "identity_guidance_scale",
			"tooltip": "身份指引強度。每一步會額外進行一次無參考的前向傳遞以強化說話人身份。設為 0 可停用（不進行額外傳遞）。"
		},
		"model": { "name": "model" },
		"negative": { "name": "negative" },
		"positive": { "name": "positive" },
		"reference_audio": {
			...
			"tooltip": "要轉換說話人身份的參考音訊 clip。建議長度約 5 秒（訓練時長）。過短或過長的 clip 可能會降低聲音身份轉換效果。"
		},
		"start_percent": {
			"name": "start_percent",
			"tooltip": "身份指引啟用的 sigma 範圍起始百分比。"
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var LTXVScheduler = {
	"display_name": "LTXV 排程器",
	"inputs": {
		"base_shift": { "name": "基礎偏移" },
		"latent": { "name": "潛在空間" },
		"max_shift": { "name": "最大偏移" },
		"steps": { "name": "步驟數" },
		"stretch": {
			"name": "拉伸",
			"tooltip": "將 sigma 拉伸至 [terminal, 1] 的範圍內。"
		},
		"terminal": {
			"name": "終值",
			"tooltip": "拉伸後 sigma 的終值。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var LTXVSeparateAVLatent = {
	"description": "LTXV 分離 AV latent",
...
var LatentBatchSeedBehavior = {
	"display_name": "潛空間批次種子行為",
	"inputs": {
		"samples": { "name": "樣本" },
		"seed_behavior": { "name": "種子行為" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var LatentBlend = {
	"display_name": "Latent 混合",
	"inputs": {
		"blend_factor": { "name": "混合係數" },
		"samples1": { "name": "samples1" },
		"samples2": { "name": "samples2" }
...
var LatentComposite = {
	...
	"inputs": {
		"feather": { "name": "羽化" },
		"samples_from": { "name": "來源樣本" },
		"samples_to": { "name": "目標樣本" },
		"x": { "name": "X 座標" },
		"y": { "name": "Y 座標" }
	}
};
var LatentCompositeMasked = {
	"display_name": "潛空間遮罩合成",
	"inputs": {
...
var LatentCutToBatch = {
	...
	"inputs": {
		"dim": { "name": "維度" },
		"samples": { "name": "樣本" },
		"slice_size": { "name": "切片大小" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var LatentFlip = {
	"display_name": "翻轉 Latent",
	"inputs": {
		"flip_method": { "name": "翻轉方法" },
		"samples": { "name": "樣本" }
	}
};
var LatentFromBatch = {
	"display_name": "從批次取得 Latent",
	"inputs": {
		"batch_index": { "name": "批次索引" },
		"length": { "name": "長度" },
		"samples": { "name": "樣本" }
...
var LatentOperationTonemapReinhard = {
	"display_name": "潛空間 Reinhard 色調映射",
	"inputs": { "multiplier": { "name": "乘數" } },
	"outputs": { "0": { "tooltip": null } }
};
var LatentRotate = {
	"display_name": "旋轉 latent",
	"inputs": {
		"rotation": { "name": "旋轉角度" },
		"samples": { "name": "樣本" }
	}
...
var LatentUpscaleModelLoader = {
	"display_name": "載入 Latent 放大模型",
	"inputs": { "model_name": { "name": "model_name" } },
	"outputs": { "0": { "tooltip": null } }
};
var LazyCache = {
	"description": "自製版 EasyCache - 更「簡單」的 EasyCache 實作版本。整體表現不如 EasyCache，但在某些罕見情況下表現更好，且與 ComfyUI 中的所有內容具有通用相容性。",
	"display_name": "懶快取",
	"inputs": {
		"end_percent": {
			"name": "結束百分比",
			"tooltip": "結束使用懶快取的相對採樣步驟。"
		},
		"model": {
			"name": "模型",
			"tooltip": "要添加懶快取的模型。"
...
var LoadDA3Model = {
	"display_name": "載入 Depth Anything 3",
	"inputs": {
		"model_name": { "name": "model_name" },
...
var LoadImage = {
	...
	"inputs": {
		"image": { "name": "影像" },
		"upload": { "name": "選擇要上傳的檔案" }
	}
};
var LoadImageDataSetFromFolder = {
	"description": "從指定資料夾載入圖像資料集並返回圖像清單。支援格式：PNG、JPG、JPEG、WEBP。",
	"display_name": "從資料夾載入圖片資料集",
	"inputs": { "folder": {
		"name": "資料夾",
		"tooltip": "從此資料夾載入圖片。"
	} },
...
var LoadImageOutput = {
	"description": "從輸出資料夾載入圖片。當點擊重新整理按鈕時，節點會更新圖片清單並自動選取第一張圖片，方便進行反覆操作。",
	"display_name": "載入圖片（來自輸出）",
	"inputs": {
...
var LoadImageTextDataSetFromFolder = {
	"description": "從指定資料夾載入圖像與文字標註配對的資料集並返回清單。支援格式：PNG、JPG、JPEG、WEBP。",
	"display_name": "從資料夾載入圖片與文字資料集",
	"inputs": { "folder": {
		"name": "資料夾",
		"tooltip": "從此資料夾載入圖片。"
	} },
...
var LoadLatent = {
	...
	"inputs": { "latent": { "name": "潛在空間" } }
};
var LoadMediaPipeFaceLandmarker = {
	"display_name": "載入 MediaPipe Face Landmarker",
	"inputs": { "model_name": {
		"name": "model_name",
		"tooltip": "來自 models/mediapipe/ 的 Face Landmarker safetensors。"
	} },
	"outputs": { "0": { "tooltip": null } }
};
var LoadMoGeModel = {
	"display_name": "載入 MoGe 模型",
	"inputs": { "model_name": { "name": "model_name" } },
	"outputs": { "0": { "tooltip": null } }
};
var LoadTrainingDataset = {
	"description": "從磁碟載入已編碼的訓練資料集（latent + conditioning），用於訓練。",
	"display_name": "載入訓練資料集",
	"inputs": { "folder_name": {
		"name": "folder_name",
		"tooltip": "包含已儲存資料集的資料夾名稱（位於輸出目錄內）。"
	} },
	"outputs": {
		"0": {
			"name": "latents",
			"tooltip": "latent 字典的列表"
		},
		"1": {
			"name": "conditioning",
			"tooltip": "conditioning 列表的列表"
		}
	}
};
var LoadVideo = {
...
var LoadVideoDataSetFromFolder = {
	"description": "從指定資料夾載入影片資料集並回傳影片清單。支援格式：MP4、AVI、MOV、WEBM、MKV、FLV。",
	"display_name": "載入影片（資料夾）",
	"inputs": { "folder": {
		"name": "資料夾",
		"tooltip": "包含影片檔案的資料夾。"
	} },
	"outputs": { "0": {
		"name": "影片",
		"tooltip": "延遲載入的影片參考；僅在下游需要時才解碼影格。"
	} }
};
var LoadVideoTextDataSetFromFolder = {
	"description": "從指定資料夾載入影片與文字標題配對的資料集並回傳清單。支援格式：MP4、AVI、MOV、WEBM、MKV、FLV。",
	"display_name": "載入影片-文字（資料夾）",
	"inputs": { "folder": {
		"name": "資料夾",
		"tooltip": "包含影片檔案與 .txt 標題的資料夾。"
	} },
	"outputs": {
		"0": {
			"name": "影片",
...
var LoraLoader = {
	"description": "LoRA 用於修改 diffusion 和 CLIP 模型，改變 latent 的去噪方式，例如套用風格。多個 LoRA 節點可以串接在一起使用。",
	"display_name": "載入 LoRA",
	"inputs": {
		"clip": {
			"name": "clip",
			"tooltip": "LoRA 將套用的 CLIP 模型。"
		},
		"lora_name": {
			"name": "lora_name",
			"tooltip": "LoRA 的名稱。"
		...
		"model": {
			"name": "model",
			"tooltip": "LoRA 將套用的 diffusion 模型。"
		},
		"strength_clip": {
			"name": "strength_clip",
			"tooltip": "調整 CLIP 模型的強度。此值可為負數。"
		},
		"strength_model": {
			"name": "strength_model",
			"tooltip": "調整 diffusion 模型的強度。此值可為負數。"
		}
	},
	"outputs": {
		"0": { "tooltip": "已修改的 diffusion 模型。" },
		"1": { "tooltip": "已修改的 CLIP 模型。" }
	}
};
var LoraLoaderBypass = {
	"description": "以繞過模式套用 LoRA。與一般 LoRA 不同，此方式不會修改模型權重，而是在前向傳遞時注入 LoRA 計算。適用於訓練場景。",
	"display_name": "載入 LoRA（繞過模式）（除錯用）",
	"inputs": {
		"clip": {
			"name": "clip",
			"tooltip": "將套用 LoRA 的 CLIP 模型。"
		},
		"lora_name": {
			"name": "lora_name",
			"tooltip": "LoRA 的名稱。"
...
var LoraLoaderBypassModelOnly = {
	"description": "以繞過模式套用 LoRA。與一般 LoRA 不同，此方式不會修改模型權重，而是在前向傳遞時注入 LoRA 計算。適用於訓練場景。",
	"display_name": "載入 LoRA（繞過模式，僅模型）（除錯用）",
	"inputs": {
		"lora_name": { "name": "lora_name" },
		"model": { "name": "model" },
		"strength_model": { "name": "strength_model" }
	},
	"outputs": { "0": { "tooltip": "已修改的擴散模型。" } }
};
var LoraLoaderModelOnly = {
	"description": "LoRA 用於修改 diffusion 和 CLIP 模型，改變 latent 去噪的方式，例如套用風格。多個 LoRA 節點可以串接在一起使用。",
	...
	"outputs": { "0": { "tooltip": "已修改的 diffusion 模型。" } }
};
var LoraModelLoader = {
...
var LoraSave = {
	...
	"inputs": {
		"bias_diff": { "name": "偏差差異" },
		"filename_prefix": { "name": "檔名前綴" },
		"lora_type": { "name": "lora類型" },
		"model_diff": {
			"name": "模型差異",
			"tooltip": "要轉換為lora的ModelSubtract輸出。"
		},
		"rank": { "name": "秩(rank)" },
		"text_encoder_diff": {
			"name": "文字編碼器差異",
			"tooltip": "要轉換為lora的CLIPSubtract輸出。"
		}
	}
};
var LossGraphNode = {
	...
	"inputs": {
		"filename_prefix": {
			"name": "檔案名稱前綴",
			"tooltip": "儲存 loss 圖像的檔名前綴。"
		},
		"loss": {
			"name": "損失",
			"tooltip": "來自訓練節點的 loss 映射。"
		}
	}
};
...
var LtxvApiImageToVideo = {
	"description": "基於起始圖片，具有可自訂持續時間和解析度的專業級影片。",
	"display_name": "LTXV 圖片轉影片",
	"inputs": {
		"duration": { "name": "持續時間" },
		"fps": { "name": "幀率" },
		"generate_audio": {
			"name": "生成音訊",
			"tooltip": "當為 true 時，生成的影片將包含與場景匹配的 AI 生成音訊。"
		},
		"image": {
			"name": "圖片",
			"tooltip": "要用於影片的第一幀。"
...
var LtxvApiTextToVideo = {
	"description": "具有可自訂持續時間和解析度的專業級影片。",
	"display_name": "LTXV 文字轉影片",
	"inputs": {
		"duration": { "name": "持續時間" },
		"fps": { "name": "幀率" },
		"generate_audio": {
...
var LumaConceptsNode = {
	"description": "包含一個或多個相機概念，可用於 Luma 文字轉影片與 Luma 圖片轉影片節點。",
...
var LumaImageEditNode2 = {
	"description": "使用 Luma UNI-1 模型，透過文字提示編輯現有圖像。",
	"display_name": "Luma UNI-1 圖像編輯",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model": {
			"name": "模型",
		...
		"model_style": { "name": "風格" },
		"model_web_search": { "name": "網路搜尋" },
		"prompt": {
			"name": "提示",
			"tooltip": "期望編輯的描述。1–6000 字元。"
		},
		"seed": {
			"name": "種子",
			"tooltip": "種子控制此節點是否重新執行；無論種子如何，結果皆為非確定性。"
		},
		"source": {
			"name": "來源",
			"tooltip": "要編輯的來源圖像。"
...
var LumaImageModifyNode = {
	"description": "根據提示詞與長寬比同步修改影像。",
	"display_name": "Luma 影像轉換",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"image": { "name": "影像" },
		"image_weight": {
			"name": "影像權重",
			"tooltip": "影像的權重；越接近 1.0，影像修改幅度越小。"
		},
		"model": { "name": "模型" },
		"prompt": {
			"name": "提示詞",
		...
		"seed": {
			"name": "種子值",
			"tooltip": "決定此節點是否重新執行的種子值；實際結果無論種子值為何都不具決定性。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var LumaImageNode = {
	"description": "根據提示詞與長寬比同步生成圖像。",
	"display_name": "Luma 文字轉圖像",
	"inputs": {
		"aspect_ratio": { "name": "長寬比" },
		"character_image": {
			"name": "角色參考圖",
			"tooltip": "角色參考圖像；可為多張批次圖像，最多可考慮 4 張圖像。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"image_luma_ref": {
			"name": "Luma 參考圖",
			"tooltip": "Luma 參考節點連接，可用輸入圖像影響生成；最多可考慮 4 張圖像。"
		},
		"model": { "name": "模型" },
		"prompt": {
			"name": "提示詞",
		...
		"seed": {
			"name": "種子值",
			"tooltip": "決定節點是否重新執行的種子值；實際結果無論種子值如何都不具決定性。"
		},
		"style_image": {
			"name": "風格參考圖",
			"tooltip": "風格參考圖像；僅會使用 1 張圖像。"
		},
		"style_image_weight": {
			"name": "風格圖權重",
			"tooltip": "風格圖像的權重。如果未提供風格圖像則忽略。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var LumaImageNode2 = {
	"description": "使用 Luma UNI-1 模型，根據文字生成圖像。",
	"display_name": "Luma UNI-1 圖像",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model": {
			"name": "模型",
...
var LumaImageToVideoNode = {
	"description": "根據提示詞、輸入圖片與輸出尺寸同步產生影片。",
	"display_name": "Luma 圖像轉影片",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"duration": { "name": "時長" },
		"first_image": {
		...
		"luma_concepts": {
			"name": "luma_concepts",
			"tooltip": "（選填）透過 Luma Concepts 節點指定相機運動的相機概念。"
		},
		"model": { "name": "模型" },
		"prompt": {
			"name": "提示詞",
		...
		"seed": {
			"name": "種子值",
			"tooltip": "決定此節點是否重新執行的種子值；實際結果無論種子值如何都不具決定性。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var LumaRay32ExtendVideoNode = {
	"description": "將先前的 Ray 3.2 生成結果向前（接續之後）或向後（插入之前）延伸。請連接前一個 Luma Ray 3.2 節點的 generation_id 輸出。每次延伸皆為 5 秒。",
	"display_name": "Luma Ray 3.2 延伸影片",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"direction": {
			"name": "direction",
			"tooltip": "Forward 代表接續前一個片段之後；backward 代表插入於其之前。"
		},
		...
		"seed": {
			"name": "seed",
			"tooltip": "決定節點是否重新執行的種子值；無論種子為何，結果皆為非決定性。"
		},
		"source_generation_id": {
			"name": "source_generation_id",
			"tooltip": "要延伸的前一個 Ray 3.2 影片的 generation_id。請連接另一個 Luma Ray 3.2 節點的 generation_id 輸出。"
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var LumaRay32ImageToVideoNode = {
	"description": "使用 Luma 的 Ray 3.2 模型，從起始和/或結束影格產生影片。以圖像為錨點的生成長度皆為 5 秒。",
	"display_name": "Luma Ray 3.2 圖像轉影片",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"end_frame": {
			"name": "end_frame",
		...
		"loop": {
			"name": "loop",
			"tooltip": "讓影片無縫循環。若設定 end_frame 則無法使用。"
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "影片生成的文字提示。"
...
var LumaRay32KeyframeNode = {
	"description": "將引導圖像錨定於 Ray 3.2 輸出影片時間軸上的特定位置。請將此節點連接至 Luma Ray 3.2 Keyframes to Video 節點的「keyframes」輸入；可透過下方的「keyframes」選填輸入串接多個關鍵影格。",
	"display_name": "Luma Ray 3.2 關鍵影格",
	"inputs": {
		"image": {
			"name": "image",
			"tooltip": "要放置於輸出影片指定時刻的引導圖像。"
		},
		"keyframes": {
			"name": "keyframes",
			"tooltip": "可選的較早關鍵影格，與本影格串接。"
		},
		"position": {
			"name": "position",
			"tooltip": "將此圖像放置於輸出影片時間軸上的方式。"
		},
...
var LumaRay32KeyframesToVideoNode = {
	"description": "使用 Luma Ray 3.2，根據一系列導引圖像（每個圖像對應時間軸上的一個位置）進行插值，生成影片。請使用 Luma Ray 3.2 關鍵影格節點建立序列（至少 2 個）。",
	"display_name": "Luma Ray 3.2 關鍵影格轉影片",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"duration": { "name": "時長" },
		"keyframes": {
			"name": "關鍵影格",
			"tooltip": "來自 Luma Ray 3.2 關鍵影格節點的關鍵影格序列（至少 2 個）。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "用於影片生成的文字提示。"
		...
		"seed": {
			"name": "種子",
			"tooltip": "決定節點是否重新執行的種子；無論種子為何，結果皆為非確定性。"
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var LumaRay32TextToVideoNode = {
	"description": "使用 Luma 的 Ray 3.2 模型，根據文字提示生成影片。",
	"display_name": "Luma Ray 3.2 文字轉影片",
	"inputs": {
		"aspect_ratio": { "name": "長寬比" },
		"control_after_generate": { "name": "生成後控制" },
		"duration": { "name": "時長" },
...
var LumaRay32VideoEditNode = {
	"description": "使用 Luma Ray 3.2 以新提示詞重新渲染現有影片（可重新風格化、重新打光、增減元素），同時保留原始動作。來源影片最長 18 秒；編輯後影片長度與來源相同。",
	"display_name": "Luma Ray 3.2 影片編輯",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"prompt": {
			"name": "提示詞",
		...
		"strength": {
			"name": "強度",
			"tooltip": "保留原始內容與重新想像的程度。'auto' 由 Ray 3.2 自動選擇；adhere_* 最保留原始內容，flex_* 平衡，reimagine_* 變化最大。"
		},
		"video": {
			"name": "影片",
			"tooltip": "要編輯的來源影片。最長 18 秒。"
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var LumaRay32VideoReframeNode = {
	"description": "更改現有影片的長寬比，使用 Luma Ray 3.2 填補新顯露的畫布區域。來源影片最長 30 秒。依輸出秒數計費。",
	"display_name": "Luma Ray 3.2 影片重構比例",
	"inputs": {
		"aspect_ratio": { "name": "aspect_ratio" },
		"control_after_generate": { "name": "control after generate" },
		"prompt": {
			"name": "prompt",
			"tooltip": "描述新顯露畫布區域應如何填補。"
		},
		"resolution": { "name": "resolution" },
		"seed": {
			"name": "seed",
			"tooltip": "決定是否重新執行節點的種子值；無論種子為何，結果皆為非確定性。"
		},
		"video": {
			"name": "video",
			"tooltip": "要重構比例的來源影片。最長 30 秒。"
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var LumaReferenceNode = {
	"description": "保存一張圖片及其權重，供 Luma 生成圖片節點使用。",
	"display_name": "Luma 參考",
	"inputs": {
		"image": {
			"name": "影像",
			"tooltip": "用作參考的圖片。"
...
var LumaVideoNode = {
	"description": "根據提示詞與輸出尺寸同步產生影片。",
	"display_name": "Luma 文字轉影片",
	"inputs": {
		"aspect_ratio": { "name": "長寬比" },
		"control_after_generate": { "name": "生成後控制" },
		"duration": { "name": "時長" },
...
var MagnificImageRelightNode = {
	"description": "透過光線調整與可選的參考光線轉移，重新打光圖像。",
	"display_name": "Magnific 圖像重光",
	"inputs": {
		"advanced_settings": {
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "光線描述指引。支援強調標註（1-1.4）。"
		},
		"reference_image": {
			"name": "reference_image",
			"tooltip": "可選的參考圖像，用於轉移光線。"
		},
		"style": {
			"name": "style",
			"tooltip": "風格化輸出偏好。"
...
var MagnificImageSkinEnhancerNode = {
	"description": "人像美膚增強，支援多種處理模式。",
	"display_name": "Magnific 圖像美膚增強",
	"inputs": {
		"image": {
			"name": "image",
			"tooltip": "要增強的人像圖像。"
		...
		"mode": {
			"name": "mode",
			"tooltip": "處理模式：creative 為藝術增強，faithful 保留原貌，flexible 針對性優化。"
		},
		"sharpen": {
			"name": "sharpen",
			"tooltip": "銳化強度等級。"
...
var MagnificImageStyleTransferNode = {
	"description": "將參考圖像的風格轉移到您的輸入圖像上。",
	"display_name": "Magnific 圖像風格轉換",
	"inputs": {
		"engine": {
			"name": "engine",
			"tooltip": "處理引擎選擇。"
		...
		"fixed_generation": {
			...
			"tooltip": "停用時，每次生成都會引入一定的隨機性，產生更多元的結果。"
		},
		"flavor": {
			"name": "flavor",
			"tooltip": "風格轉換風格。"
...
var MagnificImageUpscalerCreativeNode = {
	"description": "基於提示詞的增強、風格化，以及 2x/4x/8x/16x 放大。最大輸出：25.3 百萬像素。",
	"display_name": "Magnific 影像放大（創意）",
	"inputs": {
		"auto_downscale": {
			"name": "自動降尺寸",
			"tooltip": "若輸出超過最大像素限制，自動縮小輸入影像。"
		},
		"creativity": { "name": "創意" },
		"engine": { "name": "引擎" },
		"fractality": {
			"name": "複雜度",
			"tooltip": "每平方像素的提示詞強度與細緻度。"
		},
		"hdr": {
			"name": "HDR",
			"tooltip": "細節與解析度的等級。"
		...
		"image": { "name": "影像" },
		"optimized_for": { "name": "最佳化目標" },
		"prompt": { "name": "提示詞" },
		"resemblance": {
			"name": "相似度",
			"tooltip": "與原始影像的相似程度。"
		},
		"scale_factor": { "name": "放大倍率" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var MagnificImageUpscalerPreciseV2Node = {
	"description": "高保真放大，細緻控制銳利度、顆粒感與細節。最大輸出：10060×10060 像素。",
	"display_name": "Magnific 影像放大（精確 V2）",
	"inputs": {
		"auto_downscale": {
			"name": "自動降尺寸",
			"tooltip": "若輸出超過最大解析度，自動縮小輸入影像。"
		},
		"flavor": {
			"name": "處理風格",
			"tooltip": "處理風格：sublime 適用於一般用途，photo 適用於照片，photo_denoiser 適用於雜訊照片。"
		},
		"image": { "name": "影像" },
		"scale_factor": { "name": "放大倍率" },
		"sharpen": {
			"name": "銳利度",
			"tooltip": "影像銳利度強度。數值越高，邊緣越清晰。"
		},
		"smart_grain": {
			"name": "智慧顆粒",
			"tooltip": "智慧增強顆粒/紋理，避免影像過於平滑或不自然。"
		},
		"ultra_detail": {
			"name": "極致細節",
			"tooltip": "控制放大時新增的細節、紋理與微細節。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var Mahiro = {
	"description": "修改引導方式，讓其更著重於正向提示詞的「方向性」而非正負提示詞之間的差異。",
	"display_name": "Mahiro 太可愛了，應該要有更好的引導功能!! (。・ω・。)",
	"inputs": { "model": { "name": "model" } },
	"outputs": { "0": {
		"name": "patched_model",
		"tooltip": null
...
var MakeTrainingDataset = {
	"description": "使用VAE對圖像編碼、CLIP對文字編碼，建立包含latent與conditioning的訓練資料集。",
	"display_name": "建立訓練資料集",
	"inputs": {
		"clip": {
			"name": "clip",
			"tooltip": "用於將文字編碼為條件的 CLIP 模型。"
		},
		"images": {
			"name": "圖片",
			"tooltip": "要編碼的圖片清單。"
		...
		"texts": {
			"name": "文字",
			"tooltip": "文字標題清單。可為 n 筆（與圖片數量相同）、1 筆（全部重複），或省略（使用空字串）。"
		},
		"vae": {
			"name": "vae",
			"tooltip": "用於將圖片編碼為 latent 的 VAE 模型。"
		}
	},
	"outputs": {
		"0": {
...
var MaskPreview = {
	"description": "將輸入影像儲存到您的 ComfyUI 輸出目錄。",
...
var MaskToImage = {
	"display_name": "將遮罩轉換為影像",
	"inputs": { "mask": { "name": "遮罩" } },
	"outputs": { "0": { "tooltip": null } }
};
var MediaPipeFaceLandmarker = {
	"description": "使用MediaPipe模型偵測臉部關鍵點。",
	"display_name": "MediaPipe Face Landmarker",
	"inputs": {
		"detector_variant": {
			"name": "detector_variant",
			"tooltip": "人臉偵測器範圍。「short」適用於近距離人臉（約 2 公尺內）；「full」可偵測較遠／較小的人臉（最遠約 5 公尺），但速度較慢。「both」會同時執行兩種偵測器，並保留每幀找到最多人臉的結果（約 2 倍偵測成本）。"
		},
		"face_detection_model": { "name": "face_detection_model" },
		"image": { "name": "image" },
		"min_confidence": {
			"name": "min_confidence",
			"tooltip": "BlazeFace 分數門檻。降低可捕捉較小／被遮擋的人臉。"
		},
		"missing_frame_fallback": {
			"name": "missing_frame_fallback",
			"tooltip": "批次處理時偵測失敗的每幀行為。「empty」讓該幀無人臉。「previous」複製最近一次成功偵測的結果。「interpolate」在包圍成功幀之間插值地標／邊界框／blendshapes。多臉：跨幀以貪婪邊界框中心最近鄰配對人臉。"
		},
		"num_faces": {
			"name": "num_faces",
			"tooltip": "每幀最多回傳的人臉數量。0 = 不限制（回傳所有偵測到的人臉）。"
		}
	},
	"outputs": {
		"0": {
...
var MediaPipeFaceMask = {
	"description": "根據臉部關鍵點繪製mask。",
	"display_name": "MediaPipe Face Mask",
	"inputs": {
		"face_landmarks": { "name": "face_landmarks" },
		"regions": {
			"name": "regions",
			"tooltip": "「all」= face_oval+lips+eyes+irises 的聯集（實際上等同於 face_oval，因其包含其他區域）。「custom」= 可單獨切換各區域，例如 lips+eyes 組合。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var MediaPipeFaceMeshVisualize = {
	"description": "在輸入圖像上繪製臉部關鍵點網格。",
	"display_name": "MediaPipe Face Mesh 視覺化",
	"inputs": {
		"color": { "name": "color" },
		"connections": {
			"name": "connections",
			"tooltip": "「all」= oval+eyes+brows+lips+irises+nose。「fill」= 實心 face_oval 多邊形（輪廓 mask）。「custom」= 可單獨切換各特徵（包含「tesselation」，即完整 2547 邊線框）。"
		},
		"face_landmarks": { "name": "face_landmarks" },
		"image": {
			"name": "image",
			"tooltip": "若未連接，將使用黑色畫布。"
		},
		"point_size": {
			"name": "point_size",
			"tooltip": "地標點半徑（像素）。0 代表不繪製點。"
		},
		"thickness": {
			"name": "thickness",
			"tooltip": "邊線粗細（像素）。0 代表不繪製邊線。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var MergeImageLists = {
	"description": "將多個圖像清單合併為一個。",
	"display_name": "合併圖片清單",
	"inputs": { "images": {
		"name": "圖片",
		"tooltip": "要處理的圖片清單。"
...
var MergeSplat = {
	"description": "將任意數量的高斯 splat 合併為一個。對同一 latent 以不同種子進行多次解碼並合併，可讓表面更密集，進而提升網格品質。",
	"display_name": "合併 Splats",
...
var MeshyAnimateModelNode = {
	"description": "將特定動畫動作應用於先前已綁定骨架的角色。",
	"display_name": "Meshy：動畫模型",
	"inputs": {
		"action_id": {
			"name": "action_id",
			"tooltip": "請造訪 https://docs.meshy.ai/en/api/animation-library 以取得可用值列表。"
		},
...
var MeshyRefineNode = {
	...
	"display_name": "Meshy：精修草稿模型",
	"inputs": {
		"enable_pbr": {
			"name": "enable_pbr",
			"tooltip": "除了基礎色彩外，還會產生 PBR 貼圖（金屬度、粗糙度、法線）。注意：若使用雕塑風格，請設為 false，因為雕塑風格會產生自己的 PBR 貼圖。"
		},
		"meshy_task_id": { "name": "meshy_task_id" },
		"model": { "name": "model" },
		"texture_image": {
			"name": "texture_image",
			"tooltip": "「texture_image」與「texture_prompt」只能擇一使用。"
		},
		"texture_prompt": {
			"name": "texture_prompt",
...
var MeshyRigModelNode = {
	...
	"display_name": "Meshy：骨架綁定模型",
	"inputs": {
		"height_meters": {
			"name": "height_meters",
			"tooltip": "角色模型的約略高度（公尺）。有助於縮放與骨架綁定精度。"
		},
		"meshy_task_id": { "name": "meshy_task_id" },
		"texture_image": {
			"name": "texture_image",
...
var MeshyTextToModelNode = {
	...
	"inputs": {
		...
		"seed": {
			"name": "seed",
			"tooltip": "Seed 控制節點是否重新執行；無論 seed 為何，結果皆為非確定性。"
		},
		"should_remesh": {
			"name": "should_remesh",
			"tooltip": "設為 false 時，回傳未處理的三角網格。"
		},
		"should_remesh_target_polycount": { "name": "target_polycount" },
		"should_remesh_topology": { "name": "topology" },
		"style": { "name": "style" },
...
var MeshyTextureNode = {
	...
	"inputs": {
		"enable_original_uv": {
			"name": "啟用原始UV",
			"tooltip": "使用模型的原始UV，而非產生新的UV。啟用後，Meshy會保留上傳模型中現有的材質。如果模型沒有原始UV，輸出品質可能會較差。"
		},
		"image_style": {
			"name": "影像風格",
			"tooltip": "用一張2D影像來引導材質生成過程。不能與「text_style_prompt」同時使用。"
		},
		"meshy_task_id": { "name": "meshy_task_id" },
		"model": { "name": "模型" },
		"pbr": { "name": "PBR" },
...
var MinimaxHailuoVideoNode = {
	...
	"display_name": "MiniMax 海螺影片",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"duration": {
			"name": "duration",
			"tooltip": "輸出影片的長度（單位：秒）。"
		},
		"first_frame_image": {
			"name": "第一幀圖片",
			"tooltip": "可選的影像，用作生成影片的第一幀。"
		},
		"prompt_optimizer": {
			"name": "prompt_optimizer",
			"tooltip": "需要時優化提示詞以提升生成品質。"
		},
		"prompt_text": {
			"name": "提示文字",
			"tooltip": "引導影片生成的文字提示。"
		...
		"resolution": {
			"name": "resolution",
			"tooltip": "影片顯示的尺寸。1080p 為 1920x1080，768p 為 1366x768。"
		},
		"seed": {
			"name": "種子",
			"tooltip": "用於創建噪聲的隨機種子。"
...
var MinimaxImageToVideoNode = {
	"description": "使用 MiniMax 的 API，根據圖像與提示生成影片",
	"display_name": "MiniMax 圖像轉影片",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"image": {
			"name": "圖像",
			"tooltip": "用作影片生成第一幀的圖像"
		},
		"model": {
			"name": "模型",
			"tooltip": "用於影片生成的模型"
...
var MinimaxTextToVideoNode = {
	"description": "使用 MiniMax 的 API 根據提示生成影片",
	"display_name": "MiniMax 文字轉影片",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model": {
			"name": "模型",
...
var MoGeInference = {
	"description": "在單張圖像上執行MoGe以估算深度與幾何資訊。",
	"display_name": "MoGe 推論",
	"inputs": {
		"apply_mask": {
			"name": "apply_mask",
			"tooltip": "將遮罩區域（天空／無效像素）在點雲和深度圖中設為 inf，以便網格化時排除。若停用則保留所有預測幾何，遮罩仍會單獨返回。"
		},
		"batch_size": {
			"name": "batch_size",
			"tooltip": "每次推論的圖像數量。如果處理長影片或大量圖像時記憶體不足，請降低此值。"
		},
		"force_projection": { "name": "force_projection" },
		"fov_x_degrees": {
			"name": "fov_x_degrees",
			"tooltip": "來源相機的水平視角。設定用於將深度圖反投影到 3D 的焦距。0 = 自動從預測點回推。"
		},
		"image": { "name": "image" },
...
var MoGePanoramaInference = {
	"description": "將全景圖像分割為12個透視視角，分別執行MoGe推論，並合併結果為單一深度圖。",
	"display_name": "MoGe 全景推論",
	"inputs": {
		"batch_size": {
			"name": "batch_size",
			"tooltip": "每批推論的視角數（共 12 個分割）。"
		},
		"image": {
			"name": "image",
			"tooltip": "等距矩形全景圖（任意長寬比）。"
		},
		"merge_resolution": {
			"name": "merge_resolution",
			"tooltip": "合併後等距深度圖的長邊解析度。"
		},
		"moge_model": { "name": "moge_model" },
		"resolution_level": {
			"name": "resolution_level",
			"tooltip": "每視角細緻度（0 = 最快，9 = 最細緻）。"
		},
		"split_resolution": {
...
var MoGePointMapToMesh = {
	"description": "將MoGe點雲圖轉換為3D網格。",
	"display_name": "MoGe 點雲轉網格",
	"inputs": {
		"batch_index": {
			"name": "batch_index",
			"tooltip": "要轉換為網格的 MoGe 幾何批次中的哪一張影像。每張影像的頂點數不同，因此批次無法合併為單一網格（MESH）。"
		},
		"decimation": {
			"name": "decimation",
			"tooltip": "頂點間隔；1 代表完整解析度。"
		},
		"discontinuity_threshold": {
			"name": "discontinuity_threshold",
			"tooltip": "若 3x3 深度範圍超過此比例，則捨棄該像素。0 代表關閉。"
		},
		"moge_geometry": { "name": "moge_geometry" },
		"texture": {
			"name": "texture",
			"tooltip": "將來源影像作為 baseColor 紋理帶入。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var MoGeRender = {
	"description": "根據幾何資料渲染深度圖或法線圖。",
	"display_name": "MoGe 渲染",
	"inputs": {
		"moge_geometry": { "name": "moge_geometry" },
		"output": {
			"name": "output",
			"tooltip": "DirectX 與 OpenGL 控制法線貼圖綠色通道的慣例。DirectX：綠色 = -Y 向下（Unreal）。OpenGL：綠色 = +Y 向上（Blender、Substance、Unity、glTF）。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var ModelMergeCosmosPredict2_2B = {
	"display_name": "模型合併宇宙預測2_2B",
	"inputs": {
		"blocks_0_": { "name": "區塊.0." },
		"blocks_10_": { "name": "區塊.10." },
		"blocks_11_": { "name": "區塊.11." },
		"blocks_12_": { "name": "區塊.12." },
		"blocks_13_": { "name": "區塊.13." },
		"blocks_14_": { "name": "區塊.14." },
		"blocks_15_": { "name": "區塊.15." },
		"blocks_16_": { "name": "區塊.16." },
		"blocks_17_": { "name": "區塊.17." },
		"blocks_18_": { "name": "區塊.18." },
		"blocks_19_": { "name": "區塊.19." },
		"blocks_1_": { "name": "區塊.1." },
		"blocks_20_": { "name": "區塊.20." },
		"blocks_21_": { "name": "區塊.21." },
		"blocks_22_": { "name": "區塊.22." },
		"blocks_23_": { "name": "區塊.23." },
		"blocks_24_": { "name": "區塊.24." },
		"blocks_25_": { "name": "區塊.25." },
		"blocks_26_": { "name": "區塊.26." },
		"blocks_27_": { "name": "區塊.27." },
		"blocks_2_": { "name": "區塊.2." },
		"blocks_3_": { "name": "區塊.3." },
		"blocks_4_": { "name": "區塊.4." },
		"blocks_5_": { "name": "區塊.5." },
		...
		"model1": { "name": "模型1" },
		"model2": { "name": "模型2" },
		"pos_embedder_": { "name": "位置嵌入器." },
		"t_embedder_": { "name": "t嵌入器." },
		"t_embedding_norm_": { "name": "t嵌入歸一化." },
		"x_embedder_": { "name": "x嵌入器." }
	}
};
var ModelMergeFlux1 = {
...
var ModelMergeQwenImage = {
	...
	"inputs": {
		...
		"model1": { "name": "模型1" },
		"model2": { "name": "模型2" },
		"pos_embeds_": { "name": "位置嵌入." },
		"proj_out_": { "name": "proj_out." },
		"time_text_embed_": { "name": "時間文字嵌入." },
		"transformer_blocks_0_": { "name": "轉換器區塊.0." },
		"transformer_blocks_10_": { "name": "transformer_blocks.10." },
		"transformer_blocks_11_": { "name": "transformer_blocks.11." },
		"transformer_blocks_12_": { "name": "transformer_blocks.12." },
		"transformer_blocks_13_": { "name": "transformer_blocks.13." },
		...
		"transformer_blocks_18_": { "name": "transformer_blocks.18." },
		"transformer_blocks_19_": { "name": "transformer_blocks.19." },
		"transformer_blocks_1_": { "name": "轉換器區塊.1." },
		"transformer_blocks_20_": { "name": "transformer_blocks.20." },
		"transformer_blocks_21_": { "name": "transformer_blocks.21." },
		"transformer_blocks_22_": { "name": "transformer_blocks.22." },
		"transformer_blocks_23_": { "name": "transformer_blocks.23." },
		...
		"transformer_blocks_2_": { "name": "轉換器區塊.2." },
		...
		"transformer_blocks_3_": { "name": "轉換器區塊.3." },
		...
		"transformer_blocks_9_": { "name": "transformer_blocks.9." },
		"txt_in_": { "name": "文字輸入." },
		"txt_norm_": { "name": "文字歸一化." }
	}
};
var ModelMergeSD1 = {
	"display_name": "模型合併 (SD1)",
	"inputs": {
...
var ModelMergeWAN2_1 = {
	"description": "1.3B 模型有 30 個區塊，14B 模型有 40 個區塊。影像轉影片模型有額外的 img_emb。",
	"display_name": "模型合併 (WAN2.1)",
	"inputs": {
		"blocks_0_": { "name": "blocks.0." },
		"blocks_10_": { "name": "blocks.10." },
		"blocks_11_": { "name": "blocks.11." },
...
var ModelSamplingStableCascade = {
	"display_name": "模型取樣 Stable Cascade",
	"inputs": {
		"model": { "name": "model" },
		"shift": { "name": "偏移" }
	}
...
var Morphology = {
	...
	"inputs": {
		"image": { "name": "影像" },
		"kernel_size": { "name": "核心大小" },
		"operation": { "name": "操作" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var MultiGPU_WorkUnits = {
	"description": "將模型準備好以透過分割工作單元來加速取樣。\n\n應放置於會修改模型物件本身的節點之後，例如 compile 或 attention-switch 節點。\n\n除了這些例外情況外，此節點可在任何順序中放置。",
	"display_name": "多 GPU CFG 分割",
	"inputs": {
...
var NAGuidance = {
	...
	"outputs": { "0": { "tooltip": "已啟用 NAG 的修補模型。" } }
};
var NormalizeImages = {
	"description": "使用平均值與標準差對圖像進行正規化。",
	"display_name": "標準化圖片",
	"inputs": {
		"images": {
			"name": "圖片",
...
var NormalizeVideoLatentStart = {
	"description": "將影片 latent 的初始幀正規化，使其均值與標準差與後續參考幀相符。可幫助減少起始幀與影片其餘部分的差異。",
	"display_name": "NormalizeVideoLatentStart",
	"inputs": {
		"latent": { "name": "latent" },
		"reference_frame_count": {
			"name": "reference_frame_count",
			"tooltip": "用作參考的 latent 幀數，從起始幀之後開始"
		},
		"start_frame_count": {
			"name": "start_frame_count",
			"tooltip": "要正規化的 latent 幀數，從起始處開始計算"
		}
	},
	"outputs": { "0": {
		"name": "latent",
...
var OpenAIChatConfig = {
	"description": "允許為 OpenAI 聊天節點指定進階配置選項。",
	"display_name": "OpenAI ChatGPT 進階選項",
	"inputs": {
		"instructions": {
			"name": "instructions",
			"tooltip": "模型生成回應的指示說明"
		...
		"max_output_tokens": {
			...
			"tooltip": "為回應生成的 token 數量的上限，包括可見的輸出 token"
		},
		"truncation": {
			"name": "truncation",
			"tooltip": "用於模型回應的截斷策略。auto：如果此回應和先前回應的上下文超過模型的上下文窗口大小，模型將通過丟棄對話中間的輸入項目來截斷回應以適應上下文窗口。disabled：如果模型回應將超過模型的上下文窗口大小，請求將失敗並返回 400 錯誤"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var OpenAIChatNode = {
	"description": "從 OpenAI 模型生成文字回應。",
	"display_name": "OpenAI ChatGPT",
	"inputs": {
		"advanced_options": {
			"name": "advanced_options",
			"tooltip": "模型的選項配置。接受來自 OpenAI 聊天進階選項節點的輸入。"
		},
		"files": {
			"name": "files",
			"tooltip": "可選的文件，用作模型的上下文。接受來自 OpenAI 聊天輸入文件節點的輸入。"
		},
		"images": {
			"name": "images",
			"tooltip": "可選的圖像，用作模型的上下文。要包含多個圖像，可以使用批次圖像節點。"
		},
		"model": {
			"name": "model",
			"tooltip": "用於生成回應的模型"
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "模型的文字輸入，用於生成回應。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var OpenAIDalle2 = {
	"description": "透過 OpenAI 的 DALL·E 2 端點同步產生影像。",
	"display_name": "OpenAI DALL·E 2",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"image": {
			"name": "參考影像",
			"tooltip": "可選的參考影像，用於影像編輯。"
		},
		"mask": {
			"name": "遮罩",
			"tooltip": "可選的遮罩，用於修補（白色區域將被取代）"
		},
		"n": {
			"name": "數量",
			"tooltip": "要產生多少張影像"
...
var OpenAIDalle3 = {
	"description": "透過 OpenAI 的 DALL·E 3 端點同步產生影像。",
	...
	"inputs": {
		...
		"style": {
			"name": "風格",
			"tooltip": "「生動」會讓模型傾向產生超現實且戲劇化的影像。「自然」則會讓模型產生較自然、不那麼超現實的影像。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var OpenAIGPTImage1 = {
	...
	"inputs": {
		...
		"custom_height": {
			"name": "custom_height",
			"tooltip": "僅當「size」為「Custom」時使用。必須為 16 的倍數（僅限 GPT Image 2）。"
		},
		"custom_width": {
			"name": "custom_width",
			"tooltip": "僅當「size」為「Custom」時使用。必須為 16 的倍數（僅限 GPT Image 2）。"
...
var OpenAIGPTImageNodeV2 = {
	...
	"inputs": {
		...
		"model_custom_height": { "name": "自訂高度" },
		"model_custom_width": { "name": "自訂寬度" },
...
var OpenAIInputFiles = {
	...
	"inputs": {
		"OPENAI_INPUT_FILES": {
			...
			"tooltip": "可選的額外文件，與從此節點載入的文件批次處理。允許鏈接輸入文件，以便單個訊息可以包含多個輸入文件。"
		},
		"file": {
			"name": "file",
			"tooltip": "要作為模型上下文包含的輸入文件。目前僅接受文字 (.txt) 和 PDF (.pdf) 文件。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var OpenAIVideoSora2 = {
	"description": "OpenAI 影片和音訊生成。",
	"display_name": "OpenAI Sora - 影片",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "引導文字；如果存在輸入圖像，可以為空。"
		},
		"seed": {
			"name": "seed",
			"tooltip": "決定節點是否應重新運行的種子；無論種子如何，實際結果都是非確定性的。"
		},
		"size": { "name": "size" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var OpenRouterLLMNode = {
	"description": "透過OpenRouter產生文字回應。路由至xAI、DeepSeek、Qwen、Mistral、Z.AI（GLM）、Moonshot（Kimi）、Perplexity Sonar等熱門模型。",
	"display_name": "OpenRouter LLM",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model": {
			"name": "model",
			"tooltip": "用於產生回應的OpenRouter模型。"
		},
		"model_reasoning_effort": { "name": "reasoning_effort" },
		"prompt": {
			"name": "prompt",
		...
		"seed": {
			"name": "seed",
			"tooltip": "取樣用的種子。設為0則不指定。大多數模型僅將此作為參考。"
		},
		"system_prompt": {
			"name": "system_prompt",
			"tooltip": "決定模型行為的基礎指令。"
...
var OpticalFlowLoader = {
	...
	"inputs": { "model_name": {
		"name": "model_name",
		"tooltip": "要載入的光流模型。檔案必須放在 'optical_flow' 資料夾。目前僅支援 torchvision 的 raft_large.pth。"
	} },
	"outputs": { "0": { "tooltip": null } }
};
var OptimalStepsScheduler = {
	"display_name": "最佳步數排程器",
	"inputs": {
		"denoise": { "name": "去雜訊強度" },
		"model_type": { "name": "model_type" },
		"steps": { "name": "步驟數" }
...
var PairConditioningSetDefaultCombine = {
	"display_name": "Cond 配對組預設合併",
	"inputs": {
		"hooks": { "name": "hooks" },
		"negative": { "name": "負向" },
		"negative_DEFAULT": { "name": "負向_預設" },
		"positive": { "name": "正向" },
		"positive_DEFAULT": { "name": "正向_預設" }
	},
	"outputs": {
		"0": { "name": "正向" },
		"1": { "name": "負向" }
...
var PairConditioningSetProperties = {
	"display_name": "條件配對組屬性",
	"inputs": {
		"hooks": { "name": "hooks" },
		"mask": { "name": "遮罩" },
		"negative_NEW": { "name": "負向_NEW" },
		"positive_NEW": { "name": "正向_NEW" },
		"set_cond_area": { "name": "設定條件區域" },
		"strength": { "name": "強度" },
		"timesteps": { "name": "時間步驟" }
	},
...
var PairConditioningSetPropertiesAndCombine = {
	"display_name": "Cond Pair 設定屬性並合併",
	"inputs": {
		"hooks": { "name": "hooks" },
		"mask": { "name": "遮罩" },
		"negative": { "name": "負向" },
...
var PatchModelAddDownscale = {
	...
	"inputs": {
		"block_number": { "name": "區塊編號" },
		"downscale_after_skip": { "name": "跳過後縮小" },
		"downscale_factor": { "name": "縮小比例" },
		"downscale_method": { "name": "縮小方法" },
		"end_percent": { "name": "結束百分比" },
		"model": { "name": "model" },
		"start_percent": { "name": "起始百分比" },
		"upscale_method": { "name": "放大方法" }
...
var PerpNeg = {
	"display_name": "Perp-Neg（已被 PerpNegGuider 棄用）",
	"inputs": {
...
var PerpNegGuider = {
	"display_name": "垂直負向引導器",
	"inputs": {
		"cfg": { "name": "cfg" },
		"empty_conditioning": { "name": "空條件" },
		"model": { "name": "model" },
		"neg_scale": { "name": "負向比例" },
		"negative": { "name": "負向" },
		"positive": { "name": "正向" }
...
var PhotoMakerLoader = {
	"display_name": "PhotoMaker 載入器",
	"inputs": { "photomaker_model_name": { "name": "photomaker_model_name" } },
	"outputs": { "0": { "tooltip": null } }
};
var PiDConditioning = {
	"description": "將 latent 及 degrade_sigma 純量附加到 PiD 解碼／升頻的 CONDITIONING",
	"display_name": "PiD 條件設定",
	"inputs": {
		"degrade_sigma": {
			"name": "degrade_sigma",
			"tooltip": "0 = 乾淨 latent。提高數值可去雜訊受損的 latent 輸出。"
		},
		"latent": {
			"name": "latent",
			"tooltip": "latent（來自 VAEEncode 或 KSampler）。"
		},
		"latent_format": {
			"name": "latent 格式",
			"tooltip": "Flux1 與 Flux2 latent 會自動從 channel 維度偵測，sd3 需手動選擇。"
		},
		"positive": { "name": "正向" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var PixverseImageToVideoNode = {
	...
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"duration_seconds": { "name": "持續秒數" },
		"image": { "name": "圖像" },
		"motion_mode": { "name": "動作模式" },
		"negative_prompt": {
			"name": "負向提示詞",
			"tooltip": "可選的文字描述，用於排除不希望出現在圖像中的元素。"
		},
		"pixverse_template": {
			"name": "PixVerse 樣板",
			"tooltip": "可選的樣板，由 PixVerse Template 節點建立，用於影響生成風格。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "用於影片生成的提示詞"
...
var PixverseTemplateNode = {
	"display_name": "PixVerse 範本",
	"inputs": { "template": { "name": "範本" } },
	"outputs": { "0": {
...
var PixverseTextToVideoNode = {
	"description": "根據提示詞與輸出尺寸同步生成影片。",
	"display_name": "PixVerse 文字轉影片",
	"inputs": {
		"aspect_ratio": { "name": "長寬比" },
		"control_after_generate": { "name": "生成後控制" },
		"duration_seconds": { "name": "影片長度（秒）" },
		"motion_mode": { "name": "動作模式" },
		"negative_prompt": {
			"name": "負向提示詞",
			"tooltip": "可選的文字描述，用於排除不希望出現在影像中的元素。"
		},
		"pixverse_template": {
			"name": "PixVerse 樣板",
			"tooltip": "可選的樣板，由 PixVerse Template 節點建立，用於影響生成風格。"
...
var PixverseTransitionVideoNode = {
	"description": "根據提示詞與輸出尺寸同步生成影片。",
	"display_name": "PixVerse 轉場影片",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"duration_seconds": { "name": "持續秒數" },
		"first_frame": { "name": "第一幀" },
		"last_frame": { "name": "最後一幀" },
		"motion_mode": { "name": "動作模式" },
		"negative_prompt": {
			"name": "負向提示詞",
			"tooltip": "可選的文字描述，用於排除不希望出現在影像中的元素。"
...
var Preview3D = {
	"description": "預覽 3D 模型檔案，無需儲存至 ComfyUI 輸出目錄。",
	"display_name": "3D 預覽",
	"inputs": {
...
var Preview3DAdvanced = {
	"description": "預覽 3D 模型檔案，無需儲存至 ComfyUI 輸出目錄。",
	"display_name": "3D 預覽（進階）",
	"inputs": {
		"camera_info": { "name": "camera_info" },
		"height": { "name": "高度" },
		"model_3d": {
			"name": "model_3d",
			"tooltip": "來自上游 3D 節點的 3D 模型檔案。"
		},
...
var PreviewAudio = {
	"description": "預覽音訊，無需儲存至 ComfyUI 輸出目錄。",
	"display_name": "預覽音訊",
	"inputs": {
		"audio": { "name": "音訊" },
		"audioUI": { "name": "音訊介面" }
...
var PreviewGaussianSplat = {
	"description": "預覽 gaussian splat 3D 檔案，無需儲存至 ComfyUI 輸出目錄。",
	"display_name": "預覽 Splat",
	"inputs": {
		"camera_info": { "name": "camera_info" },
		"height": { "name": "height" },
		"model_3d": {
			"name": "model_3d",
			"tooltip": "一個 gaussian splat 3D 檔案。"
		},
		"model_3d_info": { "name": "model_3d_info" },
		"viewport_state": { "name": "viewport_state" },
		"width": { "name": "width" }
...
var PreviewImage = {
	"description": "將輸入圖片儲存到您的 ComfyUI 輸出目錄。",
	"display_name": "預覽圖片",
	"inputs": { "images": { "name": "圖片" } },
	"outputs": { "0": { "name": "images" } }
};
var PreviewPointCloud = {
	"description": "預覽點雲 3D 檔案，無需儲存至 ComfyUI 輸出目錄。",
	"display_name": "預覽點雲",
	"inputs": {
		"camera_info": { "name": "camera_info" },
		"height": { "name": "height" },
...
var QuiverImageToSVGNode = {
	"description": "使用 Quiver AI 將點陣圖像向量化為 SVG。",
	"display_name": "Quiver 圖像轉 SVG",
	"inputs": {
		"auto_crop": {
			"name": "auto_crop",
			"tooltip": "自動裁切至主要主體。"
		...
		"seed": {
			"name": "seed",
			"tooltip": "決定節點是否重新執行的種子值；實際結果無論種子如何都不具決定性。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var QuiverTextToSVGNode = {
	"description": "使用 Quiver AI 根據文字提示生成 SVG。",
	"display_name": "Quiver 文字轉 SVG",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"instructions": {
			"name": "instructions",
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "對期望 SVG 輸出的文字描述。"
		},
		"reference_images": {
			"name": "reference_images",
			"tooltip": "最多 4 張參考圖像以輔助生成。"
		},
		"seed": {
			"name": "seed",
			"tooltip": "決定節點是否重新執行的種子值；實際結果無論種子如何都不具決定性。"
...
var RTDETR_detect = {
	"display_name": "RT-DETR 偵測",
	"inputs": {
		"class_name": {
			"name": "類別名稱",
			"tooltip": "依類別篩選偵測結果。設為 'all' 以停用篩選。"
		},
		"image": { "name": "圖像" },
		"max_detections": {
			"name": "最大偵測數",
			"tooltip": "每張圖像最多回傳的偵測數量，依信心分數由高至低排序。"
		},
		"model": { "name": "模型" },
		"threshold": { "name": "閾值" }
	},
...
var RecordAudio = {
	"display_name": "錄製音訊",
	"inputs": { "audio": { "name": "音訊" } },
	"outputs": { "0": { "tooltip": null } }
};
var RecraftColorRGB = {
	"description": "透過選擇特定的 RGB 數值來建立 Recraft 色彩。",
	"display_name": "Recraft 色彩 RGB",
	"inputs": {
		"b": {
			"name": "b",
			"tooltip": "色彩的藍色值。"
...
var RecraftControls = {
	"description": "建立 Recraft 控制項以自訂 Recraft 生成。",
	"display_name": "Recraft 控制項",
	"inputs": {
		"background_color": { "name": "背景顏色" },
		"colors": { "name": "顏色" }
	},
	"outputs": { "0": {
...
var RecraftCreateStyleNode = {
	"description": "從參考圖片建立自訂風格。上傳 1-5 張圖片作為風格參考。所有圖片的總大小限制為 5 MB。",
	"display_name": "Recraft 建立風格",
	"inputs": {
		"images": { "name": "圖片" },
		"style": {
			"name": "風格",
...
var RecraftCreativeUpscaleNode = {
	"description": "同步放大影像。\n使用「creative upscale」工具增強所提供的點陣影像，提升解析度，特別強化細節與人臉。",
	"display_name": "Recraft Creative 影像放大",
	"inputs": { "image": { "name": "影像" } },
	"outputs": { "0": { "tooltip": null } }
};
var RecraftCrispUpscaleNode = {
	"description": "同步放大圖片。\n使用「清晰放大」工具增強所提供的點陣圖，提升解析度，讓圖片更加銳利與乾淨。",
	"display_name": "Recraft 清晰放大圖片",
	"inputs": { "image": { "name": "圖片" } },
	"outputs": { "0": { "tooltip": null } }
};
var RecraftImageInpaintingNode = {
	"description": "根據提示詞與遮罩修改影像。",
	"display_name": "Recraft 影像修補",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"image": { "name": "影像" },
		"mask": { "name": "遮罩" },
		...
		"negative_prompt": {
			"name": "負向提示詞",
			"tooltip": "可選的文字描述，用於指定影像中不希望出現的元素。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "用於影像生成的提示詞。"
		},
		"recraft_style": { "name": "Recraft 風格" },
		"seed": {
			"name": "種子",
			"tooltip": "決定節點是否重新執行的種子；實際結果無論種子如何都不具決定性。"
		}
...
var RecraftImageToImageNode = {
	"description": "根據提示詞與強度修改影像。",
	"display_name": "Recraft 影像轉影像",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"image": { "name": "影像" },
		"n": {
		...
		"recraft_controls": {
			"name": "recraft 控制",
			"tooltip": "可選的額外控制，透過 Recraft Controls 節點進行生成調整。"
		},
		"recraft_style": { "name": "recraft 風格" },
		"seed": {
			"name": "種子值",
		...
		"strength": {
			"name": "強度",
			"tooltip": "定義與原始影像的差異，範圍為 [0, 1]，0 表示幾乎相同，1 表示極大差異。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var RecraftRemoveBackgroundNode = {
	"description": "從圖片中去除背景，並返回處理後的圖片與遮罩。",
	"display_name": "Recraft 去背",
	"inputs": { "image": { "name": "圖片" } },
	"outputs": {
		"0": { "tooltip": null },
		"1": { "tooltip": null }
...
var RecraftReplaceBackgroundNode = {
	"description": "根據提供的提示詞，替換圖片背景。",
	"display_name": "Recraft 更換背景",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"image": { "name": "影像" },
		"n": {
		...
		"negative_prompt": {
			"name": "負向提示詞",
			"tooltip": "可選的文字描述，用於指定圖片中不希望出現的元素。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "用於生成圖片的提示詞。"
		...
		"seed": {
			"name": "種子值",
			"tooltip": "用於決定節點是否重新執行的種子值；實際結果無論種子值如何都不具決定性。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var RecraftStyleV3DigitalIllustration = {
	"description": "選擇 realistic_image 風格及可選的子風格。",
	"display_name": "Recraft 風格 - 數位插畫",
	"inputs": { "substyle": { "name": "子風格" } },
	"outputs": { "0": {
		"name": "recraft_style",
		"tooltip": null
	} }
...
var RecraftStyleV3InfiniteStyleLibrary = {
	"description": "根據 Recraft 無限風格庫中已存在的 UUID 選擇風格。",
	"display_name": "Recraft 風格 - 無限風格庫",
	"inputs": { "style_id": {
		"name": "style_id",
		"tooltip": "來自無限風格庫的風格 UUID。"
	} },
	"outputs": { "0": {
		"name": "recraft_style",
		"tooltip": null
...
var RecraftStyleV3LogoRaster = {
	"description": "選擇 realistic_image 風格及可選的子風格。",
	"display_name": "Recraft Style - 標誌點陣圖",
	"inputs": { "substyle": { "name": "子風格" } },
	"outputs": { "0": {
		"name": "recraft_style",
		"tooltip": null
...
var RecraftTextToImageNode = {
	...
	"inputs": {
		...
		"negative_prompt": {
			"name": "負向提示詞",
			"tooltip": "可選的文字描述，用於指定圖像中不希望出現的元素。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "用於圖像生成的提示詞。"
		...
		"recraft_controls": {
			"name": "Recraft 控制",
			"tooltip": "透過 Recraft Controls 節點進行額外生成控制（可選）。"
		},
...
var RecraftTextToVectorNode = {
	"description": "根據提示詞與解析度同步產生 SVG。",
	"display_name": "Recraft 文字轉向量",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"n": {
			"name": "數量",
...
var ReferenceLatent = {
	"description": "此節點為編輯模型設定引導潛在空間。如果模型支援，您可以串聯多個節點來設定多個參考圖像。",
	"display_name": "參考潛在空間",
	"inputs": {
		"conditioning": { "name": "條件設定" },
		"latent": { "name": "潛在空間" }
...
var RegexExtract = {
	...
	"inputs": {
		"case_insensitive": { "name": "忽略大小寫" },
		"dotall": { "name": "點號匹配所有" },
		"group_index": { "name": "群組索引" },
		"mode": { "name": "模式" },
		"multiline": { "name": "多行模式" },
		"regex_pattern": { "name": "正則表達式模式" },
		"string": { "name": "字串" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var RegexMatch = {
	"display_name": "正則表達式匹配",
	"inputs": {
		"case_insensitive": { "name": "忽略大小寫" },
		"dotall": { "name": "點號匹配所有" },
		"multiline": { "name": "多行模式" },
...
var RegexReplace = {
	"description": "使用正則表達式模式尋找並替換文字。",
	"display_name": "正則表達式替換",
	"inputs": {
		"case_insensitive": { "name": "忽略大小寫" },
		"count": {
			"name": "計數",
			"tooltip": "最大替換次數。設為 0 可替換所有出現（預設值）。設為 1 僅替換第一個匹配，2 替換前兩個匹配，依此類推。"
		},
		"dotall": {
			"name": "點號匹配所有",
			"tooltip": "啟用時，點號（.）字符將匹配包括換行符在內的任何字符。停用時，點號不會匹配換行符。"
		},
		"multiline": { "name": "多行模式" },
		"regex_pattern": { "name": "正則表達式模式" },
		"replace": { "name": "替換內容" },
...
var RemoveBackground = {
	"description": "使用背景去除模型產生前景遮罩，以從圖像中移除背景。",
	"display_name": "移除背景",
	"inputs": {
		"bg_removal_model": {
...
var RenderSplat = {
	"description": "使用各向異性 EWA 光柵器將高斯 splat 渲染為影像（定向橢圓 splat，抗鋸齒，深度排序由前到後）。相機來自 camera_info 輸入（載入 / 預覽 3D，或建立 Camera Info 節點）；留空則自動框選 splat。將 frames 設為大於 1 可產生旋轉台批次影像，供 Video 節點使用。",
	"display_name": "渲染 Splat",
	"inputs": {
		"background": { "name": "背景" },
		"bg_image": {
			"name": "背景影像",
			"tooltip": "可選的背景底圖，合成於 splat 後方（會覆蓋實色背景）。會調整為渲染尺寸；批次時每幀一張，單張時全用同一張。僅適用於 color/clay。"
		},
		"camera_info": {
			"name": "camera_info",
			"tooltip": "渲染所用相機 - 來自 Load3D / Preview3D 相機或 Create Camera Info 節點。若留空，splat 會自動以預設 3/4 視角框選。"
		},
		"frames": {
			"name": "幀數",
			"tooltip": "-1、0、1 = 單張靜態影像；>1 = 旋轉台，相機繞 360 度旋轉（適用於任何 camera_info）。負值則反向旋轉。"
		},
		"headlight_shading": {
			"name": "頭燈光影",
			"tooltip": "來自相機（頭燈）的漫射光影，使用 splat 表面法線：轉離視角的表面會變暗，以顯示形體/曲率。0 = 平面反照率，1 = 最強光影。"
		},
		"height": { "name": "高度" },
		"opacity_threshold": {
			"name": "不透明度閾值",
			"tooltip": "剔除不透明度低於此值的高斯（移除微弱的漂浮點）。"
		},
		"render_style": {
			"name": "渲染樣式",
			"tooltip": "影像輸出顯示內容：color（顏色）、clay（中性反照率光影）、depth（近=亮）、normal（OpenGL 法線貼圖）。"
		},
		"sharpen": {
			"name": "銳化",
			"tooltip": "銳化重疊的 splat：1.0 = 物理正確混合；更高值會讓每個像素更偏向其主導（最近）的 splat，產生更銳利的紋理，但不會縮小 splat 或產生縫隙。超過 1 則非物理。"
		},
		"splat": { "name": "splat" },
		"splat_scale": {
			"name": "splat 縮放",
			"tooltip": "每個 splat 投影面積的乘數（較低 = 點更銳利，較高 = 表面更柔和/飽滿）。"
		},
		"width": { "name": "寬度" }
	},
	"outputs": {
...
var ReplaceVideoLatentFrames = {
	...
	"inputs": {
		"destination": {
			"name": "destination",
			"tooltip": "要被取代幀的目標 latent。"
		},
		"index": {
			"name": "index",
			"tooltip": "來源 latent 幀將插入目標 latent 的起始幀索引。負值則從結尾倒數計算。"
		},
		"source": {
			"name": "source",
			"tooltip": "提供要插入目標 latent 幀的來源 latent。如果未提供，則返回未更動的目標 latent。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var ResizeAndPadImage = {
	"display_name": "調整尺寸並填充圖像",
	"inputs": {
		"image": { "name": "圖像" },
		"interpolation": { "name": "插值方法" },
		"padding_color": { "name": "填充顏色" },
		"target_height": { "name": "目標高度" },
		"target_width": { "name": "目標寬度" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var ResizeImageMaskNode = {
	"description": "使用各種縮放方法調整圖像或 mask 的大小。",
	"display_name": "調整影像／遮罩大小",
	"inputs": {
		"input": { "name": "input" },
		"resize_type": {
			"name": "resize_type",
			"tooltip": "選擇調整大小的方式：依照精確尺寸、縮放比例、匹配其他圖像等。"
		},
		"resize_type_crop": { "name": "裁切" },
		"resize_type_height": { "name": "高度" },
		"resize_type_width": { "name": "寬度" },
		"scale_method": {
			"name": "scale_method",
			"tooltip": "插值演算法。'area' 適合縮小，'lanczos' 適合放大，'nearest-exact' 適合像素藝術。"
		}
	},
	"outputs": { "0": {
		"name": "resized",
...
var ResizeImagesByLongerEdge = {
	"description": "將圖像較長邊縮放至指定尺寸，並保持長寬比。",
	"display_name": "依較長邊調整圖片尺寸",
	"inputs": {
		"images": {
			"name": "images",
			"tooltip": "要處理的圖片。"
...
var ResizeImagesByShorterEdge = {
	"description": "調整圖像大小，使較短的邊緣符合指定尺寸，同時保持長寬比。",
	"display_name": "依較短邊調整圖片尺寸",
	"inputs": {
		"images": {
			"name": "images",
			"tooltip": "要處理的圖片。"
...
var ResolutionBucket = {
	"description": "將 latent 和 conditioning 分組到不同的桶中",
	"display_name": "解析度分桶",
	"inputs": {
		"conditioning": {
			"name": "conditioning",
			"tooltip": "條件列表（必須與 latents 長度相同）。"
		},
		"latents": {
			"name": "latents",
			"tooltip": "依解析度分桶的 latent 字典列表。"
		}
	},
	"outputs": {
		"0": {
			"name": "latents",
			"tooltip": "每個解析度分桶的 batched latent 字典列表。"
		},
		"1": {
			"name": "conditioning",
			"tooltip": "每個解析度分桶的條件列表。"
		}
	}
};
var ResolutionSelector = {
	"description": "根據長寬比與百萬像素目標計算寬度與高度。適合用於設定 Empty Latent Image 的尺寸。",
	"display_name": "解析度選擇器",
	"inputs": {
		"aspect_ratio": {
			"name": "長寬比",
		...
		"megapixels": {
			"name": "百萬像素",
			"tooltip": "目標總百萬像素。1.0 MP ≈ 1024×1024（正方形）。"
		},
		"multiple": {
			"name": "倍數",
			"tooltip": "將所選解析度設為結果的最接近倍數。"
		}
	},
	"outputs": {
		"0": {
			"name": "寬度",
			"tooltip": "計算後的像素寬度（8 的倍數）。"
		},
		"1": {
			"name": "高度",
			"tooltip": "計算後的像素高度（8 的倍數）。"
		}
	}
};
var ReveImageCreateNode = {
	...
	"inputs": {
		...
		"model_aspect_ratio": { "name": "長寬比" },
		"model_test_time_scaling": { "name": "測試時縮放" },
		"prompt": {
			"name": "提示詞",
...
var Rodin3D_Detail = {
	...
	"inputs": {
		"Images": { "name": "圖像" },
		"Material_Type": { "name": "材質類型" },
		"Polygon_count": { "name": "多邊形數量" },
		"Seed": { "name": "種子值" }
	},
	"outputs": {
		"0": {
...
var Rodin3D_Gen2 = {
	"description": "使用 Rodin API 生成 3D 資源",
	"display_name": "Rodin 3D 生成 - Gen-2 生成",
	"inputs": {
		"Images": { "name": "圖像" },
		"Material_Type": { "name": "材質類型" },
		"Polygon_count": { "name": "多邊形數量" },
...
var Rodin3D_Gen25_Image = {
	"description": "透過 Rodin Gen-2.5，從 1-5 張參考圖像生成 3D 模型。選擇模式（快速／標準／極高）以調整品質與成本。",
	"display_name": "Rodin 3D Gen-2.5 - 圖像轉 3D",
	"inputs": {
		"TAPose": {
			"name": "TAPose",
			"tooltip": "人形模型的 T/A 姿勢。"
		},
		"addon_highpack": {
			"name": "addon_highpack",
			"tooltip": "HighPack 附加功能：4K 材質與 Quad 模式下約 16 倍面數。"
		},
		"bbox_height": {
			"name": "bbox_height",
			"tooltip": "包圍盒高度（Z 軸）。"
		...
		"bbox_width": {
			"name": "bbox_width",
			"tooltip": "包圍盒寬度（Y 軸）。與其他設為 0 可跳過包圍盒。"
		},
		"control_after_generate": { "name": "control after generate" },
		...
		"height_cm": {
			"name": "height_cm",
			"tooltip": "模型大約高度（公分，0 為跳過）。"
		},
		"images": {
			"name": "images",
			"tooltip": "1-5 張圖像。多視角時，第一張圖像用於材質。"
		},
		"material": { "name": "material" },
		"mode": {
			"name": "mode",
			"tooltip": "生成模式。標準＝平衡。快速＝1K-20K 面，適合快速原型。極高＝20K-2M 面，可選微細節。"
		},
		...
		"texture_mode": {
			"name": "texture_mode",
			"tooltip": "材質品質預設。『預設』會使用伺服器針對所選等級的預設值。"
		},
		"use_original_alpha": {
...
var Rodin3D_Gen25_Text = {
	"description": "透過 Rodin Gen-2.5，根據文字提示生成 3D 模型。請選擇模式（快速 / 標準 / 極高）以調整品質與成本。",
	"display_name": "Rodin 3D Gen-2.5 - 文字轉3D",
	"inputs": {
		"TAPose": {
			"name": "T/A 姿勢",
			"tooltip": "適用於類人模型的 T/A 姿勢。"
		},
		"addon_highpack": {
			"name": "HighPack 附加包",
			"tooltip": "HighPack 附加包：4K 材質與 Quad 模式下約 16 倍面數。"
		},
		"bbox_height": {
			"name": "包圍盒高度",
			"tooltip": "包圍盒高度（Z 軸）。"
		...
		"control_after_generate": { "name": "生成後控制" },
		"geometry_file_format": { "name": "幾何檔案格式" },
		"hd_texture": {
			"name": "高畫質材質",
			"tooltip": "高品質材質增強。"
		},
		"height_cm": {
			"name": "模型高度（公分）",
			"tooltip": "模型大約高度（公分，0 表示略過）。"
		},
		"material": { "name": "材質" },
		"mode": {
			"name": "模式",
			"tooltip": "生成模式。標準 = 平衡。快速 = 1K-20K 面數，適合快速原型。極高 = 20K-2M 面數，可選微細節。"
		},
		"mode_creative": { "name": "創意" },
		"mode_polygon_count": { "name": "多邊形數" },
		"mode_tier": { "name": "等級" },
		"prompt": {
			"name": "提示詞",
			"tooltip": "3D 模型的文字提示。"
...
var RunwayAleph2KeyframeNode = {
	"description": "將引導圖片錨定於輸入（來源）影片的某一時刻，讓 Aleph2 在該時刻引導編輯。請將此節點連接至 Runway Aleph2 影片轉影片節點的「keyframes」輸入；可透過下方的「keyframes」選填輸入串接多個（最多 5 個）。",
	"display_name": "Runway Aleph2 關鍵影格",
	"inputs": {
		"image": {
			"name": "圖片",
			"tooltip": "要在輸入影片指定時刻套用的引導圖片。"
		},
		"keyframes": {
			"name": "keyframes",
			"tooltip": "可選的前一個關鍵影格，用於串接。"
		},
		"timing": {
			"name": "時機",
			"tooltip": "如何將此圖片放置於輸入影片的時間軸上。"
		},
		"timing_seconds": { "name": "秒數" }
	},
	"outputs": { "0": {
		"name": "keyframes",
		"tooltip": null
...
var RunwayAleph2PromptImageNode = {
	"description": "將引導圖片錨定於輸出（結果）影片的某一時刻，以引導該時刻的影片外觀。請將此節點連接至 Runway Aleph2 影片轉影片節點的「prompt_images」輸入；可透過下方的「prompt_images」選填輸入串接多個（最多 5 個）。",
	"display_name": "Runway Aleph2 提示圖片",
	"inputs": {
		"image": {
			"name": "圖片",
			"tooltip": "要在輸出影片指定時刻放置的引導圖片。"
		},
		"position": {
			"name": "位置",
			"tooltip": "如何將此圖片放置於輸出影片的時間軸上。"
		},
		"position_seconds": { "name": "秒數" },
		"prompt_images": {
			"name": "prompt_images",
			"tooltip": "可選的前一個提示圖片，用於串接。"
		}
	},
	"outputs": { "0": {
		"name": "prompt_images",
...
var RunwayAleph2VideoToVideoNode = {
	"description": "使用 Runway 的 Aleph2 模型，透過文字提示編輯影片。Aleph2 可在保留原始動作與時序的同時，轉換您的影片（重新風格化、重新打光、添加或移除元素、改變視角）；輸出解析度與輸入影片相同，輸入影片需為 2-30 秒、30 fps 或更低。可選擇以關鍵影格（錨定於輸入影片）或提示圖像（錨定於輸出影片）引導編輯——請擇一使用，不可同時使用。",
	"display_name": "Runway Aleph2 影片轉影片",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"keyframes": {
			"name": "關鍵影格",
			"tooltip": "錨定於輸入影片的引導圖像，來自 Aleph2 Keyframe 節點（最多 5 張）。請擇一使用關鍵影格或提示圖像，不可同時使用。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "描述輸出中應出現的內容（1-1000 字元）。"
		},
		"prompt_images": {
			"name": "提示圖像",
			"tooltip": "錨定於輸出影片的引導圖像，來自 Aleph2 Prompt Image 節點（最多 5 張）。請擇一使用關鍵影格或提示圖像，不可同時使用。"
		},
		"public_figure_threshold": {
			"name": "公眾人物辨識門檻",
			"tooltip": "對可辨識公眾人物進行內容審查。"
		},
		"seed": {
			"name": "隨機種子",
			"tooltip": "生成用的隨機種子"
		...
		"video": {
			"name": "影片",
			"tooltip": "要編輯的輸入影片。必須為 2-30 秒、30 fps 或更低。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var RunwayFirstLastFrameNode = {
	...
	"display_name": "Runway 首尾幀轉影片",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"duration": { "name": "持續時間" },
		"end_frame": {
			"name": "結束幀",
			"tooltip": "用於影片的結束幀。僅支援 gen3a_turbo。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "生成用的文字提示詞"
...
var RunwayImageToVideoNodeGen3a = {
	"description": "使用 Gen3a Turbo 模型從單一起始幀生成影片。開始前，請先閱讀這些最佳實踐指南，確保您的輸入選擇能為生成成功奠定基礎：https://help.runwayml.com/hc/en-us/articles/33927968552339-Creating-with-Act-One-on-Gen-3-Alpha-and-Turbo。",
	"display_name": "Runway 圖片轉影片 (Gen3a Turbo)",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"duration": { "name": "持續時間" },
		"prompt": {
...
var RunwayImageToVideoNodeGen4 = {
	"description": "使用 Gen4 Turbo 模型從單一起始幀生成影片。開始前，請先閱讀這些最佳實踐指南，確保您的輸入選擇能為生成成功奠定基礎：https://help.runwayml.com/hc/en-us/articles/37327109429011-Creating-with-Gen-4-Video。",
	"display_name": "Runway 圖片轉影片 (Gen4 Turbo)",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"duration": { "name": "duration" },
		"prompt": {
...
var RunwayTextToImageNode = {
	"description": "使用 Runway 的 Gen 4 模型從文字提示生成圖像。您也可以包含參考圖像來引導生成過程。",
	"display_name": "Runway 文字轉圖像",
	"inputs": {
		"prompt": {
			"name": "prompt",
			"tooltip": "用於生成的文字提示"
		...
		"reference_image": {
			"name": "reference_image",
			"tooltip": "可選的參考圖像，用於引導生成過程"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var SAM3_Detect = {
	"display_name": "SAM3 偵測",
	"inputs": {
		"bboxes": {
			"name": "邊界框",
			"tooltip": "要分割的區域邊界框"
		...
		"conditioning": {
			"name": "條件",
			"tooltip": "來自 CLIPTextEncode 的文字條件"
		},
		"image": { "name": "影像" },
		"individual_masks": {
			"name": "個別 mask",
			"tooltip": "輸出每個物件的 mask，而非合併"
		},
		"model": { "name": "model" },
		"negative_coords": {
			"name": "負向座標",
			"tooltip": "負向點提示，格式為 JSON [{\"x\": int, \"y\": int}, ...]（像素座標）"
		},
		"positive_coords": {
			"name": "正向座標",
			"tooltip": "正向點提示，格式為 JSON [{\"x\": int, \"y\": int}, ...]（像素座標）"
		},
		"refine_iterations": {
			"name": "細化次數",
			"tooltip": "SAM 解碼器細化次數（0=使用原始偵測器 mask）"
		},
		"threshold": { "name": "閾值" }
	},
	"outputs": {
...
var SAM3_TrackPreview = {
	"display_name": "SAM3 追蹤預覽",
	"inputs": {
		"fps": { "name": "每秒影格數" },
		"images": { "name": "影像" },
		"opacity": { "name": "不透明度" },
		"track_data": { "name": "追蹤資料" }
	}
};
var SAM3_TrackToMask = {
	"display_name": "SAM3 追蹤轉 mask",
	"inputs": {
		"object_indices": {
			"name": "物件索引",
			"tooltip": "要包含的物件索引（以逗號分隔，例如 '0,2,3'）。空白=所有物件。"
		},
		"track_data": { "name": "追蹤資料" }
	},
	"outputs": { "0": {
...
var SAM3_VideoTrack = {
	"display_name": "SAM3 影片追蹤",
	"inputs": {
		"conditioning": {
			"name": "條件",
			"tooltip": "追蹤期間偵測新物件的文字條件"
		},
		"detect_interval": {
			"name": "偵測間隔",
			"tooltip": "每 N 個影格執行一次偵測（1=每個影格）。數值越高越省運算資源。"
		},
		"detection_threshold": {
			"name": "偵測閾值",
			"tooltip": "文字提示偵測的分數閾值"
		...
		"initial_mask": {
			"name": "初始 mask",
			"tooltip": "第一個影格要追蹤的 mask（每個物件一個）"
		},
		"max_objects": {
			"name": "最大物件數",
			"tooltip": "最多追蹤物件數（0=無限制）。初始 mask 也計入此限制。"
		},
		"model": { "name": "model" }
	},
	"outputs": { "0": {
...
var SCAIL2ColoredMask = {
	"display_name": "建立 SCAIL-2 彩色遮罩",
	"inputs": {
		"driving_track_data": {
			"name": "驅動追蹤資料",
			"tooltip": "驅動姿勢影片的 SAM3 追蹤。將會渲染到 pose_video_mask 輸出。"
		},
		"object_indices": {
			"name": "物件索引",
			"tooltip": "要包含的人員索引，以逗號分隔（例如 '0,2,3'）。會套用於參考與姿勢影片遮罩。留空代表全部。"
		},
		"ref_track_data": {
			"name": "參考追蹤資料",
			"tooltip": "參考圖像的 SAM3 追蹤。"
		},
		"replacement_mode": {
			"name": "替換模式",
			"tooltip": "False = mask_video 為黑色背景（動畫模式）。True = 白色背景（替換模式）。請在 WanSCAILToVideo 設定相同的 replacement_mode。reference_image_mask 一律為黑色背景。"
		},
		"sort_by": {
			"name": "排序方式",
			"tooltip": "調色盤顏色分配給追蹤物件的順序（同時套用於參考與姿勢影片，確保每個身份保持同色）。left_to_right = 最左邊物件（以首幀重心）獲得第一個顏色；area = 最大物件（以首幀遮罩面積）獲得第一個顏色；none = 保持 SAM3 的順序。"
		}
	},
	"outputs": {
		"0": {
...
var SDPoseKeypointExtractor = {
	"description": "使用 SDPose 模型從影像中提取姿勢關鍵點：https://huggingface.co/Comfy-Org/SDPose/tree/main/checkpoints",
	...
	"outputs": { "0": {
		"name": "keypoints",
		"tooltip": "以 OpenPose 幀格式（canvas_width, canvas_height, people）表示的關鍵點"
	} }
};
...
var SUPIRApply = {
	...
	"inputs": {
		...
		"restore_cfg": {
			"name": "restore_cfg",
			"tooltip": "將去噪後的輸出拉回輸入 latent。數值越高，越忠於輸入。設為 0 則停用。"
		},
		"restore_cfg_s_tmin": {
			"name": "restore_cfg_s_tmin",
			"tooltip": "低於此 sigma 閾值時，restore_cfg 會停用。"
		},
		"strength_end": {
			"name": "strength_end",
			"tooltip": "控制取樣結束時（低 sigma）的強度。從開始值線性插值。"
		},
		"strength_start": {
			"name": "strength_start",
			"tooltip": "控制取樣開始時（高 sigma）的強度。"
		},
		"vae": { "name": "vae" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var SV3D_Conditioning = {
	...
	"inputs": {
		...
		"elevation": { "name": "仰角" },
		"height": { "name": "高度" },
		"init_image": { "name": "初始影像" },
		"vae": { "name": "vae" },
		"video_frames": { "name": "影片幀數" },
		"width": { "name": "寬度" }
	},
	"outputs": {
		"0": {
...
var SVD_img2vid_Conditioning = {
	...
	"inputs": {
		"augmentation_level": { "name": "增強等級" },
		"clip_vision": { "name": "clip_vision" },
		"fps": { "name": "每秒幀數 (FPS)" },
		"height": { "name": "高度" },
		"init_image": { "name": "初始影像" },
		"motion_bucket_id": { "name": "動作分組 ID" },
		"vae": { "name": "vae" },
		"video_frames": { "name": "影片幀數" },
		"width": { "name": "寬度" }
	},
...
var SamplerARVideo = {
	"display_name": "Sampler AR 視訊",
	"inputs": { "num_frame_per_block": {
		"name": "每區塊影格數",
		"tooltip": "每個自回歸區塊的影格數。1 = 逐影格，3 = 區塊方式。必須與 checkpoint 的訓練模式相符。"
	} },
	"outputs": { "0": { "tooltip": null } }
};
var SamplerCustom = {
...
var SamplerER_SDE = {
	...
	"inputs": {
		"eta": {
			"name": "eta",
			"tooltip": "反向時間 SDE 的隨機強度。\n當 eta=0 時，它簡化為確定性 ODE。此設定不適用於 ER-SDE 求解器類型。"
		},
...
var SamplingPercentToSigma = {
	...
	"inputs": {
		...
		"return_actual_sigma": {
			...
			"tooltip": "返回實際的 sigma 值，而非用於區間檢查的值。\n這僅影響 0.0 和 1.0 處的結果。"
		},
...
var SaveAudioAdvanced = {
	"description": "將輸入的音訊儲存到你的 ComfyUI 輸出目錄。",
	"display_name": "儲存音訊（進階）",
	"inputs": {
		"audio": {
			"name": "audio",
			"tooltip": "要儲存的音訊。"
		...
		"filename_prefix": {
			...
			"tooltip": "要儲存檔案的前綴。可包含格式化標記，例如 %date:yyyy-MM-dd%。"
		},
		"format": {
			"name": "format",
			"tooltip": "儲存音訊的檔案格式。"
...
var SaveImage = {
	"description": "將輸入的圖片儲存到您的 ComfyUI 輸出目錄。",
	"display_name": "儲存圖片",
	"inputs": {
		"filename_prefix": {
			"name": "檔名前綴",
...
var SaveImageAdvanced = {
	"description": "將輸入的影像儲存到你的 ComfyUI 輸出目錄。",
	"display_name": "儲存影像（進階）",
	"inputs": {
		"filename_prefix": {
			"name": "檔名字首",
			"tooltip": "要儲存檔案的字首。可包含格式化標記，例如 %date:yyyy-MM-dd% 或 %Empty Latent Image.width%。"
		},
		"format": {
			"name": "格式",
			"tooltip": "儲存影像時使用的檔案格式。"
		},
		"format_bit_depth": { "name": "位元深度" },
		"format_input_color_space": { "name": "輸入色彩空間" },
		"images": {
			"name": "影像",
			"tooltip": "要儲存的影像。"
		}
...
var SaveImageDataSetToFolder = {
	"description": "將圖像資料集儲存到指定資料夾。支援格式：PNG。",
	"display_name": "儲存影像資料集到資料夾",
	"inputs": {
		"filename_prefix": {
			"name": "filename_prefix",
			"tooltip": "儲存影像檔名的前綴。"
		...
		"mode": {
			"name": "模式",
			"tooltip": "選擇是否覆蓋現有檔案，或自動遞增檔名以避免覆蓋。"
		}
	}
};
var SaveImageTextDataSetToFolder = {
	"description": "將圖像與文字標題配對的資料集儲存到指定資料夾。圖像以 PNG 檔案儲存，標題以相同檔名前綴的 TXT 檔案儲存。",
	"display_name": "儲存影像與文字資料集到資料夾",
	"inputs": {
		"filename_prefix": {
			"name": "filename_prefix",
			"tooltip": "儲存影像檔名的前綴。"
...
var SaveLoRA = {
	...
	"inputs": {
		...
		"prefix": {
			"name": "prefix",
			"tooltip": "儲存 LoRA 檔案時使用的前綴。"
		},
		"steps": {
			"name": "steps",
			"tooltip": "選填：LoRA 訓練的步數，將用於命名儲存檔案。"
		}
	}
};
var SavePointCloud = {
...
var SaveSVGNode = {
	...
	"inputs": {
		"filename_prefix": {
			"name": "檔案名稱前綴",
			"tooltip": "要儲存檔案的前綴。可包含格式化資訊，例如 %date:yyyy-MM-dd% 或 %Empty Latent Image.width% 以包含來自節點的值。"
		},
		"svg": { "name": "svg" }
	},
	"outputs": { "0": {
...
var SaveTrainingDataset = {
	"description": "將已編碼的訓練資料集（latent + conditioning）儲存到磁碟，以便訓練時高效載入。",
	"display_name": "儲存訓練資料集",
	"inputs": {
		"conditioning": {
			"name": "conditioning",
			"tooltip": "來自 MakeTrainingDataset 的 conditioning 清單。"
		},
		"folder_name": {
			"name": "folder_name",
			"tooltip": "要儲存資料集的資料夾名稱（於輸出目錄內）。"
		},
		"latents": {
			"name": "latents",
			"tooltip": "來自 MakeTrainingDataset 的 latent 字典清單。"
		},
		"shard_size": {
			"name": "shard_size",
			"tooltip": "每個分片檔案的樣本數。"
...
var SaveWEBM = {
	...
	"inputs": {
		...
		"crf": {
			"name": "CRF",
			"tooltip": "CRF 值越高，畫質越低但檔案較小；CRF 值越低，畫質越高但檔案較大。"
		},
		"filename_prefix": { "name": "檔名前綴" },
		"fps": { "name": "每秒影格數" },
		"images": {
			"name": "images",
			"tooltip": "RGBA 影像將以 alpha 通道作為透明度儲存（僅限 vp9 編解碼器）。"
		}
	},
	"outputs": { "0": {
		"name": "images",
...
var SeedVR2Conditioning = {
	"description": "從 VAE latent 建立 SeedVR2 正/負 conditioning。",
	"display_name": "套用 SeedVR2 Conditioning",
	"inputs": {
		"model": {
			"name": "model",
			"tooltip": "SeedVR2 模型。"
	...
	"outputs": {
		"0": {
			"name": "positive",
			"tooltip": "用於取樣的正向 conditioning。"
		},
		"1": {
			"name": "negative",
			"tooltip": "用於取樣的負向 conditioning。"
		}
	}
};
var SeedVR2PostProcessing = {
	"description": "將生成的影像與原始調整尺寸後的影像對齊，並套用色彩校正。",
	"display_name": "後處理 SeedVR2 輸出",
	"inputs": {
		"color_correction_method": {
			"name": "color_correction_method",
			"tooltip": "將生成影像色彩匹配到原始影像的方法。lab：在 CIELAB 空間轉換色彩，保留細節（最忠實）。wavelet：轉換低頻色彩，保留升頻後的高頻細節。adain：匹配每通道平均值/標準差（最快，整體色調）。none：跳過色彩轉換（僅幾何對齊）。"
		},
		"images": {
			"name": "images",
			"tooltip": "要處理的生成影像。"
...
var SeedVR2Preprocess = {
	"description": "為 SeedVR2 模型填充調整尺寸後的影像。Alpha 通道會被移除。Post-Process SeedVR2 Output 節點會從原始調整尺寸影像重新套用 Alpha 通道。",
	"display_name": "預處理 SeedVR2 輸入",
	...
	"outputs": { "0": {
		"name": "images",
		"tooltip": "用於 VAE 編碼的填充影像。"
	} }
};
var SeedVR2TemporalChunk = {
	"description": "將 SeedVR2 影片 latent 分割為重疊的時間區塊，每次僅取一個區塊以適應 VRAM，將 latents 輸出同時連接到 Apply SeedVR2 Conditioning 及取樣器 latent 輸入，最後用 Merge SeedVR2 Latents 合併。",
	"display_name": "分割 SeedVR2 latent",
	"inputs": {
		"chunking_mode": {
			"name": "chunking_mode",
			"tooltip": "manual = 精確使用 frames_per_chunk；auto = 預測可容納於 VRAM 的最大區塊。"
		},
		"latent": {
			"name": "latent",
			"tooltip": "要分割的 VAE 編碼 SeedVR2 latent。"
		},
		"temporal_overlap": {
			"name": "temporal_overlap",
			"tooltip": "相鄰區塊間共享的 latent 幀數，合併時進行交叉淡化；0 代表無重疊。"
		}
	},
	"outputs": {
		"0": {
		...
		"1": {
			"name": "temporal_overlap",
			"tooltip": "相鄰區塊間實際的 latent 幀重疊數，供 Merge SeedVR2 Latents 使用。"
		}
	}
};
var SeedVR2TemporalMerge = {
	"description": "將已取樣的 SeedVR2 latent 時間區塊重新組合為一個 latent，並以 Hann 窗函數根據 Split SeedVR2 Latent 輸出的 temporal_overlap 進行交叉淡化。",
	"display_name": "合併 SeedVR2 latents",
	"inputs": {
		"latents": {
			"name": "latents",
			"tooltip": "依序排列的已取樣時間區塊。"
		},
		"temporal_overlap": {
			"name": "temporal_overlap",
			"tooltip": "Split SeedVR2 Latent 的 temporal_overlap 輸出。0 代表直接串接。"
		}
	},
	"outputs": { "0": {
		"name": "latent",
		"tooltip": "重新組合後的完整 latent。"
	} }
};
var SelectCLIPDevice = {
	"description": "將 CLIP 文字編碼器放置於指定裝置（default / cpu / gpu:N）。\n\n- 「default」會還原為載入器分配的裝置。\n- 「cpu」會將載入與卸載裝置都固定於 CPU。\n- 「gpu:N」會將載入裝置固定於第 N 張可用 GPU。\n\n當所選裝置在目前機器上不存在時\n（例如在 2-GPU 機器建立的工作流程於 1-GPU 機器開啟），\n此節點會直接傳遞 CLIP 並記錄訊息，而不會導致失敗。",
	"display_name": "選擇 CLIP 裝置",
	"inputs": {
		"clip": { "name": "clip" },
		"device": { "name": "device" }
	},
...
var SelectModelDevice = {
	"description": "將 diffusion 模型放置於指定裝置（default / cpu / gpu:N）。\n\n- 「default」會還原為載入器分配的裝置（即使在先前已呼叫過 Select Model Device 後）。\n- 「cpu」會將載入與卸載裝置都固定於 CPU。\n- 「gpu:N」會將載入裝置固定於第 N 張可用 GPU；卸載裝置則還原為載入器的原始選擇。\n\n當所要求的裝置與輸入模型目前所在裝置不同時，會透過載入器的 reload factory（cached_patcher_init）產生新的模型，讓新的 patcher 在新裝置上擁有獨立權重。不支援多 GPU 的載入器（無 factory）會使此節點直接傳遞且顯示警告。\n\n若工作流程已套用多 GPU CFG 分割，且所選 GPU 與現有 multigpu 複本衝突，該複本會被移除，以避免兩個 patcher 綁定於同一裝置。\n\n當所選裝置在目前機器上不存在時\n（例如在 2-GPU 機器建立的工作流程於 1-GPU 機器開啟），\n此節點會直接傳遞模型並記錄訊息，而不會導致失敗。\n\n注意：將 Select Model Device 放在已經消耗過同一模型的節點（例如已在原始裝置上執行過的 KSampler）之後並不建議——若所選裝置與原始裝置相同（快速路徑），則先前消費者對原始模型所做的任何狀態變更都會被觀察到。請將 Select Model Device 放在任何模型消費者之前。",
	"display_name": "選擇模型裝置",
	"inputs": {
		"device": { "name": "device" },
		"model": { "name": "model" }
...
var SelectVAEDevice = {
	"description": "將 VAE 放置於特定裝置（default / gpu:N）。\n\n- 「default」會還原為載入器分配的裝置。\n- 「gpu:N」會將載入裝置固定於第 N 個可用 GPU；卸載裝置則設為標準 VAE 卸載裝置。\n\nUI 中刻意不提供 CPU 作為 VAE 的選項；如果工作流程仍然提供「cpu」（例如從其他機器開啟），該請求會被記錄並略過，VAE 會保持不變。\n\n當所選裝置在目前機器上不存在時（例如在 2-GPU 機器上建立的工作流程於 1-GPU 機器上開啟），此節點會保持 VAE 不變並記錄訊息，而不會導致失敗。",
	"display_name": "選擇 VAE 裝置",
	"inputs": {
		"device": { "name": "裝置" },
		"vae": { "name": "vae" }
	},
...
var SelfAttentionGuidance = {
	"display_name": "自我注意力引導",
	"inputs": {
		"blur_sigma": { "name": "模糊標準差" },
		"model": { "name": "model" },
		"scale": { "name": "強度" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var SetClipHooks = {
	"display_name": "設定 CLIP 掛鉤",
	"inputs": {
		"apply_to_conds": { "name": "套用至條件" },
		"clip": { "name": "clip" },
		"hooks": { "name": "hooks" },
		"schedule_clip": { "name": "排程 clip" }
	}
};
var SetFirstSigma = {
...
var ShuffleDataset = {
	"description": "隨機打亂圖像清單中的順序。",
	"display_name": "隨機重排影像資料集",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"images": {
			"name": "images",
...
var ShuffleImageTextDataset = {
	"description": "隨機打亂圖像與文字配對清單中的順序。",
	"display_name": "隨機重排影像-文字資料集",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"images": {
			"name": "images",
...
var ShuffleVideoDataset = {
	"description": "隨機打亂影片清單的順序。",
	"display_name": "隨機排序影片清單",
	"inputs": {
		"control_after_generate": { "name": "產生後控制" },
		"seed": {
			"name": "隨機種子",
...
var ShuffleVideoTextDataset = {
	"description": "隨機打亂影片-文字配對清單的順序。",
	"display_name": "隨機排序影片-文字配對",
	"inputs": {
		"control_after_generate": { "name": "產生後控制" },
		"seed": {
			"name": "隨機種子",
...
var SkipLayerGuidanceDiT = {
	"description": "可用於所有 DiT 模型的通用 SkipLayerGuidance 節點版本。",
	"display_name": "跳過層引導 DiT",
	"inputs": {
		"double_layers": { "name": "雙層" },
		"end_percent": { "name": "結束百分比" },
		"model": { "name": "model" },
		"rescaling_scale": { "name": "重新縮放比例" },
		"scale": { "name": "縮放" },
		"single_layers": { "name": "單層" },
		"start_percent": { "name": "起始百分比" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var SkipLayerGuidanceDiTSimple = {
	"description": "僅修改無條件傳遞的 SkipLayerGuidanceDiT 節點簡易版本。",
	"display_name": "跳層引導DiT簡易版",
	"inputs": {
		"double_layers": { "name": "雙層" },
		"end_percent": { "name": "結束百分比" },
		"model": { "name": "模型" },
...
var SoniloTextToMusic = {
	...
	"display_name": "Sonilo 文字轉音樂",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"duration": {
			"name": "duration",
			"tooltip": "目標時長（秒）。設為 0 讓模型自動從提示推斷時長。最長 6 分鐘。"
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "描述要產生音樂的文字提示。"
		},
		"seed": {
			"name": "seed",
			"tooltip": "用於重現性的種子。目前 Sonilo 服務會忽略此值，但為了流程一致性保留。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var SoniloVideoToMusic = {
	"description": "使用 Sonilo 的 AI 模型，從影片內容產生音樂。分析影片並創作相符的音樂。",
	"display_name": "Sonilo 影片轉音樂",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"prompt": {
			"name": "prompt",
			"tooltip": "可選的文字提示，用於引導音樂生成。留空可獲得最佳品質——模型將完整分析影片內容。"
		},
		"seed": {
			"name": "seed",
			"tooltip": "用於重現性的種子。目前 Sonilo 服務會忽略此值，但為了流程一致性保留。"
		...
		"video": {
			"name": "video",
			"tooltip": "輸入要產生音樂的影片。最長 6 分鐘。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var SplatToFile3D = {
	"description": "將高斯 splat 序列化為 File3D 物件，供 Save / Preview 3D 節點使用。僅支援每批次一項。",
	"display_name": "建立 3D 檔案（由 Splat）",
	"inputs": {
		"format": {
			"name": "格式",
			"tooltip": "ply：標準 3D Gaussian Splat，含完整球面諧波。ksplat：mkkellogg SplatBuffer（等級 0，未壓縮），僅基礎色 spz：Niantic gzip 壓縮（約小 10 倍），僅基礎色"
		},
		"splat": { "name": "splat" }
	},
	"outputs": { "0": {
...
var SplatToMesh = {
	"description": "從高斯 splat 擷取帶有顏色的網格。",
	"display_name": "從 Splat 擷取網格",
	"inputs": {
		"color_sharpen": {
			"name": "顏色銳化",
			"tooltip": "使頂點紋理更清晰：1.0 = 物理正確混合；更高則使每個體素的顏色偏向其主導高斯而非鄰近平均（減少紋理模糊）。僅影響顏色，不改變幾何。"
		},
		"kernel": {
			"name": "核心",
			"tooltip": "最大 splat 半寬（以體素為單位）。每個高斯會在以自身 3-sigma 為大小的視窗內光柵化，最大值由此設定——小的 surfel 保持高效，大的則不會被截斷。如稀疏 splat 出現空隙可提高此值。"
		},
		"level": {
			"name": "等值面層級",
			"tooltip": "等值面層級。預設由 Otsu 自動選取；此參數可調整其偏好（1.0 = 自動，較低 = 表面更厚/連接性更高，較高 = 表面更薄/更緊密）。"
		},
		"min_component": {
			"name": "最小組件",
			"tooltip": "移除小於此頂點數的連通組件（0 = 保留全部）。可去除分離的浮動塊與雙層牆的內殼。"
		},
		"min_opacity": {
			"name": "最小不透明度",
			"tooltip": "網格化前忽略低於此值的不透明高斯。"
		},
		"resolution": {
			"name": "解析度",
			"tooltip": "沿最長軸的密度網格解析度。數值越高，表面越細緻，但會消耗更多 VRAM/時間（隨解析度^3 增長）。"
		},
		"smooth": {
			"name": "平滑",
			"tooltip": "Taubin 網格平滑迭代次數。可平滑表面但不會縮小體積（與模糊密度不同）。0 = 原始表面。"
		},
		"splat": { "name": "splat" }
	},
	"outputs": { "0": {
...
var SplitImageToTileList = {
	"description": "將圖像分割為具有指定重疊區域的批次圖塊清單。",
	"display_name": "將圖像分割為圖塊清單",
	"inputs": {
		"image": { "name": "image" },
		"overlap": { "name": "overlap" },
...
var StableCascade_EmptyLatentImage = {
	"display_name": "StableCascade 空白潛在影像",
	"inputs": {
		"batch_size": { "name": "批次大小" },
		"compression": { "name": "壓縮" },
		"height": { "name": "高度" },
...
var StableCascade_StageB_Conditioning = {
	"display_name": "StableCascade 階段 B 條件設定",
	"inputs": {
		"conditioning": { "name": "條件設定" },
...
var StableCascade_StageC_VAEEncode = {
	"display_name": "StableCascade 階段 C VAE 編碼",
	"inputs": {
		"compression": { "name": "壓縮" },
		"image": { "name": "影像" },
		"vae": { "name": "vae" }
...
var StableCascade_SuperResolutionControlnet = {
	"display_name": "StableCascade 超解析度 ControlNet",
	"inputs": {
		"image": { "name": "影像" },
		"vae": { "name": "vae" }
	},
...
var StableZero123_Conditioning = {
	"display_name": "StableZero123 條件設定",
	"inputs": {
		"azimuth": { "name": "方位角" },
		"batch_size": { "name": "批次大小" },
		"clip_vision": { "name": "clip_vision" },
...
var StableZero123_Conditioning_Batched = {
	"display_name": "StableZero123 條件設定（批次）",
	"inputs": {
		"azimuth": { "name": "方位角" },
		"azimuth_batch_increment": { "name": "方位角批次遞增" },
		"batch_size": { "name": "批次大小" },
		"clip_vision": { "name": "clip_vision" },
		"elevation": { "name": "仰角" },
		"elevation_batch_increment": { "name": "仰角批次遞增" },
		"height": { "name": "高度" },
		"init_image": { "name": "初始影像" },
		"vae": { "name": "vae" },
		"width": { "name": "寬度" }
...
var StringFormat = {
	"description": "與 Python 的字串格式化方法相同。支援所有 Python 格式化選項與功能。",
	"display_name": "格式化文字",
	"inputs": {
...
var T5TokenizerOptions = {
	...
	"inputs": {
		"clip": { "name": "clip" },
		"min_length": { "name": "最小長度" },
		"min_padding": { "name": "最小填充" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var TCFG = {
	"description": "TCFG – 切向阻尼 CFG (2503.18137)\n\n精煉無條件（負向）提示以對齊有條件（正向）提示，從而提升品質。",
	"display_name": "切向阻尼 CFG",
	"inputs": { "model": { "name": "模型" } },
	"outputs": { "0": {
		"name": "修補後模型",
		"tooltip": null
	} }
...
var TemporalScoreRescaling = {
	"description": "[後 CFG 函數]\nTSR - 時間分數重新縮放 (2510.01184)\n\n重新縮放模型的分數或噪聲以引導採樣多樣性。",
	"display_name": "TSR - 時間分數重新縮放",
	"inputs": {
		"model": { "name": "模型" },
		"tsr_k": {
			"name": "tsr_k",
			"tooltip": "控制重新縮放強度。\n較低的 k 值產生更詳細的結果；較高的 k 值在圖像生成中產生更平滑的結果。設定 k = 1 可停用重新縮放。"
		},
		"tsr_sigma": {
			"name": "tsr_sigma",
			"tooltip": "控制重新縮放何時生效。\n較大的值會更早生效。"
...
var Tencent3DPartNode = {
	"description": "根據模型結構自動進行元件識別與生成。",
	"display_name": "Hunyuan3D：3D零件",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model_3d": {
			"name": "model_3d",
			"tooltip": "FBX 格式的 3D 模型。模型面數應少於 30000。"
		},
		"seed": {
			"name": "seed",
			"tooltip": "Seed 控制此節點是否重新執行；無論 seed 為何，結果皆為非確定性。"
...
var Tencent3DTextureEditNode = {
	"description": "輸入 3D 模型後，進行 3D 模型紋理重繪。",
	"display_name": "Hunyuan3D：3D 紋理編輯",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model_3d": {
			"name": "model_3d",
			"tooltip": "FBX 格式的 3D 模型。模型面數應少於 100000。"
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "描述紋理編輯內容。支援最多 1024 個 UTF-8 字元。"
		},
		"seed": {
			"name": "seed",
			"tooltip": "Seed 控制節點是否重新執行；無論 seed 為何，結果皆為非確定性。"
...
var TencentImageToModelNode = {
	"display_name": "Hunyuan3D：圖片轉模型（專業版）",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"face_count": { "name": "面數" },
		"generate_type": { "name": "生成類型" },
		"generate_type_pbr": { "name": "PBR" },
		"image": { "name": "圖片" },
		"image_back": { "name": "背面圖片" },
		"image_left": { "name": "左側圖片" },
		"image_right": { "name": "右側圖片" },
		"model": {
			"name": "模型",
			"tooltip": "「LowPoly」選項在 `3.1` 模型中不可用。"
		},
		"seed": {
			"name": "種子",
...
var TencentModelTo3DUVNode = {
	"description": "對 3D 模型進行 UV 展開，產生 UV 貼圖。輸入模型必須少於 30000 個面。",
	"display_name": "Hunyuan3D：模型展UV",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"model_3d": {
			"name": "3D 模型",
			"tooltip": "輸入 3D 模型（GLB、OBJ 或 FBX）"
		},
		"seed": {
			"name": "種子",
			"tooltip": "種子控制此節點是否重新執行；無論種子為何，結果皆為非確定性。"
...
var TencentSmartTopologyNode = {
	"description": "對 3D 模型進行智慧重拓撲。支援 GLB/OBJ 格式；最大 200MB；建議用於高面數模型。",
	"display_name": "Hunyuan3D：智慧拓撲",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"face_level": {
			"name": "面數等級",
...
var TextEncodeBooguEdit = {
	...
	"inputs": {
		...
		"images": {
			"name": "images",
			"tooltip": "要編輯的參考圖像。Boogu 每個樣本專注於一個參考圖像；也允許多個。"
		},
...
var TextEncodeHunyuanVideo_ImageToVideo = {
	...
	"inputs": {
		...
		"image_interleave": {
			"name": "影像交錯",
			"tooltip": "影像對結果的影響程度，相較於文字提示。數值越高，代表文字提示的影響越大。"
		},
		"prompt": { "name": "提示詞" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var TextEncodeMageFlowEdit = {
	"description": "為 Mage-Flow-Edit 編碼一個包含一張或多張參考圖像的編輯指令。參考 latent 會被調整為輸出解析度（寬度/高度，若為 0 則使用第一張圖像的尺寸）。請使用 latent 輸出進行取樣，以確保尺寸始終一致。",
	...
	"inputs": {
		...
		"height": {
			"name": "height",
			"tooltip": "輸出高度。0 = 使用第一張參考圖像的尺寸。"
		},
		"images": {
			"name": "images",
			"tooltip": "要編輯的參考圖像。所有參考圖像在編碼前都會被調整為輸出解析度。"
		},
		"negative_prompt": { "name": "negative_prompt" },
		"prompt": { "name": "prompt" },
		"vae": { "name": "vae" },
...
var TextEncodeZImageOmni = {
	...
	"inputs": {
		"auto_resize_images": { "name": "自動調整圖像尺寸" },
		"clip": { "name": "clip" },
		"image1": { "name": "圖像1" },
		"image2": { "name": "圖像2" },
		"image3": { "name": "圖像3" },
		"image_encoder": { "name": "圖像編碼器" },
		"prompt": { "name": "提示詞" },
		"vae": { "name": "vae" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var TextGenerate = {
	...
	"inputs": {
		...
		"clip": { "name": "clip" },
		"image": { "name": "圖像" },
		"max_length": { "name": "最大長度" },
		"prompt": { "name": "提示詞" },
		"sampling_mode": { "name": "取樣模式" },
		"sampling_mode_min_p": { "name": "最小 p" },
		"sampling_mode_presence_penalty": { "name": "出現懲罰" },
		"sampling_mode_repetition_penalty": { "name": "重複懲罰" },
		"sampling_mode_seed": { "name": "隨機種子" },
		"sampling_mode_temperature": { "name": "溫度" },
		"sampling_mode_top_k": { "name": "top_k" },
		"sampling_mode_top_p": { "name": "top_p" },
		"thinking": {
			"name": "思考模式",
			"tooltip": "若模型支援，則以思考模式運作。"
		},
		"use_default_template": {
			"name": "use_default_template",
			"tooltip": "若模型有內建系統提示/模板則使用。"
		},
		"video": {
			"name": "影片",
			"tooltip": "影片幀作為圖像批次。預設為 24 FPS；內部會降採樣為 1 FPS。"
		}
	},
	"outputs": { "0": {
		"name": "生成文字",
...
var TextGenerateLTX2Prompt = {
	...
	"inputs": {
		...
		"prompt": { "name": "提示詞" },
		"sampling_mode": { "name": "取樣模式" },
		"sampling_mode_min_p": { "name": "最小 p 值" },
		"sampling_mode_presence_penalty": { "name": "出現懲罰" },
		"sampling_mode_repetition_penalty": { "name": "重複懲罰" },
		"sampling_mode_seed": { "name": "隨機種子" },
		"sampling_mode_temperature": { "name": "溫度" },
		"sampling_mode_top_k": { "name": "Top-K" },
		"sampling_mode_top_p": { "name": "Top-P" },
		"thinking": {
			"name": "思考模式",
			"tooltip": "若模型支援，則以思考模式運作。"
		},
...
var TopazImageEnhance = {
	"description": "業界標準的放大與影像增強。",
	"display_name": "Topaz 影像增強",
	"inputs": {
		"color_preservation": {
			"name": "色彩保留",
			"tooltip": "保留原始色彩。"
		...
		"crop_to_fill": {
			"name": "裁切填滿",
			"tooltip": "預設當輸出長寬比不同時會加黑邊。啟用後將裁切影像以填滿輸出尺寸。"
		},
		"face_enhancement": {
			"name": "臉部增強",
			"tooltip": "處理時增強臉部（如有）。"
		...
		"output_height": {
			"name": "輸出高度",
			"tooltip": "設為 0 代表與原始高度或指定的輸出寬度相同。"
		},
		"output_width": {
			"name": "輸出寬度",
			"tooltip": "設為 0 代表自動計算（通常為原始尺寸或指定的輸出高度）。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "可選的文字提示，用於創意放大指引。"
		},
		"subject_detection": { "name": "主體偵測" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var TopazVideoEnhance = {
	"description": "以強大的升頻與修復技術為影片注入新生命。",
	...
	"inputs": {
		...
		"interpolation_duplicate": {
			"name": "移除重複幀",
			"tooltip": "分析輸入影片中的重複幀並移除。"
		},
		"interpolation_duplicate_threshold": {
			"name": "重複幀靈敏度",
			"tooltip": "重複幀的偵測靈敏度。"
		},
		"interpolation_enabled": { "name": "啟用插幀" },
		"interpolation_frame_rate": {
			"name": "輸出幀率",
			"tooltip": "輸出影片的幀率。"
		},
		"interpolation_model": { "name": "插幀模型" },
		"interpolation_slowmo": {
			"name": "慢動作倍數",
			"tooltip": "對輸入影片應用的慢動作倍數。例如，2 會讓輸出變成原來的兩倍慢，時長加倍。"
		},
		"upscaler_creativity": {
			"name": "創意程度",
			"tooltip": "創意等級（僅適用於 Starlight (Astra) Creative）。"
		},
		"upscaler_enabled": { "name": "啟用升頻" },
		"upscaler_model": { "name": "升頻模型" },
		"upscaler_resolution": { "name": "升頻解析度" },
		"video": { "name": "影片" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var TopazVideoEnhanceV2 = {
	"description": "以強大的升頻與修復技術為影片注入新生命。",
	"display_name": "Topaz 影片增強",
	"inputs": {
		"dynamic_compression_level": {
			"name": "動態壓縮等級",
			"tooltip": "CQP 等級。"
		},
		"interpolation_model": { "name": "插值模型" },
		"upscaler_model": { "name": "升頻模型" },
		"upscaler_model_creativity": { "name": "創意" },
		"upscaler_model_prompt": { "name": "提示詞" },
		"upscaler_model_realism": { "name": "寫實度" },
		"upscaler_model_sharp": { "name": "銳利度" },
		"upscaler_model_upscaler_resolution": { "name": "升頻解析度" },
		"video": { "name": "影片" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var TorchCompileModel = {
	"display_name": "Torch 編譯模型",
	"inputs": {
...
var TrainLoraNode = {
	...
	"inputs": {
		...
		"existing_lora": {
			"name": "現有 LoRA",
			"tooltip": "要附加到的現有 LoRA。設為 None 表示創建新的 LoRA。"
		},
		...
		"quantized_backward": {
			...
			"tooltip": "當 training_dtype 設為 'none' 並在量化模型上訓練時，啟用後將以量化矩陣相乘進行反向傳播。"
		},
		"rank": {
			"name": "秩",
			"tooltip": "LoRA 層的秩。"
		...
		"seed": {
			"name": "種子值",
			"tooltip": "訓練時使用的種子值（用於 LoRA 權重初始化和噪聲採樣的生成器）"
		},
		"steps": {
			"name": "步數",
			"tooltip": "訓練 LoRA 的步數。"
...
var TransformSplat = {
	"description": "平移、旋轉與縮放高斯 splat。非等比縮放也會改變每個 splat 的形狀，處理較慢。",
	"display_name": "變換 Splat",
	"inputs": {
		"rotate_x": { "name": "旋轉 X" },
		"rotate_y": { "name": "旋轉 Y" },
		"rotate_z": { "name": "旋轉 Z" },
		...
		"scale_z": { "name": "縮放 Z" },
		"splat": { "name": "splat" },
		"translate_x": { "name": "平移 X" },
		"translate_y": { "name": "平移 Y" },
		"translate_z": { "name": "平移 Z" }
	},
	"outputs": { "0": {
		"name": "splat",
		"tooltip": null
...
var TrimAudioDuration = {
	...
	"inputs": {
		...
		"start_index": {
			"name": "起始索引",
			"tooltip": "開始時間（秒），可為負數表示從末尾計算（支援小數秒）。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var TrimVideoLatent = {
	"display_name": "裁剪影片潛在空間",
	"inputs": {
		"samples": { "name": "samples" },
		"trim_amount": { "name": "裁剪量" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var TripleCLIPLoader = {
	"description": "[配方]\n\nsd3：clip-l、clip-g、t5",
	"display_name": "載入三重 CLIP",
	"inputs": {
		"clip_name1": { "name": "clip_name1" },
		"clip_name2": { "name": "clip_name2" },
		"clip_name3": { "name": "clip_name3" }
...
var TripoConversionNode = {
	"display_name": "Tripo：轉換模型",
	"inputs": {
		"animate_in_place": { "name": "原地動畫" },
		"bake": { "name": "烘焙" },
		"export_orientation": { "name": "匯出方向" },
		"export_vertex_colors": { "name": "匯出頂點色" },
		"face_limit": { "name": "面數限制" },
		"fbx_preset": { "name": "FBX 預設" },
		"flatten_bottom": { "name": "底部平整化" },
		"flatten_bottom_threshold": { "name": "平整化閾值" },
		"force_symmetry": { "name": "強制對稱" },
		"format": { "name": "格式" },
		"original_model_task_id": { "name": "原始模型任務ID" },
		"pack_uv": { "name": "打包 UV" },
		"part_names": { "name": "部件名稱" },
		"pivot_to_center_bottom": { "name": "樞軸移至底部中心" },
		"quad": { "name": "四邊形" },
		"scale_factor": { "name": "縮放係數" },
		"texture_format": { "name": "紋理格式" },
		"texture_size": { "name": "紋理尺寸" },
		"with_animation": { "name": "包含動畫" }
	}
};
var TripoImageToModelNode = {
	"display_name": "Tripo：圖像轉模型",
	"inputs": {
		"face_limit": { "name": "面數限制" },
		"geometry_quality": { "name": "幾何品質" },
		"image": { "name": "圖像" },
		"model_seed": { "name": "模型種子" },
		"model_version": {
			"name": "模型版本",
			"tooltip": "用於生成的模型版本"
		},
		...
		"style": { "name": "風格" },
		"texture": { "name": "紋理" },
		"texture_alignment": { "name": "紋理對齊" },
		"texture_quality": { "name": "紋理品質" },
		"texture_seed": { "name": "紋理種子" }
	},
	"outputs": {
		"0": {
			"name": "模型檔案",
...
var TripoMultiviewToModelNode = {
	...
	"inputs": {
		...
		"geometry_quality": { "name": "幾何品質" },
		"image": { "name": "圖像" },
		"image_back": { "name": "後方圖像" },
		"image_left": { "name": "左側圖像" },
		"image_right": { "name": "右側圖像" },
...
var TripoP1ImageToModelNode = {
	"description": "Tripo P1 圖片轉 3D。針對低多邊形、遊戲用網格進行最佳化。",
	"display_name": "Tripo P1：圖片轉模型",
	"inputs": {
		"auto_size": {
			"name": "自動尺寸",
			"tooltip": "將輸出縮放至接近真實世界公尺。"
		},
		"compress_geometry": {
			"name": "壓縮幾何",
			"tooltip": "套用幾何壓縮。編輯前請先解壓縮。"
		},
		"enable_image_autofix": {
			"name": "啟用圖片自動修正",
			"tooltip": "預處理輸入圖片以提升生成品質。"
		},
		"export_uv": {
			"name": "匯出 UV",
			"tooltip": "生成時進行 UV 展開。僅幾何模式可關閉以加快速度。"
		},
		"face_limit": {
			"name": "面數上限",
			"tooltip": "目標面數，48-20000。-1 讓 Tripo 自行調整。"
		},
		"image": { "name": "圖片" },
		"model_seed": { "name": "模型種子" },
		"output_mode": {
			"name": "輸出模式",
			"tooltip": "「僅幾何」僅輸出無貼圖網格。「有貼圖」則包含顏色/PBR 貼圖。"
		}
	},
	"outputs": {
		"0": {
...
var TripoP1MultiviewToModelNode = {
	"description": "Tripo P1 多視角轉 3D，需 2-4 張參考圖片，順序為［正面、左側、背面、右側］。正面為必填，其餘三個可任意省略。",
	"display_name": "Tripo P1：多視角轉模型",
	"inputs": {
		"auto_size": {
			"name": "自動尺寸",
			"tooltip": "將輸出縮放至接近真實世界公尺。"
		...
		"image_left": {
			"name": "左側圖片",
			"tooltip": "左側視角（90°），即主體的左邊。"
		},
		"image_right": {
			"name": "右側圖片",
			"tooltip": "右側視角（270°），即主體的右邊。"
		},
		"model_seed": { "name": "模型種子" },
		"output_mode": {
			"name": "輸出模式",
...
var TripoP1TextToModelNode = {
	"description": "Tripo P1 文字轉 3D。針對低多邊形、遊戲用網格與穩定拓撲進行最佳化。",
	"display_name": "Tripo P1：文字轉模型",
	"inputs": {
		"auto_size": {
			"name": "自動尺寸",
			"tooltip": "將輸出縮放至接近真實世界公尺。"
		...
		"export_uv": {
			"name": "匯出 UV",
			"tooltip": "生成時進行 UV 展開。關閉可加快僅幾何輸出。"
		},
		"face_limit": {
			"name": "面數上限",
			"tooltip": "目標面數，48-20000。-1 讓 Tripo 自動調整。"
		},
		"image_seed": { "name": "圖像種子" },
		"model_seed": { "name": "模型種子" },
		"negative_prompt": {
			"name": "負面提示詞",
			"tooltip": "最多 255 字元。"
		...
		"output_mode": {
			"name": "輸出模式",
			"tooltip": "「僅幾何」僅輸出無材質網格。「有材質」則加入顏色／PBR 貼圖。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "最多 1024 字元。"
...
var TripoRigNode = {
	...
	"inputs": { "original_model_task_id": { "name": "原始模型任務ID" } },
	"outputs": {
		"0": {
			"name": "模型檔案",
			"tooltip": null
...
var TripoSplatConditioning = {
	"description": "使用 DINOv3 與 Flux2 VAE 將圖像編碼為 TripoSplat 正/負條件，並為 KSampler 建立固定大小的噪聲目標（latent + 相機）。",
	"display_name": "TripoSplat 條件編碼",
	"inputs": {
		"clip_vision": {
			"name": "clip_vision",
			"tooltip": "DINOv3 ViT-H/16+ 圖像編碼器"
		},
		"image": { "name": "圖像" },
		"vae": {
			"name": "vae",
	...
	"outputs": {
		...
		"2": {
			"name": "latent",
			"tooltip": "固定大小的噪聲目標（latent + 相機）。"
		}
	}
};
var TripoSplatPreprocessImage = {
	"description": "將每張圖像以中心裁切方式裁成方形畫布，背景為黑色，並加入邊距。",
	"display_name": "TripoSplat 預處理圖像",
	"inputs": {
		"erode_radius": {
			"name": "腐蝕半徑",
			"tooltip": "在裁切前，將 alpha 遮罩以此像素半徑進行腐蝕（避免邊緣溢出）。"
		},
		"image": { "name": "圖像" },
		"mask": { "name": "遮罩" },
		"size": {
			"name": "尺寸",
			"tooltip": "方形圖像尺寸。模型訓練於 1024；其他尺寸可運行但分布會有偏差。"
		}
	},
	"outputs": { "0": {
		"name": "圖像",
...
var TripoSplatSamplingPreview = {
	"description": "為標準 Ksampler 節點修補 TripoSplat 模型，在每一步顯示即時解碼的高斯點雲預覽。",
	"display_name": "TripoSplat 採樣預覽",
	"inputs": {
		"model": { "name": "模型" },
		"num_gaussians": {
			"name": "高斯數量",
			"tooltip": "預覽所產生的高斯點數（四捨五入為 32 的倍數）。"
		},
		"octree_level": {
			"name": "八叉樹層級",
			"tooltip": "預覽解碼的八叉樹深度（越低越省資源/越粗糙）。"
		},
		"pitch": {
			"name": "俯仰角",
			"tooltip": "預覽相機俯仰角（度）。"
		...
		"point_size": {
			"name": "點大小",
			"tooltip": "最大點雲半徑（像素）。每個高斯點根據其縮放設定大小，並以此值為上限；越小越細緻，越大越粗壯。"
		},
		"vae": {
			"name": "vae",
			"tooltip": "TripoSplat VAE 解碼器"
		},
		"yaw": {
			"name": "偏航角",
			"tooltip": "預覽相機偏航角（度）。"
...
var TripoTextToModelNode = {
	...
	"inputs": {
		"face_limit": { "name": "面數限制" },
		"geometry_quality": { "name": "幾何品質" },
		"image_seed": { "name": "圖片種子" },
		"model_seed": { "name": "模型種子" },
		"model_version": { "name": "模型版本" },
		"negative_prompt": { "name": "負向提示詞" },
		"pbr": { "name": "PBR材質" },
		"prompt": { "name": "提示詞" },
		"quad": { "name": "四邊形" },
		"style": { "name": "風格" },
...
var UNetTemporalAttentionMultiply = {
	"display_name": "UNet 時間注意力倍增",
	"inputs": {
		"cross_structural": { "name": "交叉結構" },
		"cross_temporal": { "name": "交叉時間" },
		"model": { "name": "model" },
		"self_structural": { "name": "自我結構" },
		"self_temporal": { "name": "自我時間" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var USOStyleReference = {
	"display_name": "USO風格參考",
	"inputs": {
		"clip_vision_output": { "name": "CLIP視覺輸出" },
		"model": { "name": "模型" },
		"model_patch": { "name": "模型修補" }
	}
};
...
var VAEDecode = {
	"description": "將 latent 影像解碼回像素空間影像。",
	"display_name": "VAE 解碼",
	"inputs": {
		"samples": {
			"name": "samples",
		...
		"vae": {
			"name": "vae",
			"tooltip": "用於解碼 latent 的 VAE 模型。"
		}
	},
	"outputs": { "0": { "tooltip": "解碼後的影像。" } }
};
var VAEDecodeAudio = {
	"display_name": "VAE 解碼音訊",
	"inputs": {
		"samples": { "name": "samples" },
		"vae": { "name": "vae" }
	},
...
var VAEDecodeHunyuan3D = {
	...
	"inputs": {
		"num_chunks": { "name": "分塊數量" },
		"octree_resolution": { "name": "八叉樹解析度" },
		"samples": { "name": "樣本" },
		"vae": { "name": "vae" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var VAEDecodeTiled = {
	"display_name": "VAE 解碼（分割區塊）",
	"inputs": {
		"overlap": { "name": "重疊" },
		"samples": { "name": "樣本" },
		"temporal_overlap": {
			"name": "時間重疊",
			"tooltip": "僅用於影片 VAE：重疊的影格數量。"
		},
		"temporal_size": {
			"name": "時間區塊大小",
			"tooltip": "僅用於影片 VAE：每次解碼的影格數量。"
		},
		"tile_size": { "name": "區塊大小" },
		"vae": { "name": "vae" }
	}
...
var VAEDecodeTripoSplat = {
	"description": "將採樣後的 TripoSplat latent 解碼為 3D 高斯點雲。調整高斯數量以改變密度。",
	"display_name": "TripoSplat 解碼",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"num_gaussians": {
			"name": "高斯數量",
			"tooltip": "產生的高斯點數（四捨五入為 32 的倍數）。262144 與八叉樹點密度相符；更高則對同一點過度取樣（更密但無新細節），且 VRAM/時間成本等比增加。"
		},
		"samples": { "name": "樣本" },
		"seed": {
			"name": "種子",
			"tooltip": "為八叉樹點採樣器（全域隨機數生成器）設置種子，以獲得可重現的解碼結果。"
		},
		"vae": {
			"name": "vae",
			"tooltip": "TripoSplat VAE 解碼器"
...
var VAEEncodeForInpaint = {
	"display_name": "VAE 編碼（用於修補）",
	"inputs": {
		"grow_mask_by": { "name": "擴展遮罩範圍" },
		"mask": { "name": "遮罩" },
		"pixels": { "name": "pixels" },
		"vae": { "name": "vae" }
	}
...
var VOIDInpaintConditioning = {
	...
	"inputs": {
		...
		"length": {
			"name": "length",
			"tooltip": "要處理的像素影格數量。對於 CogVideoX-Fun-V1.5（patch_size_t=2），latent_t 必須為偶數——產生奇數 latent_t 的長度會向下取整（例如 49 → 45）。"
		},
		"negative": { "name": "negative" },
		"positive": { "name": "positive" },
		"quadmask": {
			"name": "quadmask",
			"tooltip": "來自 VOIDQuadmaskPreprocess 的預處理 quadmask [T, H, W]"
		},
		"vae": { "name": "vae" },
		"video": {
			"name": "video",
			"tooltip": "來源影片影格 [T, H, W, 3]"
		},
		"width": { "name": "width" }
	},
	"outputs": {
...
var VOIDWarpedNoise = {
	...
	"inputs": {
		...
		"length": {
			"name": "length",
			"tooltip": "像素影格數量。為符合 patch_size_t=2 的需求，會向下取整使 latent_t 為偶數，例如 49 → 45。"
		},
		"optical_flow": {
			"name": "optical_flow",
			"tooltip": "來自 OpticalFlowLoader（RAFT-large）的光流模型。"
		},
		"video": {
			"name": "video",
			"tooltip": "Pass 1 輸出影片影格 [T, H, W, 3]"
		},
		"width": { "name": "width" }
	},
	"outputs": { "0": {
...
var VOIDWarpedNoiseSource = {
	...
	"inputs": { "warped_noise": {
		"name": "warped_noise",
		"tooltip": "來自 VOIDWarpedNoise 的扭曲雜訊 latent"
	} },
	"outputs": { "0": { "tooltip": null } }
};
var VPScheduler = {
...
var Veo3FirstLastFrameNode = {
	"description": "使用提示詞及首尾影格生成影片。",
	"display_name": "Google Veo 3 首尾影格生成影片",
	"inputs": {
		"aspect_ratio": {
			"name": "長寬比",
			"tooltip": "輸出影片的長寬比"
...
var Veo3VideoGenerationNode = {
	"description": "使用Google Veo 3 API從文字提示生成影片",
	"display_name": "Google Veo 3 影片生成",
	"inputs": {
		"aspect_ratio": {
			"name": "長寬比",
			"tooltip": "輸出影片的長寬比例"
		...
		"duration_seconds": {
			"name": "持續時間（秒）",
			"tooltip": "輸出影片的持續時間（秒）（Veo 3僅支援8秒）"
		},
		"enhance_prompt": {
			"name": "增強提示詞",
			"tooltip": "是否使用AI輔助增強提示詞"
		},
		"generate_audio": {
			"name": "generate_audio",
			"tooltip": "為影片生成音訊。所有 Veo 3 模型均支援此功能。"
		},
		"image": {
			"name": "圖片",
			"tooltip": "引導影片生成的選用參考圖片"
		},
		"model": {
			"name": "模型",
			"tooltip": "用於影片生成的 Veo 3 模型"
		},
		"negative_prompt": {
			"name": "負向提示詞",
			"tooltip": "引導影片應避免內容的負向文字提示"
		},
		"person_generation": {
			"name": "人物生成",
			"tooltip": "是否允許在影片中生成人物"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "影片的文字描述"
		...
		"resolution": {
			"name": "解析度",
			"tooltip": "輸出影片解析度。veo-3.1-lite 與 veo-3.0 模型不支援 4K。"
		},
		"seed": {
			"name": "種子值",
			"tooltip": "影片生成的種子值（0表示隨機）"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var VeoVideoGenerationNode = {
	"description": "使用 Google 的 Veo API 根據文字提示生成影片",
	"display_name": "Google Veo2 影片生成",
	"inputs": {
		"aspect_ratio": {
			"name": "長寬比",
			"tooltip": "輸出影片的長寬比"
		...
		"image": {
			"name": "影像",
			"tooltip": "可選的參考圖片，用於引導影片生成"
		},
		"model": {
			"name": "model",
			"tooltip": "用於影片生成的 Veo 2 模型"
		},
		"negative_prompt": {
			"name": "負向提示詞",
			"tooltip": "用於引導影片中應避免內容的負面文字提示"
		},
		"person_generation": {
			"name": "生成人物",
			"tooltip": "是否允許在影片中生成人物"
		...
		"seed": {
			"name": "種子",
			"tooltip": "影片生成的種子（0 為隨機）"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var VideoFrameSample = {
	"description": "使用多種策略，從影片中取樣固定數量的影格。",
	"display_name": "取樣影片影格",
	"inputs": {
		"control_after_generate": { "name": "產生後控制" },
		"num_frames": {
		...
		"seed": {
			"name": "隨機種子",
			"tooltip": "隨機種子（僅用於「random」策略）。"
		},
		"strategy": {
			"name": "策略",
			"tooltip": "uniform：平均分布，head：前 N 張，tail：後 N 張，random：隨機排序。"
		},
		"video": {
			"name": "影片",
			"tooltip": "輸入影片。"
...
var VideoRandomTemporalCrop = {
	"description": "隨機裁切影片中連續的一段影格。",
	"display_name": "裁切影片（隨機時間區段）",
	"inputs": {
		"control_after_generate": { "name": "產生後控制" },
		"length": {
			"name": "保留長度",
...
var VideoTemporalCrop = {
	"description": "裁切影片中連續的一段影格。",
	"display_name": "裁切影片（時間區段）",
	"inputs": {
		"length": {
			"name": "保留長度",
			"tooltip": "要保留的影格數量。"
...
var Vidu2ImageToVideoNode = {
	"description": "從一張圖像及可選提示詞生成影片。",
	"display_name": "Vidu2 圖像轉影片生成",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"duration": { "name": "duration" },
		"image": {
			"name": "image",
			"tooltip": "用作生成影片起始畫格的圖像。"
		},
		"model": { "name": "model" },
		"movement_amplitude": {
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "影片生成的可選文字提示（最多 2000 字元）。"
		},
		"resolution": { "name": "resolution" },
		"seed": { "name": "seed" }
	},
...
var Vidu2ReferenceVideoNode = {
	"description": "從多張參考圖像及提示詞生成影片。",
	"display_name": "Vidu2 參考圖像轉影片生成",
	"inputs": {
		"aspect_ratio": { "name": "aspect_ratio" },
		"audio": {
			"name": "audio",
			"tooltip": "啟用後，影片將根據提示詞包含生成的語音及背景音樂。"
		},
		"control_after_generate": { "name": "control after generate" },
		"duration": { "name": "duration" },
		"model": { "name": "model" },
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "啟用後，影片將根據提示詞生成語音及背景音樂。"
		},
		"resolution": { "name": "resolution" },
		"seed": { "name": "seed" },
		"subjects": {
			"name": "subjects",
			"tooltip": "每個主體最多可提供 3 張參考圖像（所有主體合計最多 7 張）。可在提示詞中以 @subject{subject_id} 參照。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var Vidu2StartEndToVideoNode = {
	...
	"display_name": "Vidu2 起始/結束影格轉影片生成",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"duration": { "name": "duration" },
...
var Vidu2TextToVideoNode = {
	...
	"display_name": "Vidu2 文字轉影片生成",
	"inputs": {
		"aspect_ratio": { "name": "aspect_ratio" },
		"background_music": {
			"name": "background_music",
			"tooltip": "是否為生成的影片加入背景音樂。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"duration": { "name": "duration" },
		"model": { "name": "model" },
		"prompt": {
			"name": "prompt",
			"tooltip": "用於影片生成的文字描述，最長 2000 字元。"
		},
		"resolution": { "name": "resolution" },
		"seed": { "name": "seed" }
	},
...
var Vidu3ImageToVideoNode = {
	"description": "從圖像及可選提示詞生成影片。",
	"display_name": "Vidu Q3 圖像轉影片生成",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"image": {
			"name": "image",
			"tooltip": "作為生成影片起始畫格的圖像。"
		},
		"model": {
			"name": "model",
			"tooltip": "用於影片生成的模型。"
...
var ViduExtendVideoNode = {
	"description": "透過生成額外畫格來延伸現有影片。",
	"display_name": "Vidu 影片延伸",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"end_frame": { "name": "end_frame" },
		"model": {
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "延伸影片的可選文字提示（最多 2000 字元）。"
		},
		"seed": { "name": "seed" },
		"video": {
			"name": "video",
...
var ViduImageToVideoNode = {
	"description": "從圖像和可選提示生成影片",
	"display_name": "Vidu 圖像轉影片生成",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"duration": {
			"name": "duration",
		...
		"resolution": {
			"name": "resolution",
			"tooltip": "支援的值可能因模型和持續時間而異"
		},
		"seed": {
			"name": "seed",
			"tooltip": "影片生成的種子值（0 表示隨機）"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ViduMultiFrameVideoNode = {
	"description": "生成具有多個關鍵畫格轉場的影片。",
	"display_name": "Vidu 多畫格影片生成",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"frames": {
			"name": "frames",
			"tooltip": "關鍵畫格轉場數量（2-9）。"
		},
		...
		"start_image": {
			"name": "start_image",
			"tooltip": "起始畫格圖像。長寬比需介於 1:4 與 4:1 之間。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ViduReferenceVideoNode = {
	"description": "從多張圖像和提示生成影片",
	"display_name": "Vidu 參考圖像轉影片生成",
	"inputs": {
		"aspect_ratio": {
			"name": "aspect_ratio",
			"tooltip": "輸出影片的長寬比"
		...
		"images": {
			"name": "images",
			"tooltip": "用作參考以生成具有一致主題的影片的圖像（最多 7 張圖像）。"
		},
		"model": {
			"name": "model",
			"tooltip": "模型名稱"
...
var ViduStartEndToVideoNode = {
	"description": "從起始和結束畫面及提示生成影片",
	"display_name": "Vidu 起始結束至影片生成",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"duration": {
			"name": "持續時間",
			"tooltip": "輸出影片的持續時間（單位：秒）"
		},
		"end_frame": {
			"name": "end_frame",
			"tooltip": "結束畫面"
...
var ViduTextToVideoNode = {
	"description": "從文字提示詞生成影片",
	"display_name": "Vidu 文字轉影片生成",
	"inputs": {
		"aspect_ratio": {
			"name": "長寬比",
			"tooltip": "輸出影片的長寬比"
...
var VoxelToMesh = {
	"description": "將 voxel 格點轉換為 mesh。",
	"display_name": "體素轉網格",
	"inputs": {
		"algorithm": { "name": "演算法" },
		"threshold": { "name": "臨界值" },
...
var Wan2ImageToVideoApi = {
	...
	"inputs": {
		"audio": {
			"name": "audio",
			"tooltip": "用於驅動影片生成的音訊（如對嘴、節奏動作）。時長：2秒至30秒。若未提供，模型會自動產生相符的背景音樂或音效。"
		},
		"control_after_generate": { "name": "control after generate" },
		"first_frame": {
			"name": "first_frame",
...
var Wan2TextToVideoApi = {
	...
	"inputs": {
		"audio": {
			"name": "audio",
			"tooltip": "用於驅動影片生成的音訊（如對嘴、節奏同步動作）。時長：3秒至30秒。若未提供，模型會自動生成匹配的背景音樂或音效。"
		},
		"control_after_generate": { "name": "control after generate" },
		"model": { "name": "model" },
		"model_duration": { "name": "duration" },
...
var Wan2VideoContinuationApi = {
	...
	"inputs": {
		...
		"first_clip": {
			"name": "first_clip",
			"tooltip": "要續接的輸入影片。時長：2秒至10秒。輸出長寬比將依此影片決定。"
		},
		"last_frame": {
			"name": "last_frame",
...
var WanAnimateToVideo = {
	...
	"inputs": {
		"background_video": { "name": "背景影片" },
		"batch_size": { "name": "批次大小" },
		"character_mask": { "name": "角色遮罩" },
		"clip_vision_output": { "name": "CLIP視覺輸出" },
		"continue_motion": { "name": "連續動作" },
		"continue_motion_max_frames": { "name": "連續動作最大幀數" },
		"face_video": { "name": "臉部影片" },
		"height": { "name": "高度" },
		"length": { "name": "長度" },
		"negative": { "name": "負面提示" },
		"pose_video": { "name": "姿勢影片" },
		"positive": { "name": "正面提示詞" },
		"reference_image": { "name": "參考圖像" },
		"vae": { "name": "VAE" },
		"video_frame_offset": {
			"name": "影片幀偏移",
			"tooltip": "在所有輸入影片中要跳過的幀數。用於通過分塊生成更長的影片。連接到前一個節點的 video_frame_offset 輸出以擴展影片。"
		},
		"width": { "name": "寬度" }
	},
	"outputs": {
...
var WanCameraEmbedding = {
	"display_name": "WanCamera嵌入",
	"inputs": {
		"camera_pose": { "name": "相機姿勢" },
		"cx": { "name": "cx" },
		"cy": { "name": "cy" },
		"fx": { "name": "fx" },
		"fy": { "name": "fy" },
...
var WanCameraImageToVideo = {
	"display_name": "Wan攝影機圖像轉影片",
	"inputs": {
		"batch_size": { "name": "批次大小" },
		"camera_conditions": { "name": "攝影機條件" },
		"clip_vision_output": { "name": "CLIP視覺輸出" },
		"height": { "name": "高度" },
		"length": { "name": "長度" },
		"negative": { "name": "負面提示詞" },
...
var WanContextWindowsManual = {
	"description": "手動設定WAN類模型的上下文窗口（維度=2）。",
	"display_name": "WAN上下文窗口（手動）",
	"inputs": {
		"closed_loop": {
			"name": "閉環",
			"tooltip": "是否關閉上下文窗口循環；僅適用於循環排程。"
		...
		"model": {
			"name": "模型",
			"tooltip": "在採樣期間應用上下文窗口的模型。"
		},
		"retain_first_frame": {
			"name": "retain_first_frame",
			"tooltip": "在每個 context window 中保留第一個 I2V 畫格（有助於保留初始參考）。"
		},
		"split_conds_to_windows": {
			"name": "split_conds_to_windows",
			"tooltip": "是否根據區域索引，將多個條件（由 ConditionCombine 建立）分配到各自的 window。"
		}
	},
	"outputs": { "0": { "tooltip": "在採樣期間應用上下文窗口的模型。" } }
};
...
var WanFirstLastFrameToVideo = {
	...
	"inputs": {
		"batch_size": { "name": "批次大小" },
		"clip_vision_end_image": { "name": "clip 視覺結束影像" },
		"clip_vision_start_image": { "name": "clip 視覺起始影像" },
		"end_image": { "name": "結束影像" },
		"height": { "name": "高度" },
		"length": { "name": "長度" },
		"negative": { "name": "負向" },
...
var WanHuMoImageToVideo = {
	"display_name": "WanHuMo圖像轉影片",
	"inputs": {
		"audio_encoder_output": { "name": "音訊編碼器輸出" },
		"batch_size": { "name": "批次大小" },
		"height": { "name": "高度" },
		"length": { "name": "長度" },
		"negative": { "name": "負面提示詞" },
...
var WanImageToImageApi = {
	"description": "根據一或兩張輸入圖像和文字提示生成圖像。輸出圖像目前固定為160萬像素；其長寬比與輸入圖像匹配。",
	"display_name": "萬圖生圖",
	"inputs": {
		"control_after_generate": { "name": "生成後控制" },
		"image": {
			"name": "圖像",
			"tooltip": "單圖編輯或多圖融合，最多2張圖像。"
		},
		"model": {
			"name": "模型",
			"tooltip": "要使用的模型。"
		...
		"negative_prompt": {
			"name": "負面提示詞",
			"tooltip": "引導避免內容的負面文字提示。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "用於描述元素和視覺特徵的提示詞，支援英文/中文。"
		},
		"seed": {
			"name": "種子值",
			"tooltip": "用於生成的種子值。"
		...
		"watermark": {
			"name": "浮水印",
			"tooltip": "是否在結果中添加「AI生成」浮水印。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var WanImageToVideo = {
	"display_name": "WAN 影像轉影片",
	"inputs": {
		"batch_size": { "name": "批次大小" },
		"clip_vision_output": { "name": "clip_vision_output" },
		"height": { "name": "高度" },
...
var WanImageToVideoApi = {
	"description": "根據首幀圖像和文字提示生成影片。",
	"display_name": "萬圖生影片",
	"inputs": {
		"audio": {
			"name": "音訊",
			"tooltip": "音訊必須包含清晰、響亮的人聲，無雜音和背景音樂。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"duration": {
			"name": "持續時間",
			"tooltip": "可用持續時間：5秒和10秒"
		},
		"generate_audio": {
			"name": "生成音訊",
			"tooltip": "若無音訊輸入，則自動生成音訊。"
		},
		"image": { "name": "圖像" },
		"model": {
			"name": "模型",
		...
		"shot_type": {
			"name": "鏡頭類型",
			"tooltip": "指定生成影片的鏡頭類型，即影片是單一連續鏡頭還是多鏡頭剪接。此參數僅在 prompt_extend 為 True 時生效。"
		},
		"watermark": {
			"name": "浮水印",
			"tooltip": "是否在結果中添加「AI生成」浮水印。"
...
var WanInfiniteTalkToVideo = {
	...
	"inputs": {
		"audio_encoder_output_1": { "name": "音訊編碼器輸出 1" },
		"audio_scale": { "name": "音訊縮放" },
		"clip_vision_output": { "name": "clip 視覺輸出" },
		"height": { "name": "高度" },
		"length": { "name": "長度" },
		"mode": { "name": "模式" },
		"model": { "name": "模型" },
		...
		"motion_frame_count": {
			"name": "動作影格數",
			"tooltip": "用作動作參考的前置影格數量。"
		},
		"negative": { "name": "負向提示" },
		"positive": { "name": "正向提示" },
		"previous_frames": { "name": "前置影格" },
		"start_image": { "name": "起始圖像" },
		"vae": { "name": "vae" },
		"width": { "name": "寬度" }
	},
...
var WanMoveVisualizeTracks = {
	...
	"inputs": {
		"circle_size": { "name": "圓圈大小" },
		"images": { "name": "影像" },
		"line_resolution": { "name": "線條解析度" },
		"line_width": { "name": "線寬" },
		"opacity": { "name": "不透明度" },
		"tracks": { "name": "軌跡" }
	},
...
var WanReferenceVideoApi = {
	"description": "使用輸入影片中的角色與聲音，結合提示詞，生成一個保持角色一致性的新影片。",
	...
	"inputs": {
		...
		"negative_prompt": {
			"name": "反向提示詞",
			"tooltip": "描述需要避免內容的反向提示詞。"
		},
		"prompt": {
			"name": "提示詞",
			"tooltip": "描述元素與視覺特徵的提示詞。支援英文與中文。可使用 `character1`、`character2` 等標識來指代參考角色。"
		},
		"reference_videos": { "name": "參考影片" },
		"seed": { "name": "隨機種子" },
		"shot_type": {
			"name": "鏡頭類型",
			"tooltip": "指定生成影片的鏡頭類型，即影片是單一連續鏡頭還是多個剪接鏡頭。"
		},
		"size": { "name": "尺寸" },
		"watermark": {
			"name": "浮水印",
...
var WanSCAILToVideo = {
	...
	"inputs": {
		...
		"clip_vision_output": {
			"name": "clip_vision_output",
			"tooltip": "用於條件設定的 CLIP 視覺特徵。模型以拉伸調整長寬比進行訓練。"
		},
		"height": { "name": "高度" },
		"length": { "name": "長度" },
		"negative": { "name": "負向" },
		...
		"pose_strength": {
			"name": "姿勢強度",
			"tooltip": "姿勢 latent 的強度。"
		},
		"pose_video": {
			"name": "姿勢影片",
			"tooltip": "用於姿勢條件的影片。將會縮小為主影片解析度的一半。"
		},
		"pose_video_mask": {
			"name": "pose_video_mask",
			"tooltip": "僅限 SCAIL-2。每個身份以顏色區分的 SAM3 mask 影片，解析度需與 pose_video 相同。"
		},
		"positive": { "name": "正向" },
		"previous_frame_count": {
			"name": "previous_frame_count",
			"tooltip": "前一區塊尾端的影格數作為錨點。SCAIL-2 以 5 訓練（81 影格區塊，76 影格步進）。"
		},
		"previous_frames": {
			"name": "previous_frames",
			"tooltip": "僅限 SCAIL-2。前一區塊完整解碼的輸出。僅使用最後 previous_frame_count 個影格作為延伸錨點。"
		},
		"reference_image": {
			"name": "參考圖片",
			"tooltip": "參考圖像，若有多個參考請合成於同一張圖像。"
		},
		"reference_image_mask": {
			"name": "reference_image_mask",
			"tooltip": "僅限 SCAIL-2。彩色參考 mask，解析度需與 reference_image 相同。"
		},
		"replacement_mode": {
			"name": "replacement_mode",
			"tooltip": "僅限 SCAIL-2。False = 動畫模式（pose_video_mask 背景應為黑色）。True = 替換模式（pose_video_mask 背景應為白色）。"
		},
		"vae": { "name": "vae" },
		"video_frame_offset": {
			"name": "video_frame_offset",
			"tooltip": "本區塊開始的累積輸出影格。請從前一區塊的 video_frame_offset 輸出連接。"
		},
		"width": { "name": "寬度" }
	},
	"outputs": {
		...
		"2": {
			"name": "latent",
			"tooltip": "生成尺寸的空 latent。"
		},
		"3": {
			"name": "video_frame_offset",
			"tooltip": "調整後的偏移與長度。請連接到下一區塊。"
		}
	}
};
var WanSoundImageToVideo = {
	"display_name": "萬聲圖像轉影片",
	"inputs": {
		"audio_encoder_output": { "name": "音訊編碼器輸出" },
		"batch_size": { "name": "批次大小" },
		"control_video": { "name": "控制影片" },
...
var WanTextToVideoApi = {
	"description": "根據文字提示生成影片。",
	"display_name": "Wan 文字轉影片",
	"inputs": {
		"audio": {
			"name": "音訊",
			"tooltip": "音訊必須包含清晰、響亮的語音，無雜音和背景音樂。"
		},
		"control_after_generate": { "name": "生成後控制" },
		"duration": {
			"name": "持續時間",
			"tooltip": "可用持續時間：5 秒和 10 秒"
		},
		"generate_audio": {
			"name": "生成音訊",
			"tooltip": "若無音訊輸入，則自動生成音訊。"
		...
		"shot_type": {
			"name": "鏡頭類型",
			"tooltip": "指定生成影片的鏡頭類型，即影片是單一連續鏡頭還是多個剪接鏡頭。此參數僅在 prompt_extend 為 True 時生效。"
		},
		"size": { "name": "尺寸" },
		"watermark": {
			"name": "浮水印",
			"tooltip": "是否在結果中添加「AI 生成」浮水印。"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var WanTrackToVideo = {
	"display_name": "Wan 追蹤轉影片",
	"inputs": {
		"batch_size": { "name": "批次大小" },
		"clip_vision_output": { "name": "CLIP 視覺輸出" },
		"height": { "name": "高度" },
...
var WanUni3CControlnetApply = {
	"display_name": "套用 Wan Uni3C ControlNet",
	"inputs": {
		"end_percent": { "name": "結束百分比" },
		"model": { "name": "模型" },
		"model_patch": { "name": "模型補丁" },
		"render_video": {
			"name": "渲染影片",
			"tooltip": "由相機軌跡渲染的引導影片，最常見的是將輸入影像的點雲渲染進行扭曲。"
		},
		"start_percent": { "name": "起始百分比" },
		"strength": { "name": "強度" },
		"vae": { "name": "vae" }
...
var WanVaceToVideo = {
	"display_name": "WAN 人臉轉影片",
	"inputs": {
		"batch_size": { "name": "批次大小" },
		"control_masks": { "name": "控制遮罩" },
		"control_video": { "name": "控制影片" },
		"height": { "name": "高度" },
		"length": { "name": "長度" },
		"negative": { "name": "負向" },
		"positive": { "name": "正向" },
		"reference_image": { "name": "參考影像" },
		"strength": { "name": "強度" },
		"vae": { "name": "vae" },
		"width": { "name": "寬度" }
	},
...
var WavespeedFlashVSRNode = {
	"description": "快速高品質影片升頻器，提升解析度並恢復低解析度或模糊影片的清晰度。",
	"display_name": "FlashVSR 影片升頻",
	"inputs": {
		"target_resolution": { "name": "目標解析度" },
		"video": { "name": "影片" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var WavespeedImageUpscaleNode = {
	"description": "提升圖像解析度與品質，將照片升頻至 4K 或 8K，獲得銳利細緻的效果。",
	"display_name": "WaveSpeed 圖像升頻",
	"inputs": {
		"image": { "name": "圖像" },
		"model": { "name": "model" },
		"target_resolution": { "name": "目標解析度" }
...
var WebcamCapture = {
	"display_name": "網路攝影機擷取",
	"inputs": {
		"capture_on_queue": { "name": "排隊時擷取" },
		"height": { "name": "高度" },
		"image": { "name": "影像" },
...
var unCLIPCheckpointLoader = {
	"display_name": "unCLIP 檢查點載入器",
	"inputs": { "ckpt_name": { "name": "ckpt_name" } }
};
var unCLIPConditioning = {
	"display_name": "unCLIP 條件化",
	"inputs": {
		"clip_vision_output": { "name": "clip_vision_output" },
		"conditioning": { "name": "條件設定" },
		"noise_augmentation": { "name": "雜訊增強" },
...
var nodeDefs_default = {
	...
	EmptySD3LatentImage,
	"Epsilon Scaling": {
		"display_name": "Epsilon縮放",
		"inputs": {
			"model": { "name": "模型" },
			"scaling_factor": { "name": "縮放係數" }
		},
		"outputs": { "0": { "tooltip": null } }
	},
...
//# sourceMappingURL=nodeDefs-Dbmac27J.js.map