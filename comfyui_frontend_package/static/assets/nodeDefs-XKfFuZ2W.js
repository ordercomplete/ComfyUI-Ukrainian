...
var AnimaLLLiteApply = {
	"display_name": "Appliquer Anima LLLite",
	"inputs": {
		...
		"start_percent": { "name": "pourcentage de début" },
...
var ByteDanceSeedAudio = {
	"description": "Générez de la parole, de la musique, des effets sonores et des dialogues multi-interlocuteurs à partir d’un seul prompt avec ByteDance Seed Audio 1.0. Décrivez la/les voix, l’émotion, l’ambiance, la musique de fond et les effets sonores dans le prompt, et incluez les répliques à prononcer. Vous pouvez choisir une voix prédéfinie intégrée, cloner jusqu’à 3 voix à partir de clips de référence (étiquetés @Audio1-3 dans le prompt), ou dériver une voix à partir de l’image d’un personnage. Jusqu’à 2 minutes d’audio par génération.",
	...
	"inputs": {
		...
		"model": {
			"name": "model",
			"tooltip": "seed-audio-1.0-multilingual : 20 langues (anglais, chinois, japonais, coréen, espagnol mexicain et castillan, indonésien, allemand, portugais brésilien, français, thaï, vietnamien, malais, philippin, italien, russe, néerlandais, polonais, turc, suédois) avec contrôle du timing par phrase via des horodatages \"[5.5s:8.0s] ...\". seed-audio-1.0 : anglais et chinois uniquement, sans contrôle du timing."
		},
		"pitch_rate": {
			"name": "pitch_rate",
			"tooltip": "Décalage de hauteur en demi-tons (-12 à 12)."
		},
		"reference_mode": {
			"name": "reference_mode",
			"tooltip": "Comment conditionner la voix : « texte uniquement » (tout décrire dans le prompt), « référence audio » (cloner jusqu’à 3 voix, étiquetées @Audio1-3), « référence image » (dériver une voix à partir de l’image d’un personnage), ou « voix prédéfinie » (choisir une voix intégrée qui lit le prompt)."
		},
		"sample_rate": {
			"name": "sample_rate",
			"tooltip": "Fréquence d’échantillonnage de sortie en Hz."
		},
		"seed": {
			"name": "seed",
		...
		"speech_rate": {
			"name": "speech_rate",
			"tooltip": "Vitesse de parole. 0 = normal, 100 = 2,0x, -50 = 0,5x."
		},
		"text_prompt": {
			"name": "text_prompt",
			"tooltip": "Décrivez la/les voix, l’émotion, le rythme, l’ambiance, la musique de fond et les effets sonores, et incluez les répliques à prononcer (nommez les personnages dans le texte pour les dialogues). En mode « référence audio », faites référence aux clips connectés par ordre : @Audio1, @Audio2, @Audio3. Maximum 3000 caractères."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var ByteDanceSeedreamNodeV2 = {
	...
	"inputs": {
		...
		"thinking": {
			"name": "thinking",
			"tooltip": "Activez le raisonnement d'optimisation du prompt du modèle (« thinking ») pour une meilleure conformité. Peut augmenter considérablement le temps de génération — notamment sur Seedream 5.0 Pro. Ne peut être désactivé que pour le texte-vers-image (pas lorsque des images de référence sont fournies)."
		},
		"watermark": {
			"name": "filigrane",
...
var ConditioningMultiply = {
	"display_name": "Conditionnement (Multiplication)",
	"inputs": {
		"conditioning": { "name": "conditioning" },
		"multiplier": { "name": "multiplier" }
	}
...
var CreateBoundingBoxes = {
	...
	"inputs": {
		...
		"bboxes": {
			"name": "bboxes",
			"tooltip": "Boîtes englobantes, éléments ou une chaîne JSON pour initialiser le canvas. Une nouvelle valeur en amont initialise le canvas ; les modifications effectuées sur le canvas sont prioritaires et conservées jusqu'à ce que la valeur en amont change à nouveau."
		},
		"editor_state": {
			"name": "état_éditeur",
		...
		"last_incoming": {
			"name": "last_incoming",
			"tooltip": "État interne géré par le canvas : la dernière valeur bboxes en amont qui l'a initialisé. Laissez vide pour réinitialiser le canvas à partir de l'entrée bboxes lors de la prochaine exécution."
		},
		"width": {
			"name": "largeur",
...
var GeminiVideoOmni = {
	"description": "Générez une vidéo avec audio à partir d’un prompt texte en utilisant le modèle Gemini Omni Flash de Google. Vous pouvez fournir des images et/ou vidéos de référence pour guider ou éditer le résultat. Décrivez la durée souhaitée (3-10s) et le format d’image (16:9 ou 9:16) directement dans le prompt.",
	"display_name": "Google Gemini Omni (Vidéo)",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model": {
			"name": "model",
			"tooltip": "Le modèle vidéo Gemini utilisé pour générer la vidéo."
		},
		"model_prompt": { "name": "prompt" },
		"model_temperature": { "name": "temperature" },
		"model_top_p": { "name": "top_p" },
...
var HeyGenAvatarVideoNode = {
	"description": "Générez une vidéo de présentateur parlant à partir d’un avatar HeyGen. Inclut les avatars publics les plus populaires de HeyGen ; tout identifiant de look peut être fourni en remplacement.",
	"display_name": "Vidéo Avatar HeyGen",
	"inputs": {
		"aspect_ratio": {
			"name": "format d’image",
			"tooltip": "Format d’image de sortie. 'auto' suit la source de l’avatar."
		},
		"background_color": {
			"name": "couleur de fond",
			"tooltip": "Couleur de fond unie optionnelle en code hexadécimal (ex : '#00ff00'). Laissez vide pour utiliser le fond de l’avatar."
		},
		"control_after_generate": { "name": "contrôle après génération" },
		"custom_avatar_id": {
			"name": "identifiant_avatar_personnalisé",
			"tooltip": "Identifiant de look d’avatar HeyGen optionnel. Lorsqu’il est défini, il remplace l’avatar sélectionné ci-dessus. N’importe lequel des 3000+ looks publics de HeyGen (ou vos avatars privés) peut être utilisé."
		},
		"engine": {
			"name": "moteur",
			"tooltip": "Moteur de rendu ; chaque choix liste uniquement les avatars qui le prennent en charge. 'auto' propose tous les avatars et sélectionne leur meilleur moteur (Avatar IV préféré). Avatar V offre la meilleure fidélité, Avatar III est le plus abordable."
		},
		"engine_avatar": { "name": "avatar" },
		"resolution": {
			"name": "résolution",
			"tooltip": "Résolution de la vidéo de sortie."
		},
		"seed": {
			"name": "graine",
			"tooltip": "Non envoyé à HeyGen ; modifiez-le pour forcer une nouvelle génération."
		},
		"speech": {
			"name": "parole",
			"tooltip": "Animez l’avatar avec un script texte (HeyGen texte-à-parole) ou votre propre audio."
		},
		"speech_custom_voice_id": { "name": "identifiant_voix_personnalisée" },
		"speech_text": { "name": "texte" },
		"speech_voice": { "name": "voix" },
		"speech_voice_speed": { "name": "vitesse_voix" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var HeyGenCreateAvatarNode = {
	"description": "Créez votre propre avatar HeyGen réutilisable à partir d’une photo d’une personne ou d’une invite texte (un personnage généré). Utilisez l’avatar_id résultant dans le champ custom_avatar_id de Vidéo Avatar HeyGen — et sauvegardez l’ID pour réutiliser l’avatar dans de futurs workflows.",
	"display_name": "Créer un Avatar HeyGen",
	"inputs": {
		"source": {
			"name": "source",
			"tooltip": "Générez un nouveau personnage à partir d’une invite texte, ou créez l’avatar à partir d’une photo connectée d’une personne."
		},
		"source_prompt": { "name": "invite" }
	},
	"outputs": {
		"0": {
			"name": "avatar_id",
			"tooltip": "Identifiant de look d’avatar. Passez-le au champ custom_avatar_id de Vidéo Avatar HeyGen ; sauvegardez-le pour réutiliser l’avatar plus tard."
		},
		"1": {
			"name": "aperçu",
			"tooltip": null
...
var HeyGenTalkingPhotoNode = {
	"description": "Animez n'importe quelle image d'une personne en une vidéo parlante synchronisée sur les lèvres (HeyGen Avatar IV). Contrôlez-la avec un script texte ou votre propre audio.",
	"display_name": "HeyGen Talking Photo",
	"inputs": {
		"aspect_ratio": {
			"name": "aspect_ratio",
			"tooltip": "Format d'image de sortie. 'auto' suit l'image d'entrée."
		},
		"control_after_generate": { "name": "contrôle après génération" },
		"expressiveness": {
			"name": "expressiveness",
			"tooltip": "Degré d'expressivité du visage et des gestes animés."
		},
		"image": {
			"name": "image",
			"tooltip": "Image d'une personne à animer. Redimensionnée automatiquement si supérieure à 2K."
		},
		"resolution": {
			"name": "resolution",
			"tooltip": "Résolution vidéo de sortie."
		},
		"seed": {
			"name": "seed",
			"tooltip": "Non envoyé à HeyGen ; modifiez-le pour forcer une nouvelle génération."
		...
		"speech": {
			"name": "speech",
			"tooltip": "Animez l'avatar avec un script texte (HeyGen text-to-speech) ou votre propre audio."
		},
...
var HeyGenTextToSpeechNode = {
	"description": "Générez un audio de parole à partir d'un texte grâce au moteur Starfish TTS de HeyGen. Inclut les voix les plus populaires de HeyGen dans 17 langues.",
	"display_name": "HeyGen Texte en Parole",
	"inputs": {
		"control_after_generate": { "name": "contrôle après génération" },
		"custom_voice_id": {
			"name": "custom_voice_id",
			"tooltip": "ID de voix HeyGen optionnel. Si défini, remplace la voix sélectionnée ci-dessus. La voix doit être compatible avec le moteur Starfish."
		},
		"seed": {
			"name": "seed",
			"tooltip": "Non envoyé à HeyGen ; modifiez-le pour forcer une nouvelle génération."
		...
		"speed": {
			"name": "vitesse",
			"tooltip": "Multiplicateur de vitesse de la parole."
		},
		"ssml": {
			"name": "ssml",
			"tooltip": "Traiter le texte comme du balisage SSML (pour les pauses, l'emphase et le contrôle de la prononciation)."
		},
		"text": {
			"name": "texte",
			"tooltip": "Texte à synthétiser (jusqu'à 5000 caractères). La parole générée doit durer au moins 1 seconde."
		},
		"voice": {
			"name": "voix",
			"tooltip": "Voix à utiliser (sélection parmi les voix Starfish les plus populaires de HeyGen)."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var HeyGenVideoTranslateNode = {
	"description": "Traduisez une vidéo parlée dans une autre langue. Clone la voix originale du locuteur et ré-anime la bouche pour correspondre à la parole traduite.",
	"display_name": "HeyGen Traduction Vidéo",
	"inputs": {
		"control_after_generate": { "name": "contrôle après génération" },
		"mode": {
			"name": "mode",
			"tooltip": "'speed' est plus rapide ; 'precision' produit une synchronisation labiale de meilleure qualité à un coût doublé."
		},
		"output_language": {
			"name": "langue de sortie",
			"tooltip": "Langue cible pour la vidéo traduite."
		},
		"seed": {
			"name": "graine",
			"tooltip": "Non envoyé à HeyGen ; modifiez-le pour forcer une nouvelle exécution."
		},
		"speaker_count": {
			"name": "nombre de locuteurs",
			"tooltip": "Nombre de locuteurs dans la vidéo. 0 = détection automatique."
		},
		"translate_audio_only": {
			"name": "traduire uniquement l'audio",
			"tooltip": "Remplace uniquement la piste audio, en conservant les mouvements de bouche originaux (pas de synchronisation labiale)."
		},
		"video": {
			"name": "vidéo",
			"tooltip": "Vidéo avec discours à traduire."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var LoadVideoDataSetFromFolder = {
	"description": "Chargez un ensemble de vidéos à partir d’un dossier spécifié et renvoie une liste de vidéos. Formats pris en charge : MP4, AVI, MOV, WEBM, MKV, FLV.",
	"display_name": "Charger Vidéo (depuis dossier)",
	"inputs": { "folder": {
		"name": "dossier",
		"tooltip": "Le dossier contenant les fichiers vidéo."
	} },
	"outputs": { "0": {
		"name": "vidéos",
		"tooltip": "Références vidéo paresseuses ; les images sont décodées uniquement lorsque nécessaire en aval."
	} }
};
var LoadVideoTextDataSetFromFolder = {
	"description": "Chargez un ensemble de paires vidéos et légendes textuelles à partir d’un dossier spécifié et les retourne sous forme de liste. Formats pris en charge : MP4, AVI, MOV, WEBM, MKV, FLV.",
	"display_name": "Charger Vidéo-Texte (depuis dossier)",
	"inputs": { "folder": {
		"name": "dossier",
		"tooltip": "Le dossier contenant les fichiers vidéo et les légendes .txt."
	} },
	"outputs": {
		"0": {
			"name": "vidéos",
...
var Preview3D = {
	"description": "Prévisualisez un fichier de modèle 3D sans l'enregistrer dans le répertoire de sortie ComfyUI.",
...
var PreviewAny = {
	"description": "Prévisualisez n'importe quelle valeur d'entrée sous forme de texte.",
...
var PreviewAudio = {
	"description": "Prévisualisez l'audio sans l'enregistrer dans le répertoire de sortie ComfyUI.",
...
var PreviewGaussianSplat = {
	"description": "Prévisualisez un fichier 3D gaussian splat sans l'enregistrer dans le répertoire de sortie ComfyUI.",
...
var PreviewPointCloud = {
	"description": "Prévisualisez un fichier 3D de nuage de points sans l'enregistrer dans le répertoire de sortie ComfyUI.",
...
var Save3DAdvanced = {
	"display_name": "Enregistrer 3D (Avancé)",
	"inputs": {
...
var SaveGaussianSplat = {
	"display_name": "Enregistrer Splat",
	"inputs": {
		"camera_info": { "name": "camera_info" },
		"filename_prefix": { "name": "filename_prefix" },
		"height": { "name": "height" },
...
var SavePointCloud = {
	"display_name": "Enregistrer le nuage de points",
	"inputs": {
		"camera_info": { "name": "camera_info" },
		"filename_prefix": { "name": "filename_prefix" },
		"height": { "name": "height" },
...
var SaveText = {
	"description": "Enregistrer le contenu texte dans un fichier du répertoire de sortie.",
	"display_name": "Enregistrer le texte",
	"inputs": {
		"filename_prefix": { "name": "filename_prefix" },
		"format": { "name": "format" },
		"preview_mode": {},
...
var SeedVR2Conditioning = {
	"description": "Générer le conditionnement positif/négatif SeedVR2 à partir d'un latent VAE.",
	"display_name": "Appliquer le conditionnement SeedVR2",
	"inputs": {
		"model": {
			"name": "model",
			"tooltip": "Le modèle SeedVR2."
		},
	...
	"outputs": {
		"0": {
			"name": "positive",
			"tooltip": "Le conditionnement positif pour l'échantillonnage."
		},
		"1": {
			"name": "negative",
			"tooltip": "Le conditionnement négatif pour l'échantillonnage."
		}
	}
};
var SeedVR2PostProcessing = {
	"description": "Aligne l’image générée avec l’image redimensionnée d’origine et applique une correction des couleurs.",
	"display_name": "Post-traitement de la sortie SeedVR2",
	"inputs": {
		"color_correction_method": {
			"name": "color_correction_method",
			"tooltip": "Méthode pour faire correspondre les couleurs de l’image générée à l’image d’origine. lab : transfert de couleur dans l’espace CIELAB, préservant les détails (le plus fidèle). wavelet : transfert des couleurs basses fréquences, en conservant les détails haute fréquence suréchantillonnés. adain : correspondance moyenne/écart-type par canal (le plus rapide, teinte globale). none : pas de transfert de couleur (alignement géométrique uniquement)."
		},
		"images": {
			"name": "images",
			"tooltip": "L’image générée à traiter."
		},
		"original_resized_images": {
			"name": "original_resized_images",
			"tooltip": "L’image redimensionnée d’origine avant prétraitement, utilisée comme référence."
		}
	},
	"outputs": { "0": {
		"name": "images",
		"tooltip": "L’image alignée et corrigée en couleur."
	} }
};
var SeedVR2Preprocess = {
	"description": "Ajoute un remplissage à une image redimensionnée pour le modèle SeedVR2. Le canal alpha est supprimé. Le nœud Post-traitement SeedVR2 réapplique le canal alpha à partir de l’image redimensionnée d’origine.",
	"display_name": "Prétraitement de l’entrée SeedVR2",
	"inputs": { "resized_images": {
		"name": "resized_images",
		"tooltip": "L’image redimensionnée à traiter."
	} },
	"outputs": { "0": {
		"name": "images",
		"tooltip": "L’image rembourrée pour l’encodage VAE."
	} }
};
var SeedVR2TemporalChunk = {
	"description": "Découpe un latent vidéo SeedVR2 en segments temporels qui se chevauchent, suffisamment petits pour être traités un à un dans la VRAM. Les sorties latentes sont connectées à la fois à Appliquer le conditionnement SeedVR2 et à l’entrée latente du sampler, avant de les recombiner avec Fusionner les latents SeedVR2.",
	"display_name": "Découper le latent SeedVR2",
	"inputs": {
		"chunking_mode": {
			"name": "chunking_mode",
			"tooltip": "manual = utilise exactement frames_per_chunk ; auto = prédit le plus grand segment possible selon la VRAM disponible."
		},
		"latent": {
			"name": "latent",
			"tooltip": "Le latent SeedVR2 encodé par VAE à découper."
		},
		"temporal_overlap": {
			"name": "temporal_overlap",
			"tooltip": "Images latentes partagées entre segments adjacents et fondues lors de la fusion ; 0 = pas de chevauchement."
		}
	},
	"outputs": {
		"0": {
			"name": "latents",
			"tooltip": "Les segments temporels dans l’ordre de la séquence."
		},
		"1": {
			"name": "temporal_overlap",
			"tooltip": "Le chevauchement effectif d’images latentes entre segments adjacents, pour Fusionner les latents SeedVR2."
		}
	}
};
var SeedVR2TemporalMerge = {
	"description": "Recombine les segments temporels latents SeedVR2 échantillonnés en un seul latent, en fondant chaque chevauchement avec une fenêtre de Hann dimensionnée par le temporal_overlap issu de Découper le latent SeedVR2.",
	"display_name": "Fusionner les latents SeedVR2",
	"inputs": {
		"latents": {
			"name": "latents",
			"tooltip": "Les segments temporels échantillonnés dans l’ordre de la séquence."
		},
		"temporal_overlap": {
			"name": "temporal_overlap",
			"tooltip": "La sortie temporal_overlap de Découper le latent SeedVR2. 0 = simple concaténation."
		}
	},
	"outputs": { "0": {
		"name": "latent",
		"tooltip": "Le latent recombiné sur toute la durée."
	} }
};
...
var ShuffleVideoDataset = {
	"description": "Mélangez aléatoirement l’ordre des vidéos dans une liste.",
	"display_name": "Mélanger la liste de vidéos",
	"inputs": {
		"control_after_generate": { "name": "contrôle après génération" },
		"seed": {
			"name": "graine",
		...
		"videos": {
			"name": "vidéos",
			"tooltip": "Liste des vidéos à mélanger."
		}
	},
	"outputs": { "0": {
		"name": "vidéos",
		"tooltip": "Vidéos mélangées"
	} }
};
var ShuffleVideoTextDataset = {
	"description": "Mélangez aléatoirement l’ordre des paires vidéo-texte dans une liste.",
	"display_name": "Mélanger les paires Vidéo-Texte",
	"inputs": {
		"control_after_generate": { "name": "contrôle après génération" },
		"seed": {
			"name": "graine",
...
var SyncLipSyncNode = {
	...
	"inputs": {
		...
		"model_speaker_frame": { "name": "image_locuteur" },
		"model_speaker_selection": { "name": "sélection_locuteur" },
		"model_speaker_x": { "name": "locuteur_x" },
		"model_speaker_y": { "name": "locuteur_y" },
		"model_sync_mode": { "name": "mode_sync" },
		"seed": {
			"name": "graine",
			"tooltip": "La graine contrôle si le nœud doit être relancé ; les résultats sont non déterministes quel que soit la graine."
		},
...
var SyncTalkingImageNode = {
	...
	"inputs": {
		...
		"model_auto_downscale": { "name": "auto_redimensionnement" },
		"model_speaker_selection": { "name": "sélection_locuteur" },
		"model_speaker_x": { "name": "locuteur_x" },
		"model_speaker_y": { "name": "locuteur_y" },
		"prompt": {
...
var TextEncodeMageFlowEdit = {
	"description": "Encode une instruction d’édition avec une ou plusieurs images de référence pour Mage-Flow-Edit. Les latents de référence sont redimensionnés à la résolution de sortie (largeur/hauteur, ou à la taille de la première image si 0). Utilisez la sortie latent pour l’échantillonnage afin que les tailles correspondent toujours.",
	...
	"inputs": {
		...
		"height": {
			"name": "height",
			"tooltip": "Hauteur de sortie. 0 = utiliser la taille de la première image de référence."
		},
		"images": {
			"name": "images",
			"tooltip": "Image(s) de référence à éditer. Toutes les références sont redimensionnées à la résolution de sortie avant l’encodage."
		},
		"negative_prompt": { "name": "negative_prompt" },
		"prompt": { "name": "prompt" },
		"vae": { "name": "vae" },
		"width": {
			"name": "width",
			"tooltip": "Largeur de sortie. 0 = utiliser la taille de la première image de référence."
		}
	},
	"outputs": {
		"0": {
...
var TextOverlay = {
	"description": "Superposez du texte sur une image ou un lot d’images.",
	"display_name": "Superposer du texte",
	"inputs": {
		"align": { "name": "alignement" },
		"color": {
			"name": "couleur",
			"tooltip": "Couleur du texte."
		},
		"font_size": {
			"name": "taille_de_police",
			"tooltip": "Taille de la police en pourcentage de la hauteur de l’image."
		},
		"images": { "name": "images" },
		"outline": {
			"name": "contour",
			"tooltip": "Dessiner un contour noir autour du texte."
		},
...
var VideoFrameSample = {
	"description": "Échantillonnez un nombre fixe d’images d’une vidéo en utilisant différentes stratégies.",
	"display_name": "Échantillonner une image vidéo",
	"inputs": {
		"control_after_generate": { "name": "contrôle après génération" },
		"num_frames": {
			"name": "nombre d’images",
			"tooltip": "Nombre d’images à échantillonner."
		},
		"seed": {
			"name": "graine",
			"tooltip": "Graine aléatoire (utilisée uniquement avec la stratégie 'random')."
		},
		"strategy": {
			"name": "stratégie",
			"tooltip": "uniform: espacement régulier, head: premiers N, tail: derniers N, random: aléatoire trié."
		},
		"video": {
			"name": "vidéo",
			"tooltip": "Vidéo d’entrée."
		}
	},
	"outputs": { "0": {
		"name": "vidéo",
		"tooltip": "Vidéo échantillonnée."
	} }
};
...
var VideoRandomTemporalCrop = {
	"description": "Rogne aléatoirement une plage continue d’images d’une vidéo.",
	"display_name": "Rogner la vidéo (aléatoire temporel)",
	"inputs": {
		"control_after_generate": { "name": "contrôle après génération" },
		"length": {
			"name": "longueur",
			"tooltip": "Nombre d’images à conserver."
		},
		"seed": {
			"name": "graine",
			"tooltip": "Graine aléatoire."
	...
	"outputs": { "0": {
		"name": "vidéo",
		"tooltip": "Vidéo rognée (paresseux)."
	} }
};
var VideoTemporalCrop = {
	"description": "Rogne une plage continue d’images d’une vidéo.",
	"display_name": "Rogner la vidéo (temporel)",
	"inputs": {
		"length": {
			"name": "longueur",
			"tooltip": "Nombre d’images à conserver."
		...
		"start_frame": {
			"name": "image de départ",
			"tooltip": "Indice de l’image de départ."
		},
		"video": {
			"name": "vidéo",
			"tooltip": "Vidéo d’entrée."
...
var WanUni3CControlnetApply = {
	"display_name": "Appliquer Wan Uni3C ControlNet",
	"inputs": {
		"end_percent": { "name": "pourcentage de fin" },
		"model": { "name": "modèle" },
		"model_patch": { "name": "correctif du modèle" },
		"render_video": {
			"name": "vidéo de rendu",
			"tooltip": "La vidéo de guidage rendue à partir de la trajectoire de la caméra, le plus souvent des rendus de nuages de points déformés de l’image d’entrée."
		},
		"start_percent": { "name": "pourcentage de début" },
		"strength": { "name": "force" },
		"vae": { "name": "vae" }
...
//# sourceMappingURL=nodeDefs-XKfFuZ2W.js.map