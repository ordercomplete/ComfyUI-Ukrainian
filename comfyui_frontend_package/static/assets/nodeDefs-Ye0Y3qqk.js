//#region src/locales/ko/nodeDefs.json
var APG = {
	"display_name": "적응형 투사 가이던스",
	"inputs": {
		"eta": {
			"name": "eta",
			"tooltip": "병렬 가이던스 벡터의 크기를 조절합니다. 1로 설정 시 기본 CFG 동작입니다."
		},
		"model": { "name": "모델" },
		"momentum": {
			"name": "momentum",
			"tooltip": "확산 과정 중 가이던스의 이동 평균을 조절합니다. 0으로 설정 시 비활성화됩니다."
		},
		"norm_threshold": {
			"name": "norm_threshold",
			"tooltip": "가이던스 벡터를 이 값으로 정규화합니다. 0으로 설정 시 정규화가 비활성화됩니다."
		}
	},
...
var AdjustBrightness = {
	"description": "이미지의 밝기를 조절합니다.",
	"display_name": "밝기 조정",
	"inputs": {
		"factor": {
			"name": "factor",
			"tooltip": "밝기 계수. 1.0 = 변경 없음, <1.0 = 더 어둡게, >1.0 = 더 밝게."
		},
		"images": {
			"name": "images",
			"tooltip": "처리할 이미지."
...
var AdjustContrast = {
	"description": "이미지의 대비를 조절합니다.",
	"display_name": "명암 조정",
	"inputs": {
		"factor": {
			"name": "factor",
			"tooltip": "명암 계수. 1.0 = 변경 없음, <1.0 = 명암 감소, >1.0 = 명암 증가."
		},
		"images": {
			"name": "images",
			"tooltip": "처리할 이미지."
...
var AlignYourStepsScheduler = {
	...
	"inputs": {
		"denoise": { "name": "노이즈 제거양" },
		"model_type": { "name": "모델 유형" },
		"steps": { "name": "스텝 수" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var AnimaLLLiteApply = {
	"display_name": "Anima LLLite 적용",
	"inputs": {
		"end_percent": { "name": "종료 비율" },
		"image": { "name": "image" },
		"mask": { "name": "mask" },
		"model": { "name": "model" },
		"model_patch": { "name": "model_patch" },
		"start_percent": { "name": "시작 비율" },
		"strength": { "name": "강도" }
	}
};
var AudioAdjustVolume = {
	"description": "오디오의 볼륨을 데시벨(dB) 단위로 지정한 만큼 조절합니다.",
	"display_name": "오디오 볼륨 조절",
	"inputs": {
		"audio": { "name": "오디오" },
		"volume": {
			"name": "volume",
			"tooltip": "데시벨(dB) 단위의 볼륨 조절. 0 = 변경 없음, +6 = 두 배, -6 = 절반 등"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var AudioConcat = {
	"description": "지정된 방향으로 audio1을 audio2에 연결합니다.",
	"display_name": "오디오 연결",
	"inputs": {
		"audio1": { "name": "audio1" },
		"audio2": { "name": "audio2" },
		"direction": {
			"name": "direction",
			"tooltip": "audio2를 audio1 뒤에 추가할지 앞에 추가할지 여부입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var AudioEncoderEncode = {
	"display_name": "오디오 인코더 인코딩",
	"inputs": {
		"audio": { "name": "audio" },
...
var AudioMerge = {
	...
	"inputs": {
		...
		"merge_method": {
			"name": "merge_method",
			"tooltip": "오디오 파형을 결합하는 데 사용되는 방법입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var BeebleSwitchXImageEdit = {
	"description": "Beeble SwitchX로 단일 이미지를 편집합니다. 장면의 모든 요소(배경, 조명, 의상 등)를 변경하면서 원본 피사체의 픽셀은 그대로 유지합니다. 참조 이미지 및/또는 텍스트 프롬프트로 새로운 모습을 설명하세요. 최대 약 2.77MP.",
	"display_name": "Beeble SwitchX 이미지 편집",
	"inputs": {
		"alpha_mode": {
			"name": "alpha_mode",
			"tooltip": "SwitchX가 무엇을 유지하고 재생성할지 결정하는 방식을 제어합니다. 'auto'는 주요 피사체를 자동으로 분리합니다. 'fill'은 기하학을 유지하면서 전체 프레임을 재생성합니다. 'select'는 첫 프레임의 키프레임을 clip 전체에 적용합니다. 'custom'은 사용자가 제공한 프레임별 알파 매트를 사용합니다."
		},
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "원하는 출력에 대한 텍스트 설명(최대 2000자). 'prompt' 또는 'reference_image' 중 하나는 반드시 필요합니다."
		},
		"reference_image": {
			"name": "reference_image",
			"tooltip": "결과가 적용할 참조 이미지의 스타일(배경, 조명, 의상 등). 'reference_image' 또는 'prompt' 중 하나는 반드시 필요합니다."
		},
		"seed": {
			"name": "seed",
	...
	"outputs": {
		...
		"1": {
			"name": "alpha",
			"tooltip": "Beeble이 사용한 알파 매트입니다. 별도의 매트가 없는 'fill' 모드에서는 비어 있습니다."
		}
	}
};
var BeebleSwitchXVideoEdit = {
	"description": "Beeble SwitchX로 비디오를 편집합니다. 장면의 모든 요소(배경, 조명, 의상 등)를 변경하면서 원본 피사체의 픽셀과 동작은 그대로 유지합니다. 참조 이미지 및/또는 텍스트 프롬프트로 새로운 모습을 설명하세요. 최대 240프레임, 프레임당 최대 약 2.77MP.",
	"display_name": "Beeble SwitchX 비디오 편집",
	"inputs": {
		"alpha_mode": {
			"name": "alpha_mode",
			"tooltip": "SwitchX가 무엇을 유지하고 재생성할지 결정하는 방식을 제어합니다. 'auto'는 주요 피사체를 자동으로 분리합니다. 'fill'은 기하학을 유지하면서 전체 프레임을 재생성합니다. 'select'는 첫 프레임의 키프레임을 clip 전체에 적용합니다. 'custom'은 사용자가 제공한 프레임별 알파 매트를 사용합니다."
...
var BerniniConditioning = {
	"description": "Bernini 인컨텍스트 비디오/이미지 컨디셔닝을 위한 컨디셔닝 노드입니다. 다음 작업에 사용할 수 있습니다: t2v (텍스트-투-비디오), v2v (비디오-투-비디오), rv2v (참조 기반 비디오 편집), r2v (참조-투-비디오), ads2v (이미지/비디오를 비디오에 삽입). 인컨텍스트 토큰(r2v, rv2v)으로 삽입된 참조 이미지는 고유의 원본 종횡비(긴 변이 ref_max_size로 제한됨)로 독립적으로 인코딩됩니다.",
	...
	"inputs": {
		...
		"ref_max_size": {
			"name": "ref_max_size",
			"tooltip": "reference_video 및 reference_images의 긴 변의 최대 크기. 종횡비를 유지하며 리사이즈되고 16px 단위로 맞춰집니다."
		},
		"reference_images": { "name": "reference_images" },
		"reference_video": {
			"name": "reference_video",
			"tooltip": "원본 비디오에 삽입할 비디오(ads2v)."
		},
		"source_video": {
			"name": "source_video",
			"tooltip": "편집 또는 스타일 변경할 원본 비디오(v2v, rv2v). width/height로 리사이즈되고 length로 자릅니다."
		},
		"vae": { "name": "vae" },
		"width": { "name": "width" }
	},
...
var BriaImageEditNode = {
	...
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"guidance_scale": {
			"name": "가이던스 스케일",
		...
		"negative_prompt": { "name": "네거티브 프롬프트" },
		"prompt": {
			"name": "프롬프트",
...
var BriaRemoveImageBackground = {
	"description": "Bria RMBG 2.0을 사용하여 이미지에서 배경을 제거합니다.",
	"display_name": "Bria 이미지 배경 제거",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"image": { "name": "image" },
		"moderation": {
...
var BriaRemoveVideoBackground = {
	"description": "Bria를 사용하여 비디오에서 배경을 제거합니다.",
	"display_name": "Bria 비디오 배경 제거",
	"inputs": {
		"background_color": {
			"name": "background_color",
			"tooltip": "출력 비디오의 배경색입니다."
		},
		"control_after_generate": { "name": "생성 후 제어" },
		"seed": {
			"name": "seed",
...
var BriaTransparentVideoBackground = {
	"description": "Bria를 사용하여 비디오에서 배경을 제거하고 잘라낸 프레임과 알파 마스크를 반환합니다. 둘 다 합성 노드에 연결하거나, Save WEBM에 전달하여 투명 비디오로 저장할 수 있습니다.",
	"display_name": "Bria 비디오 배경 제거 (투명)",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"seed": {
			"name": "seed",
...
var BriaVideoGreenScreen = {
	"description": "Bria를 사용하여 비디오의 배경을 단색 크로마키 스크린으로 교체합니다.",
	"display_name": "Bria 비디오 그린 스크린",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"green_shade": {
			"name": "green_shade",
			"tooltip": "전경 뒤에 적용되는 단색 크로마키 색상: broadcast_green (#00B140), chroma_green (#00FF00), 또는 blue_screen (#0000FF)."
		},
		"seed": {
			"name": "seed",
			"tooltip": "시드는 노드가 다시 실행될지 여부를 제어합니다. 시드와 관계없이 결과는 비결정적입니다."
...
var BriaVideoReplaceBackground = {
	"description": "Bria를 사용하여 비디오의 배경을 제공된 이미지 또는 비디오로 교체합니다. 출력은 전경의 해상도와 프레임 속도를 유지하며, 배경의 종횡비가 다를 경우 맞춰 늘어나므로 왜곡 없는 결과를 원한다면 종횡비를 맞추세요.",
	"display_name": "Bria 비디오 배경 교체",
	"inputs": {
		"background_image": {
			"name": "background_image",
			"tooltip": "전경 뒤에 합성할 배경 이미지입니다. 배경 이미지 또는 배경 비디오 중 하나만 제공하세요."
		},
		"background_video": {
			"name": "background_video",
			"tooltip": "전경 뒤에 합성할 배경 비디오입니다. 배경 이미지 또는 배경 비디오 중 하나만 제공하세요."
		},
		"control_after_generate": { "name": "control after generate" },
		"seed": {
			"name": "seed",
		...
		"video": {
			"name": "video",
			"tooltip": "배경이 교체될 전경 비디오입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var BuildJsonPromptIdeogram = {
	"description": "Ideogram 4 모델을 위한 JSON 프롬프트를 생성합니다.",
	"display_name": "JSON 프롬프트 생성 (Ideogram)",
	"inputs": {
		"aesthetics": {
			"name": "미적 요소",
			"tooltip": "필수 미적 키워드 (예: moody, cinematic, desaturated)."
		},
		"background": {
			"name": "배경",
			"tooltip": "이미지의 배경 또는 환경에 대한 필수 설명입니다."
		},
		"color_palette": {
			"name": "컬러 팔레트",
			"tooltip": "이미지의 주요 색상을 지정하는 헥스 색상 코드입니다. 최대 16개까지 입력 가능합니다."
		},
		"element": {
			"name": "요소",
			"tooltip": "노드 Create Bounding Boxes에서 가져온 프롬프트 요소입니다."
		},
		"high_level_description": {
			"name": "상위 설명",
			"tooltip": "이미지에 대한 1~2문장의 선택적 설명입니다. 강력히 권장합니다."
		},
		"lighting": {
			"name": "조명",
			"tooltip": "필수 조명 설명 (예: golden hour, rim light, dramatic shadows)."
		},
		"medium": {
			"name": "매체",
			"tooltip": "필수 매체 유형 (예: photograph, illustration, 3d_render, painting, graphic_design). 스타일이 photo일 때는 photograph로 설정하세요."
		},
		"style": { "name": "스타일" }
	},
	"outputs": { "0": {
...
var ByteDance2FirstLastFrameNode = {
	"description": "Seedance 2.0을 사용하여 첫 프레임 이미지와 선택적인 마지막 프레임 이미지로 비디오를 생성합니다.",
	"display_name": "ByteDance Seedance 2.0 첫-마지막 프레임에서 비디오 생성",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"first_frame": {
			"name": "first_frame",
			"tooltip": "비디오의 첫 프레임 이미지입니다."
		},
		"first_frame_asset_id": {
			"name": "first_frame_asset_id",
			"tooltip": "첫 프레임으로 사용할 Seedance asset_id입니다. first_frame 이미지 입력과는 상호 배타적입니다."
		},
		"last_frame": {
			"name": "last_frame",
			"tooltip": "비디오의 마지막 프레임 이미지입니다."
		},
		"last_frame_asset_id": {
			"name": "last_frame_asset_id",
			"tooltip": "마지막 프레임으로 사용할 Seedance asset_id입니다. last_frame 이미지 입력과는 상호 배타적입니다."
		},
		"model": {
			"name": "model",
			"tooltip": "최고 품질을 위한 Seedance 2.0; 속도 최적화를 위한 Seedance 2.0 Fast."
		},
		...
		"watermark": {
			"name": "watermark",
			"tooltip": "비디오에 워터마크를 추가할지 여부입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ByteDance2ReferenceNode = {
	"description": "Seedance 2.0을 사용하여 레퍼런스 이미지, 비디오, 오디오로 비디오를 생성, 편집 또는 확장합니다. 멀티모달 레퍼런스, 비디오 편집, 비디오 확장을 지원합니다.",
	"display_name": "ByteDance Seedance 2.0 레퍼런스에서 비디오 생성",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model": {
			"name": "model",
...
var ByteDance2TextToVideoNode = {
	"description": "텍스트 프롬프트를 기반으로 Seedance 2.0 모델로 비디오를 생성합니다.",
	"display_name": "ByteDance Seedance 2.0 텍스트에서 비디오 생성",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model": {
			"name": "model",
...
var ByteDanceCreateImageAsset = {
	"description": "Seedance 2.0 개인 이미지 에셋을 생성합니다. 입력 이미지를 업로드하고 지정된 에셋 그룹에 등록합니다. group_id가 비어 있으면, 새로운 그룹을 생성하기 전에 실명 인증(H5 인증)을 진행합니다.",
	"display_name": "ByteDance 이미지 에셋 생성",
	"inputs": {
		"group_id": {
			"name": "group_id",
			"tooltip": "동일 인물에 대한 반복 인증을 건너뛰기 위해 기존 Seedance 에셋 그룹 ID를 재사용합니다. 비워두면 브라우저에서 실명 인증을 진행하고 새 그룹을 생성합니다."
		},
		"image": {
			"name": "image",
			"tooltip": "개인 에셋으로 등록할 이미지입니다."
		}
	},
	"outputs": {
		"0": {
...
var ByteDanceCreateVideoAsset = {
	"description": "Seedance 2.0 개인 비디오 에셋을 생성합니다. 입력 비디오를 업로드하고 지정된 에셋 그룹에 등록합니다. group_id가 비어 있으면, 새로운 그룹을 생성하기 전에 실명 인증(H5 인증)을 진행합니다.",
	"display_name": "ByteDance 비디오 에셋 생성",
	"inputs": {
		"group_id": {
			"name": "group_id",
			"tooltip": "동일 인물에 대한 반복 인증을 건너뛰기 위해 기존 Seedance 에셋 그룹 ID를 재사용합니다. 비워두면 브라우저에서 실명 인증을 진행하고 새 그룹을 생성합니다."
...
var ByteDanceFirstLastFrameNode = {
	...
	"inputs": {
		"aspect_ratio": {
			"name": "aspect_ratio",
			"tooltip": "출력 비디오의 화면비입니다."
		},
		"camera_fixed": {
			"name": "camera_fixed",
			"tooltip": "카메라를 고정할지 여부를 지정합니다. 플랫폼이 카메라 고정 지시를 프롬프트에 추가하지만 실제 효과를 보장하지는 않습니다."
		},
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": {
			"name": "duration",
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "비디오 생성에 사용되는 텍스트 프롬프트입니다."
		},
		"resolution": {
			"name": "resolution",
			"tooltip": "출력 비디오의 해상도입니다."
		},
		"seed": {
			"name": "seed",
		...
		"watermark": {
			"name": "watermark",
			"tooltip": "비디오에 \"AI 생성\" 워터마크를 추가할지 여부"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ByteDanceImageNode = {
	"description": "프롬프트 기반으로 ByteDance 모델을 사용하여 이미지 생성",
	"display_name": "ByteDance 이미지",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"guidance_scale": {
			"name": "가이던스 스케일",
			"tooltip": "값이 높을수록 이미지가 프롬프트를 더 밀접하게 따름"
		},
		"height": {
			"name": "높이",
		...
		"prompt": {
			"name": "프롬프트",
			"tooltip": "이미지 생성에 사용할 텍스트 프롬프트"
		},
		"seed": {
			"name": "시드",
			"tooltip": "생성에 사용할 시드 값"
		},
		"size_preset": {
			"name": "크기 사전 설정",
			"tooltip": "권장 크기를 선택하세요. 사용자 지정을 선택하면 아래 너비와 높이를 사용합니다"
		},
		"watermark": {
			"name": "워터마크",
			"tooltip": "이미지에 \"AI 생성\" 워터마크를 추가할지 여부"
		},
		"width": {
			"name": "너비",
			"tooltip": "이미지의 사용자 지정 너비. `size_preset`이 `Custom`으로 설정된 경우에만 값이 적용됨"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ByteDanceImageReferenceNode = {
	"description": "프롬프트와 참조 이미지를 사용하여 비디오 생성",
	"display_name": "ByteDance 참조 이미지를 비디오로",
	"inputs": {
		"aspect_ratio": {
			"name": "화면비율",
			"tooltip": "출력 비디오의 화면비율입니다."
		},
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": {
			"name": "지속 시간",
		...
		"watermark": {
			"name": "워터마크",
			"tooltip": "비디오에 \"AI 생성\" 워터마크를 추가할지 여부입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ByteDanceImageToVideoNode = {
	"description": "이미지와 프롬프트를 기반으로 API를 통해 ByteDance 모델을 사용하여 비디오 생성",
	"display_name": "ByteDance 이미지 투 비디오",
	"inputs": {
		"aspect_ratio": {
			"name": "화면비율",
			"tooltip": "출력 비디오의 화면비율입니다."
		...
		"prompt": {
			"name": "프롬프트",
			"tooltip": "비디오 생성에 사용된 텍스트 프롬프트입니다."
		},
		"resolution": {
			"name": "해상도",
			"tooltip": "출력 비디오의 해상도입니다."
...
var ByteDanceSeedAudio = {
	"description": "ByteDance Seed Audio 1.0을 사용하여 하나의 프롬프트로 음성, 음악, 효과음, 다중 화자 대화를 생성합니다. 프롬프트에 음성(들), 감정, 분위기, 배경 음악, 효과음을 설명하고, 말할 대사를 포함하세요. 내장 프리셋 음성을 선택하거나, 최대 3개의 참조 clip에서 음성을 클론하거나(@Audio1-3으로 프롬프트에 태그), 캐릭터 이미지에서 음성을 추출할 수 있습니다. 실행당 최대 2분의 오디오를 생성할 수 있습니다.",
	"display_name": "ByteDance Seed Audio 1.0",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"loudness_rate": {
			"name": "loudness_rate",
			"tooltip": "음량. 0 = 보통, 100 = 2.0배, -50 = 0.5배."
		},
		"model": {
			"name": "model",
			"tooltip": "seed-audio-1.0-multilingual: 20개 언어(영어, 중국어, 일본어, 한국어, 멕시코 및 카스티야 스페인어, 인도네시아어, 독일어, 브라질 포르투갈어, 프랑스어, 태국어, 베트남어, 말레이어, 필리핀어, 이탈리아어, 러시아어, 네덜란드어, 폴란드어, 터키어, 스웨덴어) 및 문장별 타이밍 제어(\"[5.5s:8.0s] ...\" 타임스탬프 사용) 지원. seed-audio-1.0: 영어와 중국어만 지원, 타이밍 제어 없음."
		},
		"pitch_rate": {
			"name": "pitch_rate",
			"tooltip": "피치(음높이) 반음 단위 이동(-12 ~ 12)."
		},
		"reference_mode": {
			"name": "reference_mode",
			"tooltip": "음성 조건 방식: 'text only'(모든 것을 프롬프트에 설명), 'audio reference'(최대 3개의 음성 클론, @Audio1-3 태그), 'image reference'(캐릭터 이미지에서 음성 추출), 'preset voice'(내장된 이름 음성으로 프롬프트 읽기) 중 선택."
		},
		"sample_rate": {
			"name": "sample_rate",
			"tooltip": "출력 샘플레이트(Hz)."
		...
		"speech_rate": {
			"name": "speech_rate",
			"tooltip": "말하기 속도. 0 = 보통, 100 = 2.0배, -50 = 0.5배."
		},
		"text_prompt": {
			"name": "text_prompt",
			"tooltip": "음성(들), 감정, 속도, 분위기, 배경 음악, 효과음을 설명하고, 말할 대사를 포함하세요(대화의 경우 캐릭터 이름을 함께 작성). 'audio reference' 모드에서는 연결된 clip을 @Audio1, @Audio2, @Audio3 순서로 참조하세요. 최대 3000자까지 입력 가능합니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ByteDanceSeedNode = {
	"description": "ByteDance의 Seed 2.0 모델로 텍스트 응답을 생성합니다. 텍스트 프롬프트와 선택적으로 하나 이상의 이미지 또는 비디오를 멀티모달 컨텍스트로 제공합니다.",
	"display_name": "ByteDance Seed",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"model": {
			"name": "모델",
			"tooltip": "응답을 생성하는 데 사용되는 Seed 모델입니다."
		},
		"model_temperature": { "name": "온도" },
		"prompt": {
			"name": "프롬프트",
			"tooltip": "모델에 입력할 텍스트입니다."
		},
		"seed": {
			"name": "시드",
			"tooltip": "시드는 노드가 다시 실행될지 여부를 제어합니다. 시드와 관계없이 결과는 비결정적입니다."
		...
		"system_prompt": {
			"name": "시스템 프롬프트",
			"tooltip": "모델의 동작을 지시하는 기본 지침입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ByteDanceSeedreamNode = {
	"description": "최대 4K 해상도까지 통합 텍스트-이미지 생성 및 정밀한 단일 문장 편집.",
	"display_name": "ByteDance Seedream 4",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"fail_on_partial": {
			"name": "fail_on_partial",
			"tooltip": "활성화하면 요청된 이미지 중 일부가 누락되거나 오류가 반환될 경우 실행을 중단합니다."
		},
		"height": {
			"name": "높이",
			"tooltip": "이미지의 사용자 지정 높이입니다. 이 값은 `size_preset`이 `Custom`으로 설정된 경우에만 작동합니다"
		},
		"image": {
			"name": "이미지",
			"tooltip": "이미지-이미지 생성을 위한 입력 이미지입니다. 단일 또는 다중 참조 생성을 위한 1-10개 이미지 목록입니다."
		},
		"max_images": {
			"name": "max_images",
			"tooltip": "sequential_image_generation='auto'일 때 생성할 최대 이미지 수입니다. 총 이미지 수(입력 + 생성)는 15개를 초과할 수 없습니다."
		},
		"model": { "name": "모델" },
		"prompt": {
			"name": "프롬프트",
		...
		"sequential_image_generation": {
			"name": "순차적 이미지 생성",
			"tooltip": "그룹 이미지 생성 모드입니다. 'disabled'는 단일 이미지를 생성하고, 'auto'는 모델이 여러 관련 이미지(예: 스토리 장면, 캐릭터 변형)를 생성할지 여부를 결정하도록 합니다."
		},
		"size_preset": {
			"name": "크기 사전 설정",
			"tooltip": "권장 크기를 선택하세요. 아래 너비와 높이를 사용하려면 사용자 지정을 선택하세요."
		},
		"watermark": {
			"name": "watermark",
			"tooltip": "이미지에 \"AI 생성\" 워터마크를 추가할지 여부입니다."
		},
		"width": {
			"name": "너비",
			"tooltip": "이미지의 사용자 지정 너비입니다. 이 값은 `size_preset`이 `Custom`으로 설정된 경우에만 작동합니다"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ByteDanceSeedreamNodeV2 = {
	...
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"model": { "name": "모델" },
		"model_height": { "name": "높이" },
		"model_size_preset": { "name": "사이즈 프리셋" },
		"model_width": { "name": "너비" },
		"prompt": {
			"name": "프롬프트",
			"tooltip": "이미지를 생성하거나 편집하기 위한 텍스트 프롬프트입니다."
		...
		"thinking": {
			"name": "thinking",
			"tooltip": "모델의 프롬프트 최적화 추론('thinking')을 활성화하여 더 나은 프롬프트 준수를 제공합니다. 생성 시간이 크게 증가할 수 있습니다 — 특히 Seedream 5.0 Pro에서 두드러집니다. 텍스트-투-이미지에서만 비활성화할 수 있으며, 참조 이미지가 제공된 경우에는 비활성화할 수 없습니다."
		},
		"watermark": {
			"name": "워터마크",
...
var CFGNorm = {
	...
	"inputs": {
		...
		"pre_cfg": {
			"name": "pre_cfg",
			"tooltip": "참이면, 샘플러의 CFG 결합 전에 결합된 노이즈를 클램핑 없이 리스케일합니다(증폭될 수 있음). Lens와 같은 모델에서 사용되는 norm-scaled CFG와 일치합니다. 기본값 false는 원래의 post-CFG x0-space 감쇠 전용 동작을 유지합니다."
		},
...
var CFGOverride = {
	"description": "[start, end] 퍼센트 구간 동안 cfg를 고정 값으로 오버라이드합니다. 여러 오버라이드가 있을 경우, 샘플러에 가장 가까운 것이 겹치는 부분에서 우선 적용됩니다.",
	"display_name": "CFG 오버라이드",
	"inputs": {
		"cfg": { "name": "cfg" },
		"end_percent": { "name": "종료 퍼센트" },
		"model": { "name": "model" },
		"start_percent": { "name": "시작 퍼센트" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var CFGZeroStar = {
	"display_name": "CFGZeroStar",
	"inputs": { "model": { "name": "모델" } },
	"outputs": { "0": {
		"name": "패치된 모델",
		"tooltip": null
	} }
...
var CLIPSetLastLayer = {
	...
	"inputs": {
		"clip": { "name": "clip" },
		"stop_at_clip_layer": { "name": "CLIP 레이어 중단점" }
	}
};
var CLIPTextEncode = {
	...
	"outputs": { "0": { "tooltip": "확산 모델을 유도하는 데 사용되는 텍스트 임베딩을 포함하는 조건입니다." } }
};
...
var CLIPTextEncodeFlux = {
	...
	"inputs": {
		"clip": { "name": "clip" },
		"clip_l": { "name": "clip-l 프롬프트" },
		"guidance": { "name": "가이던스" },
		"t5xxl": { "name": "t5xxl 프롬프트" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var CLIPTextEncodeHiDream = {
	...
	"inputs": {
		"clip": { "name": "clip" },
		"clip_g": { "name": "clip-g 프롬프트" },
		"clip_l": { "name": "clip-l 프롬프트" },
		"llama": { "name": "llama 프롬프트" },
		"t5xxl": { "name": "t5xxl 프롬프트" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var CLIPTextEncodeSDXL = {
	...
	"inputs": {
		...
		"crop_w": { "name": "크롭 너비" },
		"height": { "name": "높이" },
		"target_height": { "name": "목표 높이" },
		"target_width": { "name": "목표 너비" },
		"text_g": { "name": "clip-g 프롬프트" },
		"text_l": { "name": "clip-l 프롬프트" },
		"width": { "name": "너비" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var CLIPVisionLoader = {
	...
	"inputs": { "clip_name": { "name": "CLIP 파일명" } }
};
var Canny = {
	"display_name": "Canny 경계 필터",
	"inputs": {
		"high_threshold": { "name": "높은 임계값" },
		"image": { "name": "이미지" },
		"low_threshold": { "name": "낮은 임계값" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var CaseConverter = {
	"display_name": "대소문자 변환기",
	"inputs": {
		"mode": { "name": "mode" },
		"string": { "name": "string" }
	},
...
var CenterCropImages = {
	"description": "이미지를 지정한 크기로 중앙에서 자릅니다.",
	"display_name": "중앙 자르기",
	"inputs": {
		"height": {
			"name": "height",
...
var CheckpointLoader = {
	...
	"inputs": {
		"ckpt_name": { "name": "체크포인트 파일명" },
		"config_name": { "name": "설정 이름" }
	}
};
var CheckpointLoaderSimple = {
	...
	"outputs": {
		"0": { "tooltip": "노이즈 제거를 위한 잠재 모델입니다." },
		"1": { "tooltip": "텍스트 프롬프트를 인코딩하는 데 사용되는 CLIP 모델입니다." },
		"2": { "tooltip": "이미지를 잠재 공간으로 인코딩하고 디코딩하는 데 사용되는 VAE 모델입니다." }
	}
};
var CheckpointSave = {
...
var ChromaRadianceOptions = {
	"description": "Chroma Radiance 모델의 고급 옵션을 설정할 수 있습니다.",
	"display_name": "ChromaRadianceOptions",
	"inputs": {
		"end_sigma": {
			"name": "end_sigma",
			"tooltip": "이 옵션이 적용될 마지막 시그마 값입니다."
		},
		"force_sequential_txt_ids": {
			"name": "force_sequential_txt_ids",
			"tooltip": "연속 텍스트 토큰 ID를 0 대신 강제로 사용합니다. 2026-05-22부터 2026-06-01 사이에 이 방식으로 학습되었으나 state dict에 __sequential__ 키가 없는 체크포인트에 사용해야 합니다."
		},
		"model": { "name": "model" },
		"nerf_tile_size": {
			"name": "nerf_tile_size",
			"tooltip": "기본 NeRF 타일 크기를 재정의할 수 있습니다. -1은 기본값(32)을 사용함을 의미합니다. 0은 비타일링 모드를 사용함을 의미합니다(많은 VRAM이 필요할 수 있음)."
		},
		"preserve_wrapper": {
			"name": "preserve_wrapper",
			"tooltip": "활성화하면 기존 모델 함수 래퍼가 존재할 경우 이를 위임합니다. 일반적으로 활성화된 상태로 유지해야 합니다."
		},
		"start_sigma": {
			"name": "start_sigma",
			"tooltip": "이 옵션이 적용될 첫 번째 시그마 값입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ClaudeNode = {
	"description": "Anthropic의 Claude 모델로 텍스트 응답을 생성합니다. 텍스트 프롬프트를 제공하고, 선택적으로 하나 이상의 이미지를 멀티모달 컨텍스트로 사용할 수 있습니다.",
	"display_name": "Anthropic Claude",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"images": {
			"name": "이미지",
			"tooltip": "모델의 컨텍스트로 사용할 선택적 이미지(최대 20장)입니다."
		},
		"model": {
			"name": "모델",
			"tooltip": "응답을 생성하는 데 사용되는 Claude 모델입니다."
		},
		"model_max_tokens": { "name": "최대 토큰" },
...
var ColorTransfer = {
	"description": "여러 알고리즘을 사용하여 한 이미지의 색상을 다른 이미지와 일치시킵니다.",
	"display_name": "ColorTransfer",
	"inputs": {
		"image_ref": {
			"name": "image_ref",
			"tooltip": "색상을 맞출 기준 이미지(들)입니다. 제공되지 않으면 처리가 건너뜁니다."
		},
		"image_target": {
			"name": "image_target",
			"tooltip": "색상 변환을 적용할 이미지(들)입니다."
		},
		"method": { "name": "method" },
		"source_stats": {
			"name": "source_stats",
			"tooltip": "per_frame: 각 프레임을 image_ref에 개별적으로 맞춥니다. uniform: 모든 소스 프레임의 통계를 풀링하여 기준선으로 사용하고, image_ref에 맞춥니다. target_frame: 선택한 한 프레임을 변환의 기준선으로 사용하여 image_ref에 일괄 적용합니다(상대적 차이 유지)."
		},
		"strength": { "name": "strength" }
	},
	"outputs": { "0": {
...
var ComfyAndNode = {
	"description": "논리 AND 연산. 모든 값이 참(truthy)이면 true를 반환합니다. Python의 truthiness 규칙을 따릅니다.",
	"display_name": "And",
...
var ComfyNotNode = {
	"description": "논리 NOT 연산. 값이 거짓(falsy)이면 true를 반환합니다. Python의 truthiness 규칙을 따릅니다.",
	"display_name": "Not",
...
var ComfyOrNode = {
	"description": "논리 OR 연산. 값 중 하나라도 참(truthy)이면 true를 반환합니다. Python의 truthiness 규칙을 따릅니다.",
	"display_name": "Or",
	"inputs": { "values": { "name": "values" } },
	"outputs": { "0": { "tooltip": null } }
};
...
var ConditioningAverage = {
	"display_name": "조건 (평균)",
	"inputs": {
		"conditioning_from": { "name": "추가 조건" },
		"conditioning_to": { "name": "대상 조건" },
		"conditioning_to_strength": { "name": "대상 조건 강도" }
	}
};
var ConditioningCombine = {
	"display_name": "조건 (결합)",
	"inputs": {
		"conditioning_1": { "name": "조건 1" },
		"conditioning_2": { "name": "조건 2" }
	}
};
...
var ConditioningStableAudio = {
	...
	"inputs": {
		"negative": { "name": "부정 조건" },
		"positive": { "name": "긍정 조건" },
		"seconds_start": { "name": "시작(초)" },
		"seconds_total": { "name": "전체(초)" }
	},
	"outputs": {
		"0": {
			"name": "positive",
...
var ConditioningZeroOut = {
	...
	"inputs": { "conditioning": { "name": "조건" } }
};
var ContextWindowsManual = {
	"description": "컨텍스트 윈도우를 수동으로 설정합니다.",
	"display_name": "컨텍스트 윈도우 (수동)",
	"inputs": {
		"causal_window_fix": {
			"name": "causal_window_fix",
			"tooltip": "0이 아닌 인덱스의 컨텍스트 윈도우에 인과적 수정 프레임을 추가할지 여부입니다."
		},
		"closed_loop": {
			"name": "closed_loop",
			"tooltip": "컨텍스트 윈도우 루프를 닫을지 여부입니다. 루프 스케줄에만 적용됩니다."
		},
		"cond_retain_index_list": {
			"name": "cond_retain_index_list",
			"tooltip": "각 윈도우의 conditioning 텐서에서 유지할 latent 인덱스 목록입니다. 예를 들어 '0'으로 설정하면 각 윈도우에 대해 초기 시작 이미지를 사용합니다."
		},
		"context_length": {
			"name": "context_length",
			"tooltip": "컨텍스트 윈도우의 길이입니다."
		},
		"context_overlap": {
			"name": "context_overlap",
			"tooltip": "컨텍스트 윈도우의 중첩 정도입니다."
		},
		"context_schedule": {
			"name": "context_schedule",
			"tooltip": "컨텍스트 윈도우의 스케줄입니다."
		},
		"context_stride": {
			"name": "context_stride",
			"tooltip": "컨텍스트 윈도우의 스트라이드입니다. 균일 스케줄에만 적용됩니다."
		},
		"dim": {
			"name": "dim",
			"tooltip": "컨텍스트 윈도우를 적용할 차원입니다."
		},
		"freenoise": {
			"name": "프리노이즈",
			"tooltip": "FreeNoise 노이즈 셔플을 적용할지 여부, 윈도우 블렌딩을 향상시킵니다."
		},
		"fuse_method": {
			"name": "fuse_method",
			"tooltip": "컨텍스트 윈도우를 융합하는 데 사용할 방법입니다."
		},
		"latent_retain_index_list": {
			"name": "latent_retain_index_list",
			"tooltip": "각 윈도우마다 노이즈 latent 자체에서 유지할 latent 인덱스 목록입니다. 참조 콘텐츠(예: 시작 이미지)가 별도의 컨디셔닝 채널이 아닌 노이즈 latent에 직접 존재하는 워크플로우(예: inplace 스타일 I2V, LTXV, AnimateDiff 등)에 사용합니다. cond_retain_index_list와는 독립적입니다."
		},
		"model": {
			"name": "model",
			"tooltip": "샘플링 중 컨텍스트 윈도우를 적용할 모델입니다."
		},
		"split_conds_to_windows": {
			"name": "split_conds_to_windows",
			"tooltip": "여러 개의 conditioning(ConditionCombine에서 생성됨)을 영역 인덱스에 따라 각 윈도우로 분할할지 여부입니다."
		}
	},
	"outputs": { "0": { "tooltip": "샘플링 중 컨텍스트 윈도우가 적용된 모델입니다." } }
};
var ControlNetApply = {
	"display_name": "컨트롤넷 적용 (구형)",
	"inputs": {
		"conditioning": { "name": "조건" },
		"control_net": { "name": "컨트롤넷" },
		"image": { "name": "이미지" },
		"strength": { "name": "강도" }
	}
};
...
var ControlNetLoader = {
	...
	"inputs": { "control_net_name": { "name": "컨트롤넷 파일명" } }
};
var ConvertArrayToString = {
	"display_name": "배열을 문자열로 변환",
	"inputs": {
		"array": { "name": "배열" },
		"indent": {
			"name": "들여쓰기",
			"tooltip": "들여쓰기 수준별 공백 수. 0은 한 줄로 압축된 문자열을 생성합니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ConvertDictionaryToString = {
	"display_name": "딕셔너리를 문자열로 변환",
	"inputs": {
		"dictionary": { "name": "딕셔너리" },
		"indent": {
			"name": "들여쓰기",
			"tooltip": "들여쓰기 수준별 공백 수. 0은 한 줄로 압축된 문자열을 생성합니다."
		}
...
var CosmosImageToVideoLatent = {
	...
	"inputs": {
		"batch_size": { "name": "배치 크기" },
		"end_image": { "name": "끝 이미지" },
		"height": { "name": "높이" },
		"length": { "name": "길이" },
		"start_image": { "name": "시작 이미지" },
		"vae": { "name": "vae" },
		"width": { "name": "너비" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var CreateBoundingBoxes = {
	"description": "캔버스에 바운딩 박스를 그립니다. Ideogram 프롬프트 요소, 픽셀 공간 바운딩 박스, 미리보기 이미지를 출력합니다.",
	"display_name": "바운딩 박스 생성",
	"inputs": {
		"background": {
			"name": "배경",
			"tooltip": "캔버스와 미리보기에서 배경으로 사용되는 선택적 이미지입니다."
		},
		"bboxes": {
			"name": "bboxes",
			"tooltip": "바운딩 박스, 요소 또는 캔버스를 초기화할 JSON 문자열입니다. 새로운 상위 값이 들어오면 캔버스가 초기화됩니다. 캔버스에서 편집한 내용이 우선 적용되며, 상위 값이 다시 변경될 때까지 유지됩니다."
		},
		"editor_state": {
			"name": "에디터 상태",
			"tooltip": "바운딩 박스를 그리고 각 박스의 유형, 텍스트, 설명, 컬러 팔레트를 설정하세요. 배경 요소부터 시작하고 전경은 마지막에 추가하세요."
		},
		"height": {
			"name": "높이",
			"tooltip": "캔버스 및 바운딩 박스의 픽셀 그리드 높이입니다."
		},
		"last_incoming": {
			"name": "last_incoming",
			"tooltip": "캔버스에서 관리하는 내부 상태: 마지막으로 캔버스를 초기화한 상위 bboxes 값입니다. 비워두면 다음 실행 시 bboxes 입력값으로 캔버스를 다시 초기화합니다."
		},
		"width": {
			"name": "너비",
			"tooltip": "캔버스 및 바운딩 박스의 픽셀 그리드 너비입니다."
		}
	},
	"outputs": {
		"0": {
...
var CreateCameraInfo = {
	"description": "카메라 정보를 생성합니다. 'orbit' 모드는 타겟을 중심으로 yaw/pitch/거리로 회전하며, 'look_at'은 월드 좌표에 카메라를 배치합니다. 좌표는 뷰어의 월드 공간(오른손 좌표계, Y-업) 기준입니다.",
	"display_name": "카메라 정보 생성",
	"inputs": {
		"camera_type": {
			"name": "camera_type",
			"tooltip": "Render Splat에서 사용하는 투영 방식: 원근(foreshortening) 또는 직교(평행)."
		},
		"fov": {
			"name": "fov",
			"tooltip": "수직 시야각(도 단위)."
		...
		"mode": {
			"name": "mode",
			"tooltip": "카메라를 정의하는 방법: 오빗 각도, 명시적 위치, 또는 위치 + 쿼터니언."
		},
		...
		"roll": {
			"name": "roll",
			"tooltip": "뷰 축을 기준으로 한 카메라 롤(도 단위)."
		},
		"target_x": {
			"name": "target_x",
			"tooltip": "바라보는 지점(오빗 피벗/조준점). 오빗 모드에서 전체 카메라를 이동하려면 이 값을 조정하세요. 쿼터니언 모드에서는 무시됩니다. 기본값은 원점입니다."
		},
		"target_y": { "name": "target_y" },
		"target_z": { "name": "target_z" },
		"zoom": {
			"name": "zoom",
			"tooltip": "디지털 줌(초점 거리 배수). 1보다 크면 카메라를 이동하지 않고 확대합니다."
		}
	},
	"outputs": { "0": {
		"name": "camera_info",
...
var CreateHookKeyframe = {
	...
	"inputs": {
		"prev_hook_kf": { "name": "이전 KF 후크" },
		"start_percent": { "name": "시작 퍼센트" },
		"strength_mult": { "name": "강도 곱" }
	},
	"outputs": { "0": { "name": "KF 후크" } }
};
var CreateHookKeyframesFromFloats = {
	"display_name": "실수로 후크 키프레임 생성",
	"inputs": {
		"end_percent": { "name": "종료 퍼센트" },
		"floats_strength": { "name": "실수 강도" },
		"prev_hook_kf": { "name": "이전 KF 후크" },
		"print_keyframes": { "name": "키프레임 출력" },
		"start_percent": { "name": "시작 퍼센트" }
	},
	"outputs": { "0": { "name": "KF 후크" } }
};
var CreateHookKeyframesInterpolated = {
	...
	"inputs": {
		"end_percent": { "name": "종료 퍼센트" },
		"interpolation": { "name": "보간" },
		"keyframes_count": { "name": "키프레임 카운트" },
		"prev_hook_kf": { "name": "이전 KF 후크" },
		"print_keyframes": { "name": "키프레임 출력" },
		"start_percent": { "name": "시작 퍼센트" },
		"strength_end": { "name": "종료 강도" },
		"strength_start": { "name": "시작 강도" }
	},
	"outputs": { "0": { "name": "KF 후크" } }
};
var CreateHookLora = {
	...
	"inputs": {
		"lora_name": { "name": "LoRA 파일명" },
		"prev_hooks": { "name": "이전 후크" },
		"strength_clip": { "name": "CLIP 강도" },
		"strength_model": { "name": "모델 강도" }
	}
};
...
var CropByBBoxes = {
	...
	"outputs": { "0": { "tooltip": "모든 잘라낸 이미지가 하나의 이미지 배치로 쌓입니다." } }
};
var CropMask = {
...
var DA3GeometryToMesh = {
	"description": "깊이 맵을 삼각형 3D 메시로 변환합니다.",
	"display_name": "DA3 지오메트리를 메시로 변환",
	"inputs": {
		"batch_index": {
			"name": "batch_index",
			"tooltip": "변환할 배치 내 이미지 인덱스입니다. 이미지마다 버텍스 개수가 다르므로 배치를 쌓을 수 없습니다."
		},
		"confidence_threshold": {
			"name": "confidence_threshold",
			"tooltip": "이미지별 정규화된 신뢰도가 이 값보다 낮은 픽셀을 제외합니다 (0 = 모두 유지, 1 = 가장 신뢰도 높은 픽셀만 유지). 지오메트리에 신뢰도 맵이 있을 때 사용합니다 (Small/Base 모델)."
		},
		"da3_geometry": { "name": "da3_geometry" },
		"decimation": {
			"name": "decimation",
			"tooltip": "버텍스 간격입니다. 1 = 전체 해상도, 2 = 절반 해상도 등."
		},
		"discontinuity_threshold": {
			"name": "discontinuity_threshold",
			"tooltip": "3x3 깊이 범위가 이 비율을 초과하는 삼각형을 제거합니다. 0 = 비활성화."
		},
		"texture": {
			"name": "texture",
			"tooltip": "원본 이미지를 기본 색상 텍스처로 사용합니다."
		},
		"use_sky_mask": {
			"name": "use_sky_mask",
			"tooltip": "메시에서 하늘 확률 픽셀(하늘 >= 0.5)을 제외합니다. 지오메트리에 하늘 맵이 있을 때 사용합니다 (Mono/Metric 모델)."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var DA3Inference = {
	"description": "이미지에서 Depth Anything 3을 실행합니다. 다중 뷰 모드에서는 각 이미지를 동일한 장면의 별도 뷰로 처리합니다.",
	"display_name": "Depth Anything 3 실행",
	"inputs": {
		"da3_model": { "name": "da3_model" },
		"image": { "name": "image" },
		"mode": {
			"name": "mode",
			"tooltip": "mono: 단일 뷰 이미지(모든 모델 변형에서 사용 가능).\nmultiview: 모든 이미지를 기하학적 일관성 및 카메라 포즈를 위해 함께 처리(Small/Base 모델 전용)."
		},
		"resize_method": {
			"name": "resize_method",
			"tooltip": "upper_bound_resize: 가장 긴 변이 resolution이 되도록 스케일(메모리 제한, 기본값).\nlower_bound_resize: 가장 짧은 변이 resolution이 되도록 스케일(세로/가로가 긴 이미지에서 더 많은 디테일 보존, 메모리 더 사용)."
		},
		"resolution": {
			"name": "resolution",
			"tooltip": "모델이 실행되는 해상도 (가장 긴 변, 14의 배수).\n낮을수록 빠르고 VRAM 사용량이 적음.\n높을수록 더 많은 디테일.\n출력은 원본 크기로 업샘플링됩니다."
		}
	},
	"outputs": { "0": {
		"name": "da3_geometry",
		"tooltip": "정규화되지 않은 텐서의 딕셔너리.\n항상 포함되는 키: depth, image, mode.\n선택적 키: sky(Mono/Metric), confidence(Small/Base), extrinsics + intrinsics(다중 뷰)."
	} }
};
var DA3Render = {
	"description": "Depth Anything 3 지오메트리 데이터에서 깊이 맵, 신뢰도 맵 또는 하늘 마스크를 렌더링합니다.",
	"display_name": "Depth Anything 3 렌더",
	"inputs": {
		"da3_geometry": { "name": "da3_geometry" },
		"output": {
			"name": "output",
			"tooltip": "- depth: 정규화된 그레이스케일 깊이 이미지.\n- depth_colored: Turbo 컬러맵을 적용한 깊이.\n- sky_mask: [0, 1] 범위의 하늘 확률(Mono/Metric 모델 전용).\n- confidence: 정규화된 깊이 신뢰도(Small/Base 모델 전용)."
		},
...
var DiffControlNetLoader = {
	...
	"inputs": {
		"control_net_name": { "name": "컨트롤넷 파일명" },
		"model": { "name": "모델" }
	}
};
...
var DualCFGGuider = {
	...
	"inputs": {
		"cfg_cond2_negative": { "name": "(조건2 - 부정 조건) cfg" },
		"cfg_conds": { "name": "전체 조건 cfg" },
		"cond1": { "name": "조건1" },
		"cond2": { "name": "조건2" },
		"model": { "name": "모델" },
		"negative": { "name": "부정 조건" },
...
var DualCLIPLoader = {
	...
	"inputs": {
		"clip_name1": { "name": "CLIP 파일명1" },
		"clip_name2": { "name": "CLIP 파일명2" },
		"device": { "name": "장치" },
		"type": { "name": "유형" }
	}
};
var DualModelGuider = {
	...
	"inputs": {
		...
		"model": {
			"name": "model",
			"tooltip": "양수(조건부) 패스에 사용되는 모델입니다."
		},
		"model_negative": {
			"name": "model_negative",
			"tooltip": "음수(비조건부) 패스에 사용되는 모델입니다. 일반 CFG에는 동일한 모델을 사용하세요."
		},
		"negative": {
			"name": "negative",
			"tooltip": "음수 모델에서 실행되는 네거티브 컨디셔닝입니다. 연결하지 않으면 텍스트 없는(이미지 전용) 비조건부 패스가 됩니다."
		},
		"positive": { "name": "positive" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var EasyCache = {
	"description": "네이티브 EasyCache 구현입니다.",
	"display_name": "EasyCache",
	"inputs": {
		"end_percent": {
			"name": "end_percent",
			"tooltip": "EasyCache 사용을 종료할 상대 샘플링 단계입니다."
		},
		"model": {
			"name": "model",
			"tooltip": "EasyCache를 추가할 모델입니다."
		},
		"reuse_threshold": {
			"name": "reuse_threshold",
			"tooltip": "캐시된 단계를 재사용하기 위한 임계값입니다."
		},
		"start_percent": {
			"name": "start_percent",
			"tooltip": "EasyCache 사용을 시작할 상대 샘플링 단계입니다."
		},
		"verbose": {
			"name": "verbose",
			"tooltip": "상세 정보를 로깅할지 여부입니다."
		}
	},
	"outputs": { "0": { "tooltip": "EasyCache가 적용된 모델입니다." } }
};
var ElevenLabsAudioIsolation = {
	"description": "오디오에서 배경 소음을 제거하고 보컬 또는 음성을 분리합니다.",
	"display_name": "ElevenLabs 음성 분리",
	"inputs": { "audio": {
		"name": "audio",
		"tooltip": "배경 소음 제거를 위해 처리할 오디오입니다."
	} },
	"outputs": { "0": { "tooltip": null } }
};
var ElevenLabsInstantVoiceClone = {
	"description": "오디오 샘플에서 복제된 음성을 생성합니다. 복제할 음성의 오디오 녹음 파일 1~8개를 제공합니다.",
	"display_name": "ElevenLabs 즉시 음성 복제",
	"inputs": {
		"files": {
			"name": "files",
			"tooltip": "음성 복제를 위한 오디오 녹음 파일입니다."
		},
		"remove_background_noise": {
			"name": "remove_background_noise",
			"tooltip": "오디오 분리를 사용하여 음성 샘플에서 배경 소음을 제거합니다."
		}
	},
	"outputs": { "0": {
		"name": "voice",
...
var ElevenLabsSpeechToSpeech = {
	"description": "원본 내용과 감정을 유지하면서 한 음성에서 다른 음성으로 변환합니다.",
	"display_name": "ElevenLabs 음성 변환",
	"inputs": {
		"audio": {
			"name": "audio",
			"tooltip": "변환할 소스 오디오입니다."
		},
		"control_after_generate": { "name": "control after generate" },
		"model": {
			"name": "model",
			"tooltip": "음성 변환에 사용할 모델입니다."
		},
		...
		"output_format": {
			"name": "output_format",
			"tooltip": "오디오 출력 형식입니다."
		},
		"remove_background_noise": {
			"name": "remove_background_noise",
			"tooltip": "오디오 분리를 사용하여 입력 오디오에서 배경 소음을 제거합니다."
		},
		"seed": {
			"name": "seed",
			"tooltip": "재현성을 위한 시드 값입니다."
		},
		"stability": {
			"name": "stability",
			"tooltip": "음성의 안정성입니다. 값이 낮을수록 감정의 폭이 넓고, 값이 높을수록 더 일관되지만 다소 단조로운 음성이 생성됩니다."
		},
		"voice": {
			"name": "voice",
			"tooltip": "변환할 대상 음성입니다. Voice Selector 또는 Instant Voice Clone에서 연결하세요."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ElevenLabsSpeechToText = {
	"description": "오디오를 텍스트로 전사합니다. 자동 언어 감지, 화자 분리, 오디오 이벤트 태깅을 지원합니다.",
	"display_name": "ElevenLabs 음성 → 텍스트",
	"inputs": {
		"audio": {
			"name": "audio",
			"tooltip": "전사할 오디오."
		...
		"language_code": {
			"name": "language_code",
			"tooltip": "ISO-639-1 또는 ISO-639-3 언어 코드(예: 'en', 'es', 'fra'). 자동 감지를 원하면 비워 두세요."
		},
		"model": {
			"name": "model",
			"tooltip": "전사에 사용할 모델."
		...
		"num_speakers": {
			"name": "num_speakers",
			"tooltip": "예측할 최대 화자 수. 자동 감지는 0으로 설정하세요."
		},
		"seed": {
			"name": "seed",
			"tooltip": "재현성을 위한 시드(결정적 결과는 보장되지 않음)."
		}
	},
	"outputs": {
		"0": {
...
var ElevenLabsTextToDialogue = {
	"description": "텍스트에서 다중 화자 대화를 생성합니다. 각 대화 항목은 고유한 텍스트와 음성을 가집니다.",
	"display_name": "ElevenLabs 텍스트 → 대화",
	"inputs": {
		"apply_text_normalization": {
			"name": "apply_text_normalization",
			"tooltip": "텍스트 정규화 모드. 'auto'는 시스템이 결정, 'on'은 항상 정규화 적용, 'off'는 정규화 생략."
		},
		"control_after_generate": { "name": "control after generate" },
		"inputs": {
			"name": "inputs",
		...
		"stability": {
			"name": "stability",
			"tooltip": "음성 안정성. 값이 낮을수록 감정 표현이 다양해지고, 값이 높을수록 일관성은 높지만 단조로울 수 있습니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ElevenLabsTextToSoundEffects = {
	"description": "텍스트 설명에서 효과음을 생성합니다.",
	"display_name": "ElevenLabs 텍스트 → 효과음",
	"inputs": {
		"model": {
			"name": "model",
			"tooltip": "효과음 생성을 위한 모델."
		},
		"model_duration": { "name": "duration" },
...
var ElevenLabsTextToSpeech = {
	...
	"display_name": "ElevenLabs 텍스트 음성 변환",
	"inputs": {
		"apply_text_normalization": {
			"name": "apply_text_normalization",
			"tooltip": "텍스트 정규화 모드입니다. 'auto'는 시스템이 자동으로 결정하고, 'on'은 항상 정규화를 적용하며, 'off'는 정규화를 건너뜁니다."
		},
		"control_after_generate": { "name": "control after generate" },
		"language_code": {
			"name": "language_code",
		...
		"text": {
			"name": "text",
			"tooltip": "음성으로 변환할 텍스트입니다."
		},
		"voice": {
			"name": "voice",
			"tooltip": "음성 합성에 사용할 목소리입니다. Voice Selector 또는 Instant Voice Clone에서 연결하세요."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ElevenLabsVoiceSelector = {
	"description": "텍스트 음성 변환 생성을 위한 사전 정의된 ElevenLabs 음성을 선택합니다.",
	"display_name": "ElevenLabs 음성 선택기",
	"inputs": { "voice": {
		"name": "voice",
		"tooltip": "사전 정의된 ElevenLabs 음성 중에서 선택하세요."
	} },
	"outputs": { "0": {
		"name": "voice",
		"tooltip": null
...
var EmptyAudio = {
	...
	"inputs": {
		"channels": {
			"name": "채널",
			"tooltip": "오디오 채널 수 (1: 모노, 2: 스테레오)."
		},
		"duration": {
			"name": "지속 시간",
			"tooltip": "빈 오디오 클립의 지속 시간(초 단위)"
		},
		"sample_rate": {
			"name": "샘플링 레이트",
			"tooltip": "빈 오디오 클립의 샘플링 레이트입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var EmptyChromaRadianceLatentImage = {
	"display_name": "빈 색조 복사 잠재 이미지",
	"inputs": {
		"batch_size": { "name": "배치 크기" },
		"height": { "name": "높이" },
		"width": { "name": "너비" }
...
var EmptyLatentImage = {
	...
	"outputs": { "0": { "tooltip": "빈 잠재 이미지 배치입니다." } }
};
...
var ExtendIntermediateSigmas = {
	...
	"inputs": {
		"end_at_sigma": { "name": "시그마 종료점" },
		"sigmas": { "name": "시그마 배열" },
		"spacing": { "name": "간격 분포 방식" },
		"start_at_sigma": { "name": "시그마 시작점" },
		"steps": { "name": "스텝 수" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var File3DToSplat = {
	"description": "splat File3D를 가우시안 splat으로 파싱합니다. Create 3D File (from Splat)의 역과정입니다. 지원 포맷: PLY, SPLAT, KSPLAT, SPZ. PLY는 완전한 구면 고조파를 포함하며, 다른 포맷은 기본 색상만 지원합니다. 포맷은 파일 내용에서 자동 감지됩니다.",
	"display_name": "Splat 가져오기",
	"inputs": { "model_3d": {
		"name": "model_3d",
		"tooltip": "가우시안 splat 3D 파일"
	} },
	"outputs": { "0": {
		"name": "splat",
		"tooltip": null
...
var Flux2MaxImageNode = {
	...
	"inputs": {
		...
		"images": {
			"name": "이미지",
			"tooltip": "참조용으로 최대 9개의 이미지를 사용할 수 있습니다."
		},
		"prompt": {
			"name": "프롬프트",
			"tooltip": "이미지 생성 또는 편집을 위한 프롬프트"
		...
		"prompt_upsampling": {
			"name": "프롬프트 업샘플링",
			"tooltip": "프롬프트에 업샘플링을 수행할지 여부입니다. 활성화 시, 더 창의적인 생성을 위해 프롬프트가 자동으로 수정됩니다."
		},
		"seed": {
			"name": "시드",
			"tooltip": "노이즈 생성을 위한 랜덤 시드입니다."
...
var FluxEraseNode = {
	"description": "이미지에서 마스킹된 객체를 제거하고 배경을 복원합니다. 지우고 싶은 부분에 마스크를 칠하세요.",
	"display_name": "Flux 이미지 지우기",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"dilate_pixels": {
			"name": "dilate_pixels",
			"tooltip": "객체의 가장자리를 깨끗하게 덮기 위해 마스크 경계를 확장합니다."
		},
		"image": { "name": "image" },
		"mask": {
			"name": "mask",
			"tooltip": "흰색 영역은 제거되고, 검은색 영역은 보존됩니다."
		},
		"seed": {
			"name": "seed",
			"tooltip": "노이즈 생성을 위한 랜덤 시드입니다."
...
var FluxKVCache = {
	...
	"outputs": { "0": { "tooltip": "KV 캐시가 활성화된 패치된 모델입니다." } }
};
var FluxKontextImageScale = {
	"description": "이 노드는 이미지를 Flux Kontext에 더 최적화된 크기로 조정합니다.",
	"display_name": "Flux Kontext 이미지 스케일",
	"inputs": { "image": { "name": "이미지" } },
	"outputs": { "0": { "tooltip": null } }
};
var FluxKontextMaxImageNode = {
	"description": "프롬프트와 종횡비를 기반으로 API를 통해 Flux.1 Kontext [최대]를 사용하여 이미지를 편집합니다.",
	"display_name": "Flux.1 Kontext [최대] 이미지",
	"inputs": {
		"aspect_ratio": {
			"name": "종횡비",
		...
		"input_image": { "name": "입력 이미지" },
		"prompt": {
			"name": "프롬프트",
			"tooltip": "이미지 생성용 프롬프트 - 편집할 내용과 방법을 지정합니다."
		},
		"prompt_upsampling": {
			"name": "프롬프트 업샘플링",
			"tooltip": "프롬프트에 업샘플링을 수행할지 여부입니다. 활성화하면 자동으로 프롬프트를 수정하여 더 창의적인 생성을 수행하지만, 결과는 비결정적입니다(동일한 시드라도 정확히 같은 결과를 생성하지 않음)."
		},
		"seed": {
			"name": "시드",
			"tooltip": "노이즈 생성에 사용되는 랜덤 시드입니다."
		},
		"steps": {
			"name": "단계",
...
var FluxKontextMultiReferenceLatentMethod = {
	"display_name": "Flux Kontext 다중 참조 잠재 방법",
	"inputs": {
		"conditioning": { "name": "조건화" },
		"reference_latents_method": { "name": "참조 잠재 방법" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var FluxKontextProImageNode = {
	"description": "프롬프트와 종횡비를 기반으로 API를 통해 Flux.1 Kontext [프로]를 사용하여 이미지를 편집합니다.",
	"display_name": "Flux.1 Kontext [프로] 이미지",
	"inputs": {
		"aspect_ratio": {
			"name": "aspect_ratio",
			"tooltip": "이미지의 종횡비; 1:4에서 4:1 사이여야 합니다."
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "이미지 생성을 위한 프롬프트 - 무엇을 어떻게 편집할지 지정합니다."
		},
		"prompt_upsampling": {
			"name": "prompt_upsampling",
			"tooltip": "프롬프트에 업샘플링을 수행할지 여부. 활성화하면 더 창의적인 생성을 위해 프롬프트를 자동으로 수정하지만, 결과는 비결정적입니다(동일한 시드라도 정확히 같은 결과를 생성하지 않음)."
		},
		"seed": {
			"name": "seed",
...
var FluxVTONode = {
	"description": "가상 피팅: 제공된 의상을 인물 이미지에 입힙니다.",
	"display_name": "Flux 가상 피팅",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"garment": {
			"name": "garment",
		...
		"person": {
			"name": "person",
			"tooltip": "의상을 입힐 인물 이미지."
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "선택 사항: 자연어 스타일링 지시(예: 의상이 어떻게 맞아야 하는지 등)."
		},
		"seed": {
			"name": "seed",
			"tooltip": "노이즈 생성을 위한 랜덤 시드."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var FrameInterpolationModelLoader = {
	"display_name": "프레임 보간 모델 불러오기",
	"inputs": { "model_name": {
		"name": "model_name",
		"tooltip": "불러올 프레임 보간 모델을 선택하세요. 모델은 반드시 'frame_interpolation' 폴더에 위치해야 합니다."
	} },
	"outputs": { "0": { "tooltip": null } }
};
var FreSca = {
...
var GLIGENLoader = {
	...
	"inputs": { "gligen_name": { "name": "gligen 파일명" } }
};
var GLIGENTextBoxApply = {
	"display_name": "GLIGEN 텍스트 박스 적용",
	"inputs": {
		"clip": { "name": "clip" },
		"conditioning_to": { "name": "조건 대상" },
		"gligen_textbox_model": { "name": "gligen 텍스트상자 모델" },
		"height": { "name": "높이" },
		"text": { "name": "텍스트" },
		"width": { "name": "너비" },
		"x": { "name": "x" },
...
var GLSLShader = {
	"description": "GLSL ES 프래그먼트 셰이더를 이미지에 적용합니다. u_resolution(vec2)은 항상 사용 가능합니다.",
	"display_name": "GLSL 셰이더",
	"inputs": {
		"bools": {
			"name": "불리언",
			"tooltip": "불리언은 셰이더 코드에서 u_bool0-9 (bool)로 사용할 수 있습니다"
		},
		"curves": {
			"name": "커브",
			"tooltip": "커브는 셰이더 코드에서 u_curve0-3 (sampler2D, 1D LUT)로 사용할 수 있습니다. texture(u_curve0, vec2(x, 0.5)).r로 샘플링하세요"
		},
		"floats": {
			"name": "floats",
			"tooltip": "floats는 셰이더 코드에서 u_float0-4로 사용 가능합니다."
		},
		"fragment_shader": {
			"name": "fragment_shader",
			"tooltip": "GLSL 프래그먼트 셰이더 소스 코드(GLSL ES 3.00 / WebGL 2.0 호환)"
		},
		"images": {
			"name": "images",
			"tooltip": "이미지는 셰이더 코드에서 u_image0-4(sampler2D)로 사용 가능합니다."
		},
		"ints": {
			"name": "ints",
			"tooltip": "ints는 셰이더 코드에서 u_int0-4로 사용 가능합니다."
		},
		"size_mode": {
			"name": "size_mode",
			"tooltip": "출력 크기: 'from_input'은 첫 번째 입력 이미지의 크기를 사용하며, 'custom'은 수동 크기 설정을 허용합니다."
		}
	},
	"outputs": {
		"0": {
			"name": "IMAGE0",
			"tooltip": "셰이더 코드에서 layout(location = 0) out vec4 fragColor0로 사용 가능합니다."
		},
		"1": {
			"name": "IMAGE1",
			"tooltip": "셰이더 코드에서 layout(location = 1) out vec4 fragColor1로 사용 가능합니다."
		},
		"2": {
			"name": "IMAGE2",
			"tooltip": "셰이더 코드에서 layout(location = 2) out vec4 fragColor2로 사용 가능합니다."
		},
		"3": {
			"name": "IMAGE3",
			"tooltip": "셰이더 코드에서 layout(location = 3) out vec4 fragColor3로 사용 가능합니다."
		}
	}
};
var GeminiImage2Node = {
	"description": "Google Vertex API를 통해 동기적으로 이미지를 생성하거나 편집합니다.",
	"display_name": "Nano Banana Pro (Google Gemini Image)",
	"inputs": {
		"aspect_ratio": {
			"name": "종횡비",
			"tooltip": "'auto'로 설정하면 입력 이미지의 종횡비와 일치합니다. 이미지가 없으면 일반적으로 16:9 정사각형이 생성됩니다."
		},
		"control_after_generate": { "name": "생성 후 제어" },
		"files": {
			"name": "파일",
			"tooltip": "모델의 컨텍스트로 사용할 선택적 파일(들)입니다. Gemini Generate Content Input Files 노드의 입력을 허용합니다."
		},
		"images": {
			"name": "이미지",
		...
		"prompt": {
			"name": "프롬프트",
			"tooltip": "생성할 이미지 또는 적용할 편집을 설명하는 텍스트 프롬프트입니다. 모델이 따라야 할 제약, 스타일, 세부사항을 포함하세요."
		},
		"resolution": {
			"name": "해상도",
			"tooltip": "목표 출력 해상도입니다. 2K/4K의 경우 Gemini 고유 업스케일러가 사용됩니다."
		},
		"response_modalities": {
			"name": "응답 형식",
			"tooltip": "'IMAGE'를 선택하면 이미지만 출력되고, 'IMAGE+TEXT'를 선택하면 생성된 이미지와 텍스트 응답이 모두 반환됩니다."
		},
		"seed": {
			"name": "시드",
			"tooltip": "시드를 특정 값으로 고정하면, 모델은 반복 요청에 대해 동일한 응답을 제공하려고 시도합니다. 결정적 결과는 보장되지 않습니다. 또한, 모델이나 파라미터(예: temperature)를 변경하면 같은 시드여도 결과가 달라질 수 있습니다. 기본적으로 무작위 시드가 사용됩니다."
		},
		"system_prompt": {
			"name": "시스템 프롬프트",
...
var GeminiImageNode = {
	"description": "Google API를 통해 이미지를 동기적으로 편집합니다.",
	"display_name": "Google Gemini 이미지",
	"inputs": {
		"aspect_ratio": {
			"name": "aspect_ratio",
			"tooltip": "기본적으로 출력 이미지 크기를 입력 이미지 크기에 맞추거나, 그렇지 않으면 1:1 정사각형을 생성합니다."
		},
		"control_after_generate": { "name": "control after generate" },
		"files": {
			"name": "files",
			"tooltip": "모델의 컨텍스트로 사용할 선택적 파일. Gemini Generate Content Input Files 노드의 입력을 허용합니다."
		},
		"images": {
			"name": "images",
			"tooltip": "모델의 컨텍스트로 사용할 선택적 이미지. 여러 이미지를 포함하려면 Batch Images 노드를 사용할 수 있습니다."
		},
		"model": {
			"name": "model",
			"tooltip": "응답 생성에 사용할 Gemini 모델"
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "생성을 위한 텍스트 프롬프트"
		},
		"response_modalities": {
			"name": "응답 형식",
			"tooltip": "'IMAGE'를 선택하면 이미지만 출력되고, 'IMAGE+TEXT'를 선택하면 생성된 이미지와 텍스트 응답이 모두 반환됩니다."
		...
		"seed": {
			"name": "seed",
			"tooltip": "시드가 특정 값으로 고정되면, 모델은 반복 요청에 대해 동일한 응답을 제공하기 위해 최선을 다합니다. 결정론적 출력은 보장되지 않습니다. 또한 모델이나 온도와 같은 매개변수 설정을 변경하면 동일한 시드 값을 사용하더라도 응답에 변동이 발생할 수 있습니다. 기본적으로 랜덤 시드 값이 사용됩니다."
		},
		"system_prompt": {
			"name": "시스템 프롬프트",
			"tooltip": "AI의 동작을 지시하는 기본 지침입니다."
...
var GeminiInputFiles = {
	"description": "Gemini LLM 노드의 입력으로 포함할 입력 파일을 로드하고 준비합니다. 파일은 응답을 생성할 때 Gemini 모델에 의해 읽힙니다. 텍스트 파일의 내용은 토큰 제한에 포함됩니다. 🛈 팁: 다른 Gemini 입력 파일 노드와 함께 연결하여 사용할 수 있습니다.",
	"display_name": "Gemini 입력 파일",
	"inputs": {
		"GEMINI_INPUT_FILES": {
			"name": "GEMINI_INPUT_FILES",
			"tooltip": "이 노드에서 로드된 파일과 함께 배치할 선택적 추가 파일. 단일 메시지에 여러 입력 파일을 포함할 수 있도록 입력 파일을 연결할 수 있습니다."
		},
		"file": {
			"name": "file",
			"tooltip": "모델의 컨텍스트로 포함할 입력 파일. 현재는 텍스트(.txt) 및 PDF(.pdf) 파일만 허용됩니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var GeminiNanoBanana2 = {
	...
	"inputs": {
		...
		"response_modalities": { "name": "응답 모달리티" },
		"seed": {
			"name": "시드",
	...
	"outputs": {
		...
		"2": {
			"name": "thought_image",
			"tooltip": "모델의 사고 과정에서 생성된 첫 번째 이미지입니다. thinking_level이 HIGH이고 IMAGE+TEXT 모달리티일 때만 제공됩니다."
		}
	}
};
var GeminiNanoBanana2V2 = {
	...
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"model": { "name": "모델" },
		"model_aspect_ratio": { "name": "종횡비" },
		"model_resolution": { "name": "해상도" },
		"model_thinking_level": { "name": "사고 수준" },
		"prompt": {
			"name": "프롬프트",
			"tooltip": "생성할 이미지 또는 적용할 편집을 설명하는 텍스트 프롬프트입니다. 모델이 따라야 할 제약, 스타일, 세부사항을 포함하세요."
		},
		...
		"seed": {
			"name": "시드",
			"tooltip": "시드를 특정 값으로 고정하면, 모델은 반복 요청에 대해 동일한 응답을 제공하려고 최선을 다합니다. 결정적 결과는 보장되지 않습니다. 또한, 모델이나 파라미터(예: temperature)를 변경하면 동일한 시드 값을 사용해도 응답이 달라질 수 있습니다. 기본적으로 무작위 시드 값이 사용됩니다."
		},
		"system_prompt": {
			"name": "시스템 프롬프트",
			"tooltip": "AI의 동작을 지시하는 기본 지침입니다."
		...
		"temperature": {
			"name": "temperature",
			"tooltip": "생성의 무작위성을 제어합니다. 낮을수록 더 집중되고 결정적입니다."
		},
		"top_p": {
			"name": "top_p",
			"tooltip": "누클리어스 샘플링 임계값입니다. 낮을수록 집중되고, 높을수록 다양성이 증가합니다."
		}
	},
	"outputs": {
		"0": { "tooltip": null },
		...
		"2": {
			"name": "사고 이미지",
			"tooltip": "모델의 사고 과정에서 생성된 첫 번째 이미지입니다. 사고 수준이 HIGH이고, 모달리티가 IMAGE+TEXT일 때만 제공됩니다."
		}
	}
};
var GeminiNode = {
	...
	"inputs": {
		"audio": {
			"name": "오디오",
			"tooltip": "모델의 컨텍스트로 사용할 선택적 오디오입니다."
		},
		"control_after_generate": { "name": "생성 후 제어" },
		"files": {
			"name": "파일",
			"tooltip": "모델의 컨텍스트로 사용할 선택적 파일입니다. Gemini Generate Content Input Files 노드의 입력을 허용합니다."
		},
		"images": {
			"name": "images",
			"tooltip": "모델의 컨텍스트로 사용할 선택적 이미지. 여러 이미지를 포함하려면 Batch Images 노드를 사용할 수 있습니다."
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "모델에 대한 텍스트 입력으로, 응답 생성에 사용됩니다. 모델에 대한 상세한 지침, 질문 또는 컨텍스트를 포함할 수 있습니다."
		},
		"seed": {
			"name": "seed",
			"tooltip": "시드가 특정 값으로 고정되면, 모델은 반복 요청에 대해 동일한 응답을 제공하기 위해 최선을 다합니다. 결정론적 출력은 보장되지 않습니다. 또한 모델이나 온도와 같은 매개변수 설정을 변경하면 동일한 시드 값을 사용하더라도 응답에 변동이 발생할 수 있습니다. 기본적으로 랜덤 시드 값이 사용됩니다."
		...
		"video": {
			"name": "비디오",
			"tooltip": "모델의 컨텍스트로 사용할 선택적 비디오입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var GeminiNodeV2 = {
	"description": "Google의 Gemini 모델로 텍스트 응답을 생성합니다. 텍스트 프롬프트와 선택적으로 하나 이상의 이미지, 오디오 클립, 비디오 또는 파일을 멀티모달 컨텍스트로 제공합니다.",
	"display_name": "Google Gemini",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model": {
			"name": "model",
			"tooltip": "응답 생성을 위해 사용되는 Gemini 모델입니다."
		},
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "모델에 입력할 텍스트입니다. 자세한 지침, 질문 또는 컨텍스트를 포함하세요."
		},
		"seed": {
			"name": "seed",
			"tooltip": "샘플링을 위한 시드입니다. 0으로 설정하면 랜덤 시드가 사용됩니다. 결정적 출력은 보장되지 않습니다."
		},
		"system_prompt": {
			"name": "system_prompt",
			"tooltip": "모델의 동작을 지시하는 기본 지침입니다."
...
var GeminiVideoOmni = {
	"description": "Google의 Gemini Omni Flash 모델을 사용하여 텍스트 프롬프트로 오디오가 포함된 영상을 생성합니다. 결과를 안내하거나 편집하기 위해 참조 이미지 및/또는 영상을 선택적으로 제공할 수 있습니다. 원하는 길이(3~10초)와 화면 비율(16:9 또는 9:16)을 프롬프트에 직접 작성하세요.",
	"display_name": "Google Gemini Omni (Video)",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model": {
			"name": "model",
			"tooltip": "영상 생성을 위해 사용되는 Gemini video 모델입니다."
		},
		"model_prompt": { "name": "prompt" },
		"model_temperature": { "name": "temperature" },
		"model_top_p": { "name": "top_p" },
...
var GenerateTracks = {
	...
	"inputs": {
		"bezier": {
			"name": "bezier",
			"tooltip": "중간점을 제어점으로 사용하여 베지어 곡선 경로를 활성화합니다."
		},
		"end_x": {
			"name": "end_x",
			"tooltip": "종료 위치의 정규화된 X 좌표 (0-1)."
		},
		"end_y": {
			"name": "end_y",
			"tooltip": "종료 위치의 정규화된 Y 좌표 (0-1)."
		},
		"height": { "name": "height" },
		"interpolation": {
			"name": "interpolation",
			"tooltip": "경로를 따라 움직임의 타이밍/속도를 제어합니다."
		},
		"mid_x": {
			"name": "mid_x",
			"tooltip": "베지어 곡선의 정규화된 X 제어점. 'bezier'가 활성화된 경우에만 사용됩니다."
		},
		"mid_y": {
			"name": "mid_y",
			"tooltip": "베지어 곡선의 정규화된 Y 제어점. 'bezier'가 활성화된 경우에만 사용됩니다."
		},
		"num_frames": { "name": "num_frames" },
		"num_tracks": { "name": "num_tracks" },
		"start_x": {
			"name": "start_x",
			"tooltip": "시작 위치의 정규화된 X 좌표 (0-1)."
		},
		"start_y": {
			"name": "start_y",
			"tooltip": "시작 위치의 정규화된 Y 좌표 (0-1)."
		},
		"track_mask": {
			"name": "track_mask",
			"tooltip": "보이는 프레임을 표시하는 선택적 mask입니다."
		},
		"track_spread": {
			"name": "track_spread",
			"tooltip": "트랙 간의 정규화된 거리. 트랙은 이동 방향에 수직으로 퍼집니다."
		},
		"width": { "name": "width" }
	},
	"outputs": {
...
var GetICLoRAParameters = {
	"description": "LoRA가 로드된 모델의 safetensors 메타데이터에서 IC-LoRA 파라미터를 추출하여 LTXVAddGuide(예: reference_downscale_factor)에 출력합니다.",
	"display_name": "IC-LoRA 파라미터 가져오기",
	"inputs": { "iclora_model": {
		"name": "iclora_model",
		"tooltip": "메타데이터를 추출할 특정 IC-LoRA의 LoRA Loader에서 직접 출력된 값입니다."
	} },
	"outputs": { "0": {
		"name": "iclora_parameters",
		"tooltip": "LoRA 메타데이터에서 추출된 IC-LoRA 파라미터(예: reference_downscale_factor). LoRA가 가이드의 특별한 처리를 필요로 할 경우 LTXVAddGuide에 연결하세요."
	} }
};
var GetImageSize = {
	"description": "이미지의 너비와 높이를 반환하고 변경 없이 전달합니다.",
	"display_name": "이미지 크기 가져오기",
	"inputs": { "image": { "name": "이미지" } },
	"outputs": {
		"0": {
			"name": "width",
...
var GetSplatCount = {
	"description": "배치 전체에서 합산된 splat의 개수를 반환합니다.",
	"display_name": "Splat 개수 가져오기",
...
var GrokImageEditNodeV2 = {
	...
	"inputs": {
		...
		"model": { "name": "모델" },
		"model_aspect_ratio": { "name": "종횡비" },
		"model_number_of_images": { "name": "이미지 개수" },
		"model_resolution": { "name": "해상도" },
		"prompt": {
			"name": "프롬프트",
...
var GrokVideoEditNode = {
	"description": "텍스트 프롬프트를 기반으로 기존 비디오를 편집합니다.",
	"display_name": "Grok 비디오 편집",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"model": { "name": "model" },
		"prompt": {
			"name": "프롬프트",
			"tooltip": "원하는 비디오에 대한 텍스트 설명입니다."
		},
		"seed": {
			"name": "시드",
			"tooltip": "노드가 다시 실행되어야 하는지 결정하는 시드입니다. 실제 결과는 시드와 관계없이 비결정적입니다."
		...
		"video": {
			"name": "비디오",
			"tooltip": "최대 지원 길이는 8.7초, 파일 크기는 50MB입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var GrokVideoNode = {
	...
	"inputs": {
		"aspect_ratio": {
			"name": "종횡비",
			"tooltip": "출력 비디오의 종횡비입니다."
		},
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": {
			"name": "길이",
			"tooltip": "출력 비디오의 길이(초)입니다."
		},
		"image": {
			"name": "image",
			"tooltip": "grok-imagine-video의 선택적 시작 이미지입니다. grok-imagine-video-1.5에서는 필수입니다."
		},
		"model": {
			"name": "model",
			"tooltip": "grok-imagine-video-1.5는 항상 입력 이미지를 필요로 합니다."
		},
		"prompt": {
			"name": "프롬프트",
			"tooltip": "원하는 비디오에 대한 텍스트 설명입니다."
...
var GrowMask = {
	...
	"inputs": {
		"expand": { "name": "확장" },
		"mask": { "name": "마스크" },
		"tapered_corners": { "name": "마름모 모서리" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var HappyHorseImageToVideoApi = {
	"description": "HappyHorse 모델을 사용하여 첫 프레임 이미지를 기반으로 비디오를 생성합니다.",
	"display_name": "HappyHorse 이미지 → 비디오",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"first_frame": {
			"name": "first_frame",
			"tooltip": "첫 프레임 이미지입니다. 출력 비율은 이 이미지에서 파생됩니다."
		},
		"model": { "name": "model" },
		"model_duration": { "name": "지속 시간" },
		"model_prompt": { "name": "프롬프트" },
		"model_resolution": { "name": "해상도" },
		"seed": {
			"name": "seed",
			"tooltip": "생성에 사용할 시드입니다."
		...
		"watermark": {
			"name": "watermark",
			"tooltip": "AI 생성 워터마크를 결과에 추가할지 여부입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var HappyHorseReferenceVideoApi = {
	"description": "HappyHorse 모델을 사용하여 참조 자료에서 인물 또는 객체가 등장하는 비디오를 생성합니다. 단일 캐릭터 연기와 다중 캐릭터 상호작용을 지원합니다.",
	"display_name": "HappyHorse 참조 → 비디오",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"model": { "name": "model" },
		"model_duration": { "name": "지속 시간" },
...
var HappyHorseTextToVideoApi = {
	"description": "HappyHorse 모델을 사용하여 텍스트 프롬프트를 기반으로 비디오를 생성합니다.",
	"display_name": "HappyHorse 텍스트 → 비디오",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"model": { "name": "model" },
		"model_duration": { "name": "지속 시간" },
...
var HappyHorseVideoEditApi = {
	"description": "HappyHorse 모델을 사용하여 텍스트 지시문 또는 참조 이미지를 통해 비디오를 편집합니다. 출력 지속 시간은 3~15초이며 입력 비디오와 일치합니다. 15초를 초과하는 입력은 잘립니다.",
	"display_name": "HappyHorse 비디오 편집",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"model": { "name": "model" },
		"model_prompt": { "name": "프롬프트" },
...
var HeyGenAvatarVideoNode = {
	"description": "HeyGen 아바타로부터 발표자 영상을 생성합니다. HeyGen의 가장 인기 있는 공개 아바타가 포함되어 있으며, look ID를 입력하여 원하는 아바타로 대체할 수 있습니다.",
	"display_name": "HeyGen 아바타 비디오",
	"inputs": {
		"aspect_ratio": {
			"name": "화면 비율",
			"tooltip": "출력 화면 비율. 'auto'는 아바타의 원본 영상을 따릅니다."
		},
		"background_color": {
			"name": "배경 색상",
			"tooltip": "선택적 단색 배경(예: '#00ff00'). 비워두면 아바타의 원래 배경이 사용됩니다."
		},
		"control_after_generate": { "name": "생성 후 제어" },
		"custom_avatar_id": {
			"name": "커스텀 아바타 ID",
			"tooltip": "선택 사항인 HeyGen 아바타 look ID입니다. 설정 시 위에서 선택한 아바타를 대체합니다. HeyGen의 3000개 이상의 공개 look(또는 개인 아바타)을 사용할 수 있습니다."
		},
		"engine": {
			"name": "엔진",
			"tooltip": "렌더링 엔진; 각 선택지는 해당 엔진을 지원하는 아바타만 표시합니다. 'auto'는 모든 아바타를 제공하며 최적의 엔진(Avatar IV 우선)을 선택합니다. Avatar V는 가장 높은 품질, Avatar III는 가장 경제적입니다."
		},
		"engine_avatar": { "name": "아바타" },
		"resolution": {
			"name": "해상도",
			"tooltip": "출력 비디오 해상도."
		},
		"seed": {
			"name": "시드",
			"tooltip": "HeyGen에 전송되지 않습니다. 값을 변경하면 재실행됩니다."
		},
		"speech": {
			"name": "음성",
			"tooltip": "텍스트 스크립트(헤이젠 텍스트-투-스피치) 또는 직접 녹음한 오디오로 아바타를 구동합니다."
		},
		"speech_custom_voice_id": { "name": "커스텀 음성 ID" },
		"speech_text": { "name": "텍스트" },
		"speech_voice": { "name": "음성" },
		"speech_voice_speed": { "name": "음성 속도" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var HeyGenCreateAvatarNode = {
	"description": "사람의 사진이나 텍스트 프롬프트(생성된 캐릭터)로 나만의 HeyGen 아바타를 만듭니다. 생성된 avatar_id를 HeyGen 아바타 비디오의 custom_avatar_id에 입력하고, 나중에 재사용할 수 있도록 ID를 저장하세요.",
	"display_name": "HeyGen 아바타 생성",
	"inputs": {
		"source": {
			"name": "소스",
			"tooltip": "텍스트 프롬프트로 새로운 캐릭터를 생성하거나, 연결된 인물 사진으로 아바타를 만듭니다."
		},
		"source_prompt": { "name": "프롬프트" }
	},
	"outputs": {
		"0": {
			"name": "avatar_id",
			"tooltip": "아바타 look ID. HeyGen 아바타 비디오의 custom_avatar_id에 전달하고, 나중에 아바타를 재사용하려면 저장하세요."
		},
		"1": {
			"name": "미리보기",
			"tooltip": null
...
var HeyGenTalkingPhotoNode = {
	"description": "사람의 이미지를 입 모양이 동기화된 토킹 비디오(헤이젠 아바타 IV)로 애니메이션화합니다. 텍스트 스크립트나 직접 녹음한 오디오로 구동할 수 있습니다.",
	"display_name": "HeyGen 토킹 포토",
	"inputs": {
		"aspect_ratio": {
			"name": "aspect_ratio",
			"tooltip": "출력 종횡비입니다. 'auto'는 입력 이미지를 따릅니다."
		},
		"control_after_generate": { "name": "control after generate" },
		"expressiveness": {
			"name": "expressiveness",
			"tooltip": "애니메이션 얼굴과 제스처의 표현력 정도입니다."
		},
		"image": {
			"name": "image",
			"tooltip": "애니메이션화할 인물 이미지입니다. 2K보다 크면 자동으로 축소됩니다."
		},
		"resolution": {
			"name": "resolution",
			"tooltip": "출력 비디오 해상도입니다."
		},
		"seed": {
			"name": "seed",
			"tooltip": "HeyGen에 전송되지 않습니다. 값을 변경하면 다시 실행됩니다."
		},
		"speech": {
			"name": "speech",
			"tooltip": "아바타를 텍스트 스크립트(HeyGen 텍스트-투-스피치) 또는 직접 녹음한 오디오로 구동합니다."
		},
...
var HeyGenTextToSpeechNode = {
	"description": "HeyGen의 Starfish TTS 엔진을 사용하여 텍스트로부터 음성 오디오를 생성합니다. 17개 언어의 HeyGen 인기 보이스가 포함되어 있습니다.",
	"display_name": "HeyGen 텍스트-투-스피치",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"custom_voice_id": {
			"name": "custom_voice_id",
			"tooltip": "선택 사항인 HeyGen 보이스 ID입니다. 설정 시 위에서 선택한 보이스를 덮어씁니다. 해당 보이스는 Starfish 엔진을 지원해야 합니다."
		},
		"seed": {
			"name": "seed",
			"tooltip": "HeyGen에 전송되지 않습니다. 값을 변경하면 다시 실행됩니다."
		...
		"ssml": {
			"name": "ssml",
			"tooltip": "텍스트를 SSML 마크업으로 처리합니다(일시정지, 강조, 발음 제어 등)."
		},
		"text": {
			"name": "text",
			"tooltip": "합성할 텍스트(최대 5000자). 생성된 음성은 최소 1초 이상이어야 합니다."
		},
		"voice": {
			"name": "voice",
			"tooltip": "사용할 보이스(HeyGen의 Starfish 호환 인기 보이스 중에서 선별됨)."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var HeyGenVideoTranslateNode = {
	"description": "음성이 포함된 비디오를 다른 언어로 번역합니다. 원래 화자의 목소리를 복제하고, 번역된 음성에 맞게 입 모양을 다시 애니메이션합니다.",
	"display_name": "HeyGen 비디오 번역",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"mode": {
			"name": "모드",
			"tooltip": "'speed'는 더 빠르며, 'precision'은 두 배의 비용으로 더 높은 품질의 입 모양 동기화를 제공합니다."
		},
		"output_language": {
			"name": "출력 언어",
			"tooltip": "번역된 비디오의 대상 언어입니다."
		},
		"seed": {
			"name": "시드",
			"tooltip": "HeyGen에 전송되지 않습니다; 값을 변경하면 다시 실행됩니다."
		...
		"speaker_count": {
			"name": "화자 수",
			"tooltip": "비디오에 등장하는 화자 수입니다. 0 = 자동 감지."
		},
		"translate_audio_only": {
			"name": "오디오만 번역",
			"tooltip": "오디오 트랙만 교체하고 원래의 입 모양은 유지합니다 (입 모양 동기화 없음)."
		},
		"video": {
			"name": "비디오",
			"tooltip": "번역할 음성이 포함된 비디오입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var HunyuanRefinerLatent = {
	...
	"inputs": {
		"latent": { "name": "잠재" },
		"negative": { "name": "부정적" },
		"noise_augmentation": { "name": "노이즈 증강" },
		"positive": { "name": "긍정적" }
	},
	"outputs": {
		"0": {
...
var HyperTile = {
	"display_name": "하이퍼 타일",
	"inputs": {
		"max_depth": { "name": "최대 깊이" },
		"model": { "name": "모델" },
		"scale_depth": { "name": "스케일 깊이" },
		"swap_size": { "name": "스왑 크기" },
		"tile_size": { "name": "타일 크기" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var HypernetworkLoader = {
	...
	"inputs": {
		"hypernetwork_name": { "name": "하이퍼네트워크 이름" },
		"model": { "name": "모델" },
		"strength": { "name": "강도" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var IdeogramV3 = {
	...
	"inputs": {
		...
		"character_image": {
			"name": "캐릭터 이미지",
			"tooltip": "캐릭터 참조로 사용할 이미지입니다."
		},
		"character_mask": {
			"name": "캐릭터 마스크",
			"tooltip": "캐릭터 참조 이미지에 대한 선택적 마스크입니다."
		},
		"control_after_generate": { "name": "생성 후 제어" },
		"image": {
			"name": "이미지",
...
var IdeogramV4 = {
	"description": "텍스트 프롬프트로 Ideogram 4.0 모델을 사용해 이미지를 생성합니다.",
	"display_name": "Ideogram V4",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"prompt": {
			"name": "프롬프트",
			"tooltip": "이미지 생성을 위한 텍스트 프롬프트입니다."
		},
		"rendering_speed": {
			"name": "렌더링 속도",
			"tooltip": "생성 속도와 품질 간의 균형을 제어합니다."
		},
		"resolution": { "name": "해상도" },
		"seed": { "name": "seed" }
	},
...
var ImageBlend = {
	"display_name": "이미지 혼합",
	"inputs": {
		"blend_factor": { "name": "혼합 계수" },
		"blend_mode": { "name": "혼합 모드" },
		"image1": { "name": "이미지1" },
		"image2": { "name": "이미지2" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var ImageCompare = {
	"description": "두 이미지를 슬라이더로 나란히 비교합니다.",
	"display_name": "이미지 비교",
	"inputs": {
...
var ImageCropV2 = {
	"description": "이미지를 지정한 크기로 자릅니다.",
	"display_name": "이미지 자르기",
	"inputs": {
		"crop_region": { "name": "자르기 영역" },
		"height": {},
		"image": { "name": "이미지" },
		"width": {},
		"x": {},
...
var ImageDeduplication = {
	"description": "목록에서 중복되거나 매우 유사한 이미지를 제거합니다.",
	"display_name": "이미지 중복 제거",
	"inputs": {
		"images": {
			"name": "이미지",
			"tooltip": "처리할 이미지 목록입니다."
		},
		"similarity_threshold": {
			"name": "유사도 임계값",
			"tooltip": "유사도 임계값 (0-1). 값이 높을수록 더 유사합니다. 이 임계값을 초과하는 이미지는 중복으로 간주됩니다."
		}
	},
	"outputs": { "0": {
		"name": "이미지",
...
var ImageFlip = {
	"display_name": "이미지 뒤집기",
	"inputs": {
		"flip_method": { "name": "뒤집기 방법" },
		"image": { "name": "이미지" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var ImageGrid = {
	"description": "여러 이미지를 그리드 레이아웃으로 배열합니다.",
	"display_name": "이미지 그리드",
	"inputs": {
		"cell_height": {
			"name": "셀 높이",
			"tooltip": "그리드 내 각 셀의 높이입니다."
		},
		"cell_width": {
			"name": "셀 너비",
			"tooltip": "그리드 내 각 셀의 너비입니다."
		},
		"columns": {
			"name": "열",
			"tooltip": "그리드의 열 개수입니다."
		},
		"images": {
			"name": "이미지",
			"tooltip": "처리할 이미지 목록입니다."
...
var ImageOnlyCheckpointLoader = {
	...
	"inputs": { "ckpt_name": { "name": "체크포인트 파일명" } }
};
...
var ImageScaleToMaxDimension = {
	"display_name": "이미지를 최대 크기로 확대",
	"inputs": {
		"image": { "name": "이미지" },
		"largest_size": { "name": "최대 크기" },
		"upscale_method": { "name": "업스케일 방법" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var ImageScaleToTotalPixels = {
	...
	"inputs": {
		"image": { "name": "이미지" },
		"megapixels": { "name": "메가픽셀수" },
		"resolution_steps": { "name": "해상도 단계" },
		"upscale_method": { "name": "확대 방법" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var ImageStitch = {
	...
	"display_name": "이미지 스티치",
	"inputs": {
		"direction": { "name": "방향" },
		"image1": { "name": "이미지1" },
		"image2": { "name": "이미지2" },
		"match_image_size": { "name": "이미지 크기 맞추기" },
		"spacing_color": { "name": "간격 색상" },
		"spacing_width": { "name": "간격 너비" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var ImageToMask = {
...
var InvertMask = {
	"display_name": "마스크 반전",
	"inputs": { "mask": { "name": "마스크" } },
	"outputs": { "0": { "tooltip": null } }
};
var JoinAudioChannels = {
	"description": "좌우 모노 오디오 채널을 스테레오 오디오로 합칩니다.",
	"display_name": "오디오 채널 합치기",
	"inputs": {
...
var KSampler = {
	...
	"outputs": { "0": { "tooltip": "노이즈가 제거된 잠재 데이터입니다." } }
};
var KSamplerAdvanced = {
	"display_name": "고급 KSampler",
	"inputs": {
		"add_noise": { "name": "노이즈 추가" },
		"cfg": { "name": "cfg" },
		"control_after_generate": { "name": "생성 후 제어" },
		"end_at_step": { "name": "종료 스텝" },
		"latent_image": { "name": "잠재 데이터" },
		"model": { "name": "모델" },
		"negative": { "name": "부정 조건" },
		"noise_seed": { "name": "노이즈 시드" },
		"positive": { "name": "긍정 조건" },
		"return_with_leftover_noise": { "name": "잔여 노이즈 반환" },
		"sampler_name": { "name": "샘플러 이름" },
		"scheduler": { "name": "스케줄러" },
		"start_at_step": { "name": "시작 스텝" },
		"steps": { "name": "스텝 수" }
	}
};
var KSamplerSelect = {
	"display_name": "KSampler (선택)",
	"inputs": { "sampler_name": { "name": "샘플러 이름" } },
	"outputs": { "0": { "tooltip": null } }
};
var Kandinsky5ImageToVideo = {
	...
	"outputs": {
		...
		"2": {
			"name": "latent",
			"tooltip": "비어 있는 비디오 latent"
		},
		"3": {
			"name": "cond_latent",
			"tooltip": "노이즈가 제거된 인코딩된 시작 이미지로, 모델 출력 latent의 노이즈 시작 부분을 대체하는 데 사용됩니다"
		}
	}
};
var KarrasScheduler = {
	...
	"inputs": {
		"rho": { "name": "rho" },
		"sigma_max": { "name": "최대 시그마" },
		"sigma_min": { "name": "최소 시그마" },
		"steps": { "name": "스텝 수" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var KlingAvatarNode = {
	"description": "한 장의 사진과 오디오 파일로 방송 스타일의 디지털 휴먼 영상을 생성합니다.",
	"display_name": "Kling Avatar 2.0",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"image": {
			"name": "image",
			"tooltip": "아바타 참조 이미지입니다. 너비와 높이는 최소 300px이어야 합니다. 가로세로 비율은 1:2.5에서 2.5:1 사이여야 합니다."
		},
		"mode": { "name": "mode" },
		"prompt": {
			"name": "prompt",
			"tooltip": "아바타의 동작, 감정, 카메라 움직임을 정의하는 선택적 프롬프트입니다."
		},
		"seed": {
			"name": "seed",
			"tooltip": "시드는 노드가 다시 실행될지 여부를 제어합니다. 시드와 관계없이 결과는 비결정적입니다."
		...
		"sound_file": {
			"name": "sound_file",
			"tooltip": "오디오 입력입니다. 길이는 2초에서 300초 사이여야 합니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var KlingCameraControls = {
	...
	"inputs": {
		"camera_control_type": { "name": "카메라 제어 종류" },
		"horizontal_movement": {
			"name": "수평 이동",
...
var KlingFirstLastFrameNode = {
	...
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": { "name": "지속 시간" },
		"end_frame": { "name": "마지막 프레임" },
		"first_frame": { "name": "첫 프레임" },
		"generate_audio": { "name": "오디오 생성" },
		"model": {
			"name": "모델",
			"tooltip": "모델 및 생성 설정."
		},
...
var KlingImageGenerationNode = {
	...
	"inputs": {
		...
		"image_type": { "name": "이미지 종류" },
		"model_name": { "name": "모델 명" },
		"n": {
			"name": "개수",
			"tooltip": "생성할 이미지 수"
		},
...
var KlingImageToVideoWithAudio = {
	"display_name": "Kling 이미지(첫 프레임) → 비디오 및 오디오",
	"inputs": {
		"duration": { "name": "길이" },
		"generate_audio": { "name": "오디오 생성" },
		"mode": { "name": "모드" },
		...
		"prompt": {
			"name": "프롬프트",
			"tooltip": "긍정적인 텍스트 프롬프트."
		},
		"start_frame": { "name": "시작 프레임" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var KlingMotionControl = {
	"display_name": "Kling 모션 컨트롤",
	"inputs": {
		"character_orientation": {
			"name": "캐릭터 방향",
			"tooltip": "캐릭터의 시선/방향이 어디서 오는지 제어합니다.\n비디오: 움직임, 표정, 카메라 이동, 방향이 동작 참조 비디오를 따릅니다(기타 세부사항은 프롬프트로).\n이미지: 움직임과 표정은 여전히 동작 참조 비디오를 따르지만, 캐릭터 방향은 참조 이미지를 따릅니다(카메라/기타 세부사항은 프롬프트로)."
		},
		"keep_original_sound": { "name": "원본 사운드 유지" },
		"mode": { "name": "모드" },
		"model": { "name": "모델" },
		"prompt": { "name": "프롬프트" },
		"reference_image": { "name": "참조 이미지" },
		"reference_video": {
			"name": "참조 비디오",
			"tooltip": "동작 참조 비디오로 움직임/표정을 제어합니다.\n길이 제한은 character_orientation에 따라 다릅니다:\n - 이미지: 3–10초 (최대 10초)\n - 비디오: 3–30초 (최대 30초)"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var KlingOmniProEditVideoNode = {
	...
	"inputs": {
		...
		"prompt": {
			"name": "프롬프트",
			"tooltip": "비디오 내용을 설명하는 텍스트 프롬프트입니다. 긍정적/부정적 설명 모두 포함할 수 있습니다."
		},
		"reference_images": {
			"name": "참조 이미지",
			"tooltip": "최대 4개의 추가 참조 이미지를 사용할 수 있습니다."
		},
		"resolution": { "name": "해상도" },
		"seed": {
			"name": "시드",
...
var KlingOmniProFirstLastFrameNode = {
	...
	"inputs": {
		...
		"end_frame": {
			"name": "종료 프레임",
			"tooltip": "비디오의 선택적 종료 프레임입니다. 'reference_images'와 동시에 사용할 수 없습니다."
		},
		"first_frame": { "name": "시작 프레임" },
		"generate_audio": {
			"name": "오디오 생성",
		...
		"prompt": {
			"name": "프롬프트",
			"tooltip": "비디오 내용을 설명하는 텍스트 프롬프트입니다. 긍정적 및 부정적 설명을 모두 포함할 수 있습니다."
		},
		"reference_images": {
			"name": "참조 이미지",
			"tooltip": "최대 6개의 추가 참조 이미지를 사용할 수 있습니다."
		},
		"resolution": { "name": "해상도" },
		"seed": {
			"name": "시드",
...
var KlingOmniProImageNode = {
	"description": "최신 Kling 모델로 이미지를 생성하거나 편집합니다.",
	"display_name": "Kling Omni 이미지 (Pro)",
	"inputs": {
		"aspect_ratio": { "name": "화면 비율" },
		"control_after_generate": { "name": "생성 후 제어" },
		"model_name": { "name": "model_name" },
		"prompt": {
			"name": "프롬프트",
			"tooltip": "이미지 내용을 설명하는 텍스트 프롬프트입니다. 긍정적 및 부정적 설명을 모두 포함할 수 있습니다."
		},
		"reference_images": {
			"name": "참조 이미지",
			"tooltip": "최대 10개의 추가 참조 이미지를 사용할 수 있습니다."
		},
		"resolution": { "name": "해상도" },
		"seed": {
			"name": "시드",
...
var KlingOmniProImageToVideoNode = {
	"description": "최신 Kling 모델로 최대 7개의 참조 이미지를 사용하여 비디오를 생성합니다.",
	"display_name": "Kling Omni 이미지에서 비디오로 (Pro)",
	"inputs": {
		"aspect_ratio": { "name": "화면 비율" },
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": { "name": "지속 시간" },
		...
		"reference_images": {
			"name": "참조 이미지",
			"tooltip": "최대 7개의 참조 이미지를 사용할 수 있습니다."
		},
		"resolution": { "name": "해상도" },
		"seed": {
			"name": "시드",
...
var KlingOmniProTextToVideoNode = {
	"description": "최신 Kling 모델로 텍스트 프롬프트를 사용해 비디오를 생성합니다.",
	"display_name": "Kling Omni 텍스트에서 비디오로 (Pro)",
	"inputs": {
		"aspect_ratio": { "name": "화면 비율" },
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": { "name": "지속 시간" },
...
var KlingOmniProVideoToVideoNode = {
	"description": "비디오와 최대 4개의 참조 이미지를 사용하여 최신 Kling 모델로 비디오를 생성합니다.",
	"display_name": "Kling Omni 비디오 투 비디오 (Pro)",
	"inputs": {
		"aspect_ratio": { "name": "종횡비" },
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": { "name": "길이" },
		...
		"reference_images": {
			"name": "참조 이미지",
			"tooltip": "최대 4개의 추가 참조 이미지."
		},
		"reference_video": {
			"name": "참조 비디오",
			"tooltip": "참조로 사용할 비디오입니다."
		},
		"resolution": { "name": "해상도" },
		"seed": {
			"name": "시드",
...
var KlingTextToVideoWithAudio = {
	"display_name": "Kling 텍스트 투 비디오 (오디오 포함)",
	"inputs": {
		"aspect_ratio": { "name": "종횡비" },
		"duration": { "name": "길이" },
		"generate_audio": { "name": "오디오 생성" },
...
var KlingVideoNode = {
	...
	"inputs": {
		...
		"generate_audio": {
			"name": "오디오 생성",
			"tooltip": "'kling-3.0-turbo'는 항상 기본 오디오를 생성하므로, 오디오 토글은 무시됩니다."
		},
		"model": {
			"name": "모델",
			"tooltip": "모델 및 생성 설정."
		...
		"multi_shot_duration": { "name": "지속 시간" },
		"multi_shot_negative_prompt": { "name": "네거티브 프롬프트" },
		"multi_shot_prompt": { "name": "프롬프트" },
		"seed": {
			"name": "시드",
			"tooltip": "시드는 노드가 다시 실행되어야 하는지 제어합니다. 시드와 관계없이 결과는 비결정적입니다."
		},
...
var KlingVirtualTryOnNode = {
	...
	"inputs": {
		"cloth_image": { "name": "의상 이미지" },
		"human_image": { "name": "사람 이미지" },
		"model_name": { "name": "모델 명" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var Krea2ImageNode = {
	"description": "Krea 2를 통해 이미지를 생성합니다 — Medium(표현적인 일러스트) 또는 Large(표현적인 사진 실사)를 선택하세요. 선택적으로 무드보드를 지원하며 최대 10개의 연쇄된 이미지 스타일 참조를 지원합니다.",
	"display_name": "Krea 2 이미지",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"model": {
			"name": "모델",
			"tooltip": "Krea 2 Medium은 표현적인 일러스트에, Krea 2 Large는 표현적인 사진 실사에 적합합니다."
		},
		"model_aspect_ratio": { "name": "종횡비" },
		"model_creativity": { "name": "창의성" },
		"model_moodboard_id": { "name": "무드보드 ID" },
		"model_moodboard_strength": { "name": "무드보드 강도" },
		"model_resolution": { "name": "해상도" },
		"prompt": {
			"name": "프롬프트",
			"tooltip": "이미지에 대한 텍스트 프롬프트입니다."
		},
		"seed": {
			"name": "시드",
			"tooltip": "재현성을 위한 랜덤 시드입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var Krea2StyleReferenceNode = {
	"description": "Krea 2 생성에 이미지 스타일 참조를 추가합니다. 여러 개의 Krea 2 스타일 참조 노드를 연쇄(최대 10개)하여 마지막 `style_reference` 출력을 Krea 2 이미지에 연결하세요. 각 이미지는 ComfyAPI 저장소에 업로드되고 URL로 전달됩니다.",
	"display_name": "Krea 2 스타일 참조",
	"inputs": {
		"image": {
			"name": "이미지",
			"tooltip": "생성에 스타일 영향을 주는 참조 이미지입니다."
		},
		"strength": {
			"name": "강도",
			"tooltip": "참조 강도; 음수 값은 스타일 영향을 반전시킵니다."
		},
		"style_reference": {
			"name": "스타일 참조",
			"tooltip": "선택적 연쇄 스타일 참조 입력; 이 노드는 하나를 추가합니다."
		}
	},
	"outputs": { "0": {
		"name": "스타일 참조",
...
var LTXAVTextEncoderLoader = {
	"description": "[Recipes]\n\nltxav: gemma 3 12B",
	"display_name": "LTXV 오디오 텍스트 인코더 로더",
	"inputs": {
...
var LTXVAddGuide = {
	...
	"inputs": {
		"attention_mask": {
			"name": "attention_mask",
			"tooltip": "선택적 픽셀 공간 마스크입니다. self-attention을 통해 각 영역별 조건 영향력을 strength 값과 곱하여 제어합니다."
		},
		"frame_idx": {
			"name": "프레임 번호",
		...
		"iclora_parameters": {
			"name": "iclora_parameters",
			"tooltip": "Get IC-LoRA Parameters 노드에서 가져온 선택적 IC-LoRA 파라미터입니다. reference_downscale_factor > 1인 IC-LoRA 등 일부 가이드 처리가 필요한 경우에 사용됩니다. 체인으로 연결할 경우, 각 LTXVAddGuide는 연결된 파라미터만 사용합니다."
		},
		"image": {
			"name": "이미지",
...
var LTXVAudioVAEDecode = {
	"display_name": "LTXV 오디오 VAE 디코드",
	"inputs": {
		"audio_vae": {
			"name": "audio_vae",
			"tooltip": "latent 디코딩에 사용되는 Audio VAE 모델."
		},
		"samples": {
			"name": "samples",
			"tooltip": "디코딩할 latent."
...
var LTXVAudioVAELoader = {
	"display_name": "LTXV 오디오 VAE 로더",
	"inputs": { "ckpt_name": {
		"name": "ckpt_name",
		"tooltip": "불러올 Audio VAE 체크포인트."
	} },
	"outputs": { "0": {
		"name": "Audio VAE",
		"tooltip": null
...
var LTXVContextWindows = {
	"description": "LTXV 계열 모델을 위한 컨텍스트 윈도우를 설정합니다.",
	"display_name": "LTXV 컨텍스트 윈도우",
	"inputs": {
		"closed_loop": {
			"name": "closed_loop",
			"tooltip": "컨텍스트 윈도우 루프를 닫을지 여부입니다. 루프 스케줄에만 적용됩니다."
		...
		"context_length": {
			"name": "context_length",
			"tooltip": "실제 프레임 단위의 컨텍스트 윈도우 길이입니다. 8*n + 1이어야 합니다."
		},
		"context_overlap": {
			"name": "context_overlap",
			"tooltip": "실제 프레임 단위의 컨텍스트 윈도우 오버랩입니다."
		},
		"context_schedule": {
			"name": "context_schedule",
			"tooltip": "컨텍스트 윈도우를 위한 스텝 기반 스케줄링 알고리즘입니다."
		},
		"context_stride": {
			"name": "context_stride",
			"tooltip": "컨텍스트 윈도우의 스트라이드입니다. 균일 스케줄에만 적용됩니다."
		...
		"freenoise": {
			"name": "freenoise",
			"tooltip": "FreeNoise 노이즈 셔플을 적용할지 여부입니다. 윈도우 블렌딩을 개선합니다."
		},
		"fuse_method": {
			"name": "fuse_method",
			"tooltip": "컨텍스트 윈도우를 합치는 데 사용할 방법입니다."
		},
		"model": {
			"name": "model",
			"tooltip": "샘플링 중 컨텍스트 윈도우를 적용할 모델입니다."
		...
		"retain_first_frame": {
			...
			"tooltip": "모든 컨텍스트 윈도우에서 첫 번째 latent 프레임을 유지합니다 (초기 참조 유지에 도움이 될 수 있음)."
		},
		"split_conds_to_windows": {
			"name": "split_conds_to_windows",
			"tooltip": "ConditionCombine으로 생성된 여러 컨디셔닝을 영역 인덱스에 따라 각 윈도우로 분할할지 여부입니다."
		}
	},
	"outputs": { "0": { "tooltip": "샘플링 중 컨텍스트 윈도우가 적용된 모델입니다." } }
};
...
var LTXVEmptyLatentAudio = {
	"display_name": "LTXV 빈 latent 오디오",
	"inputs": {
		"audio_vae": {
			"name": "audio_vae",
			"tooltip": "구성을 가져올 Audio VAE 모델."
		},
		"batch_size": {
			"name": "batch_size",
			"tooltip": "배치 내 latent 오디오 샘플 수."
		},
		"frame_rate": {
			"name": "frame_rate",
			"tooltip": "초당 프레임 수."
...
var LTXVScheduler = {
	...
	"inputs": {
		"base_shift": { "name": "기반 시프트" },
		"latent": { "name": "잠재 비디오" },
		"max_shift": { "name": "최대 시프트" },
		"steps": { "name": "스텝 수" },
		"stretch": {
			"name": "늘이기",
...
var LatentAdd = {
	...
	"inputs": {
		"samples1": { "name": "잠재 데이터1" },
		"samples2": { "name": "잠재 데이터2" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var LatentComposite = {
	...
	"inputs": {
		"feather": { "name": "가장자리 흐림" },
		"samples_from": { "name": "추가 잠재 데이터" },
		"samples_to": { "name": "대상 잠재 데이터" },
		"x": { "name": "x" },
		"y": { "name": "y" }
	}
};
...
var LatentUpscaleModelLoader = {
	"display_name": "Latent 업스케일 모델 불러오기",
	"inputs": { "model_name": { "name": "model_name" } },
	"outputs": { "0": { "tooltip": null } }
};
var LazyCache = {
	"description": "EasyCache의 자체 제작 버전 - 구현이 '더 쉬운' EasyCache 버전입니다. 전체적으로는 EasyCache보다 성능이 떨어지지만, 일부 드문 경우에 더 좋으며 ComfyUI의 모든 것과 완벽한 호환성을 제공합니다.",
	"display_name": "LazyCache",
	"inputs": {
		"end_percent": {
			"name": "종료 백분율",
			"tooltip": "LazyCache 사용을 종료할 상대적 샘플링 단계입니다."
		},
		"model": {
			"name": "모델",
			"tooltip": "LazyCache를 적용할 모델입니다."
		},
		"reuse_threshold": {
			"name": "재사용 임계값",
			"tooltip": "캐시된 단계를 재사용하기 위한 임계값입니다."
		...
		"start_percent": {
			"name": "시작 백분율",
			"tooltip": "LazyCache 사용을 시작할 상대적 샘플링 단계입니다."
		},
		"verbose": {
			"name": "상세 정보",
			"tooltip": "상세 정보를 기록할지 여부입니다."
		}
	},
	"outputs": { "0": { "tooltip": "LazyCache가 적용된 모델입니다." } }
};
var Load3D = {
...
var LoadDA3Model = {
	"display_name": "Depth Anything 3 불러오기",
	"inputs": {
		"model_name": { "name": "model_name" },
...
var LoadImageDataSetFromFolder = {
	"description": "지정한 폴더에서 이미지 데이터셋을 불러와 이미지 목록으로 반환합니다. 지원 포맷: PNG, JPG, JPEG, WEBP.",
	"display_name": "폴더에서 이미지 데이터셋 불러오기",
	"inputs": { "folder": {
		"name": "폴더",
		"tooltip": "이미지를 불러올 폴더입니다."
	} },
	"outputs": { "0": {
		"name": "이미지",
		"tooltip": "불러온 이미지 목록"
...
var LoadImageTextDataSetFromFolder = {
	"description": "지정한 폴더에서 이미지와 텍스트 캡션 쌍의 데이터셋을 불러와 목록으로 반환합니다. 지원 포맷: PNG, JPG, JPEG, WEBP.",
	"display_name": "폴더에서 이미지 및 텍스트 데이터셋 불러오기",
	"inputs": { "folder": {
		"name": "폴더",
		"tooltip": "이미지를 불러올 폴더입니다."
	} },
...
var LoadLatent = {
	...
	"inputs": { "latent": { "name": "잠재 데이터" } }
};
var LoadMediaPipeFaceLandmarker = {
	"display_name": "MediaPipe 얼굴 랜드마커 불러오기",
	"inputs": { "model_name": {
		"name": "model_name",
		"tooltip": "models/mediapipe/의 Face Landmarker safetensors."
	} },
	"outputs": { "0": { "tooltip": null } }
};
var LoadMoGeModel = {
	"display_name": "MoGe 모델 불러오기",
	"inputs": { "model_name": { "name": "model_name" } },
	"outputs": { "0": { "tooltip": null } }
};
var LoadTrainingDataset = {
	"description": "디스크에서 인코딩된 학습 데이터셋(latents + conditioning)을 불러와 학습에 사용합니다.",
	"display_name": "학습 데이터셋 불러오기",
	"inputs": { "folder_name": {
		"name": "folder_name",
		"tooltip": "저장된 데이터셋이 들어있는 폴더 이름 (output 디렉토리 내부)."
	} },
	"outputs": {
		"0": {
			"name": "latents",
			"tooltip": "latent 딕셔너리 목록"
		},
		"1": {
			"name": "conditioning",
			"tooltip": "conditioning 리스트 목록"
		}
	}
};
var LoadVideo = {
...
var LoadVideoDataSetFromFolder = {
	"description": "지정한 폴더에서 비디오 데이터셋을 불러와 비디오 목록을 반환합니다. 지원 형식: MP4, AVI, MOV, WEBM, MKV, FLV.",
	"display_name": "비디오 불러오기 (폴더에서)",
	"inputs": { "folder": {
		"name": "폴더",
		"tooltip": "비디오 파일이 포함된 폴더입니다."
	} },
	"outputs": { "0": {
		"name": "비디오",
		"tooltip": "지연 로딩 비디오 참조; 프레임은 필요할 때만 디코딩됩니다."
	} }
};
var LoadVideoTextDataSetFromFolder = {
	"description": "지정한 폴더에서 비디오와 텍스트 캡션 쌍의 데이터셋을 불러와 목록으로 반환합니다. 지원 형식: MP4, AVI, MOV, WEBM, MKV, FLV.",
	"display_name": "비디오-텍스트 불러오기 (폴더에서)",
	"inputs": { "folder": {
		"name": "폴더",
		"tooltip": "비디오 파일과 .txt 캡션이 포함된 폴더입니다."
	} },
	"outputs": {
		"0": {
			"name": "비디오",
...
var LoraLoader = {
	...
	"outputs": {
		"0": { "tooltip": "수정된 확산 모델입니다." },
		"1": { "tooltip": "수정된 CLIP 모델입니다." }
	}
};
var LoraLoaderBypass = {
	"description": "LoRA를 바이패스 모드로 적용합니다. 일반 LoRA와 달리 모델 가중치를 수정하지 않고, 순전파 과정에서 LoRA 연산을 주입합니다. 학습 시나리오에 유용합니다.",
	"display_name": "LoRA 불러오기 (바이패스) (디버깅용)",
	"inputs": {
		"clip": {
			"name": "clip",
			"tooltip": "LoRA가 적용될 CLIP 모델입니다."
		...
		"model": {
			"name": "model",
			"tooltip": "LoRA가 적용될 디퓨전 모델입니다."
		},
		"strength_clip": {
			"name": "strength_clip",
			"tooltip": "CLIP 모델을 얼마나 강하게 수정할지 설정합니다. 이 값은 음수도 가능합니다."
		},
		"strength_model": {
			"name": "strength_model",
			"tooltip": "디퓨전 모델을 얼마나 강하게 수정할지 설정합니다. 이 값은 음수도 가능합니다."
		}
	},
	"outputs": {
		"0": { "tooltip": "수정된 디퓨전 모델입니다." },
		"1": { "tooltip": "수정된 CLIP 모델입니다." }
	}
};
var LoraLoaderBypassModelOnly = {
	"description": "LoRA를 바이패스 모드로 적용합니다. 일반 LoRA와 달리 모델 가중치를 수정하지 않고, 순전파 과정에서 LoRA 연산을 주입합니다. 학습 시나리오에 유용합니다.",
	"display_name": "LoRA 불러오기 (바이패스, 모델만) (디버깅용)",
	"inputs": {
		"lora_name": { "name": "lora_name" },
		"model": { "name": "model" },
		"strength_model": { "name": "strength_model" }
	},
	"outputs": { "0": { "tooltip": "수정된 디퓨전 모델입니다." } }
};
var LoraLoaderModelOnly = {
	...
	"inputs": {
		"lora_name": { "name": "LoRA 이름" },
		"model": { "name": "모델" },
		"strength_model": { "name": "모델 강도" }
	},
	"outputs": { "0": { "tooltip": "수정된 확산 모델입니다." } }
};
var LoraModelLoader = {
	...
	"outputs": { "0": {
		"name": "model",
		"tooltip": "수정된 diffusion 모델입니다."
	} }
};
var LoraSave = {
	"display_name": "LoRA 추출 및 저장",
	"inputs": {
		"bias_diff": { "name": "차이 편향" },
		"filename_prefix": { "name": "파일명 접두사" },
		"lora_type": { "name": "LoRA 유형" },
		"model_diff": {
			"name": "모델 차이",
...
var LossGraphNode = {
	...
	"inputs": {
		"filename_prefix": {
			"name": "파일명 접두사",
			"tooltip": "저장될 loss 그래프 이미지의 접두사."
		},
		"loss": {
			"name": "손실",
			"tooltip": "학습 노드에서 가져온 loss 맵."
		}
	}
};
...
var LtxvApiImageToVideo = {
	"description": "시작 이미지를 기반으로 사용자 지정 가능한 지속 시간과 해상도를 가진 전문가급 품질의 비디오입니다.",
	"display_name": "LTXV 이미지 투 비디오",
	"inputs": {
		"duration": { "name": "지속 시간" },
		"fps": { "name": "FPS" },
		"generate_audio": {
			"name": "오디오 생성",
			"tooltip": "true로 설정하면 생성된 비디오에 장면과 일치하는 AI 생성 오디오가 포함됩니다."
		},
		"image": {
			"name": "이미지",
			"tooltip": "비디오에 사용할 첫 번째 프레임입니다."
...
var LtxvApiTextToVideo = {
	"description": "사용자 지정 가능한 지속 시간과 해상도를 가진 전문가급 품질의 비디오입니다.",
	"display_name": "LTXV 텍스트 투 비디오",
	"inputs": {
		"duration": { "name": "지속 시간" },
		"fps": { "name": "FPS" },
		"generate_audio": {
...
var LumaImageEditNode2 = {
	"description": "Luma UNI-1 모델을 사용하여 텍스트 프롬프트로 기존 이미지를 편집합니다.",
	"display_name": "Luma UNI-1 이미지 편집",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model": {
			"name": "model",
			"tooltip": "편집에 사용할 모델입니다."
		},
		"model_style": { "name": "style" },
		"model_web_search": { "name": "web_search" },
		"prompt": {
			"name": "prompt",
			"tooltip": "원하는 편집에 대한 설명입니다. 1~6000자."
		},
		"seed": {
			"name": "seed",
			"tooltip": "시드 값은 노드가 다시 실행될지 여부를 제어합니다. 시드와 관계없이 결과는 비결정적입니다."
		},
		"source": {
			"name": "source",
			"tooltip": "편집할 원본 이미지입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var LumaImageNode2 = {
	"description": "Luma UNI-1 모델을 사용하여 텍스트로부터 이미지를 생성합니다.",
	"display_name": "Luma UNI-1 이미지",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model": {
			"name": "model",
		...
		"prompt": {
			"name": "prompt",
			"tooltip": "원하는 이미지에 대한 텍스트 설명입니다. 1~6000자."
		},
		"seed": {
			"name": "seed",
			"tooltip": "시드 값은 노드가 다시 실행될지 여부를 제어합니다. 시드와 관계없이 결과는 비결정적입니다."
...
var LumaRay32ExtendVideoNode = {
	"description": "이전 Ray 3.2 생성 결과를 앞으로(이후 계속) 또는 뒤로(이전 앞부분 추가) 확장합니다. 이전 Luma Ray 3.2 노드의 generation_id 출력을 연결하세요. 확장 길이는 항상 5초입니다.",
	"display_name": "Luma Ray 3.2 비디오 확장",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"direction": {
			"name": "direction",
			"tooltip": "Forward는 이전 clip 이후로 계속 진행하며, backward는 그 앞에 추가됩니다."
		},
		"direction_loop": { "name": "loop" },
		"prompt": {
			"name": "prompt",
			"tooltip": "새로운 콘텐츠를 위한 텍스트 프롬프트입니다."
		},
		"resolution": { "name": "resolution" },
		"seed": {
			"name": "seed",
			"tooltip": "노드를 다시 실행할지 결정하는 시드입니다. 시드와 관계없이 결과는 비결정적입니다."
		},
		"source_generation_id": {
			"name": "source_generation_id",
			"tooltip": "확장할 이전 Ray 3.2 비디오의 generation_id입니다. 다른 Luma Ray 3.2 노드의 generation_id 출력을 연결하세요."
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var LumaRay32ImageToVideoNode = {
	"description": "Luma의 Ray 3.2 모델을 사용하여 시작 및/또는 종료 프레임에서 비디오를 생성합니다. 이미지 기반 생성은 항상 5초입니다.",
	"display_name": "Luma Ray 3.2 이미지 → 비디오",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"end_frame": {
			"name": "end_frame",
			"tooltip": "생성된 비디오의 마지막 프레임입니다."
		},
		"loop": {
			"name": "loop",
			"tooltip": "비디오가 자연스럽게 반복되도록 만듭니다. end_frame이 설정된 경우에는 사용할 수 없습니다."
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "비디오 생성을 위한 텍스트 프롬프트입니다."
		},
		"resolution": { "name": "resolution" },
		"seed": {
			"name": "seed",
...
var LumaRay32KeyframeNode = {
	"description": "Ray 3.2 출력 비디오 타임라인의 위치에 가이드 이미지를 고정합니다. 이 노드를 Luma Ray 3.2 Keyframes to Video 노드의 'keyframes' 입력에 연결하세요. 아래의 선택적 'keyframes' 입력을 통해 여러 개를 연쇄할 수 있습니다.",
	"display_name": "Luma Ray 3.2 키프레임",
	"inputs": {
		"image": {
			"name": "image",
			"tooltip": "출력 비디오의 원하는 시점에 배치할 가이드 이미지입니다."
		},
		"keyframes": {
			"name": "keyframes",
			"tooltip": "이전 키프레임을 이 키프레임과 연쇄할 때 선택적으로 사용합니다."
		},
		"position": {
			"name": "position",
			"tooltip": "이 이미지를 출력 비디오 타임라인에 어떻게 배치할지 설정합니다."
		},
...
var LumaRay32KeyframesToVideoNode = {
	"description": "Luma Ray 3.2를 사용하여 타임라인의 위치에 고정된 가이드 이미지 시퀀스를 보간하여 비디오를 생성합니다. Luma Ray 3.2 Keyframe 노드(최소 2개)로 시퀀스를 구성하세요.",
	"display_name": "Luma Ray 3.2 키프레임에서 비디오로",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": { "name": "길이" },
		"keyframes": {
			"name": "키프레임",
			"tooltip": "Luma Ray 3.2 Keyframe 노드(최소 2개)에서 가져온 키프레임 시퀀스입니다."
		},
		"prompt": {
			"name": "프롬프트",
			"tooltip": "비디오 생성을 위한 텍스트 프롬프트입니다."
...
var LumaRay32TextToVideoNode = {
	"description": "Luma의 Ray 3.2 모델을 사용하여 텍스트 프롬프트로부터 비디오를 생성합니다.",
	"display_name": "Luma Ray 3.2 텍스트에서 비디오로",
	"inputs": {
		"aspect_ratio": { "name": "화면비" },
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": { "name": "길이" },
		"loop": {
			"name": "루프",
			"tooltip": "비디오가 자연스럽게 반복되도록 만듭니다. 5초 길이에서만 사용 가능합니다."
		},
		"prompt": {
			"name": "프롬프트",
			"tooltip": "비디오 생성을 위한 텍스트 프롬프트입니다."
...
var LumaRay32VideoEditNode = {
	"description": "Luma Ray 3.2를 사용하여 기존 비디오를 새로운 프롬프트로 다시 렌더링합니다(스타일 변경, 조명 변경, 요소 추가/제거 등). 원본 모션은 유지됩니다. 소스 비디오는 최대 18초까지 지원하며, 편집된 비디오는 원본과 동일한 길이를 가집니다.",
	"display_name": "Luma Ray 3.2 비디오 편집",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"prompt": {
			"name": "프롬프트",
			"tooltip": "원하는 편집 내용을 설명합니다."
		},
		"resolution": { "name": "해상도" },
		"seed": {
			"name": "시드",
		...
		"strength": {
			"name": "강도",
			"tooltip": "원본을 얼마나 강하게 유지할지 또는 새롭게 재구성할지 설정합니다. 'auto'는 Ray 3.2가 자동으로 선택합니다. adhere_*는 가장 많이 보존, flex_*는 균형, reimagine_*는 가장 많이 변경합니다."
		},
		"video": {
			"name": "비디오",
			"tooltip": "편집할 소스 비디오입니다. 최대 18초."
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var LumaRay32VideoReframeNode = {
	"description": "기존 비디오의 종횡비를 변경하고, Luma Ray 3.2를 사용하여 새로 노출된 캔버스 영역을 채웁니다. 소스 비디오는 최대 30초까지 지원됩니다. 출력 초당 과금됩니다.",
	"display_name": "Luma Ray 3.2 비디오 리프레임",
	"inputs": {
		"aspect_ratio": { "name": "aspect_ratio" },
		"control_after_generate": { "name": "control after generate" },
		"prompt": {
			"name": "prompt",
			"tooltip": "새로 노출된 캔버스 영역을 어떻게 채울지 설명합니다."
		},
		"resolution": { "name": "resolution" },
		"seed": {
			"name": "seed",
			"tooltip": "노드가 다시 실행되어야 하는지 결정하는 시드입니다. 시드와 관계없이 결과는 비결정적입니다."
		},
		"video": {
			"name": "video",
			"tooltip": "리프레임할 소스 비디오입니다. 최대 30초."
		}
	},
	"outputs": {
		"0": { "tooltip": null },
...
var MagnificImageRelightNode = {
	"description": "이미지의 조명을 조정하고, 선택적으로 참조 기반의 조명 전송을 적용합니다.",
	"display_name": "Magnific 이미지 리라이트",
	"inputs": {
		"advanced_settings": {
			"name": "advanced_settings",
			"tooltip": "고급 조명 제어를 위한 세부 조정 옵션입니다."
		},
		"change_background": {
			"name": "change_background",
			"tooltip": "프롬프트/참조에 따라 배경을 수정합니다."
		},
		"image": {
			"name": "image",
			"tooltip": "리라이트할 이미지입니다."
		},
		"interpolate_from_original": {
			"name": "interpolate_from_original",
			"tooltip": "생성의 자유도를 제한하여 원본과 더 유사하게 만듭니다."
		},
		"light_transfer_strength": {
			"name": "light_transfer_strength",
			"tooltip": "조명 전송 적용 강도입니다."
		},
		"preserve_details": {
			"name": "preserve_details",
			"tooltip": "원본의 질감과 세부 정보를 유지합니다."
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "조명에 대한 설명 가이드입니다. 강조 표기법(1-1.4)을 지원합니다."
		},
		"reference_image": {
			"name": "reference_image",
			"tooltip": "조명을 전송할 선택적 참조 이미지입니다."
		},
		"style": {
			"name": "style",
			"tooltip": "스타일 출력 선호도입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var MagnificImageSkinEnhancerNode = {
	"description": "여러 처리 모드를 지원하는 인물 사진 피부 보정 기능입니다.",
	"display_name": "Magnific 이미지 피부 보정",
	"inputs": {
		"image": {
			"name": "image",
			"tooltip": "보정할 인물 사진입니다."
		},
		"mode": {
			"name": "mode",
			"tooltip": "처리 모드: 창의적(artistic) 보정, 원본 유지(faithful), 타겟 최적화(flexible) 중 선택."
		},
		"sharpen": {
			"name": "sharpen",
			"tooltip": "선명도 강도 수준입니다."
		},
		"smart_grain": {
			"name": "smart_grain",
			"tooltip": "스마트 그레인 강도 수준입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var MagnificImageStyleTransferNode = {
	"description": "참조 이미지의 스타일을 입력 이미지에 전송합니다.",
	"display_name": "Magnific 이미지 스타일 전송",
	"inputs": {
		"engine": {
			"name": "engine",
			"tooltip": "처리 엔진 선택입니다."
		...
		"fixed_generation": {
			...
			"tooltip": "비활성화 시, 각 생성마다 일정 수준의 무작위성이 도입되어 더 다양한 결과를 얻을 수 있습니다."
		},
		"flavor": {
			"name": "flavor",
			"tooltip": "스타일 전송의 flavor입니다."
		},
		"image": {
			"name": "image",
			"tooltip": "스타일 전송을 적용할 이미지입니다."
		},
		"portrait_mode": {
			"name": "portrait_mode",
			"tooltip": "얼굴 개선을 위한 인물 모드를 활성화합니다."
		},
		"prompt": { "name": "prompt" },
		"reference_image": {
			"name": "reference_image",
			"tooltip": "스타일을 추출할 참조 이미지입니다."
		},
		"structure_strength": {
			"name": "structure_strength",
			"tooltip": "원본 이미지의 구조를 유지합니다."
		},
		"style_strength": {
			"name": "style_strength",
			"tooltip": "스타일 강도 비율입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var MakeTrainingDataset = {
	"description": "이미지를 VAE로, 텍스트를 CLIP으로 인코딩하여 latents와 conditioning으로 구성된 학습 데이터셋을 생성합니다.",
	"display_name": "학습 데이터셋 만들기",
	"inputs": {
		"clip": {
			"name": "clip",
			"tooltip": "텍스트를 컨디셔닝으로 인코딩하는 CLIP 모델입니다."
		},
		"images": {
			"name": "이미지",
			"tooltip": "인코딩할 이미지 목록입니다."
		},
		"texts": {
			"name": "텍스트",
			"tooltip": "텍스트 캡션 목록입니다. 이미지 개수(n)와 일치하거나, 1개(모두에 반복), 또는 생략(빈 문자열 사용)할 수 있습니다."
		},
		"vae": {
			"name": "vae",
			"tooltip": "이미지를 latent로 인코딩하는 VAE 모델입니다."
		}
	},
	"outputs": {
		"0": {
...
var MediaPipeFaceLandmarker = {
	"description": "MediaPipe 모델을 사용하여 얼굴 랜드마크를 감지합니다.",
	"display_name": "MediaPipe 얼굴 랜드마커",
	"inputs": {
		"detector_variant": {
			"name": "detector_variant",
			"tooltip": "얼굴 감지기 범위. 'short'는 카메라에서 약 2m 이내의 근접 얼굴에 최적화되어 있습니다. 'full'은 더 멀리 있거나 작은 얼굴(최대 약 5m)까지 감지하지만 느립니다. 'both'는 두 감지기를 모두 실행하여 프레임당 더 많은 얼굴을 찾은 결과를 사용합니다(감지 비용 약 2배)."
		},
		"face_detection_model": { "name": "face_detection_model" },
		"image": { "name": "image" },
		"min_confidence": {
			"name": "min_confidence",
			"tooltip": "BlazeFace 점수 임계값. 낮출수록 작거나 가려진 얼굴도 감지할 수 있습니다."
		},
		"missing_frame_fallback": {
			"name": "missing_frame_fallback",
			"tooltip": "배치 내 감지 실패 시 프레임별 동작. 'empty'는 얼굴 없는 프레임으로 둡니다. 'previous'는 가장 최근의 성공한 감지 결과를 복사합니다. 'interpolate'는 성공한 프레임 사이에서 랜드마크/바운딩박스/블렌드셰이프를 보간합니다. 다중 얼굴: 프레임 간 바운딩박스 중심 NN으로 얼굴을 매칭합니다."
		},
		"num_faces": {
			"name": "num_faces",
			"tooltip": "프레임당 반환할 최대 얼굴 수. 0 = 제한 없음(모든 감지된 얼굴 반환)."
		}
	},
	"outputs": {
		"0": {
...
var MediaPipeFaceMask = {
	"description": "얼굴 랜드마크로부터 마스크를 그립니다.",
	"display_name": "MediaPipe 얼굴 마스크",
	"inputs": {
		"face_landmarks": { "name": "face_landmarks" },
		"regions": {
			"name": "regions",
			"tooltip": "'all' = face_oval+lips+eyes+irises의 합집합(실제로는 face_oval이 나머지를 모두 포함하므로 face_oval로 축소됨). 'custom' = 각 영역을 개별적으로 토글하여 lips+eyes와 같은 조합 가능."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var MediaPipeFaceMeshVisualize = {
	"description": "입력 이미지에 얼굴 랜드마크 메시(mesh)를 그립니다.",
	"display_name": "MediaPipe 얼굴 메시 시각화",
	"inputs": {
		"color": { "name": "color" },
		"connections": {
			"name": "connections",
			"tooltip": "'all' = oval+eyes+brows+lips+irises+nose. 'fill' = 실루엣 마스크로서의 단색 face_oval 폴리곤. 'custom' = 각 특징을 개별적으로 토글(2547개 엣지의 전체 와이어프레임인 'tesselation' 포함)."
		},
		"face_landmarks": { "name": "face_landmarks" },
		"image": {
			"name": "image",
			"tooltip": "연결되지 않은 경우 검은색 캔버스가 사용됩니다."
		},
		"point_size": {
			"name": "point_size",
			"tooltip": "랜드마크 점 반지름(픽셀 단위). 0이면 점 그리기 비활성화."
		},
		"thickness": {
			"name": "thickness",
			"tooltip": "엣지 선 두께(픽셀 단위). 0이면 엣지 그리기 비활성화."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var MergeImageLists = {
	"description": "여러 이미지 목록을 하나로 합칩니다.",
	"display_name": "이미지 리스트 병합",
	"inputs": { "images": {
		"name": "이미지",
		"tooltip": "처리할 이미지 목록입니다."
	} },
...
var MergeSplat = {
	"description": "여러 개의 gaussian splat을 하나로 연결합니다. 동일한 latent를 서로 다른 시드로 여러 번 디코딩하여 합치면 표면이 더 조밀해져, 메시 품질이 향상될 수 있습니다.",
	"display_name": "Splats 병합",
...
var MergeTextLists = {
	"display_name": "텍스트 리스트 병합",
	"inputs": { "texts": {
		"name": "텍스트",
		"tooltip": "처리할 텍스트 목록입니다."
	} },
	"outputs": { "0": {
		"name": "텍스트",
		"tooltip": "처리된 텍스트"
...
var MeshyAnimateModelNode = {
	"description": "이전에 리깅된 캐릭터에 특정 애니메이션 동작을 적용합니다.",
	"display_name": "Meshy: 모델 애니메이션",
	"inputs": {
		"action_id": {
			"name": "action_id",
			"tooltip": "사용 가능한 값 목록은 https://docs.meshy.ai/en/api/animation-library 를 방문하세요."
		},
...
var MeshyImageToModelNode = {
	...
	"inputs": {
		...
		"should_remesh": {
			"name": "should_remesh",
			"tooltip": "거짓으로 설정하면, 가공되지 않은 삼각형 메시를 반환합니다."
		},
		"should_remesh_target_polycount": { "name": "target_polycount" },
		"should_remesh_topology": { "name": "topology" },
		"should_texture": {
			"name": "should_texture",
			"tooltip": "텍스처 생성 여부를 결정합니다. 거짓으로 설정하면 텍스처 단계가 생략되고 텍스처 없는 메시가 반환됩니다."
		},
...
var MeshyRefineNode = {
	...
	"display_name": "Meshy: 모델 다듬기",
	"inputs": {
		"enable_pbr": {
			"name": "enable_pbr",
			"tooltip": "기본 색상 외에 PBR 맵(금속, 거칠기, 노멀)을 생성합니다. 참고: Sculpture 스타일을 사용할 때는 Sculpture 스타일이 자체 PBR 맵을 생성하므로 false로 설정해야 합니다."
		},
		"meshy_task_id": { "name": "meshy_task_id" },
		"model": { "name": "model" },
		"texture_image": {
			"name": "texture_image",
			"tooltip": "'texture_image' 또는 'texture_prompt' 중 하나만 동시에 사용할 수 있습니다."
		},
		"texture_prompt": {
			"name": "texture_prompt",
...
var MeshyRigModelNode = {
	...
	"display_name": "Meshy: 모델 리깅",
	"inputs": {
		"height_meters": {
			"name": "height_meters",
			"tooltip": "캐릭터 모델의 대략적인 높이(미터 단위)입니다. 스케일링과 리깅 정확도에 도움이 됩니다."
		},
		"meshy_task_id": { "name": "meshy_task_id" },
		"texture_image": {
			"name": "texture_image",
...
var MeshyTextToModelNode = {
	...
	"inputs": {
		...
		"should_remesh": {
			"name": "should_remesh",
			"tooltip": "false로 설정하면 가공되지 않은 삼각형 메시를 반환합니다."
		},
		"should_remesh_target_polycount": { "name": "target_polycount" },
		"should_remesh_topology": { "name": "topology" },
		"style": { "name": "style" },
...
var MeshyTextureNode = {
	...
	"inputs": {
		"enable_original_uv": {
			"name": "원본 UV 사용",
			"tooltip": "새로운 UV를 생성하는 대신 모델의 원본 UV를 사용합니다. 활성화하면 Meshy는 업로드된 모델의 기존 텍스처를 보존합니다. 모델에 원본 UV가 없을 경우 출력 품질이 저하될 수 있습니다."
		},
		"image_style": {
			"name": "이미지 스타일",
			"tooltip": "텍스처링 과정을 안내할 2D 이미지를 사용합니다. 'text_style_prompt'와 동시에 사용할 수 없습니다."
		},
		"meshy_task_id": { "name": "meshy_task_id" },
		"model": { "name": "model" },
		"pbr": { "name": "pbr" },
...
var MinimaxHailuoVideoNode = {
	...
	"display_name": "MiniMax Hailuo 비디오",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": {
			"name": "지속 시간",
		...
		"first_frame_image": {
			"name": "첫 번째 프레임 이미지",
			"tooltip": "비디오 생성에 사용할 선택적 이미지입니다."
		},
		"prompt_optimizer": {
			"name": "프롬프트 최적화",
			"tooltip": "필요할 때 생성 품질을 향상시키기 위해 프롬프트를 최적화합니다."
		},
		"prompt_text": {
			"name": "텍스트 프롬프트",
			"tooltip": "비디오 생성을 안내하는 텍스트 프롬프트입니다."
		},
		"resolution": {
			"name": "해상도",
			"tooltip": "비디오 디스플레이의 해상도입니다. 1080p는 1920x1080, 768p는 1366x768입니다."
		},
		"seed": {
			"name": "시드",
			"tooltip": "노이즈 생성에 사용되는 랜덤 시드입니다."
...
var MoGeInference = {
	"description": "단일 이미지에서 MoGe를 실행하여 깊이와 기하 정보를 추정합니다.",
	"display_name": "MoGe 추론",
	"inputs": {
		"apply_mask": {
			"name": "apply_mask",
			"tooltip": "마스킹된(하늘/유효하지 않은) 픽셀을 포인트와 깊이에서 inf로 설정하여 메시 생성 시 제거합니다. 비활성화하면 예측된 원본 지오메트리를 모두 유지합니다. 마스크는 별도로 반환됩니다."
		},
		"batch_size": {
			"name": "batch_size",
			"tooltip": "한 번의 추론 호출당 이미지 수. 긴 비디오/이미지 세트에서 OOM이 발생하면 낮추세요."
		},
		"force_projection": { "name": "force_projection" },
		"fov_x_degrees": {
			"name": "fov_x_degrees",
			"tooltip": "소스 카메라의 수평 시야각. 깊이 맵을 3D로 언프로젝션할 때 사용되는 초점 거리를 설정합니다. 0 = 예측된 포인트에서 자동 복원."
		},
		"image": { "name": "image" },
		"moge_model": { "name": "moge_model" },
		"resolution_level": {
			"name": "resolution_level",
			"tooltip": "0 = 가장 빠름, 9 = 가장 디테일함."
		}
	},
	"outputs": { "0": {
		"name": "moge_geometry",
...
var MoGePanoramaInference = {
	"description": "MoGe를 사용하여 등각 파노라마 이미지를 12개의 투시 뷰로 분할하고, 각 뷰에 대해 추론을 실행한 후 결과를 하나의 깊이 맵으로 병합합니다.",
	"display_name": "MoGe 파노라마 추론",
	"inputs": {
		"batch_size": {
			"name": "batch_size",
			"tooltip": "한 번의 추론 배치당 뷰 수 (총 12분할)."
		},
		"image": {
			"name": "image",
			"tooltip": "등각 파노라마(비율 무관)."
		},
		"merge_resolution": {
			"name": "merge_resolution",
			"tooltip": "병합된 등거리 거리 맵의 긴 변 해상도."
		},
		"moge_model": { "name": "moge_model" },
		"resolution_level": {
			"name": "resolution_level",
			"tooltip": "뷰별 디테일 (0 = 가장 빠름, 9 = 가장 디테일함)."
		},
		"split_resolution": {
			"name": "split_resolution",
			"tooltip": "각각의 투시 분할 해상도."
		}
	},
	"outputs": { "0": {
		"name": "moge_geometry",
...
var MoGePointMapToMesh = {
	"description": "MoGe 포인트 맵을 3D 메시(mesh)로 변환합니다.",
	"display_name": "MoGe 포인트 맵 → 메시",
	"inputs": {
		"batch_index": {
			"name": "batch_index",
			"tooltip": "배치된 MoGe geometry 중 메시로 변환할 이미지의 인덱스입니다. 이미지마다 버텍스 개수가 다르므로, 배치를 하나의 메시로 합칠 수 없습니다."
		},
		"decimation": {
			"name": "decimation",
			"tooltip": "버텍스 간격; 1 = 전체 해상도."
		},
		"discontinuity_threshold": {
			"name": "discontinuity_threshold",
			"tooltip": "3x3 깊이 범위가 이 비율을 초과하는 픽셀을 제거합니다. 0 = 비활성화."
		},
		"moge_geometry": { "name": "moge_geometry" },
		"texture": {
			"name": "texture",
			"tooltip": "원본 이미지를 baseColor 텍스처로 전달합니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var MoGeRender = {
	"description": "기하 데이터로부터 깊이 맵 또는 노멀 맵을 렌더링합니다.",
	"display_name": "MoGe 렌더",
	"inputs": {
		"moge_geometry": { "name": "moge_geometry" },
		"output": {
			"name": "output",
			"tooltip": "DirectX와 OpenGL은 노멀 맵의 그린 채널 기준이 다릅니다. DirectX: green = -Y 아래 (Unreal). OpenGL: green = +Y 위 (Blender, Substance, Unity, glTF)."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var ModelMergeCosmosPredict2_2B = {
	...
	"inputs": {
		"blocks_0_": { "name": "블록 0." },
		"blocks_10_": { "name": "블록 10." },
		"blocks_11_": { "name": "블록 11." },
		"blocks_12_": { "name": "블록 12." },
		"blocks_13_": { "name": "블록 13." },
		"blocks_14_": { "name": "블록 14." },
		"blocks_15_": { "name": "블록 15." },
		"blocks_16_": { "name": "블록 16." },
		"blocks_17_": { "name": "블록 17." },
		"blocks_18_": { "name": "블록 18." },
		"blocks_19_": { "name": "블록 19." },
		"blocks_1_": { "name": "블록 1." },
		"blocks_20_": { "name": "블록 20." },
		"blocks_21_": { "name": "블록 21." },
		"blocks_22_": { "name": "블록 22." },
		"blocks_23_": { "name": "블록 23." },
		"blocks_24_": { "name": "블록 24." },
		"blocks_25_": { "name": "블록 25." },
		"blocks_26_": { "name": "블록 26." },
		"blocks_27_": { "name": "블록 27." },
		"blocks_2_": { "name": "블록 2." },
		"blocks_3_": { "name": "블록 3." },
		"blocks_4_": { "name": "블록 4." },
		"blocks_5_": { "name": "블록 5." },
		...
		"model1": { "name": "모델1" },
		"model2": { "name": "모델2" },
		"pos_embedder_": { "name": "위치 임베더." },
		"t_embedder_": { "name": "t 임베더." },
		"t_embedding_norm_": { "name": "t 임베딩 정규화." },
		"x_embedder_": { "name": "x 임베더." }
	}
};
var ModelMergeFlux1 = {
...
var ModelMergeQwenImage = {
	...
	"inputs": {
		...
		"model1": { "name": "모델1" },
		"model2": { "name": "모델2" },
		"pos_embeds_": { "name": "위치 임베딩." },
		"proj_out_": { "name": "proj_out." },
		"time_text_embed_": { "name": "시간 텍스트 임베딩." },
		"transformer_blocks_0_": { "name": "트랜스포머 블록.0." },
		"transformer_blocks_10_": { "name": "트랜스포머 블록.10." },
		"transformer_blocks_11_": { "name": "트랜스포머 블록.11." },
		"transformer_blocks_12_": { "name": "트랜스포머 블록.12." },
		"transformer_blocks_13_": { "name": "트랜스포머 블록.13." },
		"transformer_blocks_14_": { "name": "트랜스포머 블록.14." },
		"transformer_blocks_15_": { "name": "트랜스포머 블록.15." },
		"transformer_blocks_16_": { "name": "트랜스포머 블록.16." },
		"transformer_blocks_17_": { "name": "트랜스포머 블록.17." },
		"transformer_blocks_18_": { "name": "트랜스포머 블록.18." },
		"transformer_blocks_19_": { "name": "트랜스포머 블록.19." },
		"transformer_blocks_1_": { "name": "트랜스포머 블록.1." },
		"transformer_blocks_20_": { "name": "트랜스포머 블록.20." },
		"transformer_blocks_21_": { "name": "트랜스포머 블록.21." },
		"transformer_blocks_22_": { "name": "트랜스포머 블록.22." },
		"transformer_blocks_23_": { "name": "트랜스포머 블록.23." },
		"transformer_blocks_24_": { "name": "트랜스포머 블록.24." },
		"transformer_blocks_25_": { "name": "트랜스포머 블록.25." },
		"transformer_blocks_26_": { "name": "트랜스포머 블록.26." },
		"transformer_blocks_27_": { "name": "트랜스포머 블록.27." },
		"transformer_blocks_28_": { "name": "트랜스포머 블록.28." },
		"transformer_blocks_29_": { "name": "트랜스포머 블록.29." },
		"transformer_blocks_2_": { "name": "트랜스포머 블록.2." },
		"transformer_blocks_30_": { "name": "트랜스포머 블록.30." },
		"transformer_blocks_31_": { "name": "트랜스포머 블록.31." },
		"transformer_blocks_32_": { "name": "트랜스포머 블록.32." },
		"transformer_blocks_33_": { "name": "트랜스포머 블록.33." },
		"transformer_blocks_34_": { "name": "트랜스포머 블록.34." },
		"transformer_blocks_35_": { "name": "트랜스포머 블록.35." },
		"transformer_blocks_36_": { "name": "트랜스포머 블록.36." },
		"transformer_blocks_37_": { "name": "트랜스포머 블록.37." },
		"transformer_blocks_38_": { "name": "트랜스포머 블록.38." },
		"transformer_blocks_39_": { "name": "트랜스포머 블록.39." },
		"transformer_blocks_3_": { "name": "트랜스포머 블록.3." },
		"transformer_blocks_40_": { "name": "트랜스포머 블록.40." },
		"transformer_blocks_41_": { "name": "트랜스포머 블록.41." },
		"transformer_blocks_42_": { "name": "트랜스포머 블록.42." },
		"transformer_blocks_43_": { "name": "트랜스포머 블록.43." },
		"transformer_blocks_44_": { "name": "트랜스포머 블록.44." },
		...
		"transformer_blocks_4_": { "name": "트랜스포머 블록.4." },
		...
		"transformer_blocks_5_": { "name": "트랜스포머 블록.5." },
		"transformer_blocks_6_": { "name": "트랜스포머 블록.6." },
		"transformer_blocks_7_": { "name": "트랜스포머 블록.7." },
		"transformer_blocks_8_": { "name": "트랜스포머 블록.8." },
		"transformer_blocks_9_": { "name": "트랜스포머 블록.9." },
		"txt_in_": { "name": "텍스트 입력." },
		"txt_norm_": { "name": "텍스트 정규화." }
	}
};
var ModelMergeSD1 = {
	...
	"inputs": {
		...
		"middle_block_0_": { "name": "middle_blocks.0." },
		"middle_block_1_": { "name": "middle_blocks.1." },
		"middle_block_2_": { "name": "middle_blocks.2." },
		"model1": { "name": "모델1" },
		"model2": { "name": "모델2" },
		"out_": { "name": "out." },
		"output_blocks_0_": { "name": "out_blocks.0." },
		"output_blocks_10_": { "name": "out_blocks.10." },
		"output_blocks_11_": { "name": "out_blocks.11." },
		"output_blocks_1_": { "name": "out_blocks.1." },
		"output_blocks_2_": { "name": "out_blocks.2." },
		"output_blocks_3_": { "name": "out_blocks.3." },
		"output_blocks_4_": { "name": "out_blocks.4." },
		"output_blocks_5_": { "name": "out_blocks.5." },
		"output_blocks_6_": { "name": "out_blocks.6." },
		"output_blocks_7_": { "name": "out_blocks.7." },
		"output_blocks_8_": { "name": "out_blocks.8." },
		"output_blocks_9_": { "name": "out_blocks.9." },
...
var Morphology = {
	...
	"inputs": {
		"image": { "name": "이미지" },
		"kernel_size": { "name": "커널 크기" },
		"operation": { "name": "연산" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var MultiGPU_WorkUnits = {
	"description": "작업 단위를 분할하여 샘플링 속도를 높이도록 모델을 준비합니다.\n\n모델 객체 자체를 수정하는 노드(예: compile 또는 attention-switch 노드) 뒤에 배치해야 합니다.\n\n이러한 예외를 제외하면, 이 노드는 어떤 순서로든 배치할 수 있습니다.",
	"display_name": "MultiGPU CFG 분할",
	"inputs": {
...
var NAGuidance = {
	...
	"outputs": { "0": { "tooltip": "NAG가 활성화된 패치된 모델입니다." } }
};
var NormalizeImages = {
	"description": "평균과 표준편차를 사용하여 이미지를 정규화합니다.",
	...
	"inputs": {
		...
		"mean": {
			"name": "평균값",
			"tooltip": "정규화에 사용할 평균값입니다."
		},
		"std": {
			"name": "표준편차",
			"tooltip": "정규화에 사용할 표준편차입니다."
		}
	},
	"outputs": { "0": {
		"name": "이미지",
...
var NormalizeVideoLatentStart = {
	"description": "비디오 latent의 초기 프레임을 이후 참조 프레임의 평균 및 표준편차에 맞게 정규화합니다. 시작 프레임과 나머지 비디오 간의 차이를 줄이는 데 도움이 됩니다.",
	"display_name": "NormalizeVideoLatentStart",
	"inputs": {
		"latent": { "name": "latent" },
		"reference_frame_count": {
			"name": "reference_frame_count",
			"tooltip": "참조로 사용할 시작 프레임 이후의 latent 프레임 수"
		},
		"start_frame_count": {
			"name": "start_frame_count",
			"tooltip": "정규화할 latent 프레임 수(시작부터 계산)"
		}
	},
	"outputs": { "0": {
		"name": "latent",
...
var OpenAIChatConfig = {
	"description": "OpenAI 채팅 노드에 대한 고급 구성 옵션을 지정할 수 있습니다.",
	"display_name": "OpenAI ChatGPT 고급 옵션",
	"inputs": {
		"instructions": {
			"name": "지침",
			"tooltip": "모델이 응답을 생성하는 방법에 대한 지침"
		},
		"max_output_tokens": {
			"name": "최대 출력 토큰",
			"tooltip": "응답에 대해 생성될 수 있는 토큰 수의 상한값으로, 표시되는 출력 토큰을 포함합니다"
		},
		"truncation": {
			"name": "트렁케이션",
			"tooltip": "모델 응답에 사용할 트렁케이션 전략. auto: 이 응답과 이전 응답의 컨텍스트가 모델의 컨텍스트 창 크기를 초과하면 모델은 대화 중간의 입력 항목을 삭제하여 컨텍스트 창에 맞도록 응답을 자릅니다. disabled: 모델 응답이 모델의 컨텍스트 창 크기를 초과하면 요청이 400 오류와 함께 실패합니다"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var OpenAIChatNode = {
	"description": "OpenAI 모델에서 텍스트 응답을 생성합니다.",
	"display_name": "OpenAI ChatGPT",
	"inputs": {
		"advanced_options": {
			"name": "고급 옵션",
			"tooltip": "모델에 대한 선택적 구성. OpenAI 채팅 고급 옵션 노드의 입력을 허용합니다."
		},
		"files": {
			"name": "파일",
			"tooltip": "모델의 컨텍스트로 사용할 선택적 파일(들). OpenAI 채팅 입력 파일 노드의 입력을 허용합니다."
		},
		"images": {
			"name": "이미지",
			"tooltip": "모델의 컨텍스트로 사용할 선택적 이미지(들). 여러 이미지를 포함하려면 배치 이미지 노드를 사용할 수 있습니다."
		},
		"model": {
			"name": "모델",
			"tooltip": "응답을 생성하는 데 사용되는 모델"
		},
		"persist_context": {
			"name": "컨텍스트 유지",
			"tooltip": "이 매개변수는 더 이상 사용되지 않으며 효과가 없습니다."
		},
		"prompt": {
			"name": "프롬프트",
			"tooltip": "모델에 대한 텍스트 입력으로, 응답을 생성하는 데 사용됩니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var OpenAIGPTImage1 = {
	...
	"inputs": {
		...
		"custom_height": {
			"name": "custom_height",
			"tooltip": "`size`가 'Custom'일 때만 사용됩니다. 16의 배수여야 합니다(GPT Image 2 전용)."
		},
		"custom_width": {
			"name": "custom_width",
			"tooltip": "`size`가 'Custom'일 때만 사용됩니다. 16의 배수여야 합니다(GPT Image 2 전용)."
...
var OpenAIGPTImageNodeV2 = {
	...
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"model": { "name": "모델" },
		"model_background": { "name": "배경" },
		"model_custom_height": { "name": "사용자 지정 높이" },
		"model_custom_width": { "name": "사용자 지정 너비" },
		"model_quality": { "name": "품질" },
		"model_size": { "name": "사이즈" },
		"n": {
			"name": "개수",
			"tooltip": "생성할 이미지 수"
...
var OpenAIInputFiles = {
	...
	"inputs": {
		"OPENAI_INPUT_FILES": {
			...
			"tooltip": "이 노드에서 로드된 파일과 함께 배치할 선택적 추가 파일(들). 단일 메시지에 여러 입력 파일을 포함할 수 있도록 입력 파일을 연결할 수 있습니다."
		},
		"file": {
			"name": "파일",
			"tooltip": "모델의 컨텍스트로 포함할 입력 파일. 현재는 텍스트(.txt) 및 PDF(.pdf) 파일만 허용됩니다."
...
var OpenAIVideoSora2 = {
	"description": "OpenAI 비디오 및 오디오 생성.",
	"display_name": "OpenAI Sora - 비디오",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": { "name": "지속 시간" },
		"image": { "name": "이미지" },
		...
		"prompt": {
			"name": "프롬프트",
			"tooltip": "안내 텍스트; 입력 이미지가 있을 경우 비워둘 수 있습니다."
		},
		"seed": {
			"name": "시드",
			"tooltip": "노드 재실행 여부를 결정하는 시드; 실제 결과는 시드와 관계없이 비결정적입니다."
		},
		"size": { "name": "크기" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var OpenRouterLLMNode = {
	"description": "OpenRouter를 통해 텍스트 응답을 생성합니다. xAI, DeepSeek, Qwen, Mistral, Z.AI(GLM), Moonshot(Kimi), Perplexity Sonar 등에서 엄선된 인기 모델로 라우팅됩니다.",
	"display_name": "OpenRouter LLM",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model": {
			"name": "model",
			"tooltip": "응답 생성을 위해 사용되는 OpenRouter 모델입니다."
		},
		"model_reasoning_effort": { "name": "reasoning_effort" },
		"prompt": {
			"name": "prompt",
		...
		"seed": {
			"name": "seed",
			"tooltip": "샘플링을 위한 시드 값입니다. 0으로 설정하면 생략됩니다. 대부분의 모델은 이를 참고 값으로만 사용합니다."
		},
		"system_prompt": {
			"name": "system_prompt",
			"tooltip": "모델의 동작을 지시하는 기본 지침입니다."
...
var OpticalFlowLoader = {
	"display_name": "광학 흐름 모델 불러오기",
	"inputs": { "model_name": {
		"name": "model_name",
		"tooltip": "불러올 광학 흐름 모델입니다. 파일은 반드시 'optical_flow' 폴더에 위치해야 합니다. 현재는 torchvision의 raft_large.pth만 지원됩니다."
	} },
	"outputs": { "0": { "tooltip": null } }
};
...
var PairConditioningCombine = {
	...
	"inputs": {
		"negative_A": { "name": "부정 조건 A" },
		"negative_B": { "name": "부정 조건 B" },
		"positive_A": { "name": "긍정 조건 A" },
		"positive_B": { "name": "긍정 조건 B" }
	},
	"outputs": {
		"0": { "name": "긍정 조건" },
		"1": { "name": "부정 조건" }
...
var PairConditioningSetDefaultCombine = {
	...
	"inputs": {
		"hooks": { "name": "후크" },
		"negative": { "name": "부정 조건" },
		"negative_DEFAULT": { "name": "기본 부정 조건" },
		"positive": { "name": "긍정 조건" },
		"positive_DEFAULT": { "name": "기본 긍정 조건" }
	},
	"outputs": {
		"0": { "name": "긍정 조건" },
		"1": { "name": "부정 조건" }
...
var PairConditioningSetProperties = {
	...
	"inputs": {
		"hooks": { "name": "후크" },
		"mask": { "name": "마스크" },
		"negative_NEW": { "name": "새 부정 조건" },
		"positive_NEW": { "name": "새 긍정 조건" },
		"set_cond_area": { "name": "조건 영역 설정" },
		"strength": { "name": "강도" },
		"timesteps": { "name": "타임스텝 범위" }
	},
...
var PatchModelAddDownscale = {
	...
	"inputs": {
		"block_number": { "name": "블록 번호" },
		"downscale_after_skip": { "name": "스킵 후 다운스케일" },
		"downscale_factor": { "name": "다운스케일 배율" },
		"downscale_method": { "name": "다운스케일 방법" },
		"end_percent": { "name": "종료 퍼센트" },
		"model": { "name": "모델" },
		"start_percent": { "name": "시작 퍼센트" },
		"upscale_method": { "name": "업스케일 방법" }
...
var PerpNeg = {
	...
	"inputs": {
		"empty_conditioning": { "name": "빈 조건" },
		"model": { "name": "모델" },
		"neg_scale": { "name": "부정 스케일" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var PerpNegGuider = {
...
var PhotoMakerLoader = {
	...
	"inputs": { "photomaker_model_name": { "name": "포토메이커 파일명" } },
	"outputs": { "0": { "tooltip": null } }
};
var PiDConditioning = {
	"description": "PiD 디코딩/업스케일링을 위해 latent와 degrade_sigma 스칼라를 CONDITIONING에 첨부합니다.",
	"display_name": "PiD 컨디셔닝",
	"inputs": {
		"degrade_sigma": {
			"name": "degrade_sigma",
			"tooltip": "0 = 깨끗한 latent. 값을 높이면 손상된 latent 출력을 디노이즈합니다."
		},
		"latent": {
			"name": "latent",
			"tooltip": "latent(VAEEncode 또는 KSampler에서 가져옴)."
		},
		"latent_format": {
			"name": "latent_format",
			"tooltip": "Flux1 및 Flux2 latent는 채널 차원에서 자동 감지되며, sd3는 수동 선택이 필요합니다."
		},
		"positive": { "name": "포지티브" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var PixverseImageToVideoNode = {
	...
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"duration_seconds": { "name": "길이(초)" },
		"image": { "name": "이미지" },
		"motion_mode": { "name": "모션 모드" },
		"negative_prompt": {
			"name": "부정 프롬프트",
...
var PorterDuffImageComposite = {
	...
	"inputs": {
		"destination": { "name": "대상" },
		"destination_alpha": { "name": "대상 알파" },
		"mode": { "name": "모드" },
		"source": { "name": "원본" },
		"source_alpha": { "name": "원본 알파" }
	},
	"outputs": {
		"0": { "tooltip": null },
		"1": { "tooltip": null }
...
var Preview3D = {
	"description": "3D 모델 파일을 ComfyUI 출력 디렉토리에 저장하지 않고 미리보기합니다.",
	"display_name": "3D 미리보기",
	"inputs": {
		"bg_image": { "name": "bg_image" },
		"camera_info": { "name": "카메라 정보" },
		"image": { "name": "이미지" },
		"model_file": {
			"name": "모델 파일",
...
var Preview3DAdvanced = {
	"description": "3D 모델 파일을 ComfyUI 출력 디렉토리에 저장하지 않고 미리보기합니다.",
	"display_name": "3D 미리보기 (고급)",
	"inputs": {
		"camera_info": { "name": "camera_info" },
		"height": { "name": "height" },
		"model_3d": {
			"name": "model_3d",
			"tooltip": "업스트림 3D 노드에서 가져온 3D 모델 파일입니다."
		},
...
var PreviewAny = {
	"description": "모든 입력 값을 텍스트로 미리보기합니다.",
...
var PreviewAudio = {
	"description": "오디오를 ComfyUI 출력 디렉토리에 저장하지 않고 미리듣기합니다.",
...
var PreviewGaussianSplat = {
	"description": "가우시안 스플랫 3D 파일을 ComfyUI 출력 디렉토리에 저장하지 않고 미리보기합니다.",
	"display_name": "스플랫 미리보기",
	"inputs": {
		"camera_info": { "name": "camera_info" },
		"height": { "name": "height" },
		"model_3d": {
			"name": "model_3d",
			"tooltip": "가우시안 스플랫 3D 파일입니다."
		},
		"model_3d_info": { "name": "model_3d_info" },
		"viewport_state": { "name": "viewport_state" },
		"width": { "name": "width" }
...
var PreviewImage = {
	...
	"inputs": { "images": { "name": "이미지" } },
	"outputs": { "0": { "name": "images" } }
};
var PreviewPointCloud = {
	"description": "포인트 클라우드 3D 파일을 ComfyUI 출력 디렉토리에 저장하지 않고 미리보기합니다.",
	"display_name": "포인트 클라우드 미리보기",
	"inputs": {
		"camera_info": { "name": "camera_info" },
		"height": { "name": "height" },
		"model_3d": {
			"name": "model_3d",
			"tooltip": "포인트 클라우드 파일 (.ply)"
		},
		"model_3d_info": { "name": "model_3d_info" },
		"viewport_state": { "name": "viewport_state" },
		"width": { "name": "width" }
...
var QuadrupleCLIPLoader = {
	...
	"inputs": {
		"clip_name1": { "name": "clip 이름 1" },
		"clip_name2": { "name": "clip 이름 2" },
		"clip_name3": { "name": "clip 이름 3" },
		"clip_name4": { "name": "clip 이름 4" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var QuiverImageToSVGNode = {
	"description": "Quiver AI를 사용하여 래스터 이미지를 SVG로 벡터화합니다.",
	"display_name": "Quiver 이미지 → SVG",
	"inputs": {
		"auto_crop": {
			"name": "auto_crop",
			"tooltip": "주요 피사체에 맞게 자동으로 자릅니다."
		},
		"control_after_generate": { "name": "control after generate" },
		"image": {
			"name": "image",
			"tooltip": "벡터화할 입력 이미지입니다."
		},
		"model": {
			"name": "model",
			"tooltip": "SVG 벡터화에 사용할 모델입니다."
		},
...
var QuiverTextToSVGNode = {
	"description": "Quiver AI를 사용하여 텍스트 프롬프트로부터 SVG를 생성합니다.",
	"display_name": "Quiver 텍스트 → SVG",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"instructions": {
			"name": "instructions",
			"tooltip": "추가 스타일 또는 포맷팅 가이드라인입니다."
		},
		"model": {
			"name": "model",
			"tooltip": "SVG 생성에 사용할 모델입니다."
		},
		"model_presence_penalty": { "name": "presence_penalty" },
		"model_temperature": { "name": "temperature" },
		"model_top_p": { "name": "top_p" },
		"prompt": {
			"name": "prompt",
			"tooltip": "원하는 SVG 출력에 대한 텍스트 설명입니다."
		},
		"reference_images": {
			"name": "reference_images",
			"tooltip": "생성을 안내할 최대 4개의 참조 이미지입니다."
		},
		"seed": {
			"name": "seed",
			"tooltip": "노드가 다시 실행되어야 하는지 결정하는 시드입니다. 실제 결과는 시드와 관계없이 비결정적입니다."
...
var RandomCropImages = {
	"description": "이미지를 지정한 크기로 무작위로 자릅니다.",
...
var RecraftImageInpaintingNode = {
	...
	"inputs": {
		...
		"recraft_style": { "name": "recraft 스타일" },
		"seed": {
			"name": "시드",
			"tooltip": "노드가 다시 실행되어야 하는지 결정하는 시드입니다. 실제 결과는 시드와 관계없이 비결정적입니다."
		}
...
var ReferenceLatent = {
	"description": "이 노드는 편집 모델의 안내 잠재를 설정합니다. 모델이 지원하는 경우 여러 개를 연결하여 여러 참조 이미지를 설정할 수 있습니다.",
	"display_name": "참조 잠재",
	"inputs": {
		"conditioning": { "name": "조건화" },
		"latent": { "name": "잠재" }
...
var RegexExtract = {
	"display_name": "정규식 추출",
	"inputs": {
		"case_insensitive": { "name": "대소문자 구분 안 함" },
		"dotall": { "name": "모든 문자 포함" },
		"group_index": { "name": "그룹 인덱스" },
		"mode": { "name": "모드" },
		"multiline": { "name": "여러 줄" },
		"regex_pattern": { "name": "정규식 패턴" },
		"string": { "name": "문자열" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var RegexReplace = {
	"description": "정규식 패턴을 사용하여 텍스트 찾기 및 바꾸기.",
	"display_name": "정규식 치환",
	"inputs": {
		"case_insensitive": { "name": "대소문자 구분 안 함" },
		"count": {
			"name": "횟수",
			"tooltip": "수행할 최대 교체 횟수입니다. 0으로 설정하면 모든 항목을 교체합니다(기본값). 1로 설정하면 첫 번째 일치 항목만, 2로 설정하면 처음 두 항목 등을 교체합니다."
		},
		"dotall": {
			"name": "모든 문자 모드",
			"tooltip": "활성화하면 점(.) 문자가 줄바꿈 문자를 포함한 모든 문자와 일치합니다. 비활성화하면 점이 줄바꿈 문자와 일치하지 않습니다."
		},
		"multiline": { "name": "여러 줄 모드" },
		"regex_pattern": { "name": "정규식 패턴" },
		"replace": { "name": "바꾸기" },
		"string": { "name": "문자열" }
	},
...
var RemoveBackground = {
	"description": "배경 제거 모델을 사용하여 이미지에서 배경을 제거하기 위한 전경 마스크를 생성합니다.",
	"display_name": "배경 제거",
	"inputs": {
		"bg_removal_model": {
...
var RenderSplat = {
	"description": "이방성 EWA 래스터라이저(방향성 타원 splat, 앤티앨리어싱, 깊이 정렬 전면-후면)로 가우시안 splat을 이미지로 렌더링합니다. 카메라는 camera_info 입력(Load / Preview 3D 또는 Create Camera Info 노드)에서 가져옵니다. 비워두면 splat이 자동으로 프레이밍됩니다. 프레임을 1보다 크게 설정하면 Video 노드에 전달할 턴테이블 이미지 배치를 생성합니다.",
	"display_name": "Render Splat",
	"inputs": {
		"background": { "name": "background" },
		"bg_image": {
			"name": "bg_image",
			"tooltip": "선택적 배경 이미지를 splat 뒤에 합성합니다(단색 배경 색상보다 우선). 렌더 크기에 맞게 리사이즈됩니다; 배치는 프레임별로 사용, 단일 이미지는 전체에 사용. color/clay에서만 사용."
		},
		"camera_info": {
			"name": "camera_info",
			"tooltip": "렌더링에 사용할 카메라 - Load3D / Preview3D 카메라 또는 Create Camera Info 노드. 비워두면 기본 3/4 뷰에서 splat이 자동 프레이밍됩니다."
		},
		"frames": {
			"name": "frames",
			"tooltip": "-1, 0, 1 = 단일 정지 이미지; >1 = 턴테이블, 카메라가 360도 회전(모든 camera_info에서 동작). 음수 값은 반대 방향으로 회전합니다."
		},
		"headlight_shading": {
			"name": "headlight_shading",
			"tooltip": "카메라(헤드라이트)에서 오는 조명으로 난반사 음영을 적용합니다. splat surfel 노멀을 사용하여, 시야에서 멀어지는 표면을 어둡게 하여 형태/곡률을 드러냅니다. 0 = 평면 알베도, 1 = 가장 강한 음영."
		},
		"height": { "name": "height" },
		"opacity_threshold": {
			"name": "opacity_threshold",
			"tooltip": "이 값보다 불투명도가 낮은 가우시안을 제거합니다(희미한 부유물 제거)."
		},
		"render_style": {
			"name": "render_style",
			"tooltip": "이미지 출력에 표시할 내용: color, clay(중립 알베도 음영), depth(가까움=밝음), normal(OpenGL 노멀 맵)."
		},
		"sharpen": {
			"name": "sharpen",
			"tooltip": "겹치는 splat을 선명하게: 1.0 = 물리적으로 올바른 블렌드; 더 높은 값은 각 픽셀을 지배적인(가장 가까운) splat에 더 치우치게 하여 질감을 선명하게 하지만, splat을 줄이거나 틈을 만들지 않습니다. 1 이상은 비물리적입니다."
		},
		"splat": { "name": "splat" },
		"splat_scale": {
			"name": "splat_scale",
			"tooltip": "각 splat의 투영 면적에 곱하는 값(낮을수록 더 선명한 점, 높을수록 더 부드럽고 풍부한 표면)."
		},
		"width": { "name": "width" }
	},
	"outputs": {
...
var ReplaceVideoLatentFrames = {
	"display_name": "비디오 Latent 프레임 교체",
	"inputs": {
		"destination": {
			"name": "destination",
			"tooltip": "프레임이 교체될 대상 latent."
		},
		"index": {
			"name": "index",
			"tooltip": "소스 latent 프레임이 대상 latent에 삽입될 시작 프레임 인덱스. 음수 값은 끝에서부터 계산."
		},
		"source": {
			"name": "source",
			"tooltip": "대상 latent에 삽입할 프레임을 제공하는 소스 latent. 제공되지 않으면 대상 latent가 변경 없이 반환됩니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var ResizeAndPadImage = {
	"display_name": "이미지 크기 조정 및 패딩",
	"inputs": {
		"image": { "name": "이미지" },
		"interpolation": { "name": "보간" },
		"padding_color": { "name": "패딩 색상" },
		"target_height": { "name": "대상 높이" },
		"target_width": { "name": "대상 너비" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var ResizeImagesByLongerEdge = {
	"description": "이미지의 긴 변이 지정한 크기에 맞도록 비율을 유지하며 크기를 조정합니다.",
	"display_name": "긴 변 기준 이미지 크기 조정",
	"inputs": {
		"images": {
			"name": "images",
			"tooltip": "처리할 이미지."
...
var ResizeImagesByShorterEdge = {
	"description": "이미지의 짧은 변이 지정된 크기에 맞도록 크기를 조정하며, 비율을 유지합니다.",
	"display_name": "짧은 변 기준 이미지 크기 조정",
	"inputs": {
		"images": {
			"name": "images",
			"tooltip": "처리할 이미지."
...
var ResolutionBucket = {
	"description": "latent 및 conditioning을 버킷으로 그룹화합니다.",
	"display_name": "해상도 버킷",
	"inputs": {
		"conditioning": {
			"name": "conditioning",
			"tooltip": "conditioning 리스트 목록 (latents 길이와 일치해야 함)."
		},
		"latents": {
			"name": "latents",
			"tooltip": "해상도별로 버킷팅할 latent 딕셔너리 목록."
		}
	},
	"outputs": {
		"0": {
			"name": "latents",
			"tooltip": "해상도 버킷별로 배치된 latent 딕셔너리 목록."
		},
		"1": {
			"name": "conditioning",
			"tooltip": "해상도 버킷별로 조건 리스트 목록."
		}
	}
};
var ResolutionSelector = {
	...
	"inputs": {
		...
		"multiple": {
			"name": "배수",
			"tooltip": "선택한 해상도를 설정할 때 결과의 가장 가까운 배수입니다."
		}
	},
	"outputs": {
		"0": {
...
var ReveImageCreateNode = {
	...
	"inputs": {
		...
		"model_aspect_ratio": { "name": "종횡비" },
		"model_test_time_scaling": { "name": "테스트 타임 스케일링" },
		"prompt": {
			"name": "프롬프트",
...
var Rodin3D_Detail = {
	...
	"inputs": {
		"Images": { "name": "이미지" },
		"Material_Type": { "name": "재질 유형" },
		"Polygon_count": { "name": "폴리곤 수" },
		"Seed": { "name": "시드" }
	},
	"outputs": {
		"0": {
...
var Rodin3D_Gen2 = {
	"description": "Rodin API를 사용하여 3D 에셋 생성",
	"display_name": "Rodin 3D 생성 - Gen-2 생성",
	"inputs": {
		"Images": { "name": "이미지" },
		"Material_Type": { "name": "재질 유형" },
		"Polygon_count": { "name": "폴리곤 수" },
...
var Rodin3D_Gen25_Image = {
	"description": "Rodin Gen-2.5를 통해 1~5개의 참조 이미지를 사용하여 3D 모델을 생성합니다. 품질과 비용을 조정하려면 모드(빠름 / 일반 / 극고화질)를 선택하세요.",
	"display_name": "Rodin 3D Gen-2.5 - 이미지에서 3D 생성",
	"inputs": {
		"TAPose": {
			"name": "TAPose",
			"tooltip": "사람 형태 모델을 위한 T/A 포즈."
		},
		"addon_highpack": {
			"name": "addon_highpack",
			"tooltip": "HighPack 애드온: 쿼드 모드에서 4K 텍스처 및 약 16배 폴리곤."
		},
		"bbox_height": {
			"name": "bbox_height",
			"tooltip": "바운딩 박스 높이(Z축)."
		},
		"bbox_length": {
			"name": "bbox_length",
			"tooltip": "바운딩 박스 길이(X축)."
		},
		"bbox_width": {
			"name": "bbox_width",
			"tooltip": "바운딩 박스 너비(Y축). 다른 값들과 함께 0으로 설정하면 바운딩 박스를 생략합니다."
		},
		"control_after_generate": { "name": "control after generate" },
		...
		"height_cm": {
			"name": "height_cm",
			"tooltip": "모델의 대략적인 높이(센티미터, 0이면 생략)."
		},
		"images": {
			"name": "images",
			"tooltip": "1~5개의 이미지. 다중 뷰일 경우 첫 번째 이미지는 재질에 사용됩니다."
		},
		"material": { "name": "material" },
		"mode": {
			"name": "mode",
			"tooltip": "생성 모드. 일반 = 균형 잡힘. 빠름 = 빠른 프로토타이핑을 위한 1K~20K 폴리곤. 극고화질 = 마이크로 디테일 옵션 포함 20K~2M 폴리곤."
		},
		...
		"texture_delight": {
			...
			"tooltip": "텍스처에서 베이크된 조명을 제거합니다."
		},
		"texture_mode": {
			"name": "texture_mode",
			"tooltip": "텍스처 품질 프리셋. 'Default'는 선택한 티어의 서버 기본값을 사용합니다."
		},
		"use_original_alpha": {
			"name": "use_original_alpha",
			"tooltip": "이미지의 투명도를 보존합니다."
		}
	},
	"outputs": { "0": {
		"name": "model_file",
...
var Rodin3D_Gen25_Text = {
	"description": "Rodin Gen-2.5를 통해 텍스트 프롬프트로부터 3D 모델을 생성합니다. 품질과 비용을 조정하려면 모드(빠름 / 일반 / 극고화질)를 선택하세요.",
	"display_name": "Rodin 3D Gen-2.5 - 텍스트에서 3D 생성",
	"inputs": {
		"TAPose": {
			"name": "T/A 포즈",
			"tooltip": "사람 형태 모델을 위한 T/A 포즈입니다."
		},
		"addon_highpack": {
			"name": "HighPack 애드온",
			"tooltip": "HighPack 애드온: 쿼드 모드에서 4K 텍스처와 약 16배 폴리곤."
		},
		"bbox_height": {
			"name": "바운딩 박스 높이",
			"tooltip": "바운딩 박스 높이(Z축)."
		...
		"control_after_generate": { "name": "생성 후 제어" },
		"geometry_file_format": { "name": "지오메트리 파일 형식" },
		"hd_texture": {
			"name": "고화질 텍스처",
			"tooltip": "고품질 텍스처 향상."
		},
		...
		"mode": {
			"name": "모드",
			"tooltip": "생성 모드입니다. 일반 = 균형 잡힘. 빠름 = 빠른 프로토타이핑을 위한 1K-20K 폴리곤. 극고화질 = 선택적 마이크로 디테일이 포함된 20K-2M 폴리곤."
		},
		"mode_creative": { "name": "창의적" },
		"mode_polygon_count": { "name": "폴리곤 수" },
		"mode_tier": { "name": "등급" },
		"prompt": {
			"name": "프롬프트",
			"tooltip": "3D 모델을 위한 텍스트 프롬프트입니다."
		},
		"seed": { "name": "시드" },
		"texture_delight": {
			"name": "텍스처 디라이트",
		...
		"texture_mode": {
			"name": "텍스처 모드",
			"tooltip": "텍스처 품질 프리셋입니다. '기본값'은 선택한 등급의 서버 기본값을 사용합니다."
		}
	},
	"outputs": { "0": {
		"name": "모델 파일",
...
var Rodin3D_Regular = {
	"description": "Rodin API를 사용하여 3D 에셋 생성",
	"display_name": "Rodin 3D 생성 - 일반 생성",
	"inputs": {
		"Images": { "name": "이미지" },
		"Material_Type": { "name": "재질 유형" },
		"Polygon_count": { "name": "폴리곤 수" },
...
var Rodin3D_Sketch = {
	"description": "Rodin API를 사용하여 3D 에셋 생성",
	"display_name": "Rodin 3D 생성 - 스케치 생성",
	"inputs": {
		"Images": { "name": "이미지" },
		"Seed": { "name": "시드" }
	},
...
var Rodin3D_Smooth = {
	"description": "Rodin API를 사용하여 3D 에셋 생성",
	"display_name": "Rodin 3D 생성 - 스무스 생성",
	"inputs": {
		"Images": { "name": "이미지" },
		"Material_Type": { "name": "재질 유형" },
		"Polygon_count": { "name": "폴리곤 수" },
...
var RunwayAleph2KeyframeNode = {
	"description": "가이드 이미지를 입력(소스) 비디오의 특정 순간에 고정하여, Aleph2가 해당 시점에서 편집을 유도하도록 합니다. 이 노드를 Runway Aleph2 Video to Video 노드의 'keyframes' 입력에 연결하세요. 아래의 선택적 'keyframes' 입력을 통해 여러 개(최대 5개)를 연쇄 연결할 수 있습니다.",
	"display_name": "Runway Aleph2 키프레임",
	"inputs": {
		"image": {
			"name": "image",
			"tooltip": "입력 비디오의 선택한 순간에 적용할 가이드 이미지입니다."
		},
		"keyframes": {
			"name": "keyframes",
			"tooltip": "이전 키프레임을 이 키프레임과 연쇄 연결할 수 있습니다(선택 사항)."
		},
		"timing": {
			"name": "timing",
			"tooltip": "이 이미지를 입력 비디오 타임라인에 배치하는 방법입니다."
		},
		"timing_seconds": { "name": "seconds" }
	},
	"outputs": { "0": {
		"name": "keyframes",
		"tooltip": null
...
var RunwayAleph2PromptImageNode = {
	"description": "가이드 이미지를 출력(결과) 비디오의 특정 순간에 고정하여, 해당 시점의 편집된 비디오가 어떻게 보일지 안내합니다. 이 노드를 Runway Aleph2 Video to Video 노드의 'prompt_images' 입력에 연결하세요. 아래의 선택적 'prompt_images' 입력을 통해 여러 개(최대 5개)를 연쇄 연결할 수 있습니다.",
	"display_name": "Runway Aleph2 프롬프트 이미지",
	"inputs": {
		"image": {
			"name": "image",
			"tooltip": "출력 비디오의 선택한 순간에 배치할 가이드 이미지입니다."
		},
		"position": {
			"name": "position",
			"tooltip": "이 이미지를 출력 비디오 타임라인에 배치하는 방법입니다."
		},
		"position_seconds": { "name": "seconds" },
		"prompt_images": {
			"name": "prompt_images",
			"tooltip": "이전 프롬프트 이미지를 이 이미지와 연쇄 연결할 수 있습니다(선택 사항)."
		}
	},
	"outputs": { "0": {
		"name": "prompt_images",
...
var RunwayAleph2VideoToVideoNode = {
	"description": "Runway의 Aleph2 모델을 사용하여 텍스트 프롬프트로 비디오를 편집합니다. Aleph2는 원본의 움직임과 타이밍을 유지하면서 영상의 스타일 변경, 조명 변경, 요소 추가/제거, 시점 변경 등을 수행합니다. 출력 해상도는 입력 비디오와 동일하며, 입력 비디오는 2~30초, 30fps 이하만 지원됩니다. 선택적으로 키프레임(입력 비디오에 고정) 또는 프롬프트 이미지(출력 비디오에 고정) 중 하나로 편집을 조정할 수 있습니다. 두 가지를 동시에 사용할 수 없습니다.",
	"display_name": "Runway Aleph2 비디오 투 비디오",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"keyframes": {
			"name": "키프레임",
			"tooltip": "입력 비디오에 고정된 가이드 이미지로, Aleph2 Keyframe 노드에서 가져옵니다(최대 5개). 키프레임 또는 프롬프트 이미지 중 하나만 사용하세요."
		},
		"prompt": {
			"name": "프롬프트",
			"tooltip": "출력에 나타나야 할 내용을 설명합니다. (1~1000자)"
		},
		"prompt_images": {
			"name": "프롬프트 이미지",
			"tooltip": "출력 비디오에 고정된 가이드 이미지로, Aleph2 Prompt Image 노드에서 가져옵니다(최대 5개). 키프레임 또는 프롬프트 이미지 중 하나만 사용하세요."
		},
		"public_figure_threshold": {
			"name": "공인 임계값",
			"tooltip": "식별 가능한 공인에 대한 콘텐츠 모더레이션."
		},
		"seed": {
			"name": "시드",
			"tooltip": "생성에 사용할 랜덤 시드"
		},
		"video": {
			"name": "비디오",
			"tooltip": "편집할 입력 비디오입니다. 2~30초, 30fps 이하만 지원됩니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var RunwayFirstLastFrameNode = {
	...
	"display_name": "Runway 첫-마지막 프레임 비디오 변환",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"duration": { "name": "duration" },
		"end_frame": {
			"name": "end_frame",
			"tooltip": "비디오에 사용할 종료 프레임. Gen3a Turbo에서만 지원됩니다."
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "생성을 위한 텍스트 프롬프트"
		...
		"seed": {
			"name": "seed",
			"tooltip": "생성을 위한 랜덤 시드"
		},
		"start_frame": {
			"name": "start_frame",
			"tooltip": "비디오에 사용할 시작 프레임"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var RunwayImageToVideoNodeGen3a = {
	"description": "Gen3a Turbo 모델을 사용하여 단일 시작 프레임에서 비디오를 생성합니다. 시작하기 전에 입력 선택이 생성 성공을 보장할 수 있도록 다음 모범 사례를 검토하세요: https://help.runwayml.com/hc/en-us/articles/33927968552339-Creating-with-Act-One-on-Gen-3-Alpha-and-Turbo.",
	"display_name": "Runway 이미지 비디오 변환 (Gen3a Turbo)",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"duration": { "name": "duration" },
		"prompt": {
...
var RunwayImageToVideoNodeGen4 = {
	"description": "Gen4 Turbo 모델을 사용하여 단일 시작 프레임에서 비디오를 생성합니다. 시작하기 전에 입력 선택이 생성 성공을 보장할 수 있도록 다음 모범 사례를 검토하세요: https://help.runwayml.com/hc/en-us/articles/37327109429011-Creating-with-Gen-4-Video.",
	"display_name": "Runway 이미지 비디오 변환 (Gen4 Turbo)",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"duration": { "name": "duration" },
		"prompt": {
...
var RunwayTextToImageNode = {
	"description": "Runway의 Gen 4 모델을 사용하여 텍스트 프롬프트에서 이미지를 생성합니다. 참조 이미지를 포함하여 생성을 안내할 수도 있습니다.",
	"display_name": "Runway 텍스트 이미지 생성",
	"inputs": {
		"prompt": {
			"name": "prompt",
			"tooltip": "생성을 위한 텍스트 프롬프트"
		...
		"reference_image": {
			"name": "reference_image",
			"tooltip": "생성을 안내하는 선택적 참조 이미지"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var SAM3_Detect = {
	"display_name": "SAM3 감지",
	"inputs": {
		"bboxes": {
			"name": "bboxes",
			"tooltip": "분할할 바운딩 박스"
		...
		"conditioning": {
			"name": "conditioning",
			"tooltip": "CLIPTextEncode의 텍스트 컨디셔닝"
		},
		"image": { "name": "image" },
		"individual_masks": {
			"name": "individual_masks",
			"tooltip": "객체별 mask를 개별적으로 출력 (합집합이 아닌)"
		},
		"model": { "name": "model" },
		"negative_coords": {
			"name": "negative_coords",
			"tooltip": "음성 포인트 프롬프트(JSON 형식: [{\"x\": int, \"y\": int}, ...], 픽셀 좌표)"
		},
		"positive_coords": {
			"name": "positive_coords",
			"tooltip": "양성 포인트 프롬프트(JSON 형식: [{\"x\": int, \"y\": int}, ...], 픽셀 좌표)"
		},
		"refine_iterations": {
			"name": "refine_iterations",
			"tooltip": "SAM 디코더 정제 반복 횟수 (0=원시 감지자 mask 사용)"
		},
		"threshold": { "name": "threshold" }
	},
	"outputs": {
...
var SAM3_TrackToMask = {
	"display_name": "SAM3 트랙 → mask",
	"inputs": {
		"object_indices": {
			"name": "object_indices",
			"tooltip": "포함할 객체 인덱스(쉼표로 구분, 예: '0,2,3'). 비워두면 모든 객체."
		},
		"track_data": { "name": "track_data" }
	},
	"outputs": { "0": {
...
var SAM3_VideoTrack = {
	"display_name": "SAM3 비디오 트랙",
	"inputs": {
		"conditioning": {
			"name": "conditioning",
			"tooltip": "추적 중 새 객체 감지를 위한 텍스트 컨디셔닝"
		},
		"detect_interval": {
			"name": "detect_interval",
			"tooltip": "N 프레임마다 감지 실행 (1=매 프레임). 값이 높을수록 연산 절약."
		},
		"detection_threshold": {
			"name": "detection_threshold",
			"tooltip": "텍스트 프롬프트 감지 점수 임계값"
		},
		"images": {
			"name": "images",
			"tooltip": "비디오 프레임(배치된 이미지)"
		},
		"initial_mask": {
			"name": "initial_mask",
			"tooltip": "첫 프레임에서 추적할 mask(객체별 1개씩)"
		},
		"max_objects": {
			"name": "max_objects",
			"tooltip": "최대 추적 객체 수 (0=무제한). 초기 mask도 포함."
		},
		"model": { "name": "model" }
	},
	"outputs": { "0": {
...
var SCAIL2ColoredMask = {
	"display_name": "SCAIL-2 컬러 마스크 생성",
	"inputs": {
		"driving_track_data": {
			"name": "driving_track_data",
			"tooltip": "드라이빙 포즈 비디오의 SAM3 트랙. pose_video_mask 출력으로 렌더링됩니다."
		},
		"object_indices": {
			"name": "object_indices",
			"tooltip": "포함할 사람 인덱스의 쉼표로 구분된 목록(예: '0,2,3'). 참조 및 포즈 비디오 마스크 모두에 적용됩니다. 비워두면 전체 선택."
		},
		"ref_track_data": {
			"name": "ref_track_data",
			"tooltip": "참조 이미지의 SAM3 트랙."
		},
		"replacement_mode": {
			"name": "replacement_mode",
			"tooltip": "False = mask_video는 검정 배경(애니메이션 모드). True = 흰색 배경(대체 모드). WanSCAILToVideo에서 일치하는 replacement_mode를 설정하세요. reference_image_mask는 항상 검정 배경입니다."
		},
		"sort_by": {
			"name": "sort_by",
			"tooltip": "팔레트 색상이 트래킹된 객체에 할당되는 순서(참조 및 포즈 비디오 모두에 적용되어 각 아이덴티티가 동일한 색상을 유지). left_to_right = 첫 프레임 중심 기준 가장 왼쪽 객체가 첫 번째 색상; area = 첫 프레임 마스크 면적 기준 가장 큰 객체가 첫 번째 색상; none = SAM3의 순서 유지."
		}
	},
	"outputs": {
		"0": {
...
var SUPIRApply = {
	...
	"inputs": {
		...
		"restore_cfg": {
			"name": "restore_cfg",
			"tooltip": "디노이즈된 출력을 입력 latent로 끌어당깁니다. 값이 높을수록 입력에 더 충실합니다. 0은 비활성화."
		},
		"restore_cfg_s_tmin": {
			"name": "restore_cfg_s_tmin",
			"tooltip": "restore_cfg가 비활성화되는 시그마 임계값입니다."
		},
		"strength_end": {
			"name": "strength_end",
			"tooltip": "샘플링 종료 시(낮은 시그마) 강도 제어. 시작값에서 선형 보간됩니다."
		},
		"strength_start": {
			"name": "strength_start",
			"tooltip": "샘플링 시작 시(높은 시그마) 강도 제어."
		},
		"vae": { "name": "vae" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var SV3D_Conditioning = {
	...
	"inputs": {
		...
		"elevation": { "name": "고도" },
		"height": { "name": "높이" },
		"init_image": { "name": "초기 이미지" },
		"vae": { "name": "vae" },
		"video_frames": { "name": "비디오 프레임" },
		"width": { "name": "너비" }
	},
	"outputs": {
		"0": {
...
var SVD_img2vid_Conditioning = {
	...
	"inputs": {
		"augmentation_level": { "name": "증강 레벨" },
		"clip_vision": { "name": "clip_vision" },
		"fps": { "name": "fps" },
		"height": { "name": "높이" },
		"init_image": { "name": "초기 이미지" },
		"motion_bucket_id": { "name": "모션 버킷 ID" },
		"vae": { "name": "vae" },
		"video_frames": { "name": "비디오 프레임" },
		"width": { "name": "너비" }
	},
...
var SamplerARVideo = {
	...
	"inputs": { "num_frame_per_block": {
		...
		"tooltip": "오토리그레시브 블록당 프레임 수입니다. 1 = 프레임 단위, 3 = 청크 단위. 체크포인트의 학습 모드와 일치해야 합니다."
	} },
	"outputs": { "0": { "tooltip": null } }
};
var SamplerCustom = {
...
var SamplerDPMPP_2M_SDE = {
	...
	"inputs": {
		"eta": { "name": "eta" },
		"noise_device": { "name": "노이즈 생성 장치" },
		"s_noise": { "name": "s_noise" },
		"solver_type": { "name": "Solver 유형" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var SamplerER_SDE = {
	...
	"inputs": {
		"eta": {
			"name": "ETA",
			"tooltip": "역시간 SDE의 확률적 강도.\neta=0일 때 결정론적 ODE로 축소됩니다. 이 설정은 ER-SDE 솔버 유형에는 적용되지 않습니다."
		},
		"max_stage": { "name": "최대 단계" },
		"s_noise": { "name": "S 노이즈" },
...
var SamplerLMS = {
	...
	"inputs": { "order": { "name": "순서" } },
	"outputs": { "0": { "tooltip": null } }
};
var SamplerSASolver = {
	"display_name": "SamplerSASolver",
	"inputs": {
		"corrector_order": { "name": "수정기 차수" },
		"eta": { "name": "ETA" },
		"model": { "name": "모델" },
		"predictor_order": { "name": "예측기 차수" },
		"s_noise": { "name": "S 노이즈" },
		"sde_end_percent": { "name": "SDE 종료 백분율" },
		"sde_start_percent": { "name": "SDE 시작 백분율" },
		"simple_order_2": { "name": "단순 2차" },
		"use_pece": { "name": "PECE 사용" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var SamplerSEEDS2 = {
	"description": "이 샘플러 노드는 여러 샘플러를 나타낼 수 있습니다:\n\nseeds_2\n- 기본 설정\n\nexp_heun_2_x0\n- solver_type=phi_2, r=1.0, eta=0.0\n\nexp_heun_2_x0_sde\n- solver_type=phi_2, r=1.0, eta=1.0, s_noise=1.0",
...
var SamplingPercentToSigma = {
	...
	"inputs": {
		...
		"return_actual_sigma": {
			"name": "실제 시그마 값 반환",
			"tooltip": "간격 검사에 사용된 값 대신 실제 시그마 값을 반환합니다.\n이 설정은 0.0과 1.0에서만 결과에 영향을 미칩니다."
		},
		"sampling_percent": { "name": "샘플링 백분율" }
	},
	"outputs": { "0": {
		"name": "시그마 값",
		"tooltip": null
...
var Save3DAdvanced = {
	...
	"inputs": {
		...
		"model_3d": {
			"name": "model_3d",
			"tooltip": "상위 3D 노드에서 가져온 3D 모델 파일입니다."
		},
		"model_3d_info": { "name": "model_3d_info" },
		"viewport_state": { "name": "viewport_state" },
		"width": { "name": "width" }
...
var SaveAudioAdvanced = {
	"description": "입력된 오디오를 ComfyUI 출력 디렉터리에 저장합니다.",
	"display_name": "오디오 저장 (고급)",
	"inputs": {
		"audio": {
			"name": "audio",
			"tooltip": "저장할 오디오입니다."
		...
		"filename_prefix": {
			...
			"tooltip": "저장할 파일의 접두사입니다. %date:yyyy-MM-dd%와 같은 포맷 토큰을 포함할 수 있습니다."
		},
		"format": {
			"name": "format",
			"tooltip": "오디오를 저장할 파일 형식입니다."
		}
	},
	"outputs": { "0": {
		"name": "audio",
...
var SaveImageAdvanced = {
	"description": "입력된 이미지를 ComfyUI 출력 디렉터리에 저장합니다.",
	"display_name": "이미지 저장 (고급)",
	"inputs": {
		"filename_prefix": {
			"name": "filename_prefix",
			"tooltip": "저장할 파일의 접두사입니다. %date:yyyy-MM-dd% 또는 %Empty Latent Image.width%와 같은 포맷 토큰을 포함할 수 있습니다."
		},
		"format": {
			"name": "format",
			"tooltip": "이미지를 저장할 파일 형식입니다."
		},
...
var SaveImageDataSetToFolder = {
	"description": "이미지 데이터셋을 지정한 폴더에 저장합니다. 지원 포맷: PNG.",
	"display_name": "이미지 데이터셋을 폴더에 저장",
	"inputs": {
		"filename_prefix": {
			"name": "filename_prefix",
			"tooltip": "저장된 이미지 파일 이름의 접두사입니다."
		},
		"folder_name": {
			"name": "folder_name",
			"tooltip": "이미지를 저장할 폴더 이름(출력 디렉터리 내)."
		},
		"images": {
			"name": "images",
			"tooltip": "저장할 이미지 목록입니다."
		},
		"mode": {
			"name": "mode",
			"tooltip": "기존 파일을 덮어쓸지, 아니면 파일 이름을 증가시켜 덮어쓰기를 방지할지 여부입니다."
		}
	}
};
var SaveImageTextDataSetToFolder = {
	"description": "이미지와 텍스트 캡션 쌍의 데이터셋을 지정한 폴더에 저장합니다. 이미지는 PNG 파일로, 캡션은 동일한 파일명 접두사를 가진 TXT 파일로 저장됩니다.",
	"display_name": "이미지 및 텍스트 데이터셋을 폴더에 저장",
	"inputs": {
		"filename_prefix": {
			"name": "filename_prefix",
			"tooltip": "저장된 이미지 파일 이름의 접두사입니다."
...
var SaveLoRA = {
	...
	"inputs": {
		"lora": {
			"name": "lora",
			"tooltip": "저장할 LoRA 모델입니다. LoRA 레이어가 있는 모델은 사용하지 마세요."
		},
		"prefix": {
			"name": "prefix",
			"tooltip": "저장된 LoRA 파일에 사용할 접두사입니다."
		},
		"steps": {
			"name": "steps",
			"tooltip": "선택 사항: LoRA가 학습된 스텝 수로, 저장 파일 이름에 사용됩니다."
		}
	}
};
var SavePointCloud = {
	"display_name": "포인트 클라우드 저장",
	"inputs": {
		"camera_info": { "name": "camera_info" },
		"filename_prefix": { "name": "filename_prefix" },
		"height": { "name": "height" },
...
var SaveSVGNode = {
	...
	"inputs": {
		"filename_prefix": {
			"name": "파일명 접두사",
			"tooltip": "저장할 파일의 접두사. 여기에는 %date:yyyy-MM-dd% 또는 %Empty Latent Image.width%와 같은 노드의 값을 포함하는 형식 정보가 포함될 수 있습니다."
		},
		"svg": { "name": "SVG" }
	},
	"outputs": { "0": {
...
var SaveText = {
	"description": "텍스트 내용을 출력 디렉터리에 파일로 저장합니다.",
	"display_name": "텍스트 저장",
	"inputs": {
		"filename_prefix": { "name": "filename_prefix" },
		"format": { "name": "format" },
...
var SaveTrainingDataset = {
	"description": "인코딩된 학습 데이터셋(latent + conditioning)을 디스크에 저장하여 학습 시 효율적으로 불러올 수 있습니다.",
	"display_name": "학습 데이터셋 저장",
	"inputs": {
		"conditioning": {
			"name": "conditioning",
			"tooltip": "MakeTrainingDataset에서 생성된 conditioning 리스트 목록입니다."
		},
		"folder_name": {
			"name": "folder_name",
			"tooltip": "데이터셋을 저장할 폴더 이름(출력 디렉터리 내)."
		},
		"latents": {
			"name": "latents",
			"tooltip": "MakeTrainingDataset에서 생성된 latent 딕셔너리 목록입니다."
		},
		"shard_size": {
			"name": "shard_size",
			"tooltip": "샤드 파일당 샘플 개수입니다."
		}
	}
};
var SaveVideo = {
...
var SaveWEBM = {
	...
	"inputs": {
		...
		"filename_prefix": { "name": "파일명_접두사" },
		"fps": { "name": "fps" },
		"images": {
			"name": "이미지",
			"tooltip": "RGBA 이미지는 알파 채널이 투명도로 저장됩니다(vp9 코덱만 지원)."
		}
	},
	"outputs": { "0": {
		"name": "images",
...
var ScaleROPE = {
	"description": "모델의 ROPE를 스케일링하고 이동합니다.",
	"display_name": "ROPE 스케일",
	"inputs": {
		"model": { "name": "모델" },
		"scale_t": { "name": "시간 축 스케일" },
		"scale_x": { "name": "X축 스케일" },
		"scale_y": { "name": "Y축 스케일" },
		"shift_t": { "name": "시간 축 이동" },
		"shift_x": { "name": "X축 이동" },
		"shift_y": { "name": "Y축 이동" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var SeedVR2Conditioning = {
	"description": "VAE latent에서 SeedVR2 긍정/부정 컨디셔닝을 생성합니다.",
	"display_name": "SeedVR2 컨디셔닝 적용",
	"inputs": {
		"model": {
			"name": "model",
			"tooltip": "SeedVR2 모델."
	...
	"outputs": {
		"0": {
			"name": "positive",
			"tooltip": "샘플링을 위한 긍정 컨디셔닝."
		},
		"1": {
			"name": "negative",
			"tooltip": "샘플링을 위한 부정 컨디셔닝."
		}
	}
};
var SeedVR2PostProcessing = {
	"description": "생성된 이미지를 원본 리사이즈 이미지와 정렬하고 색상 보정을 적용합니다.",
	"display_name": "SeedVR2 출력 후처리",
	"inputs": {
		"color_correction_method": {
			"name": "color_correction_method",
			"tooltip": "생성된 이미지의 색상을 원본 이미지와 맞추는 방법입니다. lab: CIELAB 공간에서 색상 전달, 디테일 보존(가장 충실함). wavelet: 저주파 색상만 전달, 업스케일된 고주파 디테일 유지. adain: 채널별 평균/표준편차 맞춤(가장 빠름, 전체 색조). none: 색상 전달 생략(기하학적 정렬만)."
		},
		"images": {
			"name": "images",
			"tooltip": "처리할 생성된 이미지입니다."
		},
		"original_resized_images": {
			"name": "original_resized_images",
			"tooltip": "전처리 이전의 원본 리사이즈 이미지로, 참조용으로 사용됩니다."
		}
	},
	"outputs": { "0": {
		"name": "images",
		"tooltip": "정렬 및 색상 보정된 이미지입니다."
	} }
};
var SeedVR2Preprocess = {
	"description": "SeedVR2 모델을 위해 리사이즈된 이미지에 패딩을 추가합니다. 알파 채널은 제거됩니다. Post-Process SeedVR2 Output 노드에서 원본 리사이즈 이미지로부터 다시 적용됩니다.",
	"display_name": "SeedVR2 입력 전처리",
	"inputs": { "resized_images": {
		"name": "resized_images",
		"tooltip": "처리할 리사이즈된 이미지입니다."
	} },
	"outputs": { "0": {
		"name": "images",
		"tooltip": "VAE 인코딩을 위한 패딩된 이미지입니다."
	} }
};
var SeedVR2TemporalChunk = {
	"description": "SeedVR2 비디오 latent를 VRAM 내에서 한 번에 샘플링할 수 있을 만큼 겹치는 시간 청크로 분할합니다. latent 출력은 Apply SeedVR2 Conditioning과 샘플러 latent 입력 모두에 연결한 후 Merge SeedVR2 Latents로 다시 합칩니다.",
	"display_name": "SeedVR2 latent 분할",
	"inputs": {
		"chunking_mode": {
			"name": "chunking_mode",
			"tooltip": "manual = frames_per_chunk 값을 그대로 사용; auto = 사용 가능한 VRAM에 맞는 최대 청크를 예측."
		},
		"latent": {
			"name": "latent",
			"tooltip": "분할할 VAE 인코딩된 SeedVR2 latent입니다."
		},
		"temporal_overlap": {
			"name": "temporal_overlap",
			"tooltip": "인접 청크 간에 공유되는 latent 프레임 수로, 병합 시 크로스페이드됩니다. 0 = 겹침 없음."
		}
	},
	"outputs": {
		"0": {
			"name": "latents",
			"tooltip": "순서대로 정렬된 시간 청크입니다."
		},
		"1": {
			"name": "temporal_overlap",
			"tooltip": "Merge SeedVR2 Latents에서 사용할 인접 청크 간의 실제 latent 프레임 겹침 수입니다."
		}
	}
};
var SeedVR2TemporalMerge = {
	"description": "샘플링된 SeedVR2 latent 시간 청크를 하나의 latent로 다시 결합합니다. 각 겹침 부분은 Split SeedVR2 Latent에서 전달된 temporal_overlap 값에 따라 Hann 윈도우로 크로스페이드됩니다.",
	"display_name": "SeedVR2 latent 병합",
	"inputs": {
		"latents": {
			"name": "latents",
			"tooltip": "순서대로 정렬된 샘플링된 시간 청크입니다."
		},
		"temporal_overlap": {
			"name": "temporal_overlap",
			"tooltip": "Split SeedVR2 Latent의 temporal_overlap 출력값입니다. 0 = 단순 연결."
		}
	},
	"outputs": { "0": {
		"name": "latent",
		"tooltip": "재결합된 전체 길이의 latent입니다."
	} }
};
var SelectCLIPDevice = {
	"description": "CLIP 텍스트 인코더를 특정 디바이스에 배치합니다 (default / cpu / gpu:N).\n\n- \"default\"는 로더에서 할당된 디바이스로 복원합니다.\n- \"cpu\"는 로드 및 오프로딩 디바이스를 모두 CPU로 고정합니다.\n- \"gpu:N\"은 로드 디바이스를 N번째 사용 가능한 GPU로 고정합니다.\n\n선택한 디바이스가 현재 머신에 존재하지 않을 경우\n(예: 2-GPU 환경에서 만든 워크플로우를 1-GPU 환경에서 열 때),\n노드는 CLIP을 변경 없이 통과시키고 실패 대신 메시지를 기록합니다.",
	"display_name": "CLIP 디바이스 선택",
	"inputs": {
		"clip": { "name": "clip" },
		"device": { "name": "device" }
	},
...
var SelectModelDevice = {
	"description": "디퓨전 모델을 특정 디바이스에 배치합니다 (default / cpu / gpu:N).\n\n- \"default\"는 로더에서 할당된 디바이스로 복원합니다 (이전 Select Model Device 호출 이후에도).\n- \"cpu\"는 로드 및 오프로딩 디바이스를 모두 CPU로 고정합니다.\n- \"gpu:N\"은 로드 디바이스를 N번째 사용 가능한 GPU로 고정하며, 오프로딩 디바이스는 로더의 원래 선택으로 복원됩니다.\n\n요청한 디바이스가 입력 모델이 이미 위치한 디바이스와 다를 경우, 로더의 reload factory(cached_patcher_init)를 통해 새로운 모델이 생성되어 새로운 디바이스에서 독립적인 가중치를 갖게 됩니다. 멀티GPU를 지원하지 않는 로더(팩토리 없음)는 경고와 함께 변경 없이 통과됩니다.\n\n워크플로우에 이미 MultiGPU CFG Split이 적용되어 있고 선택한 GPU가 기존 멀티GPU 클론 중 하나와 충돌할 경우, 해당 클론은 삭제되어 두 patcher가 동일한 디바이스에 바인딩되지 않도록 합니다.\n\n선택한 디바이스가 현재 머신에 존재하지 않을 경우\n(예: 2-GPU 환경에서 만든 워크플로우를 1-GPU 환경에서 열 때),\n노드는 모델을 변경 없이 통과시키고 실패 대신 메시지를 기록합니다.\n\n참고: 이미 동일한 모델을 소비한 노드(예: 원래 디바이스에서 이 모델로 실행된 KSampler) 뒤에 Select Model Device를 배치하는 것은 권장하지 않습니다. 선택한 디바이스가 원래와 일치할 경우(빠른 경로), 이전 소비자가 원래 모델에서 변경한 상태가 관찰될 수 있습니다. Select Model Device는 모델의 소비자보다 먼저 배치하세요.",
	"display_name": "모델 디바이스 선택",
	"inputs": {
		"device": { "name": "device" },
		"model": { "name": "model" }
	},
...
var SelectVAEDevice = {
	"description": "VAE를 특정 장치에 할당합니다 (기본값 / gpu:N).\n\n- \"default\"는 로더에 의해 할당된 장치로 복원합니다.\n- \"gpu:N\"은 N번째 사용 가능한 GPU에 로드를 고정하며,\n  오프로딩 장치는 표준 VAE 오프로딩 장치로 설정됩니다.\n\nVAE의 경우 CPU는 UI에서 의도적으로 노출되지 않습니다. 만약 워크플로우에서\n\"cpu\"가 제공될 경우(예: 다른 기기에서 열었을 때), 요청은 로그 메시지와 함께\n무시되고 VAE는 변경 없이 전달됩니다.\n\n선택한 장치가 현재 머신에 존재하지 않을 경우\n(예: 2-GPU 환경에서 만든 워크플로우를 1-GPU 머신에서 열었을 때),\n노드는 VAE를 변경 없이 전달하고 실패 대신 로그 메시지를 남깁니다.",
	"display_name": "VAE 장치 선택",
	"inputs": {
		"device": { "name": "장치" },
		"vae": { "name": "vae" }
	},
...
var SetClipHooks = {
	...
	"inputs": {
		"apply_to_conds": { "name": "조건에 적용" },
		"clip": { "name": "clip" },
		"hooks": { "name": "후크" },
		"schedule_clip": { "name": "clip 스케쥴 사용" }
	}
};
var SetFirstSigma = {
...
var ShuffleDataset = {
	"description": "목록 내 이미지의 순서를 무작위로 섞습니다.",
	"display_name": "이미지 데이터셋 섞기",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"images": {
			"name": "images",
...
var ShuffleImageTextDataset = {
	"description": "목록 내 이미지-텍스트 쌍의 순서를 무작위로 섞습니다.",
	"display_name": "이미지-텍스트 데이터셋 섞기",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"images": {
			"name": "images",
			"tooltip": "섞을 이미지 목록입니다."
		},
		"seed": {
			"name": "seed",
			"tooltip": "랜덤 시드입니다."
...
var ShuffleVideoDataset = {
	"description": "비디오 목록의 순서를 무작위로 섞습니다.",
	"display_name": "비디오 목록 섞기",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"seed": {
			"name": "시드",
...
var ShuffleVideoTextDataset = {
	"description": "비디오-텍스트 쌍의 순서를 무작위로 섞습니다.",
	"display_name": "비디오-텍스트 쌍 섞기",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"seed": {
			"name": "시드",
...
var SkipLayerGuidanceDiTSimple = {
	"description": "uncond 패스만 수정하는 SkipLayerGuidanceDiT 노드의 간단 버전입니다.",
	"display_name": "SkipLayerGuidanceDiT 간단 버전",
	"inputs": {
		"double_layers": { "name": "이중 레이어" },
		"end_percent": { "name": "종료 백분율" },
		"model": { "name": "모델" },
		"single_layers": { "name": "단일 레이어" },
		"start_percent": { "name": "시작 백분율" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var SoniloTextToMusic = {
	"description": "Sonilo의 AI 모델을 사용하여 텍스트 프롬프트로부터 음악을 생성합니다. 지속 시간을 0으로 두면 프롬프트에서 자동으로 추론합니다.",
	"display_name": "Sonilo 텍스트로 음악 생성",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"duration": {
			"name": "duration",
			"tooltip": "목표 지속 시간(초). 0으로 설정하면 프롬프트에서 자동으로 추론합니다. 최대: 6분."
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "생성할 음악을 설명하는 텍스트 프롬프트입니다."
		},
		"seed": {
			"name": "seed",
			"tooltip": "재현성을 위한 시드 값입니다. 현재 Sonilo 서비스에서는 무시되지만 그래프 일관성을 위해 유지됩니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var SoniloVideoToMusic = {
	"description": "Sonilo의 AI 모델을 사용하여 비디오 콘텐츠로부터 음악을 생성합니다. 비디오를 분석하여 어울리는 음악을 만듭니다.",
	"display_name": "Sonilo 비디오로 음악 생성",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"prompt": {
			"name": "prompt",
			"tooltip": "음악 생성에 참고할 선택적 텍스트 프롬프트입니다. 비워두면 최상의 품질로 모델이 비디오 내용을 완전히 분석합니다."
		},
		"seed": {
			"name": "seed",
			"tooltip": "재현성을 위한 시드 값입니다. 현재 Sonilo 서비스에서는 무시되지만 그래프 일관성을 위해 유지됩니다."
		...
		"video": {
			"name": "video",
			"tooltip": "음악을 생성할 입력 비디오입니다. 최대 지속 시간: 6분."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var SplatToFile3D = {
	"description": "가우시안 splat을 File3D 객체로 직렬화하여 Save / Preview 3D 노드에서 사용할 수 있습니다. 배치당 한 항목만 지원합니다.",
	"display_name": "3D 파일 생성(splat에서)",
	"inputs": {
		"format": {
			"name": "format",
			"tooltip": "ply: 표준 3D Gaussian Splat(완전한 구면 고조파 포함). ksplat: mkkellogg SplatBuffer(레벨 0, 비압축), 기본 색상만. spz: Niantic gzip 압축(~10배 더 작음), 기본 색상만."
		},
		"splat": { "name": "splat" }
	},
	"outputs": { "0": {
...
var SplatToMesh = {
	"description": "가우시안 splat에서 컬러 메시를 추출합니다.",
	"display_name": "Splat에서 메시 추출",
	"inputs": {
		"color_sharpen": {
			"name": "컬러 샤프닝",
			"tooltip": "버텍스 텍스처를 선명하게 만듭니다: 1.0 = 물리적으로 올바른 블렌드; 더 높게 하면 각 voxel의 색상이 이웃 평균 대신 지배적인 가우시안 쪽으로 치우쳐집니다(텍스처 번짐 방지). 색상만 변경되며, 기하학은 변하지 않습니다."
		},
		"kernel": {
			"name": "커널",
			"tooltip": "voxel 단위의 최대 splat 반너비입니다. 각 가우시안은 자신의 3-시그마 크기만큼의 윈도우에 래스터화되며, 여기서 제한됩니다. 작은 surfel은 저렴하게 유지되고, 큰 surfel은 잘리지 않습니다. splat이 드물어 빈 공간이 생기면 값을 높이세요."
		},
		"level": {
			"name": "레벨",
			"tooltip": "Iso-surface 레벨입니다. Otsu로 자동 선택되며, 이 값으로 조정할 수 있습니다(1.0 = 자동, 낮을수록 표면이 두껍고 더 연결됨, 높을수록 얇고 더 조여짐)."
		},
		"min_component": {
			"name": "최소 컴포넌트",
			"tooltip": "이 값보다 작은 꼭짓점 개수의 연결 컴포넌트는 제거합니다(0 = 모두 유지). 분리된 플로터 블롭과 이중 벽의 내부 셸을 제거합니다."
		},
		"min_opacity": {
			"name": "최소 불투명도",
			"tooltip": "메시 생성 전에 이 값보다 약한 가우시안은 무시합니다."
		},
		"resolution": {
			"name": "해상도",
			"tooltip": "가장 긴 축을 따라 밀도 그리드 해상도입니다. 높을수록 표면이 더 정밀해지며, VRAM/시간이 더 많이 소모됩니다(해상도^3에 비례)."
		},
		"smooth": {
			"name": "스무스",
			"tooltip": "Taubin 메시 스무딩 반복 횟수입니다. 표면을 줄이지 않고(부피 보존) 부드럽게 만듭니다. 밀도를 블러 처리하는 것과 다릅니다. 0 = 원본 표면."
		},
		"splat": { "name": "splat" }
	},
	"outputs": { "0": {
...
var SplitAudioChannels = {
	"description": "오디오를 좌우 채널로 분리합니다.",
	"display_name": "오디오 채널 분리",
	"inputs": { "audio": { "name": "오디오" } },
	"outputs": {
		"0": {
			"name": "왼쪽",
...
var SplitImageToTileList = {
	"description": "이미지를 지정된 오버랩으로 배치된 타일 목록으로 분할합니다.",
	"display_name": "이미지를 타일 목록으로 분할",
	"inputs": {
		"image": { "name": "image" },
		"overlap": { "name": "overlap" },
...
var StableZero123_Conditioning_Batched = {
	...
	"inputs": {
		"azimuth": { "name": "방위각" },
		"azimuth_batch_increment": { "name": "방위각 배치 증가" },
		"batch_size": { "name": "배치 크기" },
		"clip_vision": { "name": "clip_vision" },
		"elevation": { "name": "고도" },
		"elevation_batch_increment": { "name": "고도 배치 증가" },
		"height": { "name": "높이" },
		"init_image": { "name": "초기 이미지" },
		"vae": { "name": "vae" },
		"width": { "name": "너비" }
...
var StringFormat = {
	"description": "Python의 문자열 포맷 메서드와 동일합니다. Python의 모든 포맷 옵션과 기능을 지원합니다.",
	"display_name": "텍스트 포맷",
	"inputs": {
...
var StyleModelApply = {
	...
	"inputs": {
		"clip_vision_output": { "name": "clip_vision 출력" },
		"conditioning": { "name": "조건" },
		"strength": { "name": "강도" },
		"strength_type": { "name": "강도 유형" },
		"style_model": { "name": "스타일 모델" }
	}
};
var StyleModelLoader = {
	"display_name": "스타일 모델 로드",
	"inputs": { "style_model_name": { "name": "스타일 모델 이름" } }
};
var SyncLipSyncNode = {
...
var T5TokenizerOptions = {
	...
	"inputs": {
		"clip": { "name": "clip" },
		"min_length": { "name": "최소 길이" },
		"min_padding": { "name": "최소 패딩" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var TCFG = {
	"description": "TCFG – 접선 감쇠 CFG (2503.18137)\n\n품질 향상을 위해 무조건부(부정)를 조건부(긍정)와 일치하도록 정제합니다.",
	"display_name": "접선 감쇠 CFG",
	"inputs": { "model": { "name": "모델" } },
	"outputs": { "0": {
		"name": "패치된 모델",
		"tooltip": null
...
var TemporalScoreRescaling = {
	"description": "[Post-CFG 함수]\nTSR - 시간적 점수 재조정 (2510.01184)\n\n모델의 점수나 노이즈를 재조정하여 샘플링 다양성을 조절합니다.",
	"display_name": "TSR - 시간적 점수 재조정",
	"inputs": {
		"model": { "name": "모델" },
		"tsr_k": {
			"name": "tsr_k",
			"tooltip": "재조정 강도를 제어합니다.\n낮은 k 값은 더 세부적인 결과를 생성하고, 높은 k 값은 이미지 생성에서 더 부드러운 결과를 생성합니다. k = 1로 설정하면 재조정이 비활성화됩니다."
		},
		"tsr_sigma": {
			"name": "tsr_sigma",
			"tooltip": "재조정이 언제 시작되는지 제어합니다.\n값이 클수록 더 일찍 효과가 나타납니다."
		}
	},
	"outputs": { "0": {
		"name": "패치된 모델",
...
var Tencent3DPartNode = {
	"description": "모델 구조를 기반으로 자동으로 부품 식별 및 생성을 수행합니다.",
	"display_name": "Hunyuan3D: 3D 파트",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"model_3d": {
			"name": "model_3d",
			"tooltip": "FBX 형식의 3D 모델입니다. 모델의 면 개수는 30,000개 미만이어야 합니다."
		},
		"seed": {
			"name": "seed",
			"tooltip": "시드는 노드가 다시 실행될지 여부를 제어합니다. 시드와 관계없이 결과는 비결정적입니다."
...
var Tencent3DTextureEditNode = {
	"description": "3D 모델을 입력한 후, 3D 모델 텍스처를 다시 그립니다.",
	"display_name": "Hunyuan3D: 3D 텍스처 편집",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"model_3d": {
			"name": "model_3d",
			"tooltip": "FBX 형식의 3D 모델입니다. 모델은 100,000개 미만의 면을 가져야 합니다."
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "텍스처 편집을 설명합니다. 최대 1024자의 UTF-8 문자를 지원합니다."
		},
		"seed": {
			"name": "seed",
			"tooltip": "시드는 노드가 다시 실행될지 여부를 제어합니다. 시드와 관계없이 결과는 비결정적입니다."
...
var TencentImageToModelNode = {
	...
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"face_count": { "name": "면 개수" },
		"generate_type": { "name": "생성 유형" },
		"generate_type_pbr": { "name": "PBR" },
		"image": { "name": "이미지" },
		"image_back": { "name": "뒷면 이미지" },
		"image_left": { "name": "왼쪽 이미지" },
		"image_right": { "name": "오른쪽 이미지" },
		"model": {
			"name": "모델",
...
var TencentModelTo3DUVNode = {
	"description": "3D 모델에 UV 펼치기를 수행하여 UV 텍스처를 생성합니다. 입력 모델은 30,000개 미만의 면을 가져야 합니다.",
	"display_name": "Hunyuan3D: 모델에서 UV로",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"model_3d": {
			"name": "3D 모델",
			"tooltip": "입력 3D 모델 (GLB, OBJ, 또는 FBX)"
		},
		"seed": {
			"name": "시드",
			"tooltip": "시드는 노드가 다시 실행될지 여부를 제어합니다. 시드와 관계없이 결과는 비결정적입니다."
...
var TencentSmartTopologyNode = {
	"description": "3D 모델에 스마트 리토폴로지를 수행합니다. GLB/OBJ 포맷 지원; 최대 200MB; 고폴리곤 모델에 권장됩니다.",
	"display_name": "Hunyuan3D: 스마트 토폴로지",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"face_level": {
			"name": "면 수준",
...
var TextEncodeBooguEdit = {
	...
	"inputs": {
		...
		"images": {
			"name": "이미지",
			"tooltip": "편집할 참조 이미지입니다. Boogu는 샘플당 하나의 참조 이미지를 중점적으로 사용하지만, 여러 개도 허용됩니다."
		},
		"negative_prompt": { "name": "네거티브 프롬프트" },
		"prompt": { "name": "프롬프트" },
		"vae": { "name": "vae" }
...
var TextEncodeMageFlowEdit = {
	"description": "Mage-Flow-Edit를 위한 편집 지시문을 하나 이상의 참조 이미지와 함께 인코딩합니다. 참조 latent들은 출력 해상도(너비/높이, 또는 0일 경우 첫 번째 이미지의 크기)로 리사이즈됩니다. 항상 크기가 일치하도록 latent 출력을 샘플링에 사용하세요.",
	...
	"inputs": {
		...
		"height": {
			"name": "height",
			"tooltip": "출력 높이. 0 = 첫 번째 참조 이미지의 크기 사용."
		},
		"images": {
			"name": "images",
			"tooltip": "편집할 참조 이미지(들). 모든 참조 이미지는 인코딩 전에 출력 해상도로 리사이즈됩니다."
		},
		...
		"width": {
			"name": "width",
			"tooltip": "출력 너비. 0 = 첫 번째 참조 이미지의 크기 사용."
		}
	},
	"outputs": {
		"0": {
...
var TextEncodeZImageOmni = {
	...
	"inputs": {
		"auto_resize_images": { "name": "이미지 자동 크기 조정" },
		"clip": { "name": "clip" },
		"image1": { "name": "이미지1" },
		"image2": { "name": "이미지2" },
		"image3": { "name": "이미지3" },
		"image_encoder": { "name": "이미지 인코더" },
		"prompt": { "name": "프롬프트" },
		"vae": { "name": "vae" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var TextGenerate = {
	...
	"inputs": {
		...
		"clip": { "name": "clip" },
		"image": { "name": "이미지" },
		"max_length": { "name": "최대 길이" },
		"prompt": { "name": "프롬프트" },
		"sampling_mode": { "name": "샘플링 모드" },
		"sampling_mode_min_p": { "name": "최소 p" },
		"sampling_mode_presence_penalty": { "name": "presence_penalty" },
		"sampling_mode_repetition_penalty": { "name": "반복 패널티" },
		"sampling_mode_seed": { "name": "시드" },
		"sampling_mode_temperature": { "name": "온도" },
		...
		"use_default_template": {
			...
			"tooltip": "모델에 내장된 시스템 프롬프트/템플릿이 있으면 사용합니다."
		},
		"video": {
			"name": "비디오",
			"tooltip": "비디오 프레임을 이미지 배치로 처리합니다. 24 FPS로 가정하며, 내부적으로 1 FPS로 샘플링됩니다."
		}
	},
	"outputs": { "0": {
		"name": "생성된 텍스트",
...
var TextOverlay = {
	"description": "이미지 또는 이미지 배치에 텍스트 오버레이를 그립니다.",
	"display_name": "텍스트 오버레이 그리기",
	"inputs": {
		"align": { "name": "align" },
		"color": {
			"name": "color",
		...
		"font_size": {
			"name": "font_size",
			"tooltip": "이미지 높이의 백분율로 지정된 글꼴 크기입니다."
		},
		"images": { "name": "images" },
		"outline": {
			"name": "outline",
			"tooltip": "텍스트 주위에 검은색 외곽선을 그립니다."
		},
...
var TopazImageEnhance = {
	"description": "업계 표준 업스케일링 및 이미지 향상.",
	"display_name": "Topaz 이미지 향상",
	"inputs": {
		"color_preservation": {
			"name": "color_preservation",
			"tooltip": "원본 색상을 보존합니다."
		},
		"creativity": { "name": "creativity" },
		"crop_to_fill": {
			"name": "crop_to_fill",
			"tooltip": "기본적으로 출력 종횡비가 다를 때 이미지는 레터박스 처리됩니다. 출력 크기에 맞게 이미지를 자르려면 활성화하세요."
		},
		"face_enhancement": {
			"name": "face_enhancement",
			"tooltip": "처리 중 얼굴(존재 시)을 향상합니다."
		},
		...
		"face_enhancement_strength": {
			...
			"tooltip": "향상된 얼굴이 배경에 비해 얼마나 선명한지 조절합니다."
		},
		"face_preservation": {
			"name": "face_preservation",
			"tooltip": "피사체의 얼굴 정체성을 보존합니다."
		},
		"image": { "name": "image" },
		"model": { "name": "model" },
		"output_height": {
			"name": "output_height",
			"tooltip": "0으로 설정하면 원본과 동일한 높이 또는 output_width에 맞춰 출력됩니다."
		},
		"output_width": {
			"name": "output_width",
			"tooltip": "0으로 설정하면 자동으로 계산됩니다(일반적으로 원본 크기 또는 output_height가 지정된 경우 해당 값 사용)."
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "창의적인 업스케일링 가이드를 위한 선택적 텍스트 프롬프트입니다."
		},
...
var TopazVideoEnhance = {
	"description": "강력한 업스케일링 및 복원 기술로 비디오에 새 생명을 불어넣으세요.",
	...
	"inputs": {
		...
		"interpolation_duplicate": {
			...
			"tooltip": "입력에서 중복 프레임을 분석하여 제거합니다."
		},
		"interpolation_duplicate_threshold": {
			"name": "interpolation_duplicate_threshold",
			"tooltip": "중복 프레임 감지 민감도."
		},
		...
		"interpolation_slowmo": {
			...
			"tooltip": "입력 비디오에 적용되는 슬로우 모션 배수입니다. 예를 들어, 2로 설정하면 출력이 두 배 느려지고 길이도 두 배가 됩니다."
		},
		"upscaler_creativity": {
			"name": "upscaler_creativity",
			"tooltip": "창의성 수준 (Starlight (Astra) Creative에만 적용됩니다)."
		},
...
var TopazVideoEnhanceV2 = {
	...
	"inputs": {
		...
		"interpolation_model": { "name": "보간 모델" },
		"upscaler_model": { "name": "업스케일러 모델" },
		"upscaler_model_creativity": { "name": "창의성" },
		"upscaler_model_prompt": { "name": "프롬프트" },
		"upscaler_model_realism": { "name": "사실감" },
		"upscaler_model_sharp": { "name": "선명도" },
		"upscaler_model_upscaler_resolution": { "name": "업스케일러 해상도" },
		"video": { "name": "비디오" }
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var TrainLoraNode = {
	"display_name": "LoRA 학습",
	"inputs": {
		"algorithm": {
			"name": "알고리즘",
			"tooltip": "훈련에 사용할 알고리즘입니다."
		},
		"batch_size": {
			"name": "배치 크기",
			"tooltip": "학습에 사용할 배치 크기입니다."
		},
		"bucket_mode": {
			"name": "bucket_mode",
			"tooltip": "해상도 버킷 모드를 활성화합니다. 활성화 시, ResolutionBucket 노드에서 미리 버킷 처리된 latent를 기대합니다."
		},
		"bypass_mode": {
			"name": "bypass_mode",
		...
		"existing_lora": {
			"name": "기존 LoRA",
			"tooltip": "추가할 기존 LoRA입니다. 새 LoRA의 경우 None으로 설정하세요."
		},
		"grad_accumulation_steps": {
			"name": "기울기 누적 단계 수",
			"tooltip": "학습에 사용할 기울기 누적 단계 수입니다."
		},
		"gradient_checkpointing": {
			"name": "기울기 체크포인팅",
			"tooltip": "훈련에 기울기 체크포인팅을 사용합니다."
		},
		"latents": {
			"name": "잠재 변수",
			"tooltip": "학습에 사용할 잠재 변수로, 모델의 데이터셋/입력으로 사용됩니다."
		},
		"learning_rate": {
			"name": "학습률",
			"tooltip": "학습에 사용할 학습률입니다."
		},
		"lora_dtype": {
			"name": "LoRA 데이터 타입",
			"tooltip": "LoRA에 사용할 데이터 타입입니다."
		},
		"loss_function": {
			"name": "손실 함수",
			"tooltip": "훈련에 사용할 손실 함수입니다."
		},
		"model": {
			"name": "모델",
		...
		"seed": {
			"name": "시드",
			"tooltip": "훈련에 사용할 시드 (LoRA 가중치 초기화 및 노이즈 샘플링용 생성기에 사용됨)"
		},
		"steps": {
			"name": "단계 수",
			"tooltip": "LoRA를 학습시킬 단계 수입니다."
		},
		"training_dtype": {
			"name": "훈련 데이터 타입",
...
var TransformSplat = {
	"description": "가우시안 splat을 이동, 회전, 스케일합니다. 비균일 스케일은 각 splat의 형태도 변경하며, 처리 속도가 느려집니다.",
	"display_name": "Splat 변환",
	"inputs": {
		"rotate_x": { "name": "회전_x" },
		"rotate_y": { "name": "회전_y" },
		"rotate_z": { "name": "회전_z" },
		...
		"scale_z": { "name": "스케일_z" },
		"splat": { "name": "splat" },
		"translate_x": { "name": "이동_x" },
		"translate_y": { "name": "이동_y" },
		"translate_z": { "name": "이동_z" }
	},
	"outputs": { "0": {
		"name": "splat",
		"tooltip": null
...
var TrimAudioDuration = {
	...
	"inputs": {
		...
		"start_index": {
			"name": "시작 인덱스",
			"tooltip": "시작 시간(초), 음수일 경우 끝에서부터 계산 (소수 단위 지원)."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var TripleCLIPLoader = {
	...
	"inputs": {
		"clip_name1": { "name": "CLIP 파일명1" },
		"clip_name2": { "name": "CLIP 파일명2" },
		"clip_name3": { "name": "CLIP 파일명3" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var TripoConversionNode = {
	"display_name": "Tripo: 모델 변환",
	"inputs": {
...
var TripoImageToModelNode = {
	...
	"inputs": {
		...
		"style": { "name": "스타일" },
		"texture": { "name": "텍스처" },
		"texture_alignment": { "name": "텍스처 정렬" },
		"texture_quality": { "name": "텍스처 품질" },
		"texture_seed": { "name": "텍스처 시드" }
	},
	"outputs": {
		"0": {
			"name": "모델 파일",
...
var TripoP1ImageToModelNode = {
	"description": "Tripo P1 이미지-3D 변환. 저폴리곤, 게임용 메시 최적화.",
	"display_name": "Tripo P1: 이미지에서 모델로",
	"inputs": {
		"auto_size": {
			"name": "auto_size",
			"tooltip": "출력 크기를 실제 미터 단위에 가깝게 조정합니다."
		},
		"compress_geometry": {
			"name": "compress_geometry",
			"tooltip": "지오메트리 기반 압축을 적용합니다. 편집 전에는 압축을 해제하세요."
		},
		"enable_image_autofix": {
			"name": "enable_image_autofix",
			"tooltip": "입력 이미지를 사전 처리하여 생성 품질을 향상시킵니다."
		},
		"export_uv": {
			"name": "export_uv",
			"tooltip": "생성 중 UV 언랩을 수행합니다. 빠른 geometry only 실행을 원하면 끄세요."
		},
		"face_limit": {
			"name": "face_limit",
			"tooltip": "목표 면 개수, 48-20000. -1은 Tripo가 자동으로 선택합니다."
		},
		"image": { "name": "image" },
		"model_seed": { "name": "model_seed" },
		"output_mode": {
			"name": "output_mode",
			"tooltip": "\"Geometry only\"는 텍스처 없는 메시를 반환합니다. \"Textured\"는 컬러/PBR 맵을 추가합니다."
		}
	},
	"outputs": {
		"0": {
...
var TripoP1MultiviewToModelNode = {
	"description": "Tripo P1 멀티뷰-3D 변환. [정면, 좌측, 후면, 우측] 순서의 2~4개 참조 이미지 사용. 정면은 필수이며, 나머지 세 이미지는 선택입니다.",
	"display_name": "Tripo P1: 멀티뷰에서 모델로",
	"inputs": {
		"auto_size": {
			"name": "auto_size",
			"tooltip": "출력 크기를 실제 미터 단위에 가깝게 조정합니다."
		...
		"image_left": {
			"name": "image_left",
			"tooltip": "좌측(90°), 즉 피사체의 왼쪽."
		},
		"image_right": {
			"name": "image_right",
			"tooltip": "우측(270°), 즉 피사체의 오른쪽."
		},
		"model_seed": { "name": "model_seed" },
		"output_mode": {
			"name": "output_mode",
...
var TripoP1TextToModelNode = {
	"description": "Tripo P1 텍스트-투-3D. 안정적인 토폴로지로 게임에 바로 사용할 수 있는 저폴리 메시에 최적화됨.",
	"display_name": "Tripo P1: 텍스트 → 모델",
	"inputs": {
		"auto_size": {
			"name": "자동 크기 조정",
			"tooltip": "출력 결과를 실제 미터 단위에 가깝게 스케일합니다."
		},
		"compress_geometry": {
			"name": "지오메트리 압축",
			"tooltip": "지오메트리 기반 압축을 적용합니다. 편집 전 압축을 해제하세요."
		},
		"export_uv": {
			"name": "UV 내보내기",
			"tooltip": "생성 중 UV 언랩을 수행합니다. 빠른 geometry-only 실행을 원하면 끄세요."
		...
		"face_limit": {
			"name": "페이스 제한",
			"tooltip": "목표 페이스 수, 48-20000. -1은 Tripo가 자동으로 선택합니다."
		},
		"image_seed": { "name": "이미지 시드" },
		"model_seed": { "name": "모델 시드" },
		"negative_prompt": {
			"name": "네거티브 프롬프트",
			"tooltip": "최대 255자까지 입력 가능합니다."
		},
		"output_mode": {
			"name": "출력 모드",
			"tooltip": "\"Geometry only\"는 텍스처 없는 메시를 반환합니다. \"Textured\"는 컬러/PBR 맵을 추가합니다."
...
var TripoRigNode = {
	...
	"inputs": { "original_model_task_id": { "name": "원본 모델 작업 ID" } },
	"outputs": {
		"0": {
			"name": "모델 파일",
			"tooltip": null
...
var TripoSplatConditioning = {
	"description": "이미지를 DINOv3와 Flux2 VAE로 인코딩하여 TripoSplat의 positive/negative 컨디셔닝을 생성하고, KSampler를 위한 고정 크기 노이즈 타겟(latent + 카메라)을 만듭니다.",
	"display_name": "TripoSplat 컨디셔닝",
	"inputs": {
		"clip_vision": {
			"name": "clip_vision",
			"tooltip": "DINOv3 ViT-H/16+ 이미지 인코더"
		},
		"image": { "name": "이미지" },
		"vae": {
			"name": "vae",
	...
	"outputs": {
		...
		"2": {
			"name": "latent",
			"tooltip": "고정 크기 노이즈 타겟(latent + 카메라)."
		}
	}
};
var TripoSplatPreprocessImage = {
	"description": "각 이미지를 중앙에서 정사각형 캔버스로 자르고 검은색 배경에 패딩을 추가합니다.",
	"display_name": "TripoSplat 전처리 이미지",
	"inputs": {
		"erode_radius": {
			"name": "erode_radius",
			"tooltip": "자르기 전에 알파 매트를 이 픽셀 반경만큼 침식합니다(테두리 번짐 방지)."
		},
		"image": { "name": "image" },
		"mask": { "name": "mask" },
		"size": {
			"name": "size",
			"tooltip": "정사각형 이미지 크기. 모델은 1024로 학습되었습니다. 다른 크기도 실행 가능하지만 분포에서 벗어날 수 있습니다."
		}
	},
	"outputs": { "0": {
		"name": "image",
...
var TripoSplatSamplingPreview = {
	"description": "표준 Ksampler 노드에 TripoSplat 모델을 패치하여 각 단계에서 실시간 디코딩된 가우시안 splat 미리보기를 표시합니다.",
	"display_name": "TripoSplat 샘플링 미리보기",
	"inputs": {
		"model": { "name": "model" },
		"num_gaussians": {
			"name": "num_gaussians",
			"tooltip": "미리보기를 위해 생성할 가우시안 개수(32의 배수로 반올림)."
		},
		"octree_level": {
			"name": "octree_level",
			"tooltip": "미리보기 디코드용 옥트리 깊이(낮을수록 저렴/거침)."
		},
		"pitch": {
			"name": "pitch",
			"tooltip": "미리보기 카메라의 pitch(도 단위)."
		},
		"point_size": {
			"name": "point_size",
			"tooltip": "최대 splat 반지름(픽셀 단위). 각 가우시안은 스케일에 따라 크기가 정해지며 여기서 제한됩니다. 낮을수록 더 세밀/뾰족, 높을수록 더 두껍게 표시됩니다."
		},
		"vae": {
			"name": "vae",
			"tooltip": "TripoSplat VAE 디코더"
		},
		"yaw": {
			"name": "yaw",
			"tooltip": "미리보기 카메라의 yaw(도 단위)."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var UNETLoader = {
	...
	"inputs": {
		"unet_name": { "name": "UNet 모델 파일명" },
		"weight_dtype": { "name": "가중치 데이터 유형" }
	}
};
...
var UNetTemporalAttentionMultiply = {
	...
	"inputs": {
		"cross_structural": { "name": "구조적 크로스" },
		"cross_temporal": { "name": "시간적 크로스" },
		"model": { "name": "모델" },
		"self_structural": { "name": "구조적 셀프" },
		"self_temporal": { "name": "시간적 셀프" }
	},
	"outputs": { "0": { "tooltip": null } }
};
var USOStyleReference = {
	"display_name": "USO 스타일 참조",
	"inputs": {
		"clip_vision_output": { "name": "CLIP 비전 출력" },
		"model": { "name": "모델" },
		"model_patch": { "name": "모델 패치" }
	}
};
...
var VAEDecodeHunyuan3D = {
	...
	"inputs": {
		"num_chunks": { "name": "분할 수" },
		"octree_resolution": { "name": "옥트리 해상도" },
		"samples": { "name": "샘플" },
		"vae": { "name": "vae" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var VAEDecodeTripoSplat = {
	"description": "샘플링된 TripoSplat latent를 3D 가우시안 splat으로 디코딩합니다. 가우시안 개수를 조절하여 밀도를 변경할 수 있습니다.",
	"display_name": "TripoSplat 디코드",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"num_gaussians": {
			"name": "num_gaussians",
			"tooltip": "생성할 가우시안 개수(32의 배수로 반올림). 262144는 옥트리의 포인트 밀도와 일치합니다. 더 높게 설정하면 같은 포인트를 더 많이 샘플링(더 조밀하지만 새로운 디테일 없음)하며 VRAM/시간이 비례해 증가합니다."
		},
		"samples": { "name": "samples" },
		"seed": {
			"name": "seed",
			"tooltip": "옥트리 포인트 샘플러(글로벌 RNG)에 시드를 부여하여 디코드를 결정적으로 만듭니다."
		},
		"vae": {
			"name": "vae",
			"tooltip": "TripoSplat VAE 디코더"
...
var VOIDInpaintConditioning = {
	...
	"inputs": {
		...
		"length": {
			"name": "length",
			"tooltip": "처리할 픽셀 프레임 수입니다. CogVideoX-Fun-V1.5 (patch_size_t=2)에서는 latent_t가 짝수여야 하며, 홀수 latent_t가 생성되는 길이는 내림 처리됩니다 (예: 49 → 45)."
		},
		"negative": { "name": "negative" },
		"positive": { "name": "positive" },
		"quadmask": {
			"name": "quadmask",
			"tooltip": "VOIDQuadmaskPreprocess에서 전처리된 쿼드마스크 [T, H, W]"
		},
		"vae": { "name": "vae" },
		"video": {
			"name": "video",
			"tooltip": "원본 비디오 프레임 [T, H, W, 3]"
		},
		"width": { "name": "width" }
	},
	"outputs": {
...
var VOIDQuadmaskPreprocess = {
	...
	"inputs": {
		"dilate_width": {
			"name": "dilate_width",
			"tooltip": "주 마스크 영역의 팽창 반경 (0 = 팽창 없음)"
		},
		"mask": { "name": "mask" }
	},
	"outputs": { "0": {
...
var VOIDWarpedNoiseSource = {
	...
	"inputs": { "warped_noise": {
		"name": "warped_noise",
		"tooltip": "VOIDWarpedNoise에서 생성된 워프드 노이즈 latent"
	} },
	"outputs": { "0": { "tooltip": null } }
};
var VPScheduler = {
...
var Veo3FirstLastFrameNode = {
	"description": "프롬프트와 첫 프레임, 마지막 프레임을 사용하여 비디오를 생성합니다.",
	"display_name": "Google Veo 3 첫 프레임-마지막 프레임에서 비디오 생성",
	"inputs": {
		"aspect_ratio": {
			"name": "종횡비",
			"tooltip": "출력 비디오의 종횡비"
		...
		"negative_prompt": {
			"name": "네거티브 프롬프트",
			"tooltip": "비디오에서 피하고 싶은 내용을 안내하는 네거티브 텍스트 프롬프트"
		},
		"prompt": {
			"name": "프롬프트",
...
var Veo3VideoGenerationNode = {
	"description": "Google의 Veo 3 API를 사용하여 텍스트 프롬프트에서 비디오를 생성합니다",
	"display_name": "Google Veo 3 비디오 생성",
	"inputs": {
		"aspect_ratio": {
			"name": "화면비",
			"tooltip": "출력 비디오의 화면비"
		...
		"duration_seconds": {
			"name": "지속시간_초",
			"tooltip": "출력 비디오의 지속 시간(초) (Veo 3은 8초만 지원합니다)"
		},
		"enhance_prompt": {
			"name": "프롬프트 향상",
		...
		"generate_audio": {
			"name": "오디오 생성",
			"tooltip": "비디오용 오디오 생성. 모든 Veo 3 모델에서 지원됩니다."
		},
		"image": {
			"name": "이미지",
			"tooltip": "비디오 생성을 안내하는 선택적 참조 이미지"
		},
		"model": {
			"name": "모델",
			"tooltip": "비디오 생성에 사용할 Veo 3 모델"
		},
		"negative_prompt": {
			"name": "네거티브 프롬프트",
		...
		"resolution": {
			"name": "해상도",
			"tooltip": "출력 비디오 해상도입니다. 4K는 veo-3.1-lite 및 veo-3.0 모델에서 지원되지 않습니다."
		},
		"seed": {
			"name": "시드",
			"tooltip": "비디오 생성을 위한 시드 (0은 랜덤)"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var VideoFrameSample = {
	"description": "다양한 전략을 사용하여 비디오에서 고정된 개수의 프레임을 샘플링합니다.",
	"display_name": "비디오 프레임 샘플링",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"num_frames": {
			"name": "프레임 수",
			"tooltip": "샘플링할 프레임의 개수."
		},
		"seed": {
			"name": "시드",
			"tooltip": "무작위 시드('random' 전략에서만 사용)."
		},
		"strategy": {
			"name": "전략",
			"tooltip": "uniform: 균등 간격, head: 처음 N개, tail: 마지막 N개, random: 무작위 정렬."
		},
		"video": {
			"name": "비디오",
			"tooltip": "입력 비디오."
...
var VideoRandomTemporalCrop = {
	"description": "비디오에서 연속된 프레임 범위를 무작위로 자릅니다.",
	"display_name": "비디오 자르기 (임의 시간대)",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"length": {
			"name": "길이",
	...
	"outputs": { "0": {
		"name": "비디오",
		"tooltip": "잘린 비디오 (지연 처리)."
	} }
};
var VideoTemporalCrop = {
	"description": "비디오에서 연속된 프레임 범위를 자릅니다.",
	"display_name": "비디오 자르기 (시간대)",
	"inputs": {
		"length": {
			"name": "길이",
			"tooltip": "유지할 프레임의 개수."
...
var Vidu2ImageToVideoNode = {
	"description": "이미지와 선택적 프롬프트로부터 비디오를 생성합니다.",
	"display_name": "Vidu2 이미지-비디오 생성",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"duration": { "name": "duration" },
		"image": {
			"name": "image",
			"tooltip": "생성된 비디오의 시작 프레임으로 사용할 이미지입니다."
		},
		"model": { "name": "model" },
		"movement_amplitude": {
			"name": "movement_amplitude",
			"tooltip": "프레임 내 객체의 움직임 진폭입니다."
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "비디오 생성을 위한 선택적 텍스트 프롬프트 (최대 2000자)."
		},
		"resolution": { "name": "resolution" },
		"seed": { "name": "seed" }
	},
...
var Vidu2ReferenceVideoNode = {
	"description": "여러 참조 이미지와 프롬프트로부터 비디오를 생성합니다.",
	"display_name": "Vidu2 참조-비디오 생성",
	"inputs": {
		"aspect_ratio": { "name": "aspect_ratio" },
		"audio": {
			"name": "audio",
			"tooltip": "활성화 시, 프롬프트를 기반으로 생성된 음성과 배경 음악이 비디오에 포함됩니다."
		},
		"control_after_generate": { "name": "control after generate" },
		"duration": { "name": "duration" },
		"model": { "name": "model" },
		...
		"subjects": {
			"name": "subjects",
			"tooltip": "각 subject마다 최대 3개의 참조 이미지를 제공합니다 (전체 subject 합계 7장). 프롬프트에서 @subject{subject_id}로 참조하세요."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var Vidu2StartEndToVideoNode = {
	"description": "시작 프레임, 종료 프레임, 프롬프트로부터 비디오를 생성합니다.",
	"display_name": "Vidu2 시작/종료 프레임-투-비디오 생성",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"duration": { "name": "duration" },
...
var Vidu2TextToVideoNode = {
	...
	"display_name": "Vidu2 텍스트-투-비디오 생성",
	"inputs": {
		"aspect_ratio": { "name": "aspect_ratio" },
		"background_music": {
			"name": "background_music",
			"tooltip": "생성된 비디오에 배경 음악을 추가할지 여부입니다."
		},
		"control_after_generate": { "name": "control after generate" },
		"duration": { "name": "duration" },
		"model": { "name": "model" },
		"prompt": {
			"name": "prompt",
			"tooltip": "비디오 생성을 위한 텍스트 설명 (최대 2000자)."
		},
		"resolution": { "name": "resolution" },
		"seed": { "name": "seed" }
	},
...
var Vidu3ImageToVideoNode = {
	"description": "이미지와 선택적 프롬프트로부터 비디오를 생성합니다.",
	"display_name": "Vidu Q3 이미지-비디오 생성",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"image": {
			"name": "image",
...
var Vidu3StartEndToVideoNode = {
	...
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"end_frame": { "name": "종료 프레임" },
		"first_frame": { "name": "시작 프레임" },
		"model": {
			"name": "모델",
			"tooltip": "비디오 생성을 위해 사용할 모델입니다."
		},
		"model_audio": { "name": "오디오" },
		"model_duration": { "name": "길이" },
		"model_resolution": { "name": "해상도" },
		"prompt": {
			"name": "프롬프트",
			"tooltip": "프롬프트 설명 (최대 2000자)."
...
var ViduExtendVideoNode = {
	"description": "기존 비디오에 추가 프레임을 생성하여 확장합니다.",
	"display_name": "Vidu 비디오 확장",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"end_frame": { "name": "end_frame" },
		"model": {
			"name": "model",
			"tooltip": "비디오 확장을 위해 사용할 모델입니다."
		},
		"model_duration": { "name": "duration" },
		"model_resolution": { "name": "resolution" },
		"prompt": {
			"name": "prompt",
			"tooltip": "확장된 비디오를 위한 선택적 텍스트 프롬프트 (최대 2000자)."
		},
		"seed": { "name": "seed" },
		"video": {
			"name": "video",
			"tooltip": "확장할 원본 비디오입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ViduImageToVideoNode = {
	"description": "이미지와 선택적 프롬프트로부터 비디오 생성",
	"display_name": "Vidu 이미지 비디오 생성",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"duration": {
			"name": "duration",
			"tooltip": "출력 비디오의 길이(초 단위)"
		},
		"image": {
			"name": "image",
			"tooltip": "생성된 비디오의 시작 프레임으로 사용될 이미지"
		},
		"model": {
			"name": "model",
			"tooltip": "모델 이름"
		...
		"movement_amplitude": {
			"name": "movement_amplitude",
			"tooltip": "프레임 내 객체들의 움직임 진폭"
		},
		"prompt": {
			"name": "prompt",
			"tooltip": "비디오 생성을 위한 텍스트 설명"
		},
		"resolution": {
			"name": "resolution",
			"tooltip": "지원되는 값은 모델 및 길이에 따라 다를 수 있음"
		},
		"seed": {
			"name": "seed",
			"tooltip": "비디오 생성을 위한 시드(0은 랜덤)"
...
var ViduMultiFrameVideoNode = {
	"description": "여러 키프레임 전환이 포함된 비디오를 생성합니다.",
	"display_name": "Vidu 다중 프레임 비디오 생성",
	"inputs": {
		"control_after_generate": { "name": "control after generate" },
		"frames": {
			"name": "frames",
			"tooltip": "키프레임 전환 수 (2-9)."
		},
		...
		"start_image": {
			"name": "start_image",
			"tooltip": "시작 프레임 이미지입니다. 종횡비는 1:4에서 4:1 사이여야 합니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ViduReferenceVideoNode = {
	"description": "여러 이미지와 프롬프트로부터 비디오 생성",
	"display_name": "Vidu 참조 비디오 생성",
	"inputs": {
		"aspect_ratio": {
			"name": "aspect_ratio",
			"tooltip": "출력 비디오의 화면비"
		...
		"images": {
			"name": "images",
			"tooltip": "일관된 주제로 비디오를 생성하기 위한 참조 이미지(최대 7개 이미지)"
		},
		"model": {
			"name": "model",
			"tooltip": "모델 이름"
...
var ViduStartEndToVideoNode = {
	"description": "시작 및 종료 프레임과 프롬프트로부터 비디오 생성",
	"display_name": "Vidu 시작-종료 비디오 생성",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": {
			"name": "지속 시간",
			"tooltip": "출력 비디오의 지속 시간(초 단위)"
		},
		"end_frame": {
			"name": "end_frame",
			"tooltip": "종료 프레임"
		...
		"resolution": {
			"name": "해상도",
			"tooltip": "지원되는 값은 모델 및 지속 시간에 따라 다를 수 있음"
		},
		"seed": {
			"name": "시드",
			"tooltip": "비디오 생성 시드 값 (0일 경우 무작위)"
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var ViduTextToVideoNode = {
	"description": "텍스트 프롬프트로 비디오 생성",
	"display_name": "Vidu 텍스트 비디오 생성",
	"inputs": {
		"aspect_ratio": {
			"name": "화면비",
			"tooltip": "출력 비디오의 화면비"
...
var VoxelToMesh = {
	"description": "voxel 그리드를 mesh로 변환합니다.",
	"display_name": "복셀 → 매시",
	"inputs": {
		"algorithm": { "name": "알고리즘" },
		"threshold": { "name": "임계값" },
...
var Wan22FunControlToVideo = {
	...
	"inputs": {
		"batch_size": { "name": "배치 크기" },
		"control_video": { "name": "제어 비디오" },
		"height": { "name": "높이" },
		"length": { "name": "길이" },
		"negative": { "name": "부정 프롬프트" },
		"positive": { "name": "긍정 프롬프트" },
		"ref_image": { "name": "참조 이미지" },
		"vae": { "name": "VAE" },
		"width": { "name": "너비" }
	},
	"outputs": {
...
var WanAnimateToVideo = {
	...
	"inputs": {
		"background_video": { "name": "배경 비디오" },
		"batch_size": { "name": "배치 크기" },
		"character_mask": { "name": "캐릭터 마스크" },
		"clip_vision_output": { "name": "클립 비전 출력" },
		"continue_motion": { "name": "연속 모션" },
		"continue_motion_max_frames": { "name": "연속 모션 최대 프레임 수" },
		"face_video": { "name": "얼굴 비디오" },
		"height": { "name": "높이" },
		"length": { "name": "길이" },
		"negative": { "name": "부정 프롬프트" },
		"pose_video": { "name": "포즈 비디오" },
		"positive": { "name": "긍정 프롬프트" },
		"reference_image": { "name": "참조 이미지" },
		"vae": { "name": "VAE" },
		"video_frame_offset": {
			"name": "비디오 프레임 오프셋",
			"tooltip": "모든 입력 비디오에서 탐색할 프레임 수입니다. 청크 방식으로 더 긴 비디오를 생성하는 데 사용됩니다. 비디오를 연장하려면 이전 노드의 video_frame_offset 출력에 연결하세요."
		},
		"width": { "name": "너비" }
	},
	"outputs": {
...
var WanCameraEmbedding = {
	"display_name": "완카메라임베딩",
	"inputs": {
		"camera_pose": { "name": "카메라 포즈" },
		"cx": { "name": "cx" },
		"cy": { "name": "cy" },
		"fx": { "name": "fx" },
		"fy": { "name": "fy" },
...
var WanCameraImageToVideo = {
	"display_name": "완카메라이미지투비디오",
	"inputs": {
		"batch_size": { "name": "배치 크기" },
		"camera_conditions": { "name": "카메라 조건" },
		"clip_vision_output": { "name": "CLIP 비전 출력" },
		"height": { "name": "높이" },
		"length": { "name": "길이" },
		"negative": { "name": "부정 프롬프트" },
...
var WanContextWindowsManual = {
	"description": "WAN 유사 모델에 대한 컨텍스트 창을 수동으로 설정합니다 (dim=2).",
	"display_name": "WAN 컨텍스트 창 (수동)",
	"inputs": {
		"closed_loop": {
			"name": "폐쇄 루프",
			"tooltip": "컨텍스트 창 루프를 닫을지 여부입니다. 루프 스케줄에만 적용됩니다."
		},
		"context_length": {
			"name": "컨텍스트 길이",
			"tooltip": "컨텍스트 창의 길이입니다."
		},
		"context_overlap": {
			"name": "컨텍스트 오버랩",
			"tooltip": "컨텍스트 창의 오버랩입니다."
		},
		"context_schedule": {
			"name": "컨텍스트 스케줄",
			"tooltip": "컨텍스트 창의 스트라이드입니다."
		},
		"context_stride": {
			"name": "컨텍스트 스트라이드",
			"tooltip": "컨텍스트 창의 스트라이드입니다. 균일 스케줄에만 적용됩니다."
		},
		"freenoise": {
			"name": "freenoise",
			"tooltip": "FreeNoise 노이즈 셔플을 적용할지 여부, 윈도우 블렌딩을 향상시킵니다."
		...
		"fuse_method": {
			"name": "퓨즈 방법",
			"tooltip": "컨텍스트 창을 융합하는 데 사용할 방법입니다."
		},
		"model": {
			"name": "모델",
			"tooltip": "샘플링 중 컨텍스트 창을 적용할 모델입니다."
		},
		"retain_first_frame": {
			"name": "retain_first_frame",
			"tooltip": "모든 컨텍스트 윈도우에서 첫 번째 I2V 프레임을 유지합니다(초기 참조를 유지하는 데 도움이 될 수 있습니다)."
		},
		"split_conds_to_windows": {
			"name": "split_conds_to_windows",
			"tooltip": "여러 조건(ConditionCombine에서 생성됨)을 영역 인덱스에 따라 각 윈도우로 분할할지 여부입니다."
		}
	},
	"outputs": { "0": { "tooltip": "샘플링 중 컨텍스트 창이 적용된 모델입니다." } }
};
...
var WanFirstLastFrameToVideo = {
	...
	"inputs": {
		"batch_size": { "name": "배치 크기" },
		"clip_vision_end_image": { "name": "clip 비전 종료 이미지" },
		"clip_vision_start_image": { "name": "clip 비전 시작 이미지" },
		"end_image": { "name": "종료 이미지" },
		"height": { "name": "높이" },
		"length": { "name": "길이" },
		"negative": { "name": "부정 조건" },
		"positive": { "name": "긍정 조건" },
...
var WanHuMoImageToVideo = {
	"display_name": "WanHuMo 이미지-비디오 변환",
	"inputs": {
		"audio_encoder_output": { "name": "오디오 인코더 출력" },
		"batch_size": { "name": "배치 크기" },
		"height": { "name": "높이" },
		"length": { "name": "길이" },
		"negative": { "name": "부정 프롬프트" },
...
var WanImageToImageApi = {
	"description": "하나 또는 두 개의 입력 이미지와 텍스트 프롬프트로부터 이미지를 생성합니다. 출력 이미지는 현재 1.6 MP로 고정되며, 종횡비는 입력 이미지와 일치합니다.",
	"display_name": "Wan 이미지-이미지 변환",
	"inputs": {
		"control_after_generate": { "name": "생성 후 제어" },
		"image": {
			"name": "이미지",
			"tooltip": "단일 이미지 편집 또는 다중 이미지 융합, 최대 2개 이미지."
		},
		"model": {
			"name": "모델",
			"tooltip": "사용할 모델입니다."
		...
		"negative_prompt": {
			"name": "네거티브 프롬프트",
			"tooltip": "피해야 할 내용을 안내하는 네거티브 텍스트 프롬프트입니다."
		},
		"prompt": {
			"name": "프롬프트",
			"tooltip": "요소와 시각적 특징을 설명하는 데 사용되는 프롬프트로, 영어/중국어를 지원합니다."
		},
		"seed": {
			"name": "시드",
			"tooltip": "생성에 사용할 시드 값입니다."
		...
		"watermark": {
			"name": "워터마크",
			"tooltip": "결과물에 \"AI 생성\" 워터마크를 추가할지 여부입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var WanImageToVideoApi = {
	"description": "첫 번째 프레임과 텍스트 프롬프트를 기반으로 비디오를 생성합니다.",
	"display_name": "Wan 이미지-비디오 변환",
	"inputs": {
		"audio": {
			"name": "오디오",
			"tooltip": "오디오는 명확하고 큰 음성으로, 잡음이나 배경 음악 없이 포함되어야 합니다."
		},
		"control_after_generate": { "name": "생성 후 제어" },
		"duration": {
			"name": "지속 시간",
			"tooltip": "사용 가능한 지속 시간: 5초 및 10초"
		},
		"generate_audio": {
			"name": "오디오 생성",
			"tooltip": "오디오 입력이 없을 경우 자동으로 오디오를 생성합니다."
		},
		"image": { "name": "이미지" },
		"model": {
			"name": "모델",
		...
		"prompt_extend": {
			"name": "프롬프트 확장",
			"tooltip": "AI 지원으로 프롬프트를 향상시킬지 여부입니다."
		},
		"resolution": { "name": "해상도" },
		"seed": {
			"name": "시드",
		...
		"shot_type": {
			"name": "샷 타입",
			"tooltip": "생성된 비디오의 샷 타입을 지정합니다. 즉, 비디오가 단일 연속 샷인지, 컷이 있는 여러 샷인지 설정합니다. 이 파라미터는 prompt_extend가 True일 때만 적용됩니다."
		},
		"watermark": {
			"name": "워터마크",
			"tooltip": "결과물에 \"AI 생성\" 워터마크를 추가할지 여부입니다."
...
var WanMoveTracksFromCoords = {
	...
	"inputs": {
		"track_coords": { "name": "트랙 좌표" },
		"track_mask": { "name": "트랙 마스크" }
	},
	"outputs": {
		"0": { "tooltip": null },
		"1": {
...
var WanMoveVisualizeTracks = {
	...
	"inputs": {
		"circle_size": { "name": "원 크기" },
		"images": { "name": "이미지" },
		"line_resolution": { "name": "선 해상도" },
		"line_width": { "name": "선 두께" },
		"opacity": { "name": "불투명도" },
		"tracks": { "name": "트랙" }
	},
	"outputs": { "0": { "tooltip": null } }
...
var WanReferenceVideoApi = {
	"description": "입력 비디오의 캐릭터와 음성을 프롬프트와 결합하여 캐릭터 일관성을 유지하는 새로운 비디오를 생성합니다.",
	...
	"inputs": {
		...
		"negative_prompt": {
			"name": "네거티브 프롬프트",
			"tooltip": "피해야 할 내용을 설명하는 네거티브 프롬프트입니다."
		},
		"prompt": {
			"name": "프롬프트",
			"tooltip": "요소와 시각적 특징을 설명하는 프롬프트입니다. 영어와 중국어를 지원합니다. 참조 캐릭터를 지칭할 때 `character1`, `character2`와 같은 식별자를 사용하세요."
		},
		"reference_videos": { "name": "참조 비디오" },
		"seed": { "name": "시드" },
		"shot_type": {
			"name": "샷 타입",
			"tooltip": "생성된 비디오의 샷 타입을 지정합니다. 즉, 비디오가 하나의 연속된 샷인지, 컷이 있는 여러 샷인지 지정합니다."
		},
		"size": { "name": "크기" },
		"watermark": {
			"name": "워터마크",
			"tooltip": "결과에 AI 생성 워터마크를 추가할지 여부입니다."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
var WanSCAILToVideo = {
	...
	"inputs": {
		...
		"clip_vision_output": {
			"name": "clip_vision_output",
			"tooltip": "조건부를 위한 CLIP 비전 특징입니다. stretch resize로 종횡비에 맞춰 학습되었습니다."
		},
		"height": { "name": "높이" },
		"length": { "name": "길이" },
		"negative": { "name": "negative" },
		...
		"pose_video_mask": {
			"name": "pose_video_mask",
			"tooltip": "SCAIL-2 전용. pose_video와 동일 해상도의 신원별 색상 SAM3 마스크 비디오입니다."
		},
		"positive": { "name": "positive" },
		"previous_frame_count": {
			"name": "previous_frame_count",
			"tooltip": "이전 프레임의 마지막 프레임 수를 기준점으로 사용합니다. SCAIL-2는 5(81프레임 청크, 76프레임 스텝)로 학습되었습니다."
		},
		"previous_frames": {
			"name": "previous_frames",
			"tooltip": "SCAIL-2 전용. 이전 청크의 전체 디코딩 출력입니다. 마지막 previous_frame_count만 확장 기준점으로 사용됩니다."
		},
		"reference_image": {
			"name": "참조 이미지",
			"tooltip": "참조 이미지입니다. 여러 참조가 있을 경우 하나의 이미지에 모두 합성하세요."
		},
		"reference_image_mask": {
			"name": "reference_image_mask",
			"tooltip": "SCAIL-2 전용. reference_image와 동일 해상도의 색상 참조 마스크입니다."
		},
		"replacement_mode": {
			"name": "replacement_mode",
			"tooltip": "SCAIL-2 전용. 거짓 = 애니메이션 모드(pose_video_mask는 검은색 배경이어야 함). 참 = 교체 모드(pose_video_mask는 흰색 배경이어야 함)."
		},
		"vae": { "name": "vae" },
		"video_frame_offset": {
			"name": "video_frame_offset",
			"tooltip": "이 청크가 시작하는 누적 출력 프레임입니다. 이전 청크의 video_frame_offset 출력에서 연결하세요."
		},
		"width": { "name": "너비" }
	},
	"outputs": {
		...
		"3": {
			"name": "video_frame_offset",
			"tooltip": "조정된 오프셋 + 길이. 다음 청크에 연결하세요."
		}
	}
};
...
var WanTextToImageApi = {
	...
	"inputs": {
		...
		"negative_prompt": {
			"name": "부정 프롬프트",
			"tooltip": "피해야 할 내용을 안내하는 부정 텍스트 프롬프트입니다."
		},
		"prompt": {
			"name": "프롬프트",
			"tooltip": "요소와 시각적 특징을 설명하는 프롬프트로, 영어/중국어를 지원합니다."
		},
		"prompt_extend": {
			"name": "프롬프트 확장",
			"tooltip": "AI 지원으로 프롬프트를 향상시킬지 여부입니다."
...
var WanTextToVideoApi = {
	"description": "텍스트 프롬프트를 기반으로 비디오를 생성합니다.",
	"display_name": "Wan 텍스트 투 비디오",
	"inputs": {
		"audio": {
			"name": "오디오",
			"tooltip": "오디오는 명확하고 큰 음성으로, 잡음이나 배경 음악 없이 포함되어야 합니다."
		...
		"negative_prompt": {
			"name": "부정 프롬프트",
			"tooltip": "피해야 할 내용을 안내하는 부정 텍스트 프롬프트."
		},
		"prompt": {
			"name": "프롬프트",
			"tooltip": "요소와 시각적 특징을 설명하는 데 사용되는 프롬프트로, 영어/중국어를 지원합니다."
		...
		"shot_type": {
			"name": "샷 타입",
			"tooltip": "생성된 비디오의 샷 타입을 지정합니다. 즉, 비디오가 하나의 연속된 샷인지, 컷이 있는 여러 샷인지 지정합니다. 이 파라미터는 prompt_extend가 True일 때만 적용됩니다."
		},
		"size": { "name": "크기" },
		"watermark": {
			"name": "워터마크",
			"tooltip": "결과에 \"AI 생성\" 워터마크를 추가할지 여부."
		}
	},
	"outputs": { "0": { "tooltip": null } }
};
...
var WanUni3CControlnetApply = {
	"display_name": "Wan Uni3C ControlNet 적용",
	"inputs": {
		"end_percent": { "name": "종료 비율" },
		"model": { "name": "모델" },
		"model_patch": { "name": "모델 패치" },
		"render_video": {
			"name": "렌더 비디오",
			"tooltip": "카메라 궤적에서 렌더링된 가이드 비디오로, 주로 입력 이미지의 왜곡된 포인트 클라우드 렌더가 사용됩니다."
		},
		"start_percent": { "name": "시작 비율" },
		"strength": { "name": "강도" },
		"vae": { "name": "vae" }
...
var nodeDefs_default = {
	...
	EmptySD3LatentImage,
	"Epsilon Scaling": {
		"display_name": "엡실론 스케일링",
		"inputs": {
			"model": { "name": "모델" },
			"scaling_factor": { "name": "스케일링 계수" }
		},
		"outputs": { "0": { "tooltip": null } }
	},
...
//# sourceMappingURL=nodeDefs-Ye0Y3qqk.js.map