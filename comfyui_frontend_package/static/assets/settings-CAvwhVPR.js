//#region src/locales/ru/settings.json
var Comfy_Appearance_DisableAnimations = {
	"name": "Отключить анимации",
	"tooltip": "Отключает большинство CSS-анимаций и переходов. Ускоряет инференс, если видеокарта используется также для генерации."
};
...
var Comfy_ConfirmClear = { "name": "Требовать подтверждение при очистке рабочего процесса" };
var Comfy_DOMClippingEnabled = { "name": "Включить обрезку элементов DOM (включение может снизить производительность)" };
var Comfy_DevMode = { "name": "Включить параметры режима разработчика (сохранение API и т. д.)" };
...
var Comfy_DisableSliders = { "name": "Отключить ползунки виджетов нод" };
var Comfy_EditAttention_Delta = { "name": "Точность Ctrl+вверх/вниз" };
var Comfy_EnableTooltips = { "name": "Включить подсказки" };
var Comfy_EnableWorkflowViewRestore = { "name": "Сохранять и восстанавливать положение и уровень масштабирования холста в рабочих процессах" };
...
var Comfy_Graph_AutoPanSpeed = {
	"name": "Скорость автопрокрутки",
	"tooltip": "Максимальная скорость автопрокрутки при перетаскивании к краю холста. Установите 0 для отключения автопрокрутки."
};
var Comfy_Graph_CanvasInfo = { "name": "Показать информацию о холсте в нижнем левом углу (fps и т.д.)" };
var Comfy_Graph_CanvasMenu = { "name": "Показать меню холста графа" };
var Comfy_Graph_CtrlShiftZoom = { "name": "Включить быстрый зум с помощью сочетания клавиш (Ctrl + Shift + Колёсико мыши)" };
...
var Comfy_Graph_ZoomSpeed = { "name": "Скорость зума холста" };
var Comfy_GroupSelectedNodes_Padding = { "name": "Отступ для выбранных нод группы" };
var Comfy_Group_DoubleClickTitleToEdit = { "name": "Дважды щёлкните по заголовку группы, чтобы редактировать" };
...
var Comfy_NodeBadge_ShowApiPricing = { "name": "Показать значок стоимости узла API" };
...
var Comfy_NodeSearchBoxImpl_FollowCursor = {
	"name": "Добавленные узлы следуют за курсором",
	"tooltip": "Если включено, узлы, добавленные из поискового окна, будут следовать за курсором до тех пор, пока не будут размещены щелчком. Применяется только к реализации по умолчанию."
};
...
var Comfy_Node_AllowImageSizeDraw = { "name": "Показывать ширину × высоту под предварительным просмотром изображения" };
...
var Comfy_Node_DoubleClickTitleToEdit = { "name": "Дважды щёлкните по заголовку ноды, чтобы редактировать" };
var Comfy_Node_MiddleClickRerouteNode = { "name": "Средний щелчок создаёт новую ноду перенаправления" };
var Comfy_Node_Opacity = { "name": "Непрозрачность ноды" };
...
var Comfy_PromptFilename = { "name": "Запрос названия файла при сохранении рабочего процесса" };
...
var Comfy_Sidebar_UnifiedWidth = { "name": "Унифицированная ширина боковой панели" };
...
var Comfy_TextareaWidget_FontSize = { "name": "Размер шрифта виджета текстовой области" };
var Comfy_TextareaWidget_Spellcheck = { "name": "Проверка орфографии виджета текстовой области" };
var Comfy_TreeExplorer_ItemPadding = { "name": "Отступ элемента в проводнике дерева" };
...
var Comfy_Validation_Workflows = { "name": "Проверка рабочих процессов" };
...
var Comfy_Window_UnloadConfirmation = { "name": "Показать подтверждение при закрытии окна" };
...
var Comfy_Workflow_ConfirmDelete = { "name": "Показать подтверждение при удалении рабочих процессов" };
var Comfy_Workflow_Persist = { "name": "Сохранить состояние рабочего процесса и восстановить при (пере)загрузке страницы" };
var Comfy_Workflow_ShowMissingModelsWarning = { "name": "Показать предупреждение об отсутствующих моделях" };
var Comfy_Workflow_SortNodeIdOnSave = { "name": "Сортировать ID нод при сохранении рабочего процесса" };
var Comfy_Workflow_WarnBlueprintOverwrite = { "name": "Требовать подтверждение для перезаписи существующего шаблона подграфа" };
...
var LiteGraph_ContextMenu_Scaling = { "name": "Масштабирование комбинированных виджетов меню узлов (списков) при увеличении" };
var LiteGraph_Group_SelectChildrenOnClick = {
	"name": "Выделять дочерние элементы группы при клике",
	"tooltip": "Если включено, при нажатии на группу будут выделены все узлы и элементы внутри неё"
};
...
var LiteGraph_Node_TooltipDelay = { "name": "Задержка всплывающей подсказки" };
...
//# sourceMappingURL=settings-CAvwhVPR.js.map