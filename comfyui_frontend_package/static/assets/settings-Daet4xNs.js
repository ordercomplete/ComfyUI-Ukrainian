//#region src/locales/pt-BR/settings.json
var Comfy_Appearance_DisableAnimations = {
	"name": "Desativar animações",
	"tooltip": "Desativa a maioria das animações e transições CSS. Acelera a inferência quando a GPU de exibição também é usada para geração."
};
...
var Comfy_ConfirmClear = { "name": "Exigir confirmação ao limpar o fluxo de trabalho" };
var Comfy_DOMClippingEnabled = { "name": "Ativar recorte de elementos DOM (ativar pode reduzir o desempenho)" };
var Comfy_DevMode = { "name": "Ativar opções de modo desenvolvedor (salvar API, etc.)" };
...
var Comfy_DisableSliders = { "name": "Desativar sliders dos widgets dos nós" };
var Comfy_EditAttention_Delta = { "name": "Precisão de Ctrl+cima/baixo" };
var Comfy_EnableTooltips = { "name": "Ativar dicas de ferramenta" };
var Comfy_EnableWorkflowViewRestore = { "name": "Salvar e restaurar posição e nível de zoom do canvas nos fluxos de trabalho" };
...
var Comfy_Graph_AutoPanSpeed = {
	"name": "Velocidade de auto-deslocamento",
	"tooltip": "Velocidade máxima ao auto-deslocar arrastando até a borda da tela. Defina como 0 para desativar o auto-deslocamento."
};
var Comfy_Graph_CanvasInfo = { "name": "Mostrar informações do canvas no canto inferior esquerdo (fps, etc.)" };
var Comfy_Graph_CanvasMenu = { "name": "Mostrar menu do canvas do grafo" };
var Comfy_Graph_CtrlShiftZoom = { "name": "Ativar atalho de zoom rápido (Ctrl + Shift + Arrastar)" };
...
var Comfy_Graph_ZoomSpeed = { "name": "Velocidade de zoom da tela" };
var Comfy_GroupSelectedNodes_Padding = { "name": "Espaçamento dos nós selecionados no grupo" };
var Comfy_Group_DoubleClickTitleToEdit = { "name": "Clique duplo no título do grupo para editar" };
...
var Comfy_NodeBadge_ShowApiPricing = { "name": "Mostrar selo de preço do nó de API" };
...
var Comfy_NodeSearchBoxImpl_FollowCursor = {
	"name": "Nós adicionados seguem o cursor",
	"tooltip": "Quando ativado, os nós adicionados pela caixa de pesquisa seguem o cursor até serem clicados para posicionar. Aplica-se apenas à implementação padrão."
};
...
var Comfy_Node_AllowImageSizeDraw = { "name": "Mostrar largura × altura abaixo da pré-visualização da imagem" };
...
var Comfy_Node_DoubleClickTitleToEdit = { "name": "Clique duplo no título do nó para editar" };
var Comfy_Node_MiddleClickRerouteNode = { "name": "Clique do meio cria um novo nó de redirecionamento" };
var Comfy_Node_Opacity = { "name": "Opacidade do nó" };
...
var Comfy_PromptFilename = { "name": "Solicitar nome do arquivo ao salvar fluxo de trabalho" };
...
var Comfy_Sidebar_UnifiedWidth = { "name": "Largura unificada da barra lateral" };
...
var Comfy_TextareaWidget_FontSize = { "name": "Tamanho da fonte do widget de área de texto" };
var Comfy_TextareaWidget_Spellcheck = { "name": "Verificação ortográfica do widget de área de texto" };
var Comfy_TreeExplorer_ItemPadding = { "name": "Espaçamento dos itens do explorador em árvore" };
...
var Comfy_Validation_Workflows = { "name": "Validar fluxos de trabalho" };
...
var Comfy_Window_UnloadConfirmation = { "name": "Mostrar confirmação ao fechar a janela" };
...
var Comfy_Workflow_ConfirmDelete = { "name": "Mostrar confirmação ao excluir fluxos de trabalho" };
var Comfy_Workflow_Persist = { "name": "Persistir estado do fluxo de trabalho e restaurar ao recarregar a página" };
var Comfy_Workflow_ShowMissingModelsWarning = { "name": "Mostrar aviso de modelos ausentes" };
var Comfy_Workflow_SortNodeIdOnSave = { "name": "Ordenar IDs dos nós ao salvar fluxo de trabalho" };
var Comfy_Workflow_WarnBlueprintOverwrite = { "name": "Exigir confirmação para sobrescrever um blueprint de subgrafo existente" };
...
var LiteGraph_ContextMenu_Scaling = { "name": "Escalar menus de combinação de nós (listas) ao dar zoom" };
var LiteGraph_Group_SelectChildrenOnClick = {
	"name": "Selecionar filhos do grupo ao clicar",
	"tooltip": "Quando ativado, clicar em um grupo seleciona todos os nós e itens dentro dele"
};
...
var LiteGraph_Node_TooltipDelay = { "name": "Atraso da Dica de Ferramenta" };
...
//# sourceMappingURL=settings-Daet4xNs.js.map