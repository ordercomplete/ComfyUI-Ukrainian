...
import { B as createTextVNode, F as createCommentVNode, Ht as unref, I as createElementBlock, N as createBaseVNode, Nt as ref, P as createBlock, St as withCtx, U as defineComponent, V as createVNode, at as openBlock, nt as onMounted, qt as toDisplayString } from "./vendor-vue-core-oGuyqViA.js";
import { t as Button_default } from "./Button-By8A3toz.js";
import { n as useTelemetry } from "./telemetry-C8VBI5GP.js";
import { Ai as useCommandStore, Ia as getTierCredits, La as getTierFeatures, qn as useDialogService, tr as useBillingContext } from "./settingStore-pm7IqVHI.js";
...
var SubscriptionFooterLinks_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			]), __props.showInvoiceHistory ? (openBlock(), createBlock(Button_default, {
				key: 0,
				variant: "muted-textonly",
				class: "text-xs text-text-secondary",
...
//# sourceMappingURL=tierBenefits-C6k1uBLw.js.map