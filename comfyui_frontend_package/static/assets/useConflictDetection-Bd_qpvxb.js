const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./i18n-CeLfv7Ek.js","./i18n-B4bSsdRi.js","./rolldown-runtime-C9Cmlsnw.js","./vendor-primevue-T0qpAVQN.js","./vendor-vue-core-oGuyqViA.js","./vendor-i18n-CPpp7rsM.js","./commands-DJua3xt8.js","./main-CNXm6Bpt.js","./nodeDefs-ODHPSASO.js","./settings-BZV9bK15.js"])))=>i.map(i=>d[i]);
import { a as __toESM, r as __name } from "./rolldown-runtime-C9Cmlsnw.js";
import { H as script$1, S as script$2, Z as script$3, lt as __vitePreload, ot as script, st as script$4 } from "./vendor-primevue-T0qpAVQN.js";
import { B as createTextVNode, Bt as toValue, C as vShow, Ct as withDirectives, D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, It as shallowRef, J as inject, Kt as normalizeStyle, M as computed, Mt as readonly, N as createBaseVNode, Nt as ref, Ot as isRef, P as createBlock, Q as nextTick, Rt as toRef, St as withCtx, T as withModifiers, U as defineComponent, V as createVNode, W as getCurrentInstance, Wt as normalizeClass, X as mergeModels, at as openBlock, ct as renderSlot, et as onBeforeUnmount, f as storeToRefs, ht as useModel, mt as useId, nt as onMounted, ot as provide, qt as toDisplayString, rt as onUnmounted, st as renderList, u as defineStore, ut as resolveDirective, v as useCssVars, vt as watch, w as withKeys, yt as watchEffect } from "./vendor-vue-core-oGuyqViA.js";
import { Et as ComboboxPortal_default, Mt as ComboboxRoot_default, Ot as ComboboxItem_default, Rt as ComboboxAnchor_default, jt as ComboboxContent_default, kt as ComboboxInput_default } from "./vendor-reka-ui-CLUGudFd.js";
import { r as useI18n } from "./vendor-i18n-CPpp7rsM.js";
import { $ as map, B as merge, F as require_semver, G as some, H as memoize, K as isNil, L as isEmpty, N as require_quick_lru, Q as flatMap, R as pickBy, U as debounce, W as uniqBy, X as orderBy, Y as partition, Z as groupBy, a as v4, et as find, i as liteClient, tt as filter, z as omit } from "./vendor-other-hebp3VVz.js";
import { t as cn } from "./src-C1FpYMFF.js";
import { t as Button_default } from "./Button-By8A3toz.js";
import { K as createSharedComposable, V as useStorage, b as useEventListener, ct as whenever, d as useAsyncState, q as get, st as watchDebounced, tt as until } from "./vendor-vueuse-De7x5bAw.js";
...
import { $n as NoResultsPlaceholder_default, $r as PropertiesAccordionItem_default, A as useWorkflowStore, Ai as useCommandStore, Ba as BaseModalLayout_default, Bo as collectAllNodes, H as useNodeDefStore, Ha as searchInputSizeConfig, Hi as capturePreservedQuery, Rr as ModelInfoField_default, Ua as searchInputVariants, Vi as PRESERVED_QUERY_NAMESPACES, Wa as transformInputSpecV1ToV2, Yn as useSettingsDialog, ci as usePrimeVueOverlayChildStyle, ct as normalizePackKeys, es as mapAllNodes, fo as useColorPaletteStore, i as app, ii as VirtualGrid_default, li as LeftSidePanel_default, n as useSettingStore, oi as SingleSelect_default, qn as useDialogService, st as normalizePackId, ts as isAbortError, ut as NodePreview_default } from "./settingStore-pm7IqVHI.js";
import { c as t } from "./i18n-B4bSsdRi.js";
import { D as paramsToCacheKey, S as isValidUrl } from "./formatUtil-gEy6QwfT.js";
import { t as useDialogStore } from "./dialogStore-BAELBvsb.js";
import { t as useUserStore } from "./userStore-rNaWLZbN.js";
import { n as OnCloseKey } from "./widgetTypes-DCo-gXsA.js";
import { n as useCopyToClipboard, t as useSystemStatsStore } from "./systemStatsStore-DX61eilr.js";
...
import { n as toError } from "./errorUtil-Bu6ObRx2.js";
...
var useBootstrapStore = defineStore("bootstrap", () => {
	...
	const { isReady: isI18nReady, error: i18nError, execute: loadI18n } = useAsyncState(async () => {
		const { mergeCustomNodesI18n } = await __vitePreload(async () => {
			const { mergeCustomNodesI18n } = await import("./i18n-CeLfv7Ek.js");
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(ComboboxRoot_default), {
				...
				default: withCtx(() => [createVNode(unref(ComboboxAnchor_default), {
					class: normalizeClass(unref(cn)(unref(searchInputVariants)({ size: __props.size }), __props.disabled && "pointer-events-none opacity-50")),
					onClick: focus
				}, {
					default: withCtx(() => [modelValue.value ? (openBlock(), createBlock(Button_default, {
						...
						_: 1
					}, 8, ["class", "aria-label"])) : __props.loading ? (openBlock(), createElementBlock("i", {
						key: 1,
						...
						key: 2,
						class: normalizeClass(unref(cn)("pointer-events-none absolute", sizeConfig.value.iconPos, sizeConfig.value.icon, __props.icon))
					...
					_: 1
				}, 8, ["class"]), createVNode(unref(ComboboxPortal_default), null, {
					default: withCtx(() => [__props.suggestions.length > 0 ? (openBlock(), createBlock(unref(ComboboxContent_default), {
						key: 0,
						position: "popper",
						"side-offset": 4,
						style: normalizeStyle(__props.contentStyle),
						class: normalizeClass(unref(cn)("z-3000 max-h-60 w-(--reka-combobox-trigger-width) overflow-y-auto", "rounded-lg border border-border-default bg-base-background p-1 shadow-lg"))
					}, {
						default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.suggestions, (suggestion, index) => {
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				fill: "none",
				class: "animate-spin",
				style: normalizeStyle({ animationDuration: __props.duration })
...
var ContentDivider_default = /*#__PURE__*/ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		useCssVars((_ctx) => ({ "v4bb7c524": _ctx.width + "px" }));
		const colorPaletteStore = useColorPaletteStore();
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				class: normalizeClass({
					...
					"content-divider--horizontal": __props.orientation === "horizontal",
					"content-divider--vertical": __props.orientation === "vertical"
				}),
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$24, [
				...
				createBaseVNode("div", _hoisted_2$21, [
					__props.showAfterWhatsNew ? (openBlock(), createElementBlock("div", _hoisted_3$16, [createBaseVNode("p", _hoisted_4$12, [
					...
					importFailedConflicts.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_5$10, [createBaseVNode("div", {
						...
						_: 1
					})])]), importFailedExpanded.value ? (openBlock(), createElementBlock("div", _hoisted_9$4, [(openBlock(true), createElementBlock(Fragment, null, renderList(importFailedConflicts.value, (packageName, i) => {
						return openBlock(), createElementBlock("div", {
							key: i,
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$23, [createBaseVNode("div", _hoisted_2$20, [createVNode(Button_default, {
				...
				_: 1
			}), __props.buttonText ? (openBlock(), createBlock(Button_default, {
				key: 0,
				variant: "secondary",
				size: "sm",
				onClick: handleButtonClick
			}, {
				default: withCtx(() => [createTextVNode(toDisplayString(__props.buttonText), 1)]),
				_: 1
			})) : createCommentVNode("", true)])]);
		};
	}
...
function usePackInstall(getNodePacks, getHasConflict, getConflictInfo) {
	...
	const installAllPacks = async () => {
		...
		if (hasConflict) {
			...
			const conflictedPackages = nodePacks.map((pack) => {
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(Button_default, {
				variant: "primary",
				size: __props.size,
				disabled: __props.isLoading || unref(isInstalling),
				onClick: withModifiers(unref(installAllPacks), ["stop"])
			}, {
				default: withCtx(() => [__props.hasConflict && !unref(isInstalling) && !__props.isLoading ? (openBlock(), createElementBlock("i", _hoisted_1$21)) : __props.isLoading || unref(isInstalling) ? (openBlock(), createBlock(DotSpinner_default, {
					key: 1,
					duration: "1s",
					size: __props.size === "sm" ? 12 : 16
		...
		return (_ctx, _cache) => {
			...
			return withDirectives((openBlock(), createBlock(Button_default, {
				...
				default: withCtx(() => [isUpdating.value ? (openBlock(), createBlock(DotSpinner_default, {
					key: 0,
					duration: "1s"
				})) : (openBlock(), createElementBlock("i", _hoisted_1$20)), createBaseVNode("span", null, toDisplayString(__props.nodePacks.length > 1 ? _ctx.$t("manager.updateAll") : _ctx.$t("manager.update")), 1)]),
				_: 1
			}, 8, ["size", "disabled"])), [[
				_directive_tooltip,
				__props.hasDisabledUpdatePacks ? _ctx.$t("manager.disabledNodesWontUpdate") : null,
				void 0,
				{ top: true }
			]]);
		};
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1$18, [
				...
				isLoadingVersions.value || isQueueing.value ? (openBlock(), createElementBlock("div", _hoisted_4$11, [createVNode(unref(script$1), { class: "mb-2 size-8" }), createTextVNode(" " + toDisplayString(_ctx.$t("manager.loadingVersions")), 1)])) : versionOptions.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_5$9, [createVNode(NoResultsPlaceholder_default, {
					...
					option: withCtx((slotProps) => [createBaseVNode("div", _hoisted_6$7, [createBaseVNode("div", _hoisted_7$7, [slotProps.option.value === "nightly" ? (openBlock(), createElementBlock("div", _hoisted_8$6)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [slotProps.option.hasConflict ? withDirectives((openBlock(), createElementBlock("i", _hoisted_9$3, null, 512)), [[_directive_tooltip, {
...
//#endregion
//#region src/workbench/extensions/manager/utils/packUpdateStatus.ts
/**
...
function isNightlyVersion(version) {
	return !!version && !(0, import_semver.valid)(version);
}
/**
...
*/
function getPackUpdateStatus(pack, managerStore) {
	...
	return {
		...
		latestVersion,
		isNightly,
		isUpdateAvailable: isInstalled && !isNightly && !!installedVersion && !!latestVersion && !!(0, import_semver.valid)(latestVersion) && (0, import_semver.compare)(latestVersion, installedVersion) > 0
	};
}
//#endregion
...
var usePackUpdateStatus = (nodePackSource) => {
	...
	const status = computed(() => getPackUpdateStatus(nodePack.value, managerStore));
	const isInstalled = computed(() => status.value.isInstalled);
	const isEnabled = computed(() => managerStore.isPackEnabled(nodePack.value?.id));
	...
	return {
		isUpdateAvailable: computed(() => status.value.isUpdateAvailable),
		isNightlyPack,
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", null, [withDirectives((openBlock(), createElementBlock("div", {
				class: normalizeClass(["inline-flex items-center gap-1 rounded-2xl py-1 text-xs", {
					"bg-dialog-surface px-1.5": __props.fill,
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1$13, [packageConflict.value?.has_conflict ? withDirectives((openBlock(), createElementBlock("div", {
				...
				showDelay: 300
			}]]) : createCommentVNode("", true), !canToggleDirectly.value ? (openBlock(), createBlock(Switch_default, {
				key: 1,
				...
				"readonly",
				"aria-label"
			])) : (openBlock(), createBlock(Switch_default, {
				key: 2,
				"model-value": isEnabled.value,
				disabled: isLoading.value,
				"aria-label": _ctx.$t("g.enableOrDisablePack"),
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(Button_default, {
				...
				default: withCtx(() => [_cache[0] || (_cache[0] = createBaseVNode("i", { class: "icon-[lucide--trash-2]" }, null, -1)), createTextVNode(" " + toDisplayString(__props.nodePacks.length > 1 ? unref(t)("manager.uninstallSelected") : unref(t)("manager.uninstall")), 1)]),
				_: 1
			}, 8, ["size"]);
		};
	}
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [
				createVNode(ModelInfoField_default, { label: unref(t)("g.description") }, {
					default: withCtx(() => [__props.nodePack.description ? (openBlock(), createBlock(MarkdownText_default, {
						key: 0,
						text: __props.nodePack.description,
						class: "text-muted-foreground"
					}, null, 8, ["text"])) : (openBlock(), createElementBlock("span", _hoisted_1$10, toDisplayString(unref(t)("manager.noDescription")), 1))]),
					_: 1
				}, 8, ["label"]),
				__props.nodePack.repository ? (openBlock(), createBlock(ModelInfoField_default, {
					key: 0,
					label: unref(t)("manager.repository")
				}, {
					default: withCtx(() => [createBaseVNode("a", {
						href: __props.nodePack.repository,
						target: "_blank",
						rel: "noopener noreferrer",
						class: "hover:text-foreground inline-flex items-center gap-1.5 text-muted-foreground no-underline transition-colors"
					}, [
						isGitHubLink(__props.nodePack.repository) ? (openBlock(), createElementBlock("i", _hoisted_3$9)) : createCommentVNode("", true),
						createBaseVNode("span", _hoisted_4$8, toDisplayString(__props.nodePack.repository), 1),
				...
				__props.nodePack.latest_version?.dependencies?.length ? (openBlock(), createBlock(ModelInfoField_default, {
					key: 2,
					label: unref(t)("manager.dependencies")
				}, {
					default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.nodePack.latest_version.dependencies, (dep, index) => {
						return openBlock(), createElementBlock("div", {
							key: index,
...
var NodesTabPanel_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			}), 128))])) : isLoading.value ? (openBlock(), createBlock(unref(script$1), { key: 1 })) : __props.nodeNames.length ? (openBlock(true), createElementBlock(Fragment, { key: 2 }, renderList(__props.nodeNames, (node) => {
				return openBlock(), createElementBlock("div", {
					key: node,
...
var WarningTabPanel_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$8, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.conflictResult?.conflicts || [], (conflict, index) => {
				return openBlock(), createElementBlock("div", {
					key: index,
...
var _hoisted_9$2 = { class: "font-inter text-xs uppercase" };
...
var InfoPanel_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return __props.nodePack ? (openBlock(), createElementBlock("div", {
				key: 0,
				...
				createVNode(PropertiesAccordionItem_default, { class: normalizeClass(unref(accordionClass)) }, {
					...
					default: withCtx(() => [
						createVNode(ModelInfoField_default, { label: unref(t)("g.name") }, {
							default: withCtx(() => [createBaseVNode("span", _hoisted_4$6, toDisplayString(__props.nodePack.name), 1)]),
							_: 1
						}, 8, ["label"]),
						!unref(importFailed) && unref(isPackInstalled)(__props.nodePack.id) ? (openBlock(), createBlock(ModelInfoField_default, {
							key: 0,
						...
						createVNode(ModelInfoField_default, { label: unref(t)("g.status") }, {
							default: withCtx(() => [createVNode(PackStatusMessage_default, {
								"status-type": __props.nodePack.status,
				...
				createVNode(PropertiesAccordionItem_default, { class: normalizeClass(unref(accordionClass)) }, {
					...
					default: withCtx(() => [createVNode(DescriptionTabPanel_default, { "node-pack": __props.nodePack }, null, 8, ["node-pack"])]),
					_: 1
				}, 8, ["class"]),
				...
				createVNode(PropertiesAccordionItem_default, { class: normalizeClass(unref(accordionClass)) }, {
					label: withCtx(() => [createBaseVNode("span", _hoisted_9$2, toDisplayString(unref(t)("g.nodes")), 1)]),
...
var InfoPanelMultiItem_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			const _directive_tooltip = resolveDirective("tooltip");
			return __props.nodePacks?.length ? (openBlock(), createElementBlock("div", _hoisted_1$6, [createVNode(PropertiesAccordionItem_default, { class: normalizeClass(unref(accordionClass)) }, {
				...
				default: withCtx(() => [
					createVNode(ModelInfoField_default, { label: unref(t)("manager.selected") }, {
						default: withCtx(() => [createBaseVNode("span", null, [createBaseVNode("span", _hoisted_6$3, toDisplayString(__props.nodePacks.length), 1), createTextVNode(" " + toDisplayString(unref(t)("manager.packsSelected")), 1)])]),
						_: 1
					}, 8, ["label"]),
					createVNode(ModelInfoField_default, { label: unref(t)("g.status") }, {
						default: withCtx(() => [createVNode(PackStatusMessage_default, {
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$5, [showDefaultBanner.value ? (openBlock(), createElementBlock("div", _hoisted_2$5, [createBaseVNode("img", {
				...
				alt: __props.nodePack.name + " banner",
...
var PackCardFooter_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const hasConflicts = computed(() => conflictInfo.value.length > 0);
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$4, [__props.nodePack.downloads ? (openBlock(), createElementBlock("div", _hoisted_2$4, [_cache[0] || (_cache[0] = createBaseVNode("i", { class: "pi pi-download text-muted" }, null, -1)), createBaseVNode("span", null, toDisplayString(formattedDownloads.value), 1)])) : (openBlock(), createElementBlock("div", _hoisted_3$4)), !isInstalled.value ? (openBlock(), createBlock(PackInstallButton_default, {
				key: 2,
				"node-packs": [__props.nodePack],
...
var PackCard_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(unref(cn)("flex size-full cursor-pointer flex-col overflow-hidden rounded-lg bg-modal-card-background transition-colors duration-200 select-none", __props.isSelected ? "ring-3 ring-modal-card-border-highlighted" : "hover:bg-modal-card-background-hovered", isDisabled.value && "opacity-60")) }, [
				createBaseVNode("div", _hoisted_1$3, [createVNode(PackBanner_default, { "node-pack": __props.nodePack }, null, 8, ["node-pack"])]),
				createBaseVNode("div", _hoisted_2$3, [createBaseVNode("div", _hoisted_3$3, [createBaseVNode("div", _hoisted_4$3, [
					createBaseVNode("span", _hoisted_5$2, toDisplayString(__props.nodePack.name), 1),
					__props.nodePack.description ? (openBlock(), createElementBlock("p", _hoisted_6$2, toDisplayString(__props.nodePack.description), 1)) : createCommentVNode("", true),
					createBaseVNode("div", _hoisted_7$2, [createBaseVNode("div", _hoisted_8$2, [
						nodesLabel.value ? (openBlock(), createElementBlock("div", _hoisted_9$1, toDisplayString(nodesLabel.value), 1)) : createCommentVNode("", true),
...
var _hoisted_9 = { class: "flex gap-2" };
	...
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$2, [
				createBaseVNode("div", _hoisted_2$2, [createBaseVNode("div", _hoisted_3$2, [createBaseVNode("div", _hoisted_4$2, [createVNode(unref(script$4), {
					shape: "circle",
					width: "1.5rem",
					height: "1.5rem"
				...
				createBaseVNode("div", _hoisted_5$1, [createBaseVNode("div", _hoisted_6$1, [createVNode(unref(script$4), {
					width: "4rem",
					height: "4rem",
					...
					createBaseVNode("div", _hoisted_9, [createVNode(unref(script$4), {
						width: "4rem",
						height: "1.5rem",
						"border-radius": "0.75rem"
					}), createVNode(unref(script$4), {
				...
				createBaseVNode("div", _hoisted_10, [createVNode(unref(script$4), {
					width: "4rem",
					height: "0.8rem"
				}), createVNode(unref(script$4), {
					width: "6rem",
...
var GridSkeleton_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { style: normalizeStyle(__props.gridStyle) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.skeletonCardCount, (n) => {
	...
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$1, [
				...
				createBaseVNode("ul", _hoisted_4$1, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.nodeNames, (name) => {
...
var useUpdateAvailableNodes = () => {
	...
	const isOutdatedPack = (pack) => getPackUpdateStatus(pack, comfyManagerStore).isUpdateAvailable;
...
function useManagerDisplayPacks(selectedTabId, searchResults, searchQuery, sortField) {
	...
	const filterOutdated = (packs) => packs.filter((p) => getPackUpdateStatus(p, comfyManagerStore).isUpdateAvailable);
		...
		displayPacks: computed(() => {
			...
			switch (tab) {
				...
				case ManagerTab.Missing: {
					const base = hasSearch ? filterWorkflowPack(searchResults.value) : workflowPacks.value;
...
var _hoisted_2 = { class: "flex w-full items-center gap-2" };
var _hoisted_3 = {
	key: 0,
	class: "relative mx-6 mt-3 mb-4 flex items-center gap-6 rounded-lg bg-yellow-500/20 p-4"
};
var _hoisted_4 = { class: "flex flex-1 flex-col gap-2" };
var _hoisted_5 = { class: "m-0 text-sm font-bold" };
var _hoisted_6 = { class: "m-0 text-xs" };
var _hoisted_7 = { class: "flex justify-end px-6 pb-4" };
var _hoisted_8 = {
	key: 0,
...
var ManagerDialog_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const managerApiDependentTabs = /* @__PURE__ */ new Set([
			ManagerTab.AllInstalled,
			ManagerTab.UpdateAvailable,
			ManagerTab.Conflicting,
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(BaseModalLayout_default, {
				...
				header: withCtx(() => [createBaseVNode("div", {
					...
					createBaseVNode("div", _hoisted_2, [createVNode(SingleSelect_default, {
						modelValue: unref(searchMode),
						"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => isRef(searchMode) ? searchMode.value = $event : null),
						class: "min-w-34",
						options: filterOptions.value,
						"content-style": unref(selectContentStyle)
					}, null, 8, [
						"modelValue",
						"options",
						"content-style"
					]), createVNode(SearchAutocomplete_default, {
				...
				contentFilter: withCtx(() => [unref(shouldShowManagerBanner) ? (openBlock(), createElementBlock("div", _hoisted_3, [
					_cache[7] || (_cache[7] = createBaseVNode("i", { class: "icon-[lucide--triangle-alert] text-lg text-warning-background" }, null, -1)),
					createBaseVNode("div", _hoisted_4, [
						createBaseVNode("p", _hoisted_5, toDisplayString(_ctx.$t("manager.conflicts.warningBanner.title")), 1),
						createBaseVNode("p", _hoisted_6, toDisplayString(_ctx.$t("manager.conflicts.warningBanner.message")), 1),
						createBaseVNode("p", {
				...
				])) : createCommentVNode("", true), createBaseVNode("div", _hoisted_7, [createVNode(SingleSelect_default, {
				...
				content: withCtx(() => [isLoading.value ? (openBlock(), createElementBlock("div", _hoisted_8, [createVNode(GridSkeleton_default, {
...
var MANAGER_CONTENT_CLASS = "w-[90vw] max-w-[1724px] sm:max-w-[1724px] h-[80vh] max-h-[1026px] min-[3000px]:max-w-[2200px] min-[3000px]:max-h-[1320px] rounded-2xl overflow-hidden";
...
//#endregion
export { useManagerState as a, useConflictAcknowledgment as c, DotSpinner_default as d, useComfyRegistryStore as f, preserveLoggedOutShareAuthAttribution as g, isValidShareId as h, ManagerUIState as i, usePackInstall as l, useBootstrapStore as m, useComfyManagerStore as n, useMissingNodes as o, config_default as p, useComfyManagerService as r, ManagerTab as s, useConflictDetection as t, useNodeConflictDialog as u };

//# sourceMappingURL=useConflictDetection-Bd_qpvxb.js.map