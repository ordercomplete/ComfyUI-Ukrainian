...
import { Lt as toRaw, Nt as ref, d as getActivePinia, vt as watch } from "./vendor-vue-core-oGuyqViA.js";
import { $ as toRef, nt as useDebounceFn } from "./vendor-vueuse-De7x5bAw.js";
import { i as api } from "./api-btlSMXR9.js";
import { t as useToastStore } from "./toastStore-D7DQZkvm.js";
import { E as useCanvasStore, c as Load3dUtils, do as useChainCallback, ho as LiteGraph, i as app, n as useSettingStore } from "./settingStore-pm7IqVHI.js";
import { c as t } from "./i18n-B4bSsdRi.js";
import { n as createLoad3d, t as useLoad3dService } from "./load3dService-DMEySLTa.js";
import { n as isLoad3dResultViewerNode } from "./nodeTypes-CVrPWNFO.js";
import { n as isAssetPreviewSupported, r as persistThumbnail } from "./assetPreviewUtil-CAtUdiU0.js";
...
var useLoad3d = (nodeOrRef) => {
	...
	const initializeLoad3d = async (containerRef) => {
		...
		try {
			...
			if (isLoad3dResultViewerNode(node.constructor.comfyClass ?? "") || node.constructor.comfyClass?.startsWith("Preview") || !(widthWidget && heightWidget)) isPreview.value = true;
...
//# sourceMappingURL=useLoad3d-DQeWn-fO.js.map