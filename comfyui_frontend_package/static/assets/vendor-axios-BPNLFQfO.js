...
*/
var encodeUTF8$1 = /* @__PURE__ */ __name((str) => encodeURIComponent(str).replace(/%([0-9A-F]{2})/gi, (_, hex) => String.fromCharCode(parseInt(hex, 16))), "encodeUTF8");
...
//#endregion
export { axios as n, AxiosHeaders as t };

//# sourceMappingURL=vendor-axios-BPNLFQfO.js.map