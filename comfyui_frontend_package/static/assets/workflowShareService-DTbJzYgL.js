...
import { B as createTextVNode, Ct as withDirectives, D as Fragment, F as createCommentVNode, Ht as unref, I as createElementBlock, M as computed, N as createBaseVNode, Nt as ref, P as createBlock, St as withCtx, U as defineComponent, V as createVNode, Wt as normalizeClass, at as openBlock, qt as toDisplayString, st as renderList, ut as resolveDirective, vt as watch } from "./vendor-vue-core-oGuyqViA.js";
...
import { Tt as partition } from "./vendor-other-hebp3VVz.js";
import { t as cn } from "./src-C1FpYMFF.js";
import { t as Button_default } from "./Button-By8A3toz.js";
import { c as zComfyHubProfile, i as api, s as zAssetInfo } from "./api-btlSMXR9.js";
import { C as unknownType, _ as objectType, b as stringType, c as booleanType, d as enumType, s as arrayType, v as preprocessType, y as recordType } from "./vendor-zod-DrbcGYyw.js";
import { Dn as Skeleton_default, fi as zGetHubWorkflowResponse, i as app, sn as buildTooltipConfig, ui as assetService } from "./settingStore-pm7IqVHI.js";
import { t as useImageQuiet } from "./useImageQuiet-DBL4QWSj.js";
...
function extractPrefill(fields) {
	...
	if (!name && !description && !tags?.length && !thumbnailType && !thumbnailUrl && !thumbnailComparisonUrl && !sampleImageUrls?.length) return null;
	return {
		name,
		description,
		tags,
...
//# sourceMappingURL=workflowShareService-DTbJzYgL.js.map